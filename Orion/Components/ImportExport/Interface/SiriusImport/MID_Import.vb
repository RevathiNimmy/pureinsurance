...
Friend NotInheritable Class MID_Import : Inherits ImportBase
...
#Region "Private Methods"
    ...
    ''' <remarks></remarks>
    Private Sub UpdateMIDPolicy(ByVal sInsuranceRef As String, ByVal sBatchRef As String, ByVal iPPCC As Integer, _
        ...
        ' Add parameters
        'TODO: Add parameters to procedure
        ...
        ' Execute command
        nReturn = m_oDatabase.SQLAction("spu_MID_Policy_Import_Failiure", "MID Import", True)
        If nReturn <> PMEReturnCode.PMTrue Then
            Throw New ApplicationException("Unable to execute ‘spu_MID_Policy_Import_Failiure?")
        End If
    End Sub
    ...
    ''' <param name="sErrors"></param>
    ''' <remarks></remarks>
    Private Sub UpdateMIDVehicle(ByVal sBatchRef As String, ByVal sInsuranceRef As String, _
        ...
        ' Execute command
        nReturn = m_oDatabase.SQLAction("spu_MID_Vehicle_Import_Failiure", "MID Import", True)
        If nReturn <> PMEReturnCode.PMTrue Then
            Throw New ApplicationException("Unable to execute ‘spu_MID_Vehicle_Import_Failiure?")
        End If
    End Sub
...
#Region "Protected Methods"
    ...
    Protected Overrides Sub ProcessElement()
        ...
        If sRegistrationNumber = "" Then
            UpdateMIDPolicy(sInsuranceRef, m_sBatchRefNum, nPPCC, nExpectedPPCC, sErrorRef, sErrors)
        Else
            UpdateMIDVehicle(m_sBatchRefNum, sInsuranceRef, sRegistrationNumber, sErrorRef, sErrors)
        End If
    End Sub
    ...
    Protected Overrides Sub FinaliseImport()
        ...
        Try
            ...
            nReturn = m_oDatabase.SQLAction("spu_MID_Import_Finalise", "Import Finalise", True)
            If nReturn <> PMEReturnCode.PMTrue Then
                Throw New Exception("Unable to execure 'spu_MID_Import_Finalise'")
            End If
