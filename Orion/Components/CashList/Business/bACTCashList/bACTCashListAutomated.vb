...
Public NotInheritable Class Automated
    ...
    Public Function Initialise(ByRef sUsername As String, ByRef sPassword As String, ByRef iUserID As Integer, ByRef iSourceID As Integer, ByRef iLanguageID As Integer, ByRef iCurrencyID As Integer, ByRef iLogLevel As Integer, ByRef sCallingAppName As String, Optional ByRef vDatabase As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Get instance of component services
    ...
    Public Function Start() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Start Failed", vApp:=ACApp, vClass:=ACClass, vMethod:=CInt("Start"), vErrNo:=CStr(Informations.Err().Number), vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    ' Log Error Message
    'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oParameters.Add Failed", vApp:=ACApp, vClass:=ACClass, vMethod:=CInt("AddKeyParam"), vErrNo:=CStr(Informations.Err().Number), vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
    ...
    '
    ' Log Error Message
    'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="BeginTrans Failed", vApp:=ACApp, vClass:=ACClass, vMethod:=CInt("BeginTrans"), vErrNo:=CStr(Informations.Err().Number), vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
    ...
    '
    ' Log Error Message
    'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CommitTrans Failed", vApp:=ACApp, vClass:=ACClass, vMethod:=CInt("CommitTrans"), vErrNo:=CStr(Informations.Err().Number), vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
    ...
    '
    ' Log Error Message
    'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="RollbackTrans Failed", vApp:=ACApp, vClass:=ACClass, vMethod:=CInt("RollbackTrans"), vErrNo:=CStr(Informations.Err().Number), vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
