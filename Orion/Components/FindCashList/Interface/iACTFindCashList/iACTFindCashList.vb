...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bACTFindCashList.Form", vInstanceManager:="ClientManager")
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            'eck140600
            m_iCashListCompanyID = .CashListCompanyID
            ' {* USER DEFINED CODE (End) *}
        End With
