...
<System.Runtime.InteropServices.ProgId("AutoCreatePmnt_NET.AutoCreatePmnt")> _
Public NotInheritable Class AutoCreatePmnt
    ...
    Private m_vAllocationId As Integer
            ...
            For lRow As Integer = vkeyarray.GetLowerBound(1) To vkeyarray.GetUpperBound(1)
                ...
                Select Case CStr(vkeyarray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.ACTKeyNameAllocationId
                        ...
                        m_vAllocationId = CInt(vkeyarray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
    ...
    Public Function NavigatorV2_Start() As Integer Implements aPMNav.NavigatorV2.Start
        ...
        Try
            ...
            With m_oBusiness
                .AllocationId = m_vAllocationId
                .CashListId = m_vCashListId
                m_lReturn = CType(.CreatePayment(), gPMConstants.PMEReturnCode)
            End With
