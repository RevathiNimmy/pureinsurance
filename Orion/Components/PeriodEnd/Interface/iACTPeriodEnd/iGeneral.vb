...
Friend NotInheritable Class General
    ...
    'developer guide no.(Late binding works fine if variable is declared as Object)
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            If m_frmInterface.Task = gPMConstants.PMEComponentAction.PMEdit Or m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView Or (m_frmInterface.AttachToScheduler = True AndAlso m_frmInterface.Task = gPMConstants.PMEComponentAction.PMAdd) Then
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        ' CF010998 - We aren't using m_oBusiness as we
                        ' deal with 2 business objects for this interface
