...
Public NotInheritable Class Automated
    ...
    '
    ' Log Error Message
    'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oParameters.Add Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="AddKeyParam", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
