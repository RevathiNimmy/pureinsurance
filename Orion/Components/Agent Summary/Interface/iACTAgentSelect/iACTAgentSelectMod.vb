...
Module MainModule
    ...
    Public Const AgentSelect As String = "AgentSelect"
    ...
    Public m_vselecteditemArray As Object
    ...
    Public Const ACIAllowConsolidatedCommission As Integer = 24
    'sj 12/11/2002 - end
    Public Const ACIOnlineAccess As Integer = 24
    Public Const ACIIsRiBroker As Integer = 25
    Public Const ACIMax As Integer = 25

    Public Const ACISurname As Integer = 25
    Public Const ACIForename As Integer = 26
    Public Const ACIAddress3 As Integer = 27
    Public Const ACIAddress4 As Integer = 28
    ...
    Public m_bSavedata As Boolean = False
 ...
 Public g_bGenericConnectionStatus As Boolean
    ...
    Public Function GetName(ByVal v_lPartyCnt As Integer, ByRef r_sPartyShortName As String, ByRef r_sPartyResolvedName As String) As Integer
        ...
        Try
            ...
            If Not IsNothing(g_oObjectManager) Then
                ...
                If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    iPMFunc.LogError(v_sClass:=ACClass, v_sMethod:="GetName", r_lFunctionReturn:=result)
                    Return result
                End If
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogError(v_sClass:=ACClass, v_sMethod:="GetName", r_lFunctionReturn:=result, excep:=excep)
            Return result
