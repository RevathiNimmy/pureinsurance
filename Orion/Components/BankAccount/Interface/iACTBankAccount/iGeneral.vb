...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            If m_frmInterface.Task = gPMConstants.PMEComponentAction.PMEdit Or m_frmInterface.Task = gPMConstants.PMEComponentAction.PMDelete Or m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView Then
                ...
                'DC281103 DC8662 -not required until rule tab reinstated
                'sw 03/02/2003 get any rules for the selected account
                'm_lReturn& = m_frmInterface.GetAndDisplayRules
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        frmInterface.BankAccountId = m_oBusiness.BankAccountId
                        ' Check for errors.
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                Case gPMConstants.PMEComponentAction.PMDelete
                    ...
                    Else
                        ...
                        If m_lReturn = gPMConstants.PMEReturnCode.PMFail Then
                            MessageBox.Show("Please delete the receipt delays to delete this account", "Warning", MessageBoxButtons.OK)
                        ...
                        If m_lReturn = gPMConstants.PMEReturnCode.PMError Then
                            MessageBox.Show("Cannot delete this account as Cash Posted - Account Now Disabled", "Warning", MessageBoxButtons.OK)
                            m_lReturn = gPMConstants.PMEReturnCode.PMTrue
                            'DJM 30/01/2004 : Simulate a cancel click.

                            m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel
                        End If

                        'If any source is attached with account then halt deletion.
                        If m_lReturn = gPMConstants.PMEReturnCode.PMRecordInUse Then
                            MessageBox.Show("Cannot delete this account - Branch attached with this account", "Delete Account", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            m_lReturn = gPMConstants.PMEReturnCode.PMTrue
