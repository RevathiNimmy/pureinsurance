...
Public NotInheritable Class Interface_Renamed
    ...
    ' CF201198 - For NavigatorV3 Class
        ...
        If Not Me.disposedValue Then
            ...
            If disposing Then
                If g_oObjectManager IsNot Nothing Then
                    ...
                    g_oObjectManager = Nothing
                End If
                If Not frmInterface Is Nothing Then
                    frmInterface.Close()
    ...
    Private Function ProcessInterface() As Integer
        ...
        With frmInterface
            ...
            ' {* USER DEFINED CODE (Begin) *}
            .AllocationArray = VB6.CopyArray(AllocationArray)
            .CompanyID = CompanyID
            .AccountID = AccountID
            .CashListTypeID = CashListTypeID
            .CashListItemID = CashListItemID 'eck220904
