...
Public NotInheritable Class Interface_Renamed
    ...
    'sw added front office receipting / payment maintenance to make navigator aware
    ...
    Private m_lClaimMode As Integer ' MEvans : 23-6-2004 : CQ4740
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bACTFindCashListItem.Form", vInstanceManager:="ClientManager")
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case ACTKeyBatchReference

                        m_sBatchReference = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
    ...
    Public Function GetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 1) = PMNavKeyConst.ACTKeyNameCashListItemId

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 1) = m_lCashListItemId
            ...
            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 3) = PMNavKeyConst.ACTKeyNameCashListItemMode

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 3) = m_lCashlistItemMode


            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 4) = PMNavKeyConst.ACTKeyNameActionKey

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 4) = m_sActionkey
    ...
    Public Function SetProcessModes(Optional ByRef vTask As Object = Nothing, Optional ByRef vNavigate As Object = Nothing, Optional ByRef vProcessMode As Object = Nothing, Optional ByRef vTransactionType As Object = Nothing, Optional ByRef vEffectiveDate As Object = Nothing) As Integer
        ...
        Try
            ...
            If g_oBusiness Is Nothing Then
                ...
                m_lReturn = g_oBusiness.SetProcessModes(vTask:=vTask, vNavigate:=vNavigate, vProcessMode:=vProcessMode, vTypeOfBusiness:=vTransactionType, vEffectiveDate:=vEffectiveDate)
    ...
    Public Function Start() As Integer
        ...
        Try
            ...
            ' if we are in claim mode and already have a cashlistitemid
            ' then there is no need to go into the find receipt screen
            ' skip this process....
            If m_lClaimMode <> 0 And m_lCashListItemId <> 0 Then
    ...
    Public Function GetID(ByRef vSearch As Object, ByRef vID As Object) As Integer
        ...
        Try
            ...
            'TODO List:to be handled at runtime
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .BatchID = m_lBatchID
            .BatchReference = m_sBatchReference
            ' {* USER DEFINED CODE (Begin) *}
            'eck090500
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            ' {* USER DEFINED CODE (Begin) *}
            'sw added 20-11-2002 make navigator aware

            m_lCashListTypeID = .CashlistTypeID
            m_sActionkey = .ActionKey
            m_lCashListID = .CashListID
            m_lCashListItemId = .CashListItemID
            m_lCashlistItemMode = .CashListItemMode
