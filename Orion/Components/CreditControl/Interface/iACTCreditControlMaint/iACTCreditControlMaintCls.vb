...
Public NotInheritable Class Interface_Renamed
    ...
    Public CashListDrawerID As Integer
    Public StartMode As Integer
    ...
    Private m_lStartupMode As Integer
    ...
    Public Property StartupMode() As Integer
        Get
            Return m_lStartupMode
        End Get
        Set(ByVal Value As Integer)
            m_lStartupMode = Value
        End Set
    End Property
    ...
    Private Function LoadInterface() As Integer
        ...
        'Some kind of test required to determine which form to
        'start with - use keys? or public method / property
        If Me.StartMode = 0 Then
        ...
        Else
            ...
            m_frmInterface.CashListDrawerID = 1
        End If
