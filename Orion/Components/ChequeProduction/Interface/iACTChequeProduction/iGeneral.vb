...
Friend NotInheritable Class General
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            Select Case ReflectionHelper.GetMember(m_frmInterface, "Status")
                Case gPMConstants.PMEReturnCode.PMCancel
                    If g_bPrinted Then
                        'PN #32164 This stuff not required anymore
                        '                sTitle = "WARNING !"
                        '                sMessage = "You have not updated the Cash List with cheque Numbers !"
                        '                iMsgResult = MsgBox(sMessage$, _
                        ''                        vbOKCancel + vbDefaultButton2 + vbQuestion, sTitle$)
                        '
                ...
                Case gPMConstants.PMEReturnCode.PMSucceed
                    'm_lReturn = m_frmInterface.PrintCheques()
