...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("WriteOffReason_NET.WriteOffReason")> _
Public NotInheritable Class WriteOffReason
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: WriteOffReason
    '
    ' Date: 14/08/1998
    '
    ' Description: Describes the WriteOffReason attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "WriteOffReason"
