...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function CallDecision() As Integer
        ...
        vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 0) = "Repeat Cash List Item Entry"

        vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 1) = gPMConstants.PMKeyNameDecisionText

        vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 1) = "Any more items to enter?"
