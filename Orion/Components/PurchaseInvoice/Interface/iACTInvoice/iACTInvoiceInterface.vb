...
Public NotInheritable Class Interface_Renamed
    ...
    Public WriteOnly Property InvoiceID() As Integer
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            ' CTAF 310800 - Default the InvoiceType to be PIN
            m_sInvoiceType = ACInvoiceTypePIN
    ...
    Public Function SetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            ' CTAF 310800
            ' Check we've got a valid InvoiceType
            If (m_sInvoiceType <> ACInvoiceTypePIN) And (m_sInvoiceType <> ACInvoiceTypePCN) Then
                ' Default to PIN
                m_sInvoiceType = ACInvoiceTypePIN
            End If
    ...
    Public Function GetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            'vKeyArray(PMKeyValue, 0) = m_lInvoiceID
    ...
    Private Function LoadInterface() As Integer
        ...
        Dim tempLoadForm As frmInterface = m_frmInterface
