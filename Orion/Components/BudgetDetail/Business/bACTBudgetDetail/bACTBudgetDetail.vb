...
Imports System.IO
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("BudgetDetail_NET.BudgetDetail")> _
Public NotInheritable Class BudgetDetail
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: ACTBudgetDetail
    '
    ' Date: 20/10/1998
    '
    ' Description: Describes the ACTBudgetDetail attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "ACTBudgetDetail"
    ...
    Public Property BudgetDetailID() As Integer
        Get

            Return m_lBudgetDetailID

        End Get
        Set(ByVal Value As Integer)

            m_lBudgetDetailID = Value
    ...
    Public Property BudgetSequence() As Integer
        Get

            Return m_lBudgetSequence

        End Get
        Set(ByVal Value As Integer)

            m_lBudgetSequence = Value
    ...
    Public Property BudgetAmount() As Decimal
        Get
            ...
            Return m_cBudgetAmount

        End Get
        Set(ByVal Value As Decimal)

            m_cBudgetAmount = Value
    ...
    Public Property ActualAmount() As Decimal
        Get
            ...
            Return m_cActualAmount

        End Get
        Set(ByVal Value As Decimal)

            m_cActualAmount = Value

        End Set
    End Property

    Public Property VarianceAmount() As Decimal
        Get

            Return m_cVarianceAmount

        End Get
        Set(ByVal Value As Decimal)

            m_cVarianceAmount = Value
