...
Public NotInheritable Class TypeTable
    ...
    ' ***************************************************************** '
    ' Class Name: TypeTable
    '
    ' Date: 14/07/1997
    '
    ' Description: Describes the TypeTable attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    ' DataBase Attributes
    Private m_iTypeTableID As Integer
    ...
    Public Property TypeTableID() As Integer
        Get

            Return m_iTypeTableID

        End Get
        Set(ByVal Value As Integer)

            m_iTypeTableID = Value
