...
Public NotInheritable Class Interface_Renamed
    ...
    ' You will respect muh authoritah (used by nav3)
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                Return result
            End If
            'Developer guide no solution no.39
            'If sHelpFile <> "" Then
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bACTFindDocument.Form", vInstanceManager:="ClientManager")
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMNavKeyConst.ACTKeyNameDocumentID
                        ...
                        m_lDocumentId = CInt(CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)))
                End Select
    ...
    Public Function GetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 1) = PMNavKeyConst.ACTKeyNameDocumentRef

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 1) = m_sDocumentRef
    ...
    Public Function GetSummary(ByRef vSummaryArray As String) As Integer
        ...
        Try
            ...
            ' Assign the key array with the parameter members.
            '    vSummaryArray(PMKeyName, 0) = "Document Ref"
    ...
    Public Function GetID(ByRef vSearch As Object, ByRef vID As Object) As Integer
        ...
        Try
            ...
            m_lReturn = ReflectionHelper.Invoke(g_oBusiness, "GetID", New Object() {vSearch, vID})
    ...
    Private Function LoadInterface() As Integer
        ...
        result = gPMConstants.PMEReturnCode.PMTrue
        If IsNothing(frmInterface) Then
            frmInterface = New iACTFindDocument.frmInterface()
        End If
