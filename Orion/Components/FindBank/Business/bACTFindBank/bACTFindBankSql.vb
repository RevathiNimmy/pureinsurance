...
Module FindBankSql
	...
	Public Const ACBankFromQueryStored As Boolean = True
    Public Const ACBankFromQueryName As String = "SelectBankQuery"
    'Developer Guide no.39
    Public Const ACBankFromQuerySQL As String = "spu_ACT_Do_FindBank"
