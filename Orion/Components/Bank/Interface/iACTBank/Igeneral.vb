...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            'PSL Issue 5984 14/08/2003 Moved this up here so that the
            'country control is loaded with values, before trying to select one
            'for this record
            ...
            'PSL Issue 5984 14/08/2003 Moved this from here so that the
            'country control is loaded with values, before trying to select one
            'for this record
            ' Display all of the lookup details.
            'm_lReturn& = m_frmInterface.DisplayLookupDetails()
                ...
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    If m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel Then
                        ...
                        If iMsgResult = System.Windows.Forms.DialogResult.No Then
                            ...
                            result = gPMConstants.PMEReturnCode.PMFalse
                        Else
                            'Delete all bank accounts attached

                            m_lReturn = m_frmInterface.DeleteBankAccounts
                    ...
                    Else
                        ...
                        ' CTAF 181000 - This is weird but it's in keeping
                        ' with the code in the rest of the object!
                        ' Pass the bank id back to the form


                        m_frmInterface.BankID = m_oBusiness.BankID
