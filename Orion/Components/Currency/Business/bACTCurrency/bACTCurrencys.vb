...
<System.Runtime.InteropServices.ProgId("Currencys_NET.Currencys")>
Public NotInheritable Class Currencys
    ...
    Private m_Currencys As Collection(Of Object)
    ...
    '
    ' ***************************************************************** '
    Public Function Add(ByRef oNewCurrency As bACTCurrency.Currency) As Integer
    ...
    Public Function Count() As Integer
        ...
        Try
            ...
            If m_Currencys.Count > 0 AndAlso m_Currencys.Item(0) Is Nothing Then
                Return m_Currencys.Count - 1
            Else
    ...
    '
    ' ***************************************************************** '
    Public Function Item(ByRef vKey As Integer) As bACTCurrency.Currency

        Dim result As bACTCurrency.Currency = Nothing
        Try
    ...
    Public Sub Clear()
        ...
        Try
            ...
            m_Currencys = New Collection(Of Object)
