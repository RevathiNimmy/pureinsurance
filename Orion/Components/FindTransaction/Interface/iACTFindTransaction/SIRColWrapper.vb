...
Friend NotInheritable Class ColWrapper 
    ...
    Public Function Item(ByVal v_vKey As String, Optional ByRef r_vItem As Object = Nothing, Optional ByRef r_vExists As Boolean = False) As Integer
        ...
        Try
            ...
            r_vItem = m_cCollection.Item(Key:=v_vKey.ToString)
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Item Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Item", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
