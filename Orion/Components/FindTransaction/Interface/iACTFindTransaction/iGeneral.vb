            ...
            Else
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    If m_lReturn = gPMConstants.PMEReturnCode.PMRecordInUse Then
                        MessageBox.Show("One or more transactions selected are locked by another process.", "Transaction(s) locked", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        result = gPMConstants.PMEReturnCode.PMFalse
                    ElseIf m_lReturn = gPMConstants.PMEReturnCode.PMNotFound Then
                        MessageBox.Show("The search criteria has been changed and invalidated the selected transactions. " & Strings.Chr(13) & Strings.Chr(10) & Strings.Chr(13) & Strings.Chr(10) & _
                                        "Please refresh the results and make your selection again.", "Search criteria changed", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        result = gPMConstants.PMEReturnCode.PMFalse
