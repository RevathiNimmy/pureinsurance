...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        m_lReturn = CType(frmList, SSP.S4I.Interfaces.ILocalInterface).Initialise()
        ...
        m_lReturn = frmList.ShowForm(lDisplayState:=FormShowConstants.Modal)
        ...
        With frmList
            m_lStatus = .Status
            m_iSelectedCompanyID = .SelectedCompanyID
        End With
