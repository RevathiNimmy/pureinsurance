...
<ToolboxData("<{0}:PureInsAddEntityControl runat=""server""> </{0}:PureInsAddEntityControl>")>
Public NotInheritable Class PureInsAddEntityControl 
...
#Region "Fields"
    ...
    Private ctrlEntity As LabelControlPair

    Private Const controlPrefix As String = "ctlPureAddEntity"
    Private Const labelPrefix As String = "lblPureAddEntity"
    Private Const entityControlName As String = "entity"
...
#Region "Properties"
    ...
    Public Overrides Property RuleLine As EngineCommon.IRuleLine
        Get
            ...
            'Entity
            ruleLineObj.Var1 = GetPostedControlValue(ctrlEntity.Control)
    ...
    Public Overrides ReadOnly Property TargetControls As System.Collections.Generic.IEnumerable(Of System.Web.UI.Control)
        Get
            ...
            If ctrlEntity IsNot Nothing Then
                controls.Add(ctrlEntity.Control)
            End If
...
#End Region
    ...
    Public Overrides Sub BuildUI()
        ...
        If ruleLineObj IsNot Nothing Then
            entity = ruleLineObj.Var1
        End If

        ctrlEntity = AddLabelControlPair(entityControlName, "Entity", entity, Nothing, Nothing)

        dataEntryControlsAdded = True
    End Sub

    Public Overrides Sub ClearAndInitialiseInputControlValues()
        RuleLineEditorHelper.SetControlValue(ctrlEntity.Control, "")
    End Sub
