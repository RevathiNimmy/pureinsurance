...
<ToolboxData("<{0}:PureInsAddOutputTaxControl runat=""server""> </{0}:PureInsAddOutputTaxControl>")>
Public NotInheritable Class PureInsAddOutputTaxControl 
...
#Region "Fields"
    ...
    Private Const controlPrefix As String = "ctlPureAddOutputTax"
    Private Const labelPrefix As String = "lblPureAddOutputTax"
