...
Imports System
'Modified on 6/20/2010 4:07:56 PM refer developer guide no 129. 
Imports SharedFiles
...
Public NotInheritable Class Business
    ...
    ' ***************************************************************** '
    ' Class Name: FindProductType
    '
    ' Date: 27th September 1996
    '
    ' Description: Creatable Find Product Type class
    '
    ' Edit History:
    ...
    '****************************************************************** '
    ' Name: GetProductByAgent (Public)
    '
    ' Description: Gets available products given an agent
    '
    '****************************************************************** '
    Public Function GetProductByAgent(ByVal v_lAgentPartyCnt As Integer, ByRef r_vResultArray(,) As Object) As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                m_lError = .Parameters.Add(sName:="party_cnt", vValue:=CStr(v_lAgentPartyCnt), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMInteger)

                If m_lError <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error Message
                    bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Set Parameter failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetProductByAgent")

                    Return gPMConstants.PMEReturnCode.PMFalse
                End If

                m_lError = .SQLSelect(sSQL:=ACProductByAgentSQL, sSQLName:=ACProductByAgentName, bStoredProcedure:=ACProductByAgentStored, vResultArray:=r_vResultArray)

                If m_lError <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error Message
                    bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="m_oDatabase.SQLSelect failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetProductByAgent")
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetProductByAgent Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetProductByAgent", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    '****************************************************************** '
    Public Function GetDetails(ByRef r_vResultArray(,) As Object, ByRef r_lNumberOfRecords As Integer, Optional ByVal v_iUserId As Integer = 0) As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                m_lError = .Parameters.Add(sName:="user_id", vValue:=CStr(m_iUserID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMInteger)
