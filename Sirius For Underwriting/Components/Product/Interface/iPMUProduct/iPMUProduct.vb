...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_sCode As String = "" 'use to tell parent window new product details
    Private m_sDescription As String = "" 'use to tell parent window new product details
    Private m_dtProductEffectiveDate As Date 'use to tell parent window new product details
    ...
    ' ***************************************************************** '
    'Developer Guide No. 101
    Public Function SetProcessModes(Optional ByRef vTask As Object = Nothing, Optional ByRef vNavigate As Object = Nothing, Optional ByRef vProcessMode As Object = Nothing, Optional ByRef vTransactionType As Object = Nothing, Optional ByRef vEffectiveDate As Object = Nothing, Optional ByRef vProductList As Object = Nothing) As Integer
        ...
        Try
            ...
            If Not Information.IsNothing(vProductList) Then
                m_vProductList = vProductList
            End If
            '</Pankaj>
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With m_ofrmInterface
            ...
            m_sCode = .Code
            m_dtProductEffectiveDate = .ProductEffectiveDate
