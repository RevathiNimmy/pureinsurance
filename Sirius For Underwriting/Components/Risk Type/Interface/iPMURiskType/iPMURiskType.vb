...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_sCode As String = "" 'use to tell parent window new RiskType details
    'Developer Guide No.101
    Private m_vDescription As Object 'use to tell parent window new RiskType details
    Private m_dtRiskTypeEffectiveDate As Date 'use to tell parent window new RiskType details
    ...
    ' ***************************************************************** '
    'Developer Guide No.101
    Public Function SetProcessModes(Optional ByRef vTask As Object = Nothing, Optional ByRef vNavigate As Object = Nothing, Optional ByRef vProcessMode As Object = Nothing, Optional ByRef vTransactionType As Object = Nothing, Optional ByRef vEffectiveDate As Object = Nothing, Optional ByRef vRiskTypeList As Object = Nothing) As Integer
        ...
        Try
            ...
            If Not Information.IsNothing(vRiskTypeList) Then
                m_vRiskTypeList = vRiskTypeList
            End If
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With objFrmInterface
            ...
            m_sCode = .Code
            m_dtRiskTypeEffectiveDate = .RiskTypeEffectiveDate
            m_vDescription = .Description
