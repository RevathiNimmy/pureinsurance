...
Public NotInheritable Class Interface_Renamed
    ...
    'Private m_vLive As String = ""
    Private m_vLive As Object
    Private m_lRuleTypeID As Long
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .RiskTypeID = m_vRiskTypeID
            .RiskTypeRuleSetID = m_lRiskTypeRuleSetID
            .RuleType = m_sRuleType
            .RuleTypeID = m_lRuleTypeID
            .DREExecutorURL = m_sDREExecutorURL
            .DREDefaultToken = m_sDREDefaultToken
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            m_lRiskTypeRuleSetID = .RiskTypeRuleSetID
            m_sCode = .Code
            m_vDescription = .Description
            m_dtRuleEffectiveDate = .RuleEffectiveDate
            m_vFileName = .FileName
            m_vLive = .Live
            m_lRuleTypeID = .RuleTypeID
            m_sDREExecutorURL = .DREExecutorURL
            m_sDREDefaultToken = .DREDefaultToken
            m_sRuleTypeDesc = .RuleTypeDescription
