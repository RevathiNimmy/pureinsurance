...
Module MainModule
	...
	Public Const ACApp As String = "bSIRLaunchAutoRenewalsInvite"
	...
	Private m_oBatch As bSIRAutomaticRenewalsInvite.Business
	...
	Public Sub Main()
		...
		Try 
			...
			m_oBatch = New bSIRAutomaticRenewalsInvite.Business()
