...
Public NotInheritable Class NavigatorV3
    ...
    Public Function Initialise() As Integer
        ...
        Catch
            ...
            ''        sMsg:="Failed to initialise the object", _
            ''        vApp:=ACApp, _
            ''        vClass:=ACClass, _
            ''        vMethod:="Initialise", _
            ''        vErrNo:=Err.Number, _
    ...
    Public Function NavigatorV3_SetKeys(ByRef vKeyArray(,) As Object) As Integer Implements aPMNav.NavigatorV3.SetKeys
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                '        LogMessage _
                ''            iType:=PMLogError, _
                ''            sMsg:="Interface.SetKeys failed.", _
                ''            vApp:=ACApp, _
                ''            vClass:=ACClass, _
                ''            vMethod:="SetKeys"
    ...
    Public Function NavigatorV3_GetKeys(ByRef vKeyArray(,) As Object) As Integer Implements aPMNav.NavigatorV3.GetKeys
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                '        LogMessage _
                ''            iType:=PMLogError, _
                ''            sMsg:="Interface.GetKeys failed.", _
                ''            vApp:=ACApp, _
                ''            vClass:=ACClass, _
                ''            vMethod:="GetKeys"
    ...
    Public Function NavigatorV3_GetSummary(ByRef vSummaryArray As Object) As Integer Implements aPMNav.NavigatorV3.GetSummary
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                '        LogMessage _
                ''            iType:=PMLogError, _
                ''            sMsg:="Interface.GetSummary failed.", _
                ''            vApp:=ACApp, _
                ''            vClass:=ACClass, _
                ''            vMethod:="GetSummary"
        ...
        Catch
            ...
            ''        vApp:=ACApp, _
            ''        vClass:=ACClass, _
            ''        vMethod:="NavigatorV3_GetSummary", _
            ''        vErrNo:=Err.Number, _
            ''        vErrDesc:=Err.Description
    ...
    Public Function NavigatorV3_SetProcessModes(Optional ByRef vTask As Object = Nothing, Optional ByRef vNavigate As Object = Nothing, Optional ByRef vProcessMode As Object = Nothing, Optional ByRef vTransactionType As Object = Nothing, Optional ByRef vEffectiveDate As Object = Nothing) As Integer Implements aPMNav.NavigatorV3.SetProcessModes
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                '        LogMessage _
                ''            iType:=PMLogError, _
                ''            sMsg:="Interface.SetProcessModes failed.", _
                ''            vApp:=ACApp, _
                ''            vClass:=ACClass, _
        ...
        Catch
            ...
            '    LogMessage _
            ''        iType:=PMLogOnError, _
            ''        sMsg:="SetProcessModes Failed", _
            ''        vApp:=ACApp, _
            ''        vClass:=ACClass, _
            ''        vMethod:="NavigatorV3_SetProcessModes", _
            ''        vErrNo:=Err.Number, _
            ''        vErrDesc:=Err.Description
