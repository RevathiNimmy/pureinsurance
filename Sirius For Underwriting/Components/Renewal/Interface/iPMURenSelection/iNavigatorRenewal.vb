...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("NavigatorRenewal_NET.NavigatorRenewal")>
Public NotInheritable Class NavigatorRenewal
    Implements IDisposable
    Implements aPMNav.NavigatorV3
    ' ***************************************************************** '
    ' Class Name: NavigatorRenewal
    '
    ' Date: 16/10/2002
    '
    ...
    ' which class this is.
    Private Const ACClass As String = "NavigatorRenewal"
    ...
    Public Function NavigatorV3_Start() As Integer Implements aPMNav.NavigatorV3.Start
        ...
        Try
            ...
            'Show only the renewal tab
            'Developer Guide No. 50
            SSTabHelper.SetTabVisible(objfrmInterface.tabMainTab, 1, False)
            SSTabHelper.SetTabVisible(objfrmInterface.tabMainTab, 0, True)
