...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        If m_lRenewalMode = ACSilentRenewal Then
            ...
            result = objfrmInterface.SilentRenewal(v_lInsuranceFolderCnt:=m_lInsuranceFolderCnt)
            objfrmInterface.Status = gPMConstants.PMEReturnCode.PMOK
        Else
    ...
    Private Function LoadInterface() As Integer
        ...
        result = gPMConstants.PMEReturnCode.PMTrue
        'Developer Guide No. 50
        If IsNothing(objfrmInterface) Then
