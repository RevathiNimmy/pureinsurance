...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("NavigatorV3RAA_NET.NavigatorV3RAA")> _
Public NotInheritable Class NavigatorV3RAA
    Implements IDisposable
    Implements aPMNav.NavigatorV3
    ' ***************************************************************** '
    ' Class Name: NavigatorV3RAA
    '
    ' Purpose: Implement "Renewal Acceptance with Amendments" task functionality.
    '
    ' Date: 21/09/00
    '
    ...
    ' which class this is.
    Private Const ACClass As String = "NavigatorV3RAA"
    ...
    Public Function NavigatorV3_Start() As Integer Implements aPMNav.NavigatorV3.Start
        ...
        Try
            ...
            'set renewal mode
            m_oInterface.RenewalMode = ACRenModeRAA
