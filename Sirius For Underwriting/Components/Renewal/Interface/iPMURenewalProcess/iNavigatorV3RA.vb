...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("NavigatorV3RA_NET.NavigatorV3RA")> _
Public NotInheritable Class NavigatorV3RA
    Implements IDisposable
    Implements aPMNav.NavigatorV3
    ' ***************************************************************** '
    ' Class Name: NavigatorV3RA
    '
    ' Purpose: Implement "Renewal Acceptance without Amendments" task functionality.
    '
    ' Date: 21/09/00
    '
    ...
    ' which class this is.
    Private Const ACClass As String = "NavigatorV3RA"
    ...
    Public Function NavigatorV3_Start() As Integer Implements aPMNav.NavigatorV3.Start
        ...
        Try
            ...
            'set renewal mode
            m_oInterface.RenewalMode = ACRenModeRA
