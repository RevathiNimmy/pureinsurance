...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("NavigatorV3RI_NET.NavigatorV3RI")> _
Public NotInheritable Class NavigatorV3RI
    Implements IDisposable
    Implements aPMNav.NavigatorV3
    ' ***************************************************************** '
    ' Class Name: NavigatorV3RI
    '
    ' Purpose: Implement "Renewal Invites" task functionality.
    '
    ' Date: 21/09/00
    '
    ...
    ' which class this is.
    Private Const ACClass As String = "NavigatorV3RI"
    ...
    Public Function NavigatorV3_Start() As Integer Implements aPMNav.NavigatorV3.Start
        ...
        Try
            ...
            'set renewal mode
            m_oInterface.RenewalMode = ACRenModeRI
