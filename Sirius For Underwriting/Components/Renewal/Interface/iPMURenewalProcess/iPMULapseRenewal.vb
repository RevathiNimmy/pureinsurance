...
Imports SharedFiles
Partial Public Class frmLapseRenewal
    Inherits System.Windows.Forms.Form
    Private Sub frmLapseRenewal_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
    ...
    Private m_sLapseReasonDesc As String = ""

    Public ReadOnly Property LapseReasonID() As Integer
        Get
            Return m_lLapseReasonID
        End Get
    End Property

    Public ReadOnly Property LapseReasonDesc() As String
        Get
            Return m_sLapseReasonDesc
        End Get
    End Property
    ...
    Private Function ShowLapseReasons() As Integer
        ...
        Try
            ...
            stbStatus.Items.Item(0).Text = "Searching please wait"

            vReturnColumn(0) = "lapsed_reason_id"
            vReturnColumn(1) = "description"

            'AG - 11/10/2004 - PN13722 - Added the condition to filter out deleted lapse reasons.

            m_lReturn = g_oBusiness.GetValueFromTable(v_sTableName:="Lapsed_Reason", v_vReturnColumn:=vReturnColumn, v_sKeyColumn:="is_deleted", v_sKeyValue:="0", v_iDataType:=gPMConstants.PMEDataType.PMInteger, r_vResult:=m_vLapseReasons)
            ...
            'Display a searching message.
            stbStatus.Items.Item(0).Text = CStr(m_lItemsFound) & " items found"
    ...
    Private Function StoreLapseReason() As Integer
        ...
        Try
            ...
            m_lLapseReasonID = CInt(lvwLapseReasons.Items.Item(iSelected - 1).Text)
            m_sLapseReasonDesc = ListViewHelper.GetListViewSubItem(lvwLapseReasons.Items.Item(iSelected - 1), ACLapseReason).Text
