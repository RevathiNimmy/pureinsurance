...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        result = gPMConstants.PMEReturnCode.PMTrue
        'Check for direct Business
        If m_lBusinessTypeId = 1 And Not m_bIsSubAgentAdded Then
            Return result
        End If
        ...
        'RWH(22/02/2001) Get status from interface.
        m_lStatus = objfrmInterface.Status
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case "is_subagent_added"

                        m_bIsSubAgentAdded = CBool(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
