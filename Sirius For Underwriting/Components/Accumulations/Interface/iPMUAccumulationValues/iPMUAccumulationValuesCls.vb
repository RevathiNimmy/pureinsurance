...
Public NotInheritable Class Interface_Renamed
    ...
    Private frmAccumulationValues As frmAccumulationValues
    ...
    Public Function SetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                If vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow) IsNot Nothing Then
    ...
    Private Function ProcessInterface() As Integer
        ...
        'Start
        frmAccumulationValues = New frmAccumulationValues()
        'End
        If g_lInsuranceFileCnt = 0 Then
            frmAccumulationValues.ShowDialog()
        Else
            m_lReturn = CType(frmAccumulationValues.RepopulateValues(), gPMConstants.PMEReturnCode)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                'Log Error Message
                iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="An error has occured which has stopped this process", vApp:=ACApp, vClass:=ACClass, vMethod:="ProcessInterface", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            End If
            '        If frmAccumulationValues.AnyFailed Then
