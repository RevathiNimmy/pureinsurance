...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMUMaintainAURule.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMUMaintainAURule.frmInterface, ByRef oBusiness As Object) As Integer
