...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMUMaintainAuthority.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMUMaintainAuthority.frmInterface, ByRef oBusiness As Object) As Integer
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    If m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel Then
                        ...
                        End If
                    Else
                        'Just exit, all updates have already been done.
