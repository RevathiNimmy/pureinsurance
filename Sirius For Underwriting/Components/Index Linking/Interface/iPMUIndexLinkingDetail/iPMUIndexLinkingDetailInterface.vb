...
Public NotInheritable Class Interface_Renamed
    ...
    ' Public m_ofrmInterface As Object
    ...
    Public WriteOnly Property Description() As Integer
        Set(ByVal Value As Integer)
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case Convert.ToString(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case "index_linking_id"

                        m_lIndexLinkingId = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                    Case PMNavKeyConst.PMKeyNameDescription

                        'remove cint
                        ' m_vDescription = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                        m_vDescription = vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)
                    Case "Task"
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_ofrmInterface
            ...
            ' {* USER DEFINED CODE (Begin) *}
            .IndexLinkingId = m_lIndexLinkingId

            'Developer Guide No. 24
            .Description = m_vDescription
