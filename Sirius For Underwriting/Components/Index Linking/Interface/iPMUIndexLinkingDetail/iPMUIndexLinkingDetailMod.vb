...
Module MainModule
	...
	Public Const ACApp As String = "iPMUIndexLinkingDetail"
	...
	Public Const ACIndexLinking As Integer = 102
	Public Const ACEffectiveDate As Integer = 103
	Public Const ACPercentage As Integer = 104
	...
	Public Const ACFieldPosIndexLinkingDetailID As Integer = 0
	Public Const ACFieldPosIndexLinkingID As Integer = 1
	Public Const ACFieldPosEffectiveDate As Integer = 2
	Public Const ACFieldPosIsDeleted As Integer = 3
	Public Const ACFieldPosPercentage As Integer = 4
