...
Partial Friend Class frmDetail
    ...
    Private Function CalculatePremiumAndDisplay() As Integer
        ...
        Try
            ...
            'Perform the rounding up 0 decimal if product option IsSuppressDecimalValues is ON
            cPremium = gPMFunctions.ToSafeRound(cPremium, 2, IsSuppressDecimalValues)
            cThisPremium = gPMFunctions.ToSafeRound(cThisPremium, 2, IsSuppressDecimalValues)
...
Err_CalculatePremiumAndDisplay:
    ...
    Private Sub cboRateType_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cboRateType.Click
        ...
        If Not m_bSysChange Then
            ...
            'Reset to zero to prevent the decimal places.
            If m_bSuppressDecimalValues AndAlso sRateType = "V" Then
                'Get the values
                If txtRate.Visible Then
                    txtRate.Text = StringsHelper.Format(0, "##0.0000").Trim()
                ElseIf txtRate2.Visible Then
                    txtRate2.Text = StringsHelper.Format(0, "##0.0000").Trim()
                ElseIf txtRate3.Visible Then
                    txtRate3.Text = StringsHelper.Format(0, "##0.0000").Trim()
                End If
            End If
    ...
    Private Sub txtRate3_KeyPress(ByVal eventSender As Object, ByVal eventArgs As KeyPressEventArgs) Handles txtRate3.KeyPress
        ...
        If IsSuppressDecimalValues = True AndAlso cboRateType.ItemCode.Trim = "V" Then
    ...
    Private Sub txtSumInsured_KeyPress(ByVal eventSender As Object, ByVal eventArgs As KeyPressEventArgs) Handles txtSumInsured.KeyPress
        Dim KeyAscii As Integer = Strings.Asc(eventArgs.KeyChar)
        If IsSuppressDecimalValues = True Then
            gPMFunctions.NumPress(eventSender, eventArgs)
            Exit Sub
        End If
        If KeyAscii = 8 Then
        ...
        If Strings.Len(txtSumInsured.Text) > 11 Then
    ...
    Private Sub txtThisPremium_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtThisPremium.KeyPress
    ...
    Public Function CheckPremiumOverride() As Integer
        ...
        Try
            ...
            If String.IsNullOrEmpty(txtThisPremium.Text) Then
                txtThisPremium.Text = "0"
            End If
    ...
    Private Sub frmDetail_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub txtSumInsured_MouseDown(sender As Object, e As MouseEventArgs) Handles txtSumInsured.MouseDown
        If IsSuppressDecimalValues = True Then
            If e.Button = Windows.Forms.MouseButtons.Right Then
                Dim blankContextMenu As New ContextMenu()
                txtSumInsured.ContextMenu = blankContextMenu
            End If
        End If
    End Sub
    ...
    Private Sub txtRate_MouseDown(sender As Object, e As MouseEventArgs) Handles txtRate.MouseDown
        If IsSuppressDecimalValues = True Then
            If e.Button = Windows.Forms.MouseButtons.Right Then
                Dim blankContextMenu As New ContextMenu()
                txtRate.ContextMenu = blankContextMenu
            End If
        End If
    End Sub

    Private Sub txtThisPremium_MouseDown(sender As Object, e As MouseEventArgs) Handles txtThisPremium.MouseDown
        If IsSuppressDecimalValues = True Then
            If e.Button = Windows.Forms.MouseButtons.Right Then
                Dim blankContextMenu As New ContextMenu()
                txtThisPremium.ContextMenu = blankContextMenu
            End If
        End If
    End Sub
    Private Sub txtRate2_MouseDown(sender As Object, e As MouseEventArgs) Handles txtRate2.MouseDown
        If IsSuppressDecimalValues = True Then
            If e.Button = Windows.Forms.MouseButtons.Right Then
                Dim blankContextMenu As New ContextMenu()
                txtRate2.ContextMenu = blankContextMenu
            End If
        End If
    End Sub
    Private Sub txtRate3_MouseDown(sender As Object, e As MouseEventArgs) Handles txtRate3.MouseDown
        If IsSuppressDecimalValues = True Then
            If e.Button = Windows.Forms.MouseButtons.Right Then
                Dim blankContextMenu As New ContextMenu()
                txtRate3.ContextMenu = blankContextMenu
            End If
        End If
    End Sub
End Class
