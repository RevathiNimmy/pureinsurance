...
Public NotInheritable Class Business
    ...
    ''' <summary>
    ''' Hold the flag to round upto 0 decimal places.
    ''' </summary>
    ''' <remarks></remarks>
    Private m_bSuppressDecimalValues As Boolean
    Private Const kStandardRoundingUpto As Integer = 4
    ...
    Public Function Initialise(ByVal sUsername As String, ByVal sPassword As String, ByVal iUserID As Integer, ByVal iSourceID As Integer, ByVal iLanguageID As Integer, ByVal iCurrencyID As Integer, ByVal iLogLevel As Integer, ByVal sCallingAppName As String, Optional ByVal bStandAlone As Boolean = False, Optional ByVal vDatabase As Object = Nothing) As Long
        ...
        Try
            ...
            m_lReturn = CType(gPMComponentServices.CheckDatabase(m_sUsername, m_iSourceID, m_iLanguageID, v_lPMProductFamily:=PMProductFamily,
                                                                r_bNewInstanceCreated:=m_bCloseDatabase, r_oCheckedDatabase:=m_oDatabase,
            ...
            'Set the default number of decimal places to 4
            m_iInsuranceFileNoOfDp = 4
    ...
    Public Function CalculatePremium(ByVal v_lRatingSectionTypeId As Integer, ByVal v_cSumInsured As Decimal, ByRef v_cAnnualPremium As Decimal, ByRef v_cThisPremium As Decimal, ByRef v_cAnnualRate As Decimal) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CalculatePremium Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CalculatePremium", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function AddSectionAndPerils(ByVal v_lRatingSectionTypeId As Integer, ByVal v_lPolicySectionTypeId As Integer, ByVal v_cAnnualPremium As Decimal, ByVal v_cThisPremium As Decimal, ByVal v_cAnnualRate As Double, ByVal v_cSumInsured As Decimal, ByVal v_lRateTypeId As Integer, ByVal v_lOriginalFlag As Integer, ByVal v_iDefinedCurrencyID As Integer, ByVal v_lCountryID As Integer, ByVal v_lStateID As Integer, ByVal v_iIsAmended As Integer, ByVal v_cCalculatedPremium As Decimal, ByVal v_sOverrideReason As String, ByVal v_iAutoCalculated As Integer, ByVal v_lEarningPatternId As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="AddSectionAndPerils Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="AddSectionAndPerils", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function DeleteSectionAndPerils() As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                m_lReturn = .SQLAction(sSQL:=ACDeletePerilsSQL, sSQLName:=ACDeletePerilsName, bStoredProcedure:=ACDeletePerilsStored)

                If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then

                    'Call the Stored procedure to Delete the Rating section also
                    m_lReturn = .SQLAction(sSQL:=ACDeleteRatingSectionSQL, sSQLName:=ACDeleteRatingSectionName, bStoredProcedure:=ACDeleteRatingSectionStored)
                End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="DeleteSectionAndPerils Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteSectionAndPerils", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetInsuranceHeaderDetails(ByRef r_sInsuranceHolderShortName As String, ByRef r_sInsuranceHolderName As String, ByRef r_sInsuranceHolderResolvedName As String, ByRef r_sInsuranceRef As String, ByRef r_sInsuranceFolderDescription As String, ByRef r_sInsuranceCurrencyCode As String, ByRef r_sInsuranceCurrencyCaption As String, ByRef r_iInsuranceCurrencyID As Integer, ByRef r_lInsuranceCompanyID As Integer) As Integer
        ...
        Try
            ...
            sSQL = "Select ifo.insurance_holder_cnt, ifi.insurance_ref, ifi.insurance_folder_cnt, ifi.currency_id, ifi.source_id " &
                   "from insurance_file ifi, insurance_folder ifo where ifi.insurance_file_cnt = " & CStr(m_lInsuranceFileCnt) &
            ...
            lInsuranceHolderCnt = ToSafeInteger(vArray(0, 0))

            sInsuranceRef = CStr(vArray(1, 0))

            lInsuranceFolderCnt = ToSafeInteger(vArray(2, 0))

            iCurrencyID = ToSafeInteger(vArray(3, 0))


            r_lInsuranceCompanyID = ToSafeInteger(vArray(4, 0))
            r_sInsuranceRef = sInsuranceRef

            sSQL = "Select last_trans_description " &
            ...
            sSQL = "Select name, shortname, resolved_name " &
    ...
    Public Function GetDataModel(ByRef sGISDataModel As String) As Integer
        ...
        Try
            ...
            lPolicyBinder = ToSafeInteger(vArray(1, 0))
            ...
            sSQL = "DELETE" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "FROM " & sGISDataModel & "_Output" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "WHERE " & sGISDataModel & "_policy_binder_id IN (" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "SELECT " & sGISDataModel & "_policy_binder_id" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "FROM " & sGISDataModel & "_policy_binder" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "WHERE gis_policy_link_id = " & CStr(lPolicyBinder) & ")" & Strings.ChrW(13) & Strings.ChrW(10)
    ...
    Public Function PopulateRatingSections(ByRef r_vResultArray As Object) As Integer
        Return PopulateRatingSections(r_vResultArray:=r_vResultArray,
                                    v_bIsBackdatedMTA:=False,
                                    r_lPostChangeRiskCnt:=0,
                                    v_dtMTADateCurrent:=#12/30/1899#,
                                    v_bExistsPreAndPost:=False,
                                    v_sRiskMergeStatus:="")
    End Function

    Public Function PopulateRatingSections(ByRef r_vResultArray As Object,
    ...
    Public Function PopulateRatingSections() As Integer
        Return PopulateRatingSections(r_vResultArray:=Nothing,
                                    v_bIsBackdatedMTA:=False,
                                    r_lPostChangeRiskCnt:=0,
                                    v_dtMTADateCurrent:=#12/30/1899#,
                                    v_bExistsPreAndPost:=False,
    ...
    Public Function PopulateRatingSections(ByRef r_vResultArray As Object,
                                         ByRef v_bIsBackdatedMTA As Boolean,
                                         ByRef r_lPostChangeRiskCnt As Integer,
                                         ByRef v_dtMTADateCurrent As Date,
                                         ByRef v_bExistsPreAndPost As Boolean,
        ...
        Dim otempArray(,) As Object = Nothing
        Dim bIsMandatoryRisk As Boolean
        Dim dtOriginalCoverStartDate As Date
        Dim bFoundRoundingSection As Boolean = False
        Dim bNotFoundRoundingSection As Boolean = False
        Dim bIsOutputObjectIsBlank As Boolean = False
        Try
            ...
            m_lReturn = CType(GetProRataFlag(v_lInsuranceFileCnt:=m_lInsuranceFileCnt, r_iNBProrata:=m_iNBProRata,
                                             r_iMTAProrata:=m_iMTAProRata, r_iShortPeriodRate:=m_iShortPeriodRated), gPMConstants.PMEReturnCode)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            bPMAddParameter.AddParameterLite(m_oDatabase, "nInsuranceFileCnt", ToSafeInteger(m_lInsuranceFileCnt), gPMConstants.PMEParameterDirection.PMParamInput, gPMConstants.PMEDataType.PMLong, True)
            ...
            Else
                If Informations.IsArray(oArray) Then
                    If CStr(oArray(0, 0)).ToUpper().Trim = "MTAQUOTE" Then
                        m_sTransactionType = "MTA"
                    ElseIf (CStr(oArray(0, 0))).ToUpper().Trim = "MTAQCAN" Then
                        m_sTransactionType = "MTC"
                    ElseIf (CStr(oArray(0, 0))).ToUpper().Trim = "MTAQREINS" Then
            ...
            If (gPMFunctions.NullToString(CStr(oArray(3, 0))) = "") Or (gPMFunctions.NullToString(CStr(oArray(3, 0))) = "0") Then
                m_lOriginalRiskCnt = -1
            Else

                m_lOriginalRiskCnt = ToSafeInteger(oArray(3, 0))
            End If
            ...
            nPolicyBinder = ToSafeInteger(oArray(1, 0))
            ...
            Else
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Return gPMConstants.PMEReturnCode.PMFalse
                End If
                m_lReturn = m_oDatabase.Parameters.Add(sName:="cover_start_date",
                      vValue:=dtOriginalCoverStartDate,
                      iDirection:=gPMConstants.PMEParameterDirection.PMParamInput,
                ...
                ElseIf (m_sTransactionType = "PT") Then
                    m_lReturn = m_oDatabase.SQLSelect(
                        sSQL:=kSelectInsuranceFileCntForPTSQL,
                        sSQLName:=kSelectInsuranceFileCntForPTName,
                        bStoredProcedure:=kSelectInsuranceFileCntForPTStored,
                        lNumberRecords:=gPMConstants.PMAllRecords,
                        vResultArray:=oArray)
                Else

                    m_lReturn = m_oDatabase.Parameters.Add(sName:="Trans_type", vValue:=CStr(m_sTransactionType),
                                                       iDirection:=gPMConstants.PMEParameterDirection.PMParamInput,
                ...
                Else
                    ...
                    nInsuranceFileCnt = ToSafeInteger(oArray(0, 0))
            ...
            m_lReturn = CType(GetRoundingInfo(v_lProductID:=nProductId, r_iRoundPremium:=m_iRoundPremium,
                                              ...
                                              r_sRoundingSectionCode:=m_sRoundingSectionCode), gPMConstants.PMEReturnCode)
            ...
            If m_iShortPeriodRated = 1 AndAlso (m_sTransactionType <> "MTC" OrElse Not m_bIsMTCRatingRulesEnabled) Then
                ...
                m_lReturn = CType(GetShortPeriodRate(v_lProductID:=nProductId, v_dtOldStartDate:=dtOldCoverStartDate,
                                                     ...
                                                     r_dProRataRate:=m_dProRataRate), gPMConstants.PMEReturnCode)
            ...
            If Not bShortPeriodRated Then
                ...
                If m_sTransactionType = "MTC" Then
                    bCancellation = False
                ElseIf (m_sTransactionType = "DRI" AndAlso m_lInsuranceFileTypeId = 8) Then
                    bCancellation = False
                Else
                    bCancellation = True
                End If

                If ProRata And (bCancellation Or Not m_bIsMTCRatingRulesEnabled) Then
            ...
            If sStatusFlag <> "D" Then
                ...
                If (m_sTransactionType = "MTC" AndAlso Informations.IsArray(oArray) AndAlso m_bIsMTCRatingRulesEnabled) OrElse
                   (m_sTransactionType = "MTC" AndAlso Informations.IsArray(oArray) AndAlso bIsMandatoryRisk) Then
                    ...
                    If m_lOriginalRiskCnt <> -1 Then
                        ...
                        If m_sTransactionType = "MTR" Then
                            bPMAddParameter.AddParameterLite(m_oDatabase, "type", CStr(4),
                                                             gPMConstants.PMEParameterDirection.PMParamInput,
                                                             gPMConstants.PMEDataType.PMLong, True)
                        ElseIf (m_sTransactionType = "MTC" OrElse (m_sTransactionType = "DRI" AndAlso m_lInsuranceFileTypeId = 8)) Then
            ...
            If m_lOriginalRiskCnt <> -1 Then
                ...
                If m_lOriginalRiskCnt <> -1 AndAlso v_bIsBackdatedMTA AndAlso r_lPostChangeRiskCnt <> 0 Then
                    ...
                    If _
                        Informations.IsNothing(m_oDatabase.Records.Item(0).Fields()("inception_date")) = False AndAlso
                ...
                m_lReturn = CType(MergeArrays(vMTAArray:=oArray, vOriginalArray:=oRatingSectionArray, vMergedArray:=oMergedArray), gPMConstants.PMEReturnCode)
            ...
            If Informations.IsArray(oArray) Then
                ...
                For lTemp As Integer = oArray.GetLowerBound(1) To oArray.GetUpperBound(1)
                    ...
                    If CStr(oArray(ACODeclineReason, lTemp)) <> "" Then
                        ...
                        m_sDeclineReasons = m_sDeclineReasons & CStr(oArray(ACODeclineReason, lTemp)) & Strings.ChrW(13) & Strings.ChrW(10)

                    ElseIf (CStr(oArray(ACOReferReason, lTemp)) <> "") Then

                        m_sReferReasons = m_sReferReasons & CStr(oArray(ACOReferReason, lTemp)) & Strings.ChrW(13) & Strings.ChrW(10)

                    ElseIf (CStr(oArray(ACOMessage, lTemp)) <> "") Then

                        m_sMessages = m_sMessages & CStr(oArray(ACOMessage, lTemp)) & Strings.ChrW(13) & Strings.ChrW(10)
                    Else
                        ...
                        If CStr(oArray(ACOPolicyRatingSectionType, lTemp)) <> "" Then
                            ...
                            m_lReturn = CType(GetPolicyIdFromCode(
                                ...
                                cAnnualRate:=dAnnualRate, lRateTypeId:=nRateTypeId), gPMConstants.PMEReturnCode)
                        End If
                        ...
                        If CStr(oArray(ACORiskRatingSectionType, lTemp)) <> "" Then
                            ...
                            m_lReturn = CType(GetRatingIdFromCode(sCode:=CStr(oArray(ACORiskRatingSectionType, lTemp)),
                                                                  ...
                                                                  iCurrencyID:=nCurrencyId), gPMConstants.PMEReturnCode)
                        End If
                        ...
                        Else
                            dAnnualRate = If(
                               Decimal.TryParse(CStr(oArray(ACORate, lTemp)), NumberStyles.Number,
                                                CultureInfo.CurrentCulture.NumberFormat, dbNumericTemp), CDec(oArray(ACORate, lTemp)), 0)
                        ...
                        If CStr(oArray(ACORateTypeId, lTemp)) <> "" Then
                            ...
                            If CDbl(oArray(ACORateTypeId, lTemp)) <> 0 Then
                                ...
                                nRateTypeId = ToSafeInteger(oArray(ACORateTypeId, lTemp))
                            End If
                        End If
                        ...
                        If (nPolicyRatingSectionId <> -1) OrElse (nRiskRatingSectionId <> -1) Then
                            ...
                            ElseIf m_sTransactionType = "MTA" AndAlso CDbl(oArray.GetValue(ACOOriginalFlag, lTemp)) = 1 AndAlso ToSafeLong(oArray.GetValue(ACRateIsAmended, lTemp)) = 1 Then
                                dOriginalAnnualPremium = CDec(oArray.GetValue(ACOOriginalPremium, lTemp))
                                dOriginalthisPremium = CDec(oArray.GetValue(ACOPremium, lTemp))
                            ElseIf (m_sTransactionType = "MTA" Or m_sTransactionType = "MTR" Or m_sTransactionType = "DRI" Or m_sTransactionType = "PT") And CDbl(oArray.GetValue(ACOOriginalFlag, lTemp)) = 1 Then
                                dOriginalAnnualPremium = CDec(oArray.GetValue(ACOOriginalPremium, lTemp))
                                dOriginalthisPremium = dOriginalAnnualPremium
                            ElseIf ToSafeInteger(oArray(ACOOriginalFlag, lTemp)) = 1 And m_sTransactionType = "MTC" Then
                                dOriginalAnnualPremium = ToSafeDecimal(oArray(ACOOriginalPremium, lTemp))
                                dOriginalthisPremium = ToSafeDecimal(oArray(ACOPremium, lTemp))
                            Else
                                dOriginalAnnualPremium = ToSafeDecimal(oArray(ACOOriginalPremium, lTemp))
                                dOriginalthisPremium = ToSafeDecimal(oArray(ACOOriginalPremium, lTemp))
                            End If

                            'JMK 01/08/2001 - make current Annual premium zero for Cancellation
                            If (m_sTransactionType = "MTC" OrElse m_lInsuranceFileTypeId = 8) AndAlso Not bIsMandatoryRisk Then
                                dAnnualPremium = 0
                            Else
                                'Tracy Richards - 04/09/03 Protect against blank strings
                                ...
                                If CStr(oArray(ACOPremium, lTemp)) = "" Then
                                    dAnnualPremium = 0
                                Else
                                    If gPMFunctions.ToSafeLong(oArray(ACOOriginalFlag, lTemp)) = 1 Then
                                        dAnnualPremium = CDec(oArray(ACOOriginalPremium, lTemp))
                                       If gPMFunctions.ToSafeLong(oArray(ACRateIsAmended, lTemp)) = 1 Then
                                           If CDec(oArray(ACOPremium, lTemp)) <> 0 Then
                                               dOriginalthisPremium = CDec(oArray(ACOPremium, lTemp))
                                           End If
                                       End If                                                     
                                    ElseIf gPMFunctions.ToSafeLong(oArray(ACRateIsAmended, lTemp)) = 1 Then
                                        dAnnualPremium = CDec(oArray(ACOOriginalPremium, lTemp))
                                        dOriginalthisPremium = CDec(oArray(ACOPremium, lTemp))
                                    Else
                            ...
                            If _
                                ...
                                (m_sTransactionType = "MTA" OrElse m_sTransactionType = "MTR" OrElse (m_sTransactionType = "DRI" AndAlso m_lInsuranceFileTypeId <> 8) OrElse
                                 m_sTransactionType = "PT") AndAlso CDbl(oArray(ACOOriginalFlag, lTemp)) = 1 Then
                                If m_sTransactionType = "MTC" AndAlso bIsMandatoryRisk AndAlso
                                    ((ToSafeInteger(oArray(ACODisableNewProRata, lTemp), 0) = 2 AndAlso CDbl(oArray(ACOOriginalFlag, lTemp)) = 0) OrElse
                                      (ToSafeInteger(oArray(ACODisableOriginalProRata, lTemp), 0) = 2 AndAlso CDbl(oArray(ACOOriginalFlag, lTemp)) = 1)) Then
                                    m_dProRataRate = 0
                                    dThisPremium = 0
                                    dOriginalAnnualPremium = 0
                                ElseIf _
                                    (dtExpiryDate < dtOldExpiryDate OrElse m_bExtensionOfExpiryDate) AndAlso
                                     Not v_bIsBackdatedMTA Then
                                    'fetch the proratarate applied on the original risk
                                    If m_iMTAProRata = 1 AndAlso Not (m_sTransactionType = "DRI" AndAlso m_lInsuranceFileTypeId = 9) Then
                                        If Not IsTemporaryMTA Then
                                            m_lReturn = CType(GetProRataRate(v_lProductID:=nProductId,
                                                                             v_dtOldStartDate:=dtOldCoverStartDate,
                                                                             v_dtOldEndDate:=dtOldExpiryDate,
                                                                             v_dtStartDate:=dtOldCoverStartDate,
                                                                             v_dtEndDate:=dtOldExpiryDate,
                                    ...
                                    If ToSafeInteger(oArray(ACODisableOriginalProRata, lTemp), 0) = 1 Then
                                        dThisPremium = ToSafeRound(-(dOriginalthisPremium), kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    Else
                                        dThisPremium = ToSafeRound(-(dOriginalthisPremium) * dOriginalRiskProrataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                ...
                                Else
                                    ...
                                    If ToSafeInteger(oArray(ACODisableOriginalProRata, lTemp), 0) = 1 Then
                                        dThisPremium = ToSafeRound(-(dOriginalthisPremium), kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    Else
                                        dThisPremium = ToSafeRound(-(dAnnualPremium) * m_dProRataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    End If
                                End If
                            Else
                                ...
                                If ToSafeInteger(oArray(ACODisableNewProRata, lTemp), 0) = 1 Then
                                    m_dProRataRate = 1
                                    dThisPremium = ToSafeRound((dAnnualPremium - dOriginalthisPremium) * m_dProRataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                ElseIf ToSafeInteger(oArray(ACODisableNewProRata, lTemp), 0) = 2 And m_sTransactionType = "MTC" Then
                                    If CDbl(oArray(ACOOriginalFlag, lTemp)) = 1 Then
                                        m_lReturn = CType(GetProRataRate(v_lProductID:=nProductId,
                                                         v_dtOldStartDate:=dtOldCoverStartDate,
                                                         v_dtOldEndDate:=dtOldExpiryDate,
                                                         v_dtStartDate:=dtCoverStartDate, v_dtEndDate:=dtExpiryDate,
                                                         ...
                                                         v_dtInceptionDate:=dtInceptionDate),
                                          gPMConstants.PMEReturnCode)
                                        dOriginalAnnualPremium = -dOriginalAnnualPremium
                                        dThisPremium = ToSafeRound((dOriginalAnnualPremium) * m_dProRataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    ...
                                    End If
                                Else
                                    If gPMFunctions.ToSafeLong(oArray(ACRateIsAmended, lTemp)) = 1 AndAlso m_sTransactionType = "MTA" Then
                                        dThisPremium = ToSafeRound((dOriginalthisPremium) * m_dProRataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    Else
                                        dThisPremium = ToSafeRound((dAnnualPremium - dOriginalthisPremium) * m_dProRataRate, kStandardRoundingUpto, m_bSuppressDecimalValues)
                                    End If
                                End If
                            ...
                            If _
                                ...
                                bFoundRoundingSection = True
                                sSQL = "SELECT rs.risk_cnt" & Strings.ChrW(13) & Strings.ChrW(10) &
                                       "FROM rating_section rs" & Strings.ChrW(13) & Strings.ChrW(10) &
                                       "WHERE rs.risk_cnt = " & CStr(m_lRiskID) & Strings.ChrW(13) & Strings.ChrW(10) &
                                       "AND rs.rating_section_type_id = " & CStr(m_lRoundingSection) & Strings.ChrW(13) &
                                       Strings.ChrW(10) &
                                ...
                                If Not Informations.IsArray(otempArray) Then
                                    ...
                                    If _
                                        ...
                                        m_lReturn =
                                            CType(GetRoundingSectionAmounts(r_cAnnualPremium:=dRoundingAnnualPremium,
                                                                            ...
                                                                            v_lOriginal_Flag:=
                                                                               ToSafeInteger(oArray(ACOOriginalFlag, lTemp))),
                                                  gPMConstants.PMEReturnCode)
                                ...
                                End If
                            End If
                            If m_sTransactionType = "MTC" OrElse (m_sTransactionType = "DRI" AndAlso m_lInsuranceFileTypeId = 8) Then
                                m_lReturn = CType(AddSectionAndPerils(v_lRatingSectionTypeId:=nRiskRatingSectionId,
                                                                      ...
                                                                      v_cSumInsured:=gPMFunctions.ToSafeCurrency(oArray(ACOSumInsured, lTemp)),
                                                                      v_lRateTypeId:=nRateTypeId,
                                                                      v_lOriginalFlag:=gPMFunctions.ToSafeLong(oArray(ACOOriginalFlag, lTemp)),
                                                                      v_iDefinedCurrencyID:=nCurrencyId,
                                                                      v_lCountryID:=gPMFunctions.ToSafeLong(oArray(ACOCountryId, lTemp)),
                                                                      v_lStateID:=gPMFunctions.ToSafeLong(oArray(ACOStateId, lTemp)),
                                                                      v_iAutoCalculated:=1,
                                                                      v_iIsAmended:=gPMFunctions.ToSafeLong(oArray(ACRateIsAmended, lTemp)), v_cCalculatedPremium:=0, v_sOverrideReason:="",
                                                                      v_lEarningPatternId:=gPMFunctions.ToSafeLong(oArray(ACOEarningPatternID, lTemp))), gPMConstants.PMEReturnCode)
                            Else
                                m_lReturn = CType(AddSectionAndPerils(v_lRatingSectionTypeId:=nRiskRatingSectionId,
                                                                    v_lPolicySectionTypeId:=nPolicyRatingSectionId,
                        ...
                        For lTemp As Integer = oArray.GetLowerBound(1) To oArray.GetUpperBound(1)
                            ...
                            If CStr(oArray(ACOPolicyRatingSectionType, lTemp)) <> "" Then
                                ...
                                m_lReturn = CType(GetPolicyIdFromCode(
                                    ...
                                    lRateTypeId:=nRateTypeId), gPMConstants.PMEReturnCode)
                            End If
                            ...
                            If (nPolicyRatingSectionId <> -1) OrElse (nRiskRatingSectionId <> -1) Then
                                'It Will round upto zero decimals if m_bSuppressDecimalValues is ON otherwise perform standard rounding only
                                dThisPremium = ToSafeRound(CDec(oArray(ACOPremium, lTemp)), kStandardRoundingUpto, m_bSuppressDecimalValues)
                                dAnnualPremium = ToSafeRound(CDec(oArray(ACOOriginalPremium, lTemp)), kStandardRoundingUpto, m_bSuppressDecimalValues)
                                ...
                                m_lReturn = CType(AddSectionAndPerils(v_lRatingSectionTypeId:=nRiskRatingSectionId,
                                                                  ...
                                                                  v_cThisPremium:=dThisPremium,
                                                                  v_cAnnualRate:=dAnnualRate,
                                                                  v_cSumInsured:=CDec(oArray(ACOSumInsured, lTemp)),
                                                                  v_lRateTypeId:=nRateTypeId,
                                                                  v_lOriginalFlag:=ToSafeInteger(oArray(ACOOriginalFlag, lTemp)),
                                                                  v_iDefinedCurrencyID:=nCurrencyId,
                                                                  v_lCountryID:=ToSafeInteger(oArray(ACOCountryId, lTemp)),
                                                                  v_lStateID:=ToSafeInteger(oArray(ACOStateId, lTemp)),
                                                                  v_iIsAmended:=0, v_cCalculatedPremium:=0, v_sOverrideReason:="",
                                                                  v_iAutoCalculated:=1,
                                                                  v_lEarningPatternId:=ToSafeInteger(oArray(ACOEarningPatternID, lTemp))), gPMConstants.PMEReturnCode)
            ...
            If m_iRoundPremium = 1 AndAlso Not bNotFoundRoundingSection Then
                'we will be needing to round this premium total
                'so create a rounding rating section ready for later
                bNotFoundRoundingSection = True
                sSQL = "SELECT rs.risk_cnt" & Strings.ChrW(13) & Strings.ChrW(10) &
                       "FROM rating_section rs" & Strings.ChrW(13) & Strings.ChrW(10) &
                       "WHERE rs.risk_cnt = " & CStr(m_lRiskID) & Strings.ChrW(13) & Strings.ChrW(10) &
                       "AND rs.rating_section_type_id = " & CStr(m_lRoundingSection) & Strings.ChrW(13) & Strings.ChrW(10) &
                       "AND rs.original_flag = 0" & Strings.ChrW(13) & Strings.ChrW(10)
                ...
                If Not Informations.IsArray(oArray) Then
                    ...
                    m_lReturn = CType(AddSectionAndPerils(v_lRatingSectionTypeId:=m_lRoundingSection,
                                                          ...
                                                          v_cAnnualPremium:=Math.Round(dRoundingAnnualPremium, 4),
                                                          v_cThisPremium:=Math.Round(dRoundingThisPremium, 4),
                                                          ...
                                                          v_iIsAmended:=0, v_cCalculatedPremium:=0, v_sOverrideReason:="", v_lEarningPatternId:=0), gPMConstants.PMEReturnCode)
                End If
            ...
            If nRiskStatus = 0 Then
                m_lReturn = CType(CheckQuestions(bAllAnswered:=bAllAnswered, sRequirement:="pre_quote"), gPMConstants.PMEReturnCode)
            ...
            If nRiskStatus = 0 Then
                m_lReturn = CType(CheckQuestions(bAllAnswered:=bAllAnswered, sRequirement:="post_quote"), gPMConstants.PMEReturnCode)
            ...
            If nRiskStatus = 0 Then
                m_lReturn = CType(CheckQuestions(bAllAnswered:=bAllAnswered, sRequirement:="purchase"), gPMConstants.PMEReturnCode)
            ...
            'During cancellation verify calculated premium is not greater than billed premium, if it is greater than billed premium then update return premium.
            If m_sTransactionType = "MTC" Then
                m_lReturn = CType(ValidateAndUpdateReturnPremium(m_lRiskID, m_lOriginalRiskCnt), gPMConstants.PMEReturnCode)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="PopulateRatingSections Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="PopulateRatingSections", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetOriginalAnnualPremium(ByRef lRiskRatingSectionId As Integer, ByRef lPolicyRatingSectionId As Integer, ByRef cOriginalAnnualPremium As Decimal, ByRef lRatingSectionCnt As Integer) As Integer 'PN40959 (RC)
        ...
        Try
            ...
            sSQL = "SELECT CASE is_amended WHEN 1 THEN this_premium ELSE annual_premium END" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "FROM rating_section" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "WHERE risk_cnt = " & CStr(m_lOriginalRiskCnt) & Strings.ChrW(13) & Strings.ChrW(10)

            If lRiskRatingSectionId = -1 Then
                sSQL = sSQL & "AND rating_section_type_id IS NULL" & Strings.ChrW(13) & Strings.ChrW(10)
            Else
                sSQL = sSQL & "AND rating_section_type_id = " & CStr(lRiskRatingSectionId) & Strings.ChrW(13) & Strings.ChrW(10)
            End If

            If lPolicyRatingSectionId = -1 Then
                sSQL = sSQL & "AND policy_section_type_id IS NULL" & Strings.ChrW(13) & Strings.ChrW(10)
            Else
                sSQL = sSQL & "AND policy_section_type_id = " & CStr(lPolicyRatingSectionId) & Strings.ChrW(13) & Strings.ChrW(10)
            End If
            sSQL = sSQL & "AND rating_section_id = " & CStr(lRatingSectionCnt) & Strings.ChrW(13) & Strings.ChrW(10) 'PN40959 (RC)
            sSQL = sSQL & "AND original_flag=0 " & Strings.ChrW(13) & Strings.ChrW(10)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetOriginalAnnualPremium Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetOriginalAnnualPremium", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetRatingSectionTypes(ByRef vResultArray(,) As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetRatingSectionTypes Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRatingSectionTypes", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetRateTypes(ByRef vResultArray(,) As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetRateTypes Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRateTypes", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function ApplyCoinsurance(ByVal v_lInsuranceFileCnt As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ApplyCoinsurance Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ApplyCoinsurance", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function ApplyCoinsuranceToRisk() As Integer
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ApplyCoinsuranceToRisk Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ApplyCoinsuranceToRisk", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Private Function LookForNulls(ByRef sTable As String, ByRef sColumns As String, ByRef bAllAnswered As Boolean, Optional ByRef sColumnType As String = "", Optional ByRef sDataType As String = "") As Integer
        ...
        sSQL = "SELECT " & sColumns & Strings.ChrW(13) & Strings.ChrW(10) &
               "FROM " & sTable & " o," & Strings.ChrW(13) & Strings.ChrW(10) &
               m_sDataModel & "_policy_binder pb," & Strings.ChrW(13) & Strings.ChrW(10) &
               "gis_policy_link pl" & Strings.ChrW(13) & Strings.ChrW(10) &
               "WHERE pl.gis_policy_link_id = pb.gis_policy_link_id" & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND o." & m_sDataModel & "_policy_binder_id = pb." & m_sDataModel & "_policy_binder_id" & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND pl.insurance_file_cnt = " & CStr(m_lInsuranceFolderCnt) & Strings.ChrW(13) & Strings.ChrW(10) &
                   "AND pl.risk_id = " & CStr(m_lRiskID) & Strings.ChrW(13) & Strings.ChrW(10)
        ...
        For lTemp As Integer = vArray.GetLowerBound(0) To vArray.GetUpperBound(0)
            ...
            For lTemp2 As Integer = vArray.GetLowerBound(1) To vArray.GetUpperBound(1)
                ...
                If (Convert.IsDBNull(auxVar) Or Informations.IsNothing(auxVar)) And sTempDataType <> "20" Then
    ...
    Private Function GetPolicyIdFromCode(ByRef sCode As String, ByRef lId As Integer, ByRef cAnnualRate As Double, ByRef lRateTypeId As Integer) As Integer
        ...
        If Convert.IsDBNull(m_oDatabase.Parameters.Item("id").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("id").Value) Then
            lId = -1
        Else
    ...
    Private Function GetRatingIdFromCode(ByRef sCode As String, ByRef lId As Integer, ByRef cAnnualRate As Double, ByRef lRateTypeId As Integer, ByRef iCurrencyID As Integer) As Integer
        ...
        sSQL = "SELECT rate, rate_type_id, currency_id" & Strings.ChrW(13) & Strings.ChrW(10) &
               "FROM rating_section_type" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "WHERE rating_section_type_id = " & CStr(lId) & Strings.ChrW(13) & Strings.ChrW(10)
    ...
    Private Function GetShortPeriodRate(ByVal v_lProductID As Integer, ByVal v_dtOldStartDate As Date, ByVal v_dtOldEndDate As Date, ByVal v_dtStartDate As Date, ByVal v_dtEndDate As Date, ByRef r_dProRataRate As Double) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Throw New System.Exception(gPMConstants.Constants.vbObjectError.ToString() + ", GetShortPeriodRate, Unable to create business object 'bSIRShortPeriodRate.Business'")
            End If

            ' Get the rate based on new policy details.

            m_lReturn = oBusiness.GetShortPeriodRate(v_lProductID:=v_lProductID, v_sType:=If(m_sTransactionType = "MTC", "C", "P"), v_dtStartDate:=v_dtStartDate, v_dtEndDate:=v_dtEndDate, v_dtTransactDate:=v_dtStartDate, r_dRefundRate:=r_dProRataRate)
            Select Case m_lReturn
                Case gPMConstants.PMEReturnCode.PMTrue, gPMConstants.PMEReturnCode.PMNotFound
                    result = m_lReturn
                Case Else
                    Throw New System.Exception(gPMConstants.Constants.vbObjectError.ToString() + ", GetShortPeriodRate, Unable to retrieve short period rates")
            End Select
    ...
    Public Function GetProRataRate(ByVal v_lProductID As Integer, ByVal v_dtOldStartDate As Date, ByVal v_dtOldEndDate As Date, ByVal v_dtStartDate As Date, ByVal v_dtEndDate As Date, ByRef r_dProRataRate As Double, ByRef v_dtInceptionDate As Date) As Integer
        ...
        Dim dProRataRate, dProrata As Double
        ...
        Try
            ...
            If Informations.IsArray(oResultArray) Then
                ...
                bIsTrueMonthlyPolicy = If(CDbl(oResultArray(0, 0)) = 1, 1, 0)

                If bIsTrueMonthlyPolicy Then
                    dtDate = v_dtStartDate
                    dProrata = 0

                    nMonthCount = Informations.DateDiff("m", v_dtStartDate, v_dtEndDate, DayOfWeek.Sunday, FirstWeekOfYear.FirstJan1)

                    If (m_lIsMidnightRenewal = 0) Then
                        dtEndDate = Informations.DateAdd("d", -1, v_dtEndDate)
                    Else
                    ...
                    Select Case (dtDate.Month)
                        ...
                        Case Else
                            nTotalDaysInMonth = Informations.DateDiff("d", dtDate, Informations.DateAdd("m", 1, dtDate))
                    End Select

                    If Informations.DateDiff("d", v_dtStartDate, dtEndDate) + 1 = nTotalDaysInMonth Then
                        r_dProRataRate = 1
                        Return nResult
                        Exit Function
                    End If
                    ...
                    Do While dtDate <= v_dtEndDate
                        Select Case dtDate.Month
                            Case 1, 3, 5, 7, 8, 10, 12
                                nTotalDaysInMonth = 31
                            Case Else
                                nTotalDaysInMonth = Informations.DateDiff("d", dtDate, dtDate.AddMonths(1), DayOfWeek.Sunday, FirstWeekOfYear.FirstJan1)
                        End Select
                        ...
                        If dtDate.Month = v_dtEndDate.Month Then
                            ''PN 61501
                            nPolicyDays = Informations.DateDiff("d", dtDate, v_dtEndDate, DayOfWeek.Sunday, FirstWeekOfYear.FirstJan1) + 1
                        Else
                            nPolicyDays = Informations.DateDiff("d", dtDate, dtLastDateofMonth, DayOfWeek.Sunday, FirstWeekOfYear.FirstJan1) + 1
                        End If
                ...
                Else
                    ...
                    If m_lIsMidnightRenewal = 1 Then
                    ...
                    If Informations.DateDiff("d", dtInceptionDate, dtEndDate) >= 365 Then
                        dtTempEndDate = dtEndDate
                    Else
                        dtTempEndDate = dtInceptionDate.AddYears(1)
                    End If

                    If (dtInceptionDate.Month = 2 AndAlso dtInceptionDate.Day = 29) OrElse (dtTempEndDate.Month = 2 AndAlso dtTempEndDate.Day = 29) Then
                        nBaseLength = 366
                    Else
                        Do While CDate(dtTmpDate) < CDate(dtTempEndDate)
                            If (dtTmpDate.Day = 1 AndAlso dtTmpDate.Month <> 2) OrElse (dtTmpDate.Year Mod 4 <> 0) Then
                                dtTmpDate = Informations.DateAdd("m", 1, dtTmpDate)
                            Else
                                dtTmpDate = Informations.DateAdd("d", 1, dtTmpDate)
                            End If

                            If dtTmpDate.Month = 2 AndAlso dtTmpDate.Day = 29 Then
                                nBaseLength = 366
                                Exit Do
                            End If
                        Loop
                    ...
                    Dim nPeriodLength As Integer = 0
                    nPeriodLength = Informations.DateDiff("d", dtStartDate, dtEndDate)
                    'Dim dProRataRate As Double = 0.0
        ...
        Catch ex As System.Exception
            nResult = gPMConstants.PMEReturnCode.PMError
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetProRataRate Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetProRataRate", vErrNo:=Informations.Err().Number, vErrDesc:=ex, excep:=ex)
            Return nResult
        End Try
    End Function
    ...
    Private Function GetProRataFlag(ByVal v_lInsuranceFileCnt As Integer, ByRef r_iNBProrata As Integer, ByRef r_iMTAProrata As Integer, Optional ByRef r_iShortPeriodRate As Integer = 0) As Integer
        ...
        Else
            ...
            r_iNBProrata = ToSafeInteger(vResultArray(0, 0))
        End If
        ...
        Else
            ...
            r_iMTAProrata = ToSafeInteger(vResultArray(1, 0))
        End If
        ...
        Else
            ...
            r_iShortPeriodRate = ToSafeInteger(vResultArray(2, 0))
        End If
    ...
    Private Function GetRoundingInfo(ByVal v_lProductID As Integer, ByRef r_iRoundPremium As Integer, ByRef r_lRoundingSectionID As Integer, ByRef r_sRoundingSectionCode As String) As Integer
        ...
        Else
            ...
            r_iRoundPremium = ToSafeInteger(vResultArray(0, 0))
        End If
        ...
        Else
            ...
            r_lRoundingSectionID = ToSafeInteger(vResultArray(1, 0))
        End If
    ...
    Public Function GetTransactionType() As Integer
        ...
        Try
            ...
            If Informations.IsArray(vArray) Then
                ...
                m_lTransactionType = ToSafeInteger(vArray(0, 0))
                vArray = Nothing
                Return result
            End If
    ...
    Private Function MergeArrays(ByRef vMTAArray(,) As Object, ByRef vOriginalArray(,) As Object, ByRef vMergedArray(,) As Object) As Integer
        ...
        If Informations.IsArray(vMTAArray) Then
            If Informations.IsArray(vOriginalArray) Then
                'We need to merge
            Else
                'Nowt to do
                vMergedArray = vMTAArray.Clone
                Return result
            End If
        Else
            If Informations.IsArray(vOriginalArray) Then
                'Use this one
                vMergedArray = vOriginalArray.Clone
                Return result
            Else
                'Nowt to do
                Return result
        ...
        For lTemp As Integer = vOriginalArray.GetLowerBound(1) To vOriginalArray.GetUpperBound(1)
            For lTemp2 = vMTAArray.GetLowerBound(1) To vMTAArray.GetUpperBound(1)
                If ((vOriginalArray(ACORiskRatingSectionType, lTemp))).ToUpper.Trim = ((vMTAArray(ACORiskRatingSectionType, lTemp2))).ToUpper.Trim Then
        ...
        For lTemp As Integer = vOriginalArray.GetLowerBound(1) To vOriginalArray.GetUpperBound(1)
            ...
            vMergedArray(ACRateIsAmended, lTemp) = vOriginalArray(ACRateIsAmended, lTemp)
        ...
        For lTemp As Integer = vMTAArray.GetLowerBound(1) To vMTAArray.GetUpperBound(1)
            ...
            vMergedArray(ACRateIsAmended, lHowMany + lTemp) = vMTAArray(ACRateIsAmended, lTemp)
    ...
    Public Function GetRoundingSectionAmounts(ByRef r_cAnnualPremium As Decimal, ByRef r_cThisPremium As Decimal, ByVal v_lOriginal_Flag As Integer) As Integer
        ...
        Try
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("annual_premium").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("annual_premium").Value) Then
                r_cAnnualPremium = 0
            Else
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("this_premium").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("this_premium").Value) Then
                r_cThisPremium = 0
            Else
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetRoundingSectionAmounts Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRoundingSectionAmounts", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function RecalculatePremium(ByRef r_vRatingSection As Object, ByVal v_vRateTypes As Object, ByRef r_cReturnPremium As Decimal, ByRef r_cPremiumDueNet As Decimal, ByRef r_cPremiumDueTax As Decimal, ByRef r_cPremiumDueGross As Decimal, ByRef r_cNewPremiumNet As Decimal, ByRef r_cNewPremiumTax As Decimal, ByRef r_cNewPremiumGross As Decimal, ByRef r_cNewAnnPremNet As Decimal, ByRef r_cNewAnnPremTax As Decimal, ByRef r_cNewAnnPremGross As Decimal, ByRef r_cOldPremiumNet As Decimal, ByRef r_cOldPremiumTax As Decimal, ByRef r_cOldPremiumGross As Decimal, ByRef r_cOldAnnPremNet As Decimal, ByRef r_cOldAnnPremTax As Decimal, ByRef r_cOldAnnPremGross As Decimal, ByRef r_cTotalAnnualTax As Decimal, ByVal v_vOriginal(,) As Object, ByRef r_bCancelledPolicy As Boolean) As Integer
        ...
        Dim sRateTypeCode As String = String.Empty
        Dim sTemp As String
        ...
        Try
            ...
            If Informations.IsNothing(v_vRateTypes) Then
            ...
            If iRoundPremium = 1 Then
                ...
                For iLine As Integer = lLbound To lUBound
                    ...
                    lRatingSectionTypeId = ToSafeInteger(r_vRatingSection(ACRatingSectionTypeIdCol, iLine))
            ...
            If Informations.IsArray(v_vOriginal) Then
                ...
                For lTemp As Integer = lLbound To lUBound
                    ...
                    lRatingSectionTypeId = ToSafeInteger(v_vOriginal(ACRatingSectionTypeIdCol, lTemp))
            ...
            If Informations.IsArray(r_vRatingSection) Then
                ...
                For lTemp As Integer = lLbound To lUBound
                    ...
                    If CStr(r_vRatingSection(ACOriginalFlagCol, lTemp)) = "0" Or r_bCancelledPolicy Then
                        ...
                        lRatingSectionTypeId = ToSafeInteger(r_vRatingSection(ACRatingSectionTypeIdCol, lTemp))
                        ...
                        If (iRoundPremium = 0) Or (lRatingSectionTypeId <> lRoundingSectionId) Then
                            ...
                            lRateTypeId = ToSafeInteger(r_vRatingSection(ACRateTypeIdCol, lTemp))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:=m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Calculate Premium", vApp:=ACApp, vClass:="", vMethod:="RecalculatePremium", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetRatingSectionTypeTax(ByVal v_lRatingSectionTypeId As Integer, ByRef r_dTaxRate As Double) As Integer
        ...
        Try
            ...
            If Not Informations.IsArray(vResultArray) Then
                result = gPMConstants.PMEReturnCode.PMTrue
                r_dTaxRate = 0
                ' bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogInfo, sMsg:="No tax records returned for Rating Section Type " & v_lRatingSectionTypeId, vApp:=ACApp, vClass:=ACClass, vMethod:="GetRatingSectionTypeTax", vErrNo:=Informations.Err().Number, vErrDesc:=Informations.Err().Description)
                Return result
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetRatingSectionTypeTax Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRatingSectionTypeTax", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Private Function GetRateType(ByVal v_vRateTypes(,) As Object, ByVal v_lRateTypeId As Integer, ByRef r_sRateTypeCode As String) As Integer
        ...
        If Informations.IsArray(v_vRateTypes) Then
    ...
    Public Function CLngRounding(ByVal cValue As Decimal, ByRef cReturn As Decimal) As Integer
        ...
        Try
            ...
            If cValue <> 0.0# Then
                ...
                cWholeNumber = If(cValue > 0, Math.Floor(cValue), Math.Ceiling(cValue))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:=m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed rounding to whole number", vApp:=ACApp, vClass:=ACClass, vMethod:="CLngRounding", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function PopulateRatingSectionsFromExistingSections(ByVal v_lPreviousDeletedRiskInsuranceFileCnt As Integer, ByRef r_vResultArray As Object, ByVal v_bIsBackdatedMTA As Boolean) As Integer
        ...
        Try
            ...
            End If
            'sj 24/02/2003 - end
            m_lReturn = GetProRataForOriginalRisk(nOriginalRiskCnt:=m_lOriginalRiskCnt,
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="PopulateRatingSectionsFromExistingSections Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="PopulateRatingSectionsFromExistingSections", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Private Function GetOriginalRiskCnt(ByVal v_lInsuranceFileCnt As Integer, ByVal v_lRiskCnt As Integer, ByRef r_lOriginalRiskCnt As Integer, Optional ByRef r_sStatusFlag As String = "") As Integer
        ...
        Else
            ...
            Else
                ...
                r_lOriginalRiskCnt = ToSafeInteger(vArray(3, 0))
            End If
            'sj 24/02/2003 - start
            'PS104
    ...
    Private Function GetRatingSectionForReinstatement(ByRef r_vArray(,) As Object) As Integer
        ...
        'Now get the rating sections from the original risk
        sSQL = "SELECT rs.risk_cnt," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.rating_section_id," & Strings.ChrW(13) & Strings.ChrW(10) &
               "null Decline_reason," & Strings.ChrW(13) & Strings.ChrW(10) &
               "null Refer_reason," & Strings.ChrW(13) & Strings.ChrW(10) &
               "null Message," & Strings.ChrW(13) & Strings.ChrW(10) &
               "null policy_rating_section," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rst.code," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.sum_insured," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.this_premium," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.annual_rate," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.annual_premium original_premium," & Strings.ChrW(13) & Strings.ChrW(10) &
               "0 flag," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rst.rate_type_id," & Strings.ChrW(13) & Strings.ChrW(10) &
               "ISNULL(rs.country_id, 0)," & Strings.ChrW(13) & Strings.ChrW(10) &
               "ISNULL(rs.state_id, 0)" & Strings.ChrW(13) & Strings.ChrW(10) &
               "FROM rating_section rs," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rating_section_type rst" & Strings.ChrW(13) & Strings.ChrW(10) &
               "WHERE rs.risk_cnt = " & CStr(m_lOriginalRiskCnt) & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND rs.rating_section_type_id = rst.rating_section_type_id" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "AND rs.original_flag = 1" & Strings.ChrW(13) & Strings.ChrW(10)
        ...
        If m_sTransactionType.Trim.ToUpper = "MTCR" Then
            sSQL = sSQL & "ORDER BY rs.original_flag ASC, rs.rating_section_id" & vbCrLf
        Else
            sSQL = sSQL & "ORDER BY rs.original_flag DESC, rs.rating_section_id" & Strings.ChrW(13) & Strings.ChrW(10)
        End If
    ...
    Private Function GetOriginalRatingSections(ByRef r_vArray(,) As Object) As Integer
        ...
        sSQL = "SELECT rs.risk_cnt," & Strings.ChrW(13) & Strings.ChrW(10) &
               ...
               "rs.annual_rate," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.annual_premium original_premium," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rs.original_flag flag," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rst.rate_type_id," & Strings.ChrW(13) & Strings.ChrW(10) &
               "ISNULL(rs.country_id, 0)," & Strings.ChrW(13) & Strings.ChrW(10) &
               "ISNULL(rs.state_id, 0)" & Strings.ChrW(13) & Strings.ChrW(10) &
               "FROM rating_section rs," & Strings.ChrW(13) & Strings.ChrW(10) &
               ...
               "WHERE rs.risk_cnt = " & CStr(m_lOriginalRiskCnt) & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND rs.rating_section_type_id = rst.rating_section_type_id" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "AND rs.original_flag in (0,1)" & Strings.ChrW(13) & Strings.ChrW(10)
        ...
        If m_sTransactionType.ToUpper.Trim = "MTCR" Then
            sSQL = sSQL & "ORDER BY rs.original_flag ASC, rs.rating_section_id" & Strings.ChrW(13) & Strings.ChrW(10)
        Else
            sSQL = sSQL & "ORDER BY rs.original_flag DESC, rs.rating_section_id" & Strings.ChrW(13) & Strings.ChrW(10)
        End If
    ...
    Private Function GetDeletedRatingSections(ByVal v_lPreviousDeletedRiskInsuranceFileCnt As Object, ByRef r_vArray(,) As Object) As Integer
        ...
        sSQL = "SELECT rs.this_premium" & Strings.ChrW(13) & Strings.ChrW(10) &
               "FROM rating_section rs," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rating_section_type rst" & Strings.ChrW(13) & Strings.ChrW(10) &
               "WHERE rs.risk_cnt = " & CStr(m_lOriginalRiskCnt) & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND rs.rating_section_type_id = rst.rating_section_type_id" & Strings.ChrW(13) & Strings.ChrW(10) &
        ...
        'Ignore the rounding sections
        If m_sRoundingSectionCode <> "" Then
            sSQL = sSQL & "AND rst.code <> '" & m_sRoundingSectionCode.Trim() & "'" & Strings.ChrW(13) & Strings.ChrW(10)
        End If
        ...
        m_lReturn = CType(GetOriginalRiskCnt(v_lInsuranceFileCnt:=ToSafeInteger(v_lPreviousDeletedRiskInsuranceFileCnt), v_lRiskCnt:=m_lOriginalRiskCnt, r_lOriginalRiskCnt:=lOriginalDeletedRiskCnt), gPMConstants.PMEReturnCode)
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
        ...
        sSQL = "SELECT rs.risk_cnt," & Strings.ChrW(13) & Strings.ChrW(10) &
               ...
               "FROM rating_section rs," & Strings.ChrW(13) & Strings.ChrW(10) &
               "rating_section_type rst" & Strings.ChrW(13) & Strings.ChrW(10) &
               "WHERE rs.risk_cnt = " & CStr(lOriginalDeletedRiskCnt) & Strings.ChrW(13) & Strings.ChrW(10) &
               "AND rs.rating_section_type_id = rst.rating_section_type_id" & Strings.ChrW(13) & Strings.ChrW(10) &
                   "AND rs.original_flag = 0" & Strings.ChrW(13) & Strings.ChrW(10)
        ...
        For i As Integer = 0 To r_vArray.GetUpperBound(1)
            ...
            r_vArray(ACOPremium, i) = Val(CStr(vArray(ACDeletedPremium, i))) * -1
        Next i
    ...
    Public Function GetRatingSectionType_ForRiskType(ByVal lMode As Integer, ByVal lRiskCnt As Integer, ByVal lRatingSectionTypeId As Integer, ByVal lOriginalRiskCnt As Integer, ByRef r_vResults(,) As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Err_GetRatingSectionType_ForRiskType Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Err_GetRatingSectionType_ForRiskType", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetPerilAllocationSecurity(ByVal lRiskCnt As Integer, ByVal iUserID As Integer, ByRef r_bUserAllowRatingSectionAddDelete As Boolean, ByRef r_bUserAllowRatingSectionEdit As Boolean, ByRef r_bAllowRatingSectionAdd As Boolean, ByRef r_bAllowRatingSectionEdit As Boolean, ByRef r_bAllowRatingSectionDelete As Boolean, ByRef r_bAllowEditRatingSectionRateType As Boolean, ByRef r_bAllowEditRatingSectionRate As Boolean, ByRef r_bAllowEditRatingSectionSumInsured As Boolean, ByRef r_bAllowEditRatingSectionThisPremium As Boolean) As Integer
        ...
        Try
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("user_allow_ratingsection_adddelete").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("user_allow_ratingsection_adddelete").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("user_allow_ratingsection_editing").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("user_allow_ratingsection_editing").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_add_ratingsection").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_add_ratingsection").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_edit_ratingsection").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_edit_ratingsection").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_delete_ratingsection").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_delete_ratingsection").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_edit_ratingsection_ratetype").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_edit_ratingsection_ratetype").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_edit_ratingsection_rate").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_edit_ratingsection_rate").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_edit_ratingsection_suminsured").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_edit_ratingsection_suminsured").Value) Then
            ...
            If Convert.IsDBNull(m_oDatabase.Parameters.Item("allow_edit_ratingsection_thispremium").Value) Or Informations.IsNothing(m_oDatabase.Parameters.Item("allow_edit_ratingsection_thispremium").Value) Then
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Err_GetPerilAllocationSecurity Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Err_GetPerilAllocationSecurity", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function CheckMandatoryRisk(ByVal m_lRiskCnt As Long, ByRef r_bIsMandatoryRisk As Boolean) As Integer
        ...
        Try
            ...
            'Store Options
            r_bIsMandatoryRisk = If(ToSafeInteger(dtResult.Rows(0)(0).ToString) = 1, True, False)
    ...
    Public Function UpdateRiskStatus(ByVal v_lRiskCnt As Integer, ByVal v_lRiskStatusId As Integer) As Integer
        ...
        Try
            ...
            result = m_oDatabase.Parameters.Add(sName:="risk_cnt",
                                                   vValue:=v_lRiskCnt,
                                                   iDirection:=gPMConstants.PMEParameterDirection.PMParamInput,
            ...
            result = m_oDatabase.Parameters.Add(sName:="risk_status_id",
                                                   vValue:=v_lRiskStatusId,
                                                   iDirection:=gPMConstants.PMEParameterDirection.PMParamInput,
                                                   iDataType:=gPMConstants.PMEDataType.PMInteger)



            result = m_oDatabase.SQLAction(sSQL:=ACUpdateRiskStatusSQL,
                                              sSQLName:=ACUpdateRiskStatusName,
                                              bStoredProcedure:=ACUpdateRiskStatusStored)
    ...
    Private Function GetProRataForOriginalRisk(ByVal nOriginalRiskCnt As Integer,
        ...
        nReturn = m_oDatabase.SQLSelect(
                                sSQL:=kGetProRataForOriginalRiskSQL,
                                sSQLName:=kGetProRataForOriginalRiskName,
                                bStoredProcedure:=kGetProRataForOriginalRiskStored,
    ...
    Public Function GetTMPStatus() As Boolean
        ...
        If Informations.IsArray(oResultArray) Then
            m_bIsTrueMonthlyPolicy = If(CDbl(oResultArray(0, 0)) = 1, True, False)
        End If
        Return m_bIsTrueMonthlyPolicy
    End Function

    Private Function ValidateAndUpdateReturnPremium(ByVal nRiskCnt As Integer, ByVal nOriginalRiskCnt As Integer) As Integer
        Dim nReturn As Integer
        Dim r_vResults(,) As Object = Nothing
        Dim dBilledPremium As Double
        Dim dReturnPremium As Double
        Const dTolerance As Double = 0.02
        m_oDatabase.Parameters.Clear()

        AddParameterLite(m_oDatabase, "risk_cnt", nRiskCnt, gPMConstants.PMEParameterDirection.PMParamInput, gPMConstants.PMEDataType.PMLong)
        ' Execute selection Query
        nReturn = m_oDatabase.SQLSelect(
                                sSQL:=kGetRiskBilledPremiumSQL,
                                sSQLName:=kGetRiskBilledPremiumName,
                                bStoredProcedure:=kGetRiskBilledPremiumStored,
                                vResultArray:=r_vResults,
                                lNumberRecords:=gPMConstants.PMAllRecords)
        If nReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        Else
            If Informations.IsArray(r_vResults) Then
                dBilledPremium = ToSafeDouble(r_vResults(0, 0), 0) + ToSafeDouble(r_vResults(1, 0), 0)
            End If
        End If
        ...
        ' Execute selection Query
        nReturn = m_oDatabase.SQLSelect(
                                sSQL:=kGetRiskReturnPremiumSQL,
                                sSQLName:=kGetRiskReturnPremiumName,
                                bStoredProcedure:=kGetRiskRetunPremiumStored,
                                vResultArray:=r_vResults,
                                lNumberRecords:=gPMConstants.PMAllRecords)
        If nReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        Else
            If Informations.IsArray(r_vResults) Then
                dReturnPremium = ToSafeDouble(r_vResults(0, 0), 0)
            End If
        End If

        If Math.Abs(dReturnPremium + dBilledPremium) > 0 AndAlso Math.Abs(dReturnPremium + dBilledPremium) <= dTolerance Then

            m_oDatabase.Parameters.Clear()
            AddParameterLite(m_oDatabase, "risk_cnt", nRiskCnt, gPMConstants.PMEParameterDirection.PMParamInput, gPMConstants.PMEDataType.PMLong)

            nReturn = m_oDatabase.SQLAction(sSQL:=kUpdateRiskReturnPremiumSQL,
                                              sSQLName:=kUpdateRiskReturnPremiumName,
                                              bStoredProcedure:=kUpdateRiskReturnPremiumStored)
            If nReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
        End If
