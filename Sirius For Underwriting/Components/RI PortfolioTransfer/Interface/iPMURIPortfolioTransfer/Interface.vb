...
Public NotInheritable Class Interface_Renamed
    ...
    Dim frmRIPortfolioTransfer As frmRIPortfolioTransfer
    ...
    Private Function ProcessInterface() As Integer
        ...
        nResult = GetPMRegSetting(gpmConstants.HKEY_LOCAL_MACHINE, 0, PMERegSettingLevel.pmeRSLBase, "PMDIR", sPurePath)
        sPurePath &= "\Pure\Application\"

        Dim pStartInfo As New ProcessStartInfo
        pStartInfo.FileName = sPurePath & "ReinsuranceTransfer.exe"
        pStartInfo.Arguments = "PT"
