...
Friend NotInheritable Class Reinsurances
    ...
    Public Function Add(ByRef oNewReinsurance As bSIRReinsurance.Reinsurance) As Integer
    ...
    Public Function Item(ByVal Index As String) As bSIRReinsurance.Reinsurance
        ' Return item
    ...
    Public Sub Round()
        ...
        For Each oReinsurance As bSIRReinsurance.Reinsurance In m_cReinsurances
            oReinsurance.Round()
        Next oReinsurance
    End Sub
