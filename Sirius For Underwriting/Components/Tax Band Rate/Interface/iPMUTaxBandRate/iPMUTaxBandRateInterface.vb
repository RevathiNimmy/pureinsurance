...
Public NotInheritable Class Interface_Renamed
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case "tax_band_id"
                        ...
                        m_lTaxBandId = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                    Case "description"
    ...
    Public Function Start() As Integer
        ...
        Try
            ...
            'eck120605Datasure
            If iPMFunc.getProductOptionValue(v_vOptionNumber:=gPMConstants.SIRHiddenOptions.SIROPTUnderwriting, v_vBranch:=1, r_vUnderwriting:=g_sUnderwritingOrAgency) <> gPMConstants.PMEReturnCode.PMTrue Then
    ...
    Private Function LoadInterface() As Integer
        ...
        If m_sFormname.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ' We have already encountered an error,
            ' so we MUST return the error.
            result = m_sFormname.ErrorNumber
        End If
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        VB6.ShowForm(m_sFormname, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            If m_sFormname.ErrorNumber <> 0 Then
                result = m_sFormname.ErrorNumber
            End If
        End If
