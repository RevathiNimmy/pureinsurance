...
Module MainModule
    ...
    Public Const ACApp As String = "iPMUChaseCycleMaint"
	...
	' Task Group User Group Data Array Positionadd steps
    ...
    Public Const ACNoDataModelSelected As Integer = 732
 ...
 Public g_oObjectManager As bObjectManager.ObjectManager
	...
	Public Function DisplayMessage(ByRef r_lTitleId As Integer, ByRef r_lMessageId As Integer, ByRef r_lOptions As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="", vApp:=ACApp, vClass:=ACClass, vMethod:="DisplayMessage", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description, excep:=excep)
