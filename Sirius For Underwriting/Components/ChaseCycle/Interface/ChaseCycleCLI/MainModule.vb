...
#Region " Constants "
    Public Const ACApp As String = "ChaseCycleCLI"
...
#Region " Main "
    ...
    Sub Main(ByVal args() As String)
        ...
        Const ACSpokeInterfaceCode As String = "CHASECYCLE"
        ...
        Try
            ...
            Else
                ...
                lResult = m_oBusiness.Initialise(sUsername:="", _
                                sPassword:="", _
                                iUserID:=kiUserID, _
                ...
                lResult = m_oBusiness.Export(v_sInterfaceCode:=ACSpokeInterfaceCode,
                                                ...
                                                bCreateBatch:=True)
                If lResult = PMEReturnCode.PMTrue Then
                    Console.WriteLine("Chase Cycle Complete - " & Now)
                ElseIf lResult = PMEReturnCode.PMNotFound Then
                    Console.WriteLine("Chase Cycle Complete - No Records Found - " & Now)
                Else
                    Console.WriteLine("Chase Cycle Failed - " & Now)
                End If
            End If
        ...
        Catch ex As Exception
            Console.WriteLine("Chase Cycle Failed - " & ex.Message)
        End Try
    End Sub
    'End
#End Region
...
#Region " Procedures "
    ...
    Private Sub OutputSyntax()
        Console.WriteLine("Syntax: ChaseCycleCLI processingdate spooldocuments archivedocuments")
        Console.WriteLine("processingdate:  The date the Chase Cycle processing is to be run for")
        Console.WriteLine("branch:          The branch code for Chase Cycle")
        ...
        Console.WriteLine("Example: ChaseCycleCLI processingdate=25/12/08 branch=MAIN spooldocuments=true archivedocuments=false")
    End Sub
    'End 
#End Region
