...
Imports System
'Modified by Sumeet Singh on 5/27/2010 1:50:48 PM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Interface_Renamed
    ...
    ' Edit History:
    ' ***************************************************************** '
    'Modified by Sumeet Singh on 5/27/2010 1:55:32 PM refer developer guide no. 69
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/27/2010 1:55:54 PM refer developer guide no. 69
        'With frmInterface
        ...
        'Modified by Sumeet Singh on 5/27/2010 1:56:08 PM refer developer guide no. 69
        'Dim tempLoadForm As frmInterface = frmInterface
        Dim tempLoadForm As frmInterface = m_ofrmInterface

        ' Check if we have had an error so far.
        'Modified by Sumeet Singh on 5/27/2010 1:56:18 PM refer developer guide no. 69
        ...
        If m_ofrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Sumeet Singh on 5/27/2010 1:56:31 PM refer developer guide no. 69
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/27/2010 1:56:43 PM refer developer guide no. 69
        'With frmInterface
        With m_ofrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Sumeet Singh on 5/27/2010 1:56:53 PM refer developer guide no. 69
        'frmInterface.Close()
        m_ofrmInterface.Close()
        'Modified by Sumeet Singh on 5/27/2010 1:57:12 PM refer developer guide no. 69
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Sumeet Singh on 5/27/2010 1:57:51 PM refer developer guide no. 69
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(m_ofrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Sumeet Singh on 5/27/2010 1:58:01 PM refer developer guide no. 69
            'If frmInterface.ErrorNumber <> 0 Then
            If m_ofrmInterface.ErrorNumber <> 0 Then
                'Modified by Sumeet Singh on 5/27/2010 1:58:11 PM refer developer guide no. 69
                'result = frmInterface.ErrorNumber
                result = m_ofrmInterface.ErrorNumber
            End If
        End If
