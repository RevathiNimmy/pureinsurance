...
Imports System
'Modified by Sumeet Singh on 5/27/2010 2:28:39 PM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Interface_Renamed
    ...
    ' Edit History:
    ' ***************************************************************** '
    'Modified by Sumeet Singh on 5/27/2010 2:29:13 PM refer developer guide no. 69
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/27/2010 2:29:46 PM refer developer guide no. 69
        'With frmInterface
        ...
        'Modified by Sumeet Singh on 5/27/2010 2:30:08 PM refer developer guide no. 69
        'Dim tempLoadForm As frmInterface = frmInterface
        Dim tempLoadForm As frmInterface = m_ofrmInterface

        ' Check if we have had an error so far.
        'Modified by Sumeet Singh on 5/27/2010 2:30:19 PM refer developer guide no. 69
        ...
        If m_ofrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Sumeet Singh on 5/27/2010 2:30:34 PM refer developer guide no. 69
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/27/2010 2:30:45 PM refer developer guide no. 69
        'With frmInterface
        With m_ofrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Sumeet Singh on 5/27/2010 2:31:17 PM refer developer guide no. 69
        'frmInterface.Close()
        m_ofrmInterface.Close()
        'Modified by Sumeet Singh on 5/27/2010 2:31:27 PM refer developer guide no. 69
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Sumeet Singh on 5/27/2010 2:31:36 PM refer developer guide no. 69
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(m_ofrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Sumeet Singh on 5/27/2010 2:37:39 PM refer developer guide no. 69
            'If frmInterface.ErrorNumber <> 0 Then
            If m_ofrmInterface.ErrorNumber <> 0 Then
                'Modified by Sumeet Singh on 5/27/2010 2:38:47 PM refer developer guide no. 69
                'result = frmInterface.ErrorNumber
                result = m_ofrmInterface.ErrorNumber
            End If
        End If
