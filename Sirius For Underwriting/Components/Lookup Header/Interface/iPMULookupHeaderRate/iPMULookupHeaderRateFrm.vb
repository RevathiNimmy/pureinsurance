...
'Modified by Sumeet Singh on 5/27/2010 2:27:28 PM refer developer guide no. 129
Imports SharedFiles
Partial Friend Class frmInterface
    ...
    Private m_oGeneral As iPMULookupHeaderRate.General
    ...
    Private Function DisplayCaptions() As Integer
        ...
        Try
            ...
            lblHeader.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionHeader, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_oGeneral = New iPMULookupHeaderRate.General()
