...
'Modified by Vijay Pal on 5/12/2010 3:59:50 PM refer developer guide no. 129
Imports SharedFiles
Partial Friend Class frmInterface
    ...
    Private m_oGeneral As iPMULookupHeader.General
    ...
    Private m_oLookupDetail As iPMULookupDetails.Interface_Renamed
    'Private m_oLookupDetail As iPMULookupDetails.Interface

    ' Declare an instance of the Rates (or indicators) object.

    Private m_oLookupHeaderRates As iPMULookupHeaderRates.Interface_Renamed
    'Private m_oLookupHeaderRates As iPMULookupHeaderRates.Interface
    ...
    Private Function CallRatesOrIndicators(ByRef sRorI As String) As Integer
        ...
        Try
            ...
            If m_oLookupHeaderRates Is Nothing Then
                ...
                m_lReturn = g_oObjectManager.GetInstance(temp_m_oLookupHeaderRates, sClassName:="iPMULookupHeaderRates.Interface_Renamed", vInstanceManager:=gPMConstants.PMGetLocalInterface)
    ...
    Private Function CallDetails() As Integer
        ...
        Try
            ...
            If m_oLookupDetail Is Nothing Then
                ...
                m_lReturn = g_oObjectManager.GetInstance(temp_m_oLookupDetail, sClassName:="iPMULookupDetails.Interface_Renamed", vInstanceManager:=gPMConstants.PMGetLocalInterface)
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_oGeneral = New iPMULookupHeader.General()
