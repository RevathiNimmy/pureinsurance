...
Imports System
'Modified by Vijay Pal on 5/12/2010 4:01:02 PM refer developer guide no. 129
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("Interface_Renamed_NET.Interface_Renamed")> _
Public NotInheritable Class Interface_Renamed
    Implements IDisposable
    Implements SSP.S4I.Interfaces.ILocalInterface
    'Modified by Vijay Pal on 5/12/2010 4:30:24 PM refer developer guide no. 50 (guide)
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 4:31:03 PM refer developer guide no. 50 (guide)
        'With frmInterface
        With objfrmInterface
            ...
            .LookupHeaderId = m_lLookupHeaderId
            .Code = m_sCode
            .Description = m_sDescription
            .ParentId = m_lParentId
            .ParentCode = m_sParentCode
            'Modified by Vijay Pal on 5/12/2010 4:36:28 PM refer developer guide no. 24 (guide)
        ...
        'Modified by Vijay Pal on 5/12/2010 4:31:48 PM refer developer guide no. 50 (guide)
        'Dim tempLoadForm As frmInterface = frmInterface
        Dim tempLoadForm As frmInterface = objfrmInterface

        ' Check if we have had an error so far.
        'Modified by Vijay Pal on 5/12/2010 4:32:35 PM refer developer guide no. 50 (guide)
        ...
        If objfrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Vijay Pal on 5/12/2010 4:32:54 PM refer developer guide no. 50 (guide)
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 4:33:23 PM refer developer guide no. 50 (guide)
        'With frmInterface
        With objfrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Vijay Pal on 5/12/2010 4:33:57 PM refer developer guide no. 50 (guide)
        'frmInterface.Close()
        objfrmInterface.Close()
        'Modified by Vijay Pal on 5/12/2010 4:34:23 PM refer developer guide no. 50 (guide)
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Vijay Pal on 5/12/2010 4:35:00 PM refer developer guide no. 50 (guide)
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(objfrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Vijay Pal on 5/12/2010 4:35:35 PM refer developer guide no. 50(guide)
            'If frmInterface.ErrorNumber <> 0 Then
            If objfrmInterface.ErrorNumber <> 0 Then
                'Modified by Vijay Pal on 5/12/2010 4:36:00 PM refer developer guide no. 50 (guide)
                'result = frmInterface.ErrorNumber
                result = objfrmInterface.ErrorNumber
            End If
        End If
