...
Partial Friend Class frmInterface
    ...
    Private m_oGeneral As iPMULookupHeaders.General

    ' Declare an instance of the Business object.
    Private m_oBusiness As Object
    'Private m_oBusiness As bSIRLookupHeader.Business

    ' Declare an instance of the edit interface.

    Private m_oLookupHeader As iPMULookupHeader.Interface_Renamed
    'Private m_oLookupHeader As iPMULookupHeader.Interface
    ...
    Public Function BusinessToInterface() As Integer
        ...
        Try
            ...
            For iTemp As Integer = m_vLookupHeaders.GetLowerBound(1) To m_vLookupHeaders.GetUpperBound(1)
                ...
                oListItem = lvwHeaders.Items.Add(CStr(m_vLookupHeaders(ACHCode, iTemp)), "")
    ...
    Public Function InterfaceToBusiness() As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.Update(vLookupHeaders:=m_vLookupHeaders)
    ...
    Private Function DisplayCaptions() As Integer
        ...
        Try
            ...
            lvwHeaders.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionHeader1, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))



            lvwHeaders.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionHeader2, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))



            lvwHeaders.Columns.Item(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionHeader3, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))
    ...
    Private Function GetAllowedParents() As Integer
        ...
        Try
            ...
            For lTemp As Integer = m_vLookupHeaders.GetLowerBound(1) To m_vLookupHeaders.GetUpperBound(1)
                If CStr(m_vLookupHeaders(ACHParentId, lTemp)) <> "" Then

                    For lTemp2 As Integer = vArray.GetLowerBound(1) To vArray.GetUpperBound(1)

                        If vArray(0, lTemp2).Equals(m_vLookupHeaders(ACHLookupHeaderId, lTemp)) Then
    ...
    Private Sub cmdAdd_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            If m_oLookupHeader Is Nothing Then
                ...
                m_lReturn = g_oObjectManager.GetInstance(temp_m_oLookupHeader, sClassName:="iPMULookupHeader.Interface_Renamed", vInstanceManager:=gPMConstants.PMGetLocalInterface)
            ...
            oListItem = lvwHeaders.Items.Add(m_oLookupHeader.Code, "")
    ...
    Private Sub cmdDelete_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            'lvwHeaders.SelectedItem.Ghosted = Not lvwHeaders.SelectedItem.Ghosted
            ...
            'TODO check at run time
            'If lvwHeaders.SelectedItem.Ghosted Then
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_m_oBusiness, "bSIRLookupHeader.Business", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            ...
            m_oGeneral = New iPMULookupHeaders.General()
        ...
        Try
            ...
            With lvwHeaders
                ...
                If ColumnHeader.Index + 1 - 1 = ACDateColumn Then
                    ...
                    End If
                    'TODO check at run time
                    'm_lReturn = CType(ListViewSortByDate(v_oListView:=lvwHeaders, v_iSourceColumn:=ACDateColumn, v_iDirection:=iDirection), gPMConstants.PMEReturnCode)
                    ' If current sort column header is
                    ' pressed.
