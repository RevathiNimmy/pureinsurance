...
'Modified by Vijay Pal on 5/28/2010 5:20:42 PM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Business
    ...
    Public Function Update(ByRef vLookupHeaders(,) As Object) As Integer
        ...
        Try
            ...
            For lTemp As Integer = vLookupHeaders.GetLowerBound(1) To vLookupHeaders.GetUpperBound(1)
                ...
                If CDbl(vLookupHeaders(ACHLookupHeaderId, lTemp)) = -1 Then
                    ...
                    m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_header_id", vValue:=CStr(vLookupHeaders(ACHLookupHeaderId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    ...
                    m_lReturn = m_oDatabase.Parameters.Add(sName:="effective_date", vValue:=CStr(vLookupHeaders(ACHEffectiveDate, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMDate)
                    ...
                    'Modified by Vijay Pal on 5/28/2010 5:21:50 PM refer developer guide no. 85
                    'm_lReturn = m_oDatabase.Parameters.Add(sName:="parent_id", vValue:=CStr(DBNull.Value), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    ...
                    vLookupHeaders(ACHLookupHeaderId, lTemp) = m_oDatabase.Parameters.Item("lookup_header_id").Value
            ...
            For lTemp As Integer = vLookupHeaders.GetLowerBound(1) To vLookupHeaders.GetUpperBound(1)
                ...
                m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_header_id", vValue:=CStr(vLookupHeaders(ACHLookupHeaderId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                ...
                If CStr(vLookupHeaders(ACHParentId, lTemp)) = "" Then
                    ...
                    'Modified by Vijay Pal on 5/28/2010 5:22:15 PM refer developer guide no. 85
                    'm_lReturn = m_oDatabase.Parameters.Add(sName:="parent_id", vValue:=CStr(DBNull.Value), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    m_lReturn = m_oDatabase.Parameters.Add(sName:="parent_id", vValue:=DBNull.Value, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                Else

                    m_lReturn = m_oDatabase.Parameters.Add(sName:="parent_id", vValue:=CStr(vLookupHeaders(ACHParentId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                End If
