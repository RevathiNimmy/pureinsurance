...
Imports System
'Modified by Vijay Pal on 5/12/2010 1:50:05 PM refer developer guide no.129
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("Interface_Renamed_NET.Interface_Renamed")> _
Public NotInheritable Class Interface_Renamed
    Implements IDisposable
    Implements SSP.S4I.Interfaces.ILocalInterface
    'Modified by Vijay Pal on 5/12/2010 1:51:05 PM refer developer guide no.50 (guide)
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 2:04:05 PM refer developer guide no.50 (guide)
        'With frmInterface
        With objfrmInterface
            ...
            .RatesOrIndicators = m_sRatesOrIndicators
            ...
            'Modified by Vijay Pal on 5/12/2010 2:07:05 PM refer developer guide no.24 (guide)
            '.set_Value(m_vValue)
            .Value = m_vValue
        ...
        'Modified by Vijay Pal on 5/12/2010 1:59:05 PM refer developer guide no.50 (guide)
        ...
        If objfrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Vijay Pal on 5/12/2010 2:02:05 PM refer developer guide no.50 (guide)
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 2:05:05 PM refer developer guide no.50 (guide)
        'With frmInterface
        With objfrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Vijay Pal on 5/12/2010 1:53:05 PM refer developer guide no.50 (guide)
        'frmInterface.Close()
        objfrmInterface.Close()
        'Modified by Vijay Pal on 5/12/2010 1:55:05 PM refer developer guide no.50 (guide)
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Vijay Pal on 5/12/2010 1:56:05 PM refer developer guide no.50 (guide)
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(objfrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Vijay Pal on 5/12/2010 1:57:05 PM refer developer guide no.50 (guide)
            'If frmInterface.ErrorNumber <> 0 Then
            If objfrmInterface.ErrorNumber <> 0 Then
                'Modified by Vijay Pal on 5/12/2010 1:58:05 PM refer developer guide no.50 (guide)
                'result = frmInterface.ErrorNumber
                result = objfrmInterface.ErrorNumber
            End If
        End If
