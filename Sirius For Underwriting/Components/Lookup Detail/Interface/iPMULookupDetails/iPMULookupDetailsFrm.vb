...
'Modified by Sumeet Singh on 5/27/2010 12:47:27 PM refer developer guide no. 129
Imports SharedFiles
Partial Friend Class frmInterface
    ...
    Private m_oGeneral As iPMULookupDetails.General

    ' Declare an instance of the Business object.
    Private m_oBusiness As Object
    'Private m_oBusiness As bSIRLookupDetail.Business

    ' Declare an instance of the edit interface.

    Private m_oLookupDetail As iPMULookupDetail.Interface_Renamed
    'Private m_oLookupDetail As iPMULookupDetail.Interface
    ...
    Public Function BusinessToInterface() As Integer
        ...
        Try
            ...
            For iTemp As Integer = m_vLookupDetails.GetLowerBound(1) To m_vLookupDetails.GetUpperBound(1)
                ...
                oListItem = lvwDetails.Items.Add(CStr(m_vLookupDetails(ACHCode, iTemp)), "")
                ...
                If CDbl(m_vLookupDetails(ACHIsDeleted, iTemp)) = 1 Then
                    ...
                    'Modified by Sumeet Singh on 5/27/2010 12:50:21 PM refer developer guide no. 12 (No Solution)
    ...
    Public Function InterfaceToBusiness() As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.Update(vLookupDetails:=m_vLookupDetails)
    ...
    Private Function DisplayCaptions() As Integer
        ...
        Try
            ...
            lvwDetails.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lID:=ACCaptionHeader1, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))



            lvwDetails.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lID:=ACCaptionHeader2, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))
    ...
    Private Sub cmdAdd_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            If m_oLookupDetail Is Nothing Then
                ...
                m_lReturn = g_oObjectManager.GetInstance(temp_m_oLookupDetail, sClassName:="iPMULookupDetail.Interface_Renamed", vInstanceManager:=gPMConstants.PMGetLocalInterface)
            ...
            Else
                ReDim Preserve m_vLookupDetails(ACHParentId, lTag)
            End If
            ...
            oListItem = lvwDetails.Items.Add(m_oLookupDetail.Code, "")


            ListViewHelper.GetListViewSubItem(oListItem, 1).Text = m_oLookupDetail.Description

            '    oListItem.SubItems(2) = m_oLookupDetail.ParentCode
    ...
    Private Sub cmdDelete_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            'Modified by Sumeet Singh on 5/27/2010 12:50:41 PM refer developer guide no. 12
            'lvwDetails.SelectedItem.Ghosted = Not lvwDetails.SelectedItem.Ghosted
            ...
            'Modified by Sumeet Singh on 5/27/2010 12:50:54 PM refer developer guide no. 12 (No Solution)
            'If lvwDetails.SelectedItem.Ghosted Then

            '	cmdDelete.Text = CStr(iPMFunc.GetResData(MainModule.g_iLanguageID, MainModule.ACUnDeleteButton, gPMConstants.PMEResourseFileDataType.PMResString))
            '	cmdEdit.Enabled = False
            'Else

            '	cmdDelete.Text = CStr(iPMFunc.GetResData(MainModule.g_iLanguageID, MainModule.ACDeleteButton, gPMConstants.PMEResourseFileDataType.PMResString))
    ...
    Private Sub cmdEdit_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            m_lReturn = CType(GetAllowedParents(), gPMConstants.PMEReturnCode)
            ...
            '    m_oLookupDetail.ParentId = m_vLookupDetails(ACHParentId, lTag)
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_m_oBusiness, "bSIRLookupDetail.Business", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            ...
            m_oGeneral = New iPMULookupDetails.General()
    ...
    Private Sub lvwDetails_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles lvwDetails.Click
        ...
        'Modified by Sumeet Singh on 5/27/2010 12:51:12 PM refer developer guide no. 12 (No Solution)
        'If lvwDetails.SelectedItem.Ghosted Then
        ...
        Try
            ...
            With lvwDetails
                ...
                If ColumnHeader.Index + 1 - 1 = ACDateColumn Then
                    ...
                    End If
                    'Modified by Sumeet Singh on 5/27/2010 12:51:29 PM refer developer guide no. 178
                    'm_lReturn = CType(ListViewSortByDate(v_oListView:=lvwDetails, v_iSourceColumn:=ACDateColumn, v_iDirection:=iDirection), gPMConstants.PMEReturnCode)
