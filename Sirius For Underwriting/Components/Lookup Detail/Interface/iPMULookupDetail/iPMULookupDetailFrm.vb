...
'Modified by Vijay Pal on 5/12/2010 5:04:24 PM refer developer guide no. 129
Imports SharedFiles
Partial Friend Class frmInterface
    ...
    Private m_oGeneral As iPMULookupDetail.General
    ...
    Private m_oLookupDetailRates As iPMULookupDetailRates.Interface_Renamed
    'Private m_oLookupDetailRates As iPMULookupDetailRates.Interface
    ...
    Private Function DisplayCaptions() As Integer
        ...
        Try
            ...
            lblCode.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lID:=ACCaptionDate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))


            lblDescription.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lID:=ACCaptionRate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))


            lblParent.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lID:=ACCaptionAmount, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString))
    ...
    Private Function CallRatesOrIndicators(ByRef sRorI As String) As Integer
        ...
        Try
            ...
            If m_oLookupDetailRates Is Nothing Then
                ...
                m_lReturn = g_oObjectManager.GetInstance(temp_m_oLookupDetailRates, sClassName:="iPMULookupDetailRates.Interface_Renamed", vInstanceManager:=gPMConstants.PMGetLocalInterface)
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_oGeneral = New iPMULookupDetail.General()
