...
Imports System
'Modified by Vijay Pal on 5/12/2010 1:18:05 PM refer developer guide no.129
Imports SharedFiles
...
Public NotInheritable Class Interface_Renamed
    ...
    'Modified by Vijay Pal on 5/12/2010 1:20:05 PM refer developer guide no.50 (guide)
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 1:25:05 PM refer developer guide no.50 (guide)
        'With frmInterface
        ...
        'Modified by Vijay Pal on 5/12/2010 1:22:05 PM refer developer guide no.50 (guide)
        ...
        If objfrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Vijay Pal on 5/12/2010 1:24:05 PM refer developer guide no.50 (guide)
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Vijay Pal on 5/12/2010 1:27:05 PM refer developer guide no.50 (guide)
        'With frmInterface
        With objfrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Vijay Pal on 5/12/2010 1:28:05 PM refer developer guide no.50 (guide)
        'frmInterface.Close()
        objfrmInterface.Close()
        'Modified by Vijay Pal on 5/12/2010 1:29:05 PM refer developer guide no.50 (guide)
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Vijay Pal on 5/12/2010 1:30:05 PM refer developer guide no.50 (guide)
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(objfrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Vijay Pal on 5/12/2010 1:31:05 PM refer developer guide no.50 (guide)
            'If frmInterface.ErrorNumber <> 0 Then
            If objfrmInterface.ErrorNumber <> 0 Then
                'Modified by Vijay Pal on 5/12/2010 1:32:05 PM refer developer guide no.50 (guide)
                'result = frmInterface.ErrorNumber
                result = objfrmInterface.ErrorNumber
            End If
        End If
