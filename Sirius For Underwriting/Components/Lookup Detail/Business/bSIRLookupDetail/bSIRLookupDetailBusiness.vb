...
Public NotInheritable Class Business
    ...
    Public Function GetDetails(ByRef lLookupHeaderId As Integer, ByRef vLookupDetails(,) As Object) As Integer
        ...
        Try
            ...
            m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_header_id", vValue:=CStr(lLookupHeaderId), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Public Function Update(ByRef vLookupDetails(,) As Object) As Integer
        ...
        Try
            ...
            For lTemp As Integer = vLookupDetails.GetLowerBound(1) To vLookupDetails.GetUpperBound(1)
                ...
                If CDbl(vLookupDetails(ACHLookupDetailId, lTemp)) = -1 Then
                    ...
                    m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_detail_id", vValue:=CStr(vLookupDetails(ACHLookupDetailId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    ...
                    m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_header_id", vValue:=CStr(vLookupDetails(ACHLookupHeaderId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    ...
                    Else
                        ...
                        m_lReturn = m_oDatabase.Parameters.Add(sName:="parent_id", vValue:=CStr(vLookupDetails(ACHParentId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
                    End If
                    ...
                    vLookupDetails(ACHLookupDetailId, lTemp) = m_oDatabase.Parameters.Item("lookup_detail_id").Value
            ...
            For lTemp As Integer = vLookupDetails.GetLowerBound(1) To vLookupDetails.GetUpperBound(1)
                ...
                m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_detail_id", vValue:=CStr(vLookupDetails(ACHLookupDetailId, lTemp)), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
