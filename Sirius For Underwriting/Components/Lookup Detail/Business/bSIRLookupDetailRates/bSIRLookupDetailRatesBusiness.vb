...
Imports System
'Modified by Vijay Pal on 5/31/2010 10:51:54 AM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Business
    ...
    Public Function GetDetails(ByRef vLookupRates(,) As Object) As Integer
        ...
        Try
            ...
            m_lReturn = m_oDatabase.Parameters.Add(sName:="lookup_detail_id", vValue:=CStr(m_lLookupDetailId), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
