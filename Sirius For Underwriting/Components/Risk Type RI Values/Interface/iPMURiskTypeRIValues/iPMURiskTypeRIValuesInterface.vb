...
Public NotInheritable Class Interface_Renamed
    ...
    Public Property GISHeaderId1() As Integer
        Get
            Return m_lGISHeaderId1
        End Get
        Set(ByVal Value As Integer)
            m_lGISHeaderId1 = Value
        End Set
    End Property
    ...
    Public Property GISHeaderId2() As Integer
        Get
            Return m_lGISHeaderId2
        End Get
        Set(ByVal Value As Integer)
            m_lGISHeaderId2 = Value
        End Set
    End Property
    ...
    Public Property GISHeaderId3() As Integer
        Get
            Return m_lGISHeaderId3
        End Get
        Set(ByVal Value As Integer)
            m_lGISHeaderId3 = Value
        End Set
    End Property
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            m_lProcessMode = GIIConstants.GIIPMProcessModeGeneric
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMNavKeyConst.PMKeyNameDescription

                        m_sDescription = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                    Case "code"

                        m_sCode = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_ofrmInterface
            ...
            .GISHeaderInd1 = m_sGISHeaderInd1
            .GISHeaderIndId1 = m_lGISHeaderIndId1
            .GISHeaderInd2 = m_sGISHeaderInd2
            .GISHeaderIndId2 = m_lGISHeaderIndId2
            .GISHeaderInd3 = m_sGISHeaderInd3
            .GISHeaderIndId3 = m_lGISHeaderIndId3
            .MaxLevel = m_lMaxLevel
            .ThisLevel = m_lThisLevel
