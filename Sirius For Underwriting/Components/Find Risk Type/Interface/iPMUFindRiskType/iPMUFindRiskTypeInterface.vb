...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_ofrmInterface As iPMUFindRiskType.frmInterface
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bSIRFindRiskType.Business", vInstanceManager:=gPMConstants.PMGetViaClientManager)
    ...
    Private Function LoadInterface() As Integer
        ...
        m_ofrmInterface = New iPMUFindRiskType.frmInterface()
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        If m_ofrmInterface.lvwRiskTypes.Items.Count = 1 Then
            Return result
        End If

        ' Display the interface.

        m_lReturn = m_ofrmInterface.GetBusiness()

        If (m_ofrmInterface.Status = gPMConstants.PMEReturnCode.PMOK) Then
            Return result
        Else
