...
Public NotInheritable Class Business
    ...
    '
    '****************************************************************** '
    Public Function GetDetails(ByVal v_lProductTypeId As Integer, ByRef r_vResultArray(,) As Object, ByRef r_lNumberOfRecords As Integer) As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                m_lError = .Parameters.Add(sName:="product_id", vValue:=CStr(v_lProductTypeId), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
