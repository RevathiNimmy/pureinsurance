...
Option Explicit On
Imports System
'Modified by Vijay Pal on 5/13/2010 10:36:26 AM refer developer guide no. 129
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("MainModule_NET.MainModule")> _
 Public Module MainModule
    ...
    Public Const ACApp As String = "iPMBFindScreen"
    ...
    Public Const ACIScreenId As Integer = 0
    Public Const ACIScreenDescription As Integer = 1
    ...
    'Public g_oBusiness As bSIRFindPolicyType.Business
