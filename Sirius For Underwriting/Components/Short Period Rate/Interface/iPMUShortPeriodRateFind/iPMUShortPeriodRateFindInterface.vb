...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_lSPRValue As String = ""
    Private m_dtSPREffectiveRate As Date
    Private m_dSPRPercentage As Double
    Private m_iSPRIs_Deleted As Integer
    ...
    Public Function Start() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.            
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to start the object", vApp:=ACApp, vClass:=ACClass, vMethod:="Start", excep:=excep)
