Public NotInheritable Class DREConstants 
    ...
    Public Const PBCQemQuoteTypeQuoteActionName As String = "QUOTE"
    Public Const PBCQemQuoteTypeValidateActionName As String = "VALIDATE"
    Public Const PBCQemQuoteTypeUalActionName As String = "UAL"
    Public Const PBCQemQuoteTypeDefaultActionName As String = "DEFAULT"
    Public Const PBCQemQuoteTypeRenewalActionName As String = "RENEWAL"
    Public Const PBCQemQuoteTypePreScreenActionName As String = "PRESCREEN"
    Public Const PBCQemQuoteTypeCopyRiskActionName As String = "COPYRISK"
