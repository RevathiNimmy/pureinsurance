...
Public NotInheritable Class Interface_Renamed
    ...
    Private frmCloneRIBatchProcess As frmCloneRIBatchProcess
    ...
    Private Function ProcessInterface() As Integer
        ...
        result = gPMConstants.PMEReturnCode.PMTrue
        result = gPMFunctions.GetPMRegSetting(gPMConstants.HKEY_LOCAL_MACHINE, 0, gPMConstants.PMERegSettingLevel.pmeRSLBase, "PMDIR", sPurePath)
        sPurePath &= "\Pure\Application\"


        Dim pStartInfo As New ProcessStartInfo
        pStartInfo.FileName = sPurePath & "ReinsuranceTransfer.exe"
        pStartInfo.Arguments = "CT"
        Process.Start(pStartInfo)



        'frmCloneRIBatchProcess = New frmCloneRIBatchProcess()
        'frmCloneRIBatchProcess.ShowDialog()

        'frmCloneRIBatchProcess = Nothing
