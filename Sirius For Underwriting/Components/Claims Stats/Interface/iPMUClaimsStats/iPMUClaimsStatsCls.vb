...
Imports System
'Modified by Sumeet Singh on 5/27/2010 5:03:53 PM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        If g_oObjectManager.GetInstance(temp_oObject, "bControlTransClaims.Automated", vInstanceManager:=gPMConstants.PMGetViaClientManager) <> gPMConstants.PMEReturnCode.PMTrue Then
