...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            'Do this for Add as well, else we never see anything in the road map
            ' Check the task.

            'NIIT - Replaced with the Migrated code 1144 
            'If m_frmInterface.Task = gPMConstants.PMEComponentAction.PMAdd Or m_frmInterface.Task = gPMConstants.PMEComponentAction.PMEdit Or m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView Then
            If ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMAdd Or ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMEdit Or ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMView Then
