...
#Region "Private Constants"
    ...
    Private Const kBusinessTypeIdCoinsLead As Integer = 3
...
#Region "Private Variables"
    ...
    Private m_cInsPremium As Decimal
    ...
    Private frmInteface As frmInterface
#End Region
...
#Region "Public Properties"
    ...
    Public WriteOnly Property InsPremium() As Decimal
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMNavKeyConst.PMKeyNameBusinessTypeId
                        ...
                        m_lBusinessTypeId = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
...
#Region "Private Methods"
    ...
    Private Function ProcessInterface() As Integer
        ...
        If m_lBusinessTypeId = kBusinessTypeIdCoinsLead OrElse m_lBusinessTypeId = kBusinessTypeIdCoinsFollow Then
    ...
    Private Function LoadInterface() As Integer
        ...
        'developer guide no. 50
        frmInteface = New iPMUCoinsurance.frmInterface
        ...
        With frmInteface
            ...
            .FromEvent = FromEvent
            .BusinessTypeId = m_lBusinessTypeId
            ' {* USER DEFINED CODE (End) *}
        End With

        ' Load the instance of the interface into memory.
        ' Check if we have had an error so far.
        If frmInteface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ' We have already encountered an error,
            ' so we MUST return the error.
            nResult = frmInteface.ErrorNumber
        End If
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        VB6.ShowForm(frmInteface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            If frmInteface.ErrorNumber <> 0 Then
                result = frmInteface.ErrorNumber
            End If
        End If
