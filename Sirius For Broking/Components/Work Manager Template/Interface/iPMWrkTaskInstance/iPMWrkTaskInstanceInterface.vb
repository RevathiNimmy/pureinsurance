...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_sWorkflowInformation As String = "" 'PN15447
    'MS290601
    ...
    Private m_bUseExtraKeys As Boolean
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)
                    ...
                    Case "UseSuppliedTaskTemplateDetails"

                        m_bUseSuppliedTaskTemplateDetails = CBool(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))

                    Case "DoNotSaveTaskTemplateToDB"

                        m_bDoNotSaveTaskTemplateToDB = CBool(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))


                        'PN15774 Task Workflow Information
                    ...
                    Case PMNavKeyConst.PMKeyNameUseExtraKeys

                        m_bUseExtraKeys = CBool(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
    ...
    Private Sub GetIDsFromCodes(ByVal v_sTaskGroupCode As String, ByVal v_sTaskCode As String, ByRef r_lTaskGroupID As Integer, ByRef r_lTaskID As Integer)
        ...
        m_lReturn = g_oObjectManager.GetInstance(temp_oPMLookup, "bPMLookup.Business", gPMConstants.PMGetViaClientManager)
        ...
        If v_sTaskGroupCode.Trim() <> "" Then
            ...
            m_lReturn = oPMLookup.GetEffectiveIDFromCode(v_sTableName:="PMWrk_task_group", v_sCode:=v_sTaskGroupCode, v_dtEffectiveDate:=DateTime.Today, r_lID:=r_lTaskGroupID)
        ...
        If v_sTaskCode.Trim() <> "" Then
            ...
            m_lReturn = oPMLookup.GetEffectiveIDFromCode(v_sTableName:="PMWrk_Task", v_sCode:=v_sTaskCode, v_dtEffectiveDate:=DateTime.Today, r_lID:=r_lTaskID)
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_frmInterface
            ...
            .UseSuppliedTaskTemplateDetails = m_bUseSuppliedTaskTemplateDetails
            .DoNotSaveTaskTemplateToDB = m_bDoNotSaveTaskTemplateToDB
            .WorkflowInformation = WorkflowInformation 'PN15774
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With m_frmInterface
            ...
            m_sWorkflowInformation = .WorkflowInformation 'PN15774
            ' {* USER DEFINED CODE (End) *}
        End With
