...
Imports System
'Modified by Sumeet Singh on 5/10/2010 1:07:22 PM refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class Interface_Renamed
    ...
    ' which class this is.
    'Modified by Sumeet Singh on 5/10/2010 2:57:50 PM refer developer guide no. 69
    Dim m_ofrmInterface As iPMBDocLink.frmInterface
    ...
    Public ReadOnly Property SuppressErrors() As Boolean
        Get
            'Modified by Sumeet Singh on 5/10/2010 3:04:45 PM refer developer guide no. 69
            'Return frmInterface.SuppressErrors
            Return m_ofrmInterface.SuppressErrors
        End Get
    End Property
    ...
    Private Function LoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/10/2010 3:05:13 PM refer developer guide no. 69
        'With frmInterface
        ...
        'Modified by Sumeet Singh on 5/10/2010 3:06:39 PM refer developer guide no. 69
        'Dim tempLoadForm As frmInterface = frmInterface
        Dim tempLoadForm As frmInterface = m_ofrmInterface

        ' Check if we have had an error so far.
        'Modified by Sumeet Singh on 5/10/2010 3:07:01 PM refer developer guide no. 69
        ...
        If m_ofrmInterface.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ...
            'Modified by Sumeet Singh on 5/10/2010 3:07:28 PM refer developer guide no. 69
    ...
    Private Function UnLoadInterface() As Integer
        ...
        'Modified by Sumeet Singh on 5/10/2010 3:07:48 PM refer developer guide no. 69
        'With frmInterface
        With m_ofrmInterface
            m_lStatus = .Status
        ...
        ' from memory.
        'Modified by Sumeet Singh on 5/10/2010 3:09:53 PM refer developer guide no. 69
        'frmInterface.Close()
        m_ofrmInterface.Close()
        'Modified by Sumeet Singh on 5/10/2010 3:10:17 PM refer developer guide no. 69
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        'Modified by Sumeet Singh on 5/10/2010 3:10:39 PM refer developer guide no. 69
        'VB6.ShowForm(frmInterface, lDisplayState)
        VB6.ShowForm(m_ofrmInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            'Modified by Sumeet Singh on 5/10/2010 3:11:02 PM refer developer guide no. 69
            'If frmInterface.ErrorNumber <> 0 Then
            If m_ofrmInterface.ErrorNumber <> 0 Then
                'Modified by Sumeet Singh on 5/10/2010 3:11:23 PM refer developer guide no. 69
                'result = frmInterface.ErrorNumber
                result = m_ofrmInterface.ErrorNumber
            End If
        End If
