...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("SIRProspectPolicy_NET.SIRProspectPolicy")> _
Public NotInheritable Class SIRProspectPolicy
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: SIRProspectPolicy
    '
    ' Date: 27/04/1999
    '
    ' Description: Describes the SIRProspectPolicy attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "SIRProspectPolicy"
    ...
    '
    ' Description: Selects the required SIRProspectPolicy
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied SIRProspectPolicy properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                PolicyID = gPMFunctions.NullToLong(oFields("prospect_policy_id"))
                PolicyTypeID = oFields("risk_group_id")

                If Convert.IsDBNull(oFields("renewal_date")) Or IsNothing(oFields("renewal_date")) Then
                ...
                If Convert.IsDBNull(oFields("no_of_times_quoted")) Or IsNothing(oFields("no_of_times_quoted")) Then

                    NoOfTimesQuoted = Nothing
                Else

                    NoOfTimesQuoted = oFields("no_of_times_quoted")
                End If

                If Convert.IsDBNull(oFields("target_premium")) Or IsNothing(oFields("target_premium")) Then

                    TargetPremium = Nothing
                Else

                    TargetPremium = oFields("target_premium")
                End If
    ...
    Public Function GetPolicyDetails(ByVal v_vPartyCnt As Object, ByVal v_vPolicyID As Object, ByRef r_vPolicyTypeID As Object, ByRef r_vRenewalDate As Object, ByRef r_vNoOfTimesQuoted As Object, ByRef r_vTargetPremium As Object) As Integer
        ...
        Try
            ...
            ' Construct SQL
            sSQL = "SELECT risk_group_id, renewal_date, no_of_times_quoted, target_premium " & _
                   "FROM prospect_policy " & _
            ...
            m_lReturn = m_oDatabase.Parameters.Add(sName:="prospect_policy_id", vValue:=CStr(v_vPolicyID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            ' Perform the SQL
            m_lReturn = m_oDatabase.SQLSelect(sSQL:=sSQL, sSQLName:="GetPolicyDetails", bStoredProcedure:=False, vResultArray:=vResultArray)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            If Information.IsArray(vResultArray) Then
                ...
                r_vPolicyTypeID = vResultArray(0, 0)


                r_vRenewalDate = vResultArray(1, 0)


                r_vNoOfTimesQuoted = vResultArray(2, 0)


                r_vTargetPremium = vResultArray(3, 0)
            Else
    ...
    Public Function GetPoliciesForParty(ByVal v_vPartyCnt As Object, ByRef r_vPolicies As Object) As Integer
        ...
        Try
            ...
            ' construct the SQL
            sSQL = "SELECT prospect_policy_id FROM prospect_policy WHERE " & _
                   "party_cnt = {party_cnt}"
            ...
            ' Perform the SQL
            m_lReturn = m_oDatabase.SQLSelect(sSQL:=sSQL, sSQLName:="GetPoliciesForParty", bStoredProcedure:=False, vResultArray:=vResultArray)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="risk_group_id", vValue:=CStr(PolicyTypeID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            ...
            m_lReturn = .Parameters.Add(sName:="no_of_times_quoted", vValue:=NoOfTimesQuoted, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="target_premium", vValue:=TargetPremium, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="prospect_policy_id", vValue:=CStr(PolicyID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyOutputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="prospect_policy_id", vValue:=CStr(0), iDirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            PolicyID = gPMFunctions.NullToLong(.Parameters.Item("prospect_policy_id").Value)
