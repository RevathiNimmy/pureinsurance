...
<System.Runtime.InteropServices.ProgId("PartyPublicText_NET.PartyPublicText")>
Public NotInheritable Class PartyPublicText
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: PartyPublicText
    '
    ' Date: 08/09/1998
    '
    ' Description: Describes the PartyPublicText attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "PartyPublicText"
    ...
    Private m_lPartyPublicTextID As Integer
    ...
    Public Property PartyPublicTextID() As Integer
        Get

            Return m_lPartyPublicTextID

        End Get
        Set(ByVal Value As Integer)

            m_lPartyPublicTextID = Value
    ...
    '
    ' Description: Selects the required PartyPublicText
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied PartyPublicText properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                PartyPublicTextID = gPMFunctions.NullToLong(oFields("party_Public_text_id"))
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="party_Public_text_id", vValue:=CStr(PartyPublicTextID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    'With m_oDatabase
    '
    'm_lReturn = .Parameters.Add(sName:="party_cnt", vValue:=CStr(PartyCnt), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'm_lReturn = .Parameters.Add(sName:="party_Public_text_id", vValue:=CStr(PartyPublicTextID), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'End With
    '
    'Return result
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            PartyPublicTextID = gPMFunctions.NullToLong(.Parameters.Item("party_Public_text_id").Value)
