...
'Modified by Sudhanshu Behera on 5/11/2010 2:43:32 PM refer developer guide no. 129 (guide)
Imports SSP.Shared

<System.Runtime.InteropServices.ProgId("InsFilePublicText_NET.InsFilePublicText")>
Public NotInheritable Class InsFilePublicText
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: InsFilePublicText
    '
    ' Date: 08/09/1998
    '
    ' Description: Describes the InsFilePublicText attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "InsFilePublicText"
    ...
    Private m_lInsFilePublicTextID As Integer
    ...
    Public Property InsFilePublicTextID() As Integer
        Get

            Return m_lInsFilePublicTextID

        End Get
        Set(ByVal Value As Integer)

            m_lInsFilePublicTextID = Value
    ...
    '
    ' Description: Selects the required InsFilePublicText
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied InsFilePublicText properties from a database
    '              record.
    ' ***************************************************************** '
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                InsFilePublicTextID = gPMFunctions.NullToLong(oFields("ins_file_public_text_id"))
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="ins_file_public_text_id", vValue:=CStr(InsFilePublicTextID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    '
    'm_lReturn = .Parameters.Add(sName:="ins_file_public_text_id", vValue:=CStr(0), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'End With
    '
    'Return result
    ...
    'With m_oDatabase
    '
    'InsuranceFileCnt = gPMFunctions.NullToLong(.Parameters.Item("insurance_file_cnt").Value)
    'InsFilePublicTextID = gPMFunctions.NullToLong(.Parameters.Item("ins_file_public_text_id").Value)
    '
    'End With
    '
    'Return result
