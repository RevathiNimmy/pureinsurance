...
<System.Runtime.InteropServices.ProgId("EventPublicText_NET.EventPublicText")>
Public NotInheritable Class EventPublicText
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: EventPublicText
    '
    ' Date: 04/06/2001 Lifted from PartyPublicText MS
    '
    ' Description: Describes the EventPublicText attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "EventPublicText"
    ...
    Private m_lEventPublicTextID As Integer
    Private m_sTextLine As New StringsHelper.FixedLengthString(255)
    ...
    Public Property EventPublicTextID() As Integer
        Get

            Return m_lEventPublicTextID

        End Get
        Set(ByVal Value As Integer)

            m_lEventPublicTextID = Value
    ...
    '
    ' Description: Selects the required EventPublicText
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied EventPublicText properties from a database
    '              record.
    ' ***************************************************************** '
    Public Function SetPropertiesFromDB(ByRef oFields As Data.DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                EventPublicTextID = gPMFunctions.NullToLong(oFields("event_Public_text_id"))
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="event_Public_text_id", vValue:=CStr(EventPublicTextID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    'With m_oDatabase
    '
    'm_lReturn = .Parameters.Add(sName:="event_cnt", vValue:=CStr(EventCnt), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'm_lReturn = .Parameters.Add(sName:="event_Public_text_id", vValue:=CStr(EventPublicTextID), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'End With
    '
    'Return result
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            EventCnt = gPMFunctions.NullToLong(.Parameters.Item("Event_cnt").Value)
            EventPublicTextID = gPMFunctions.NullToLong(.Parameters.Item("event_Public_text_id").Value)
