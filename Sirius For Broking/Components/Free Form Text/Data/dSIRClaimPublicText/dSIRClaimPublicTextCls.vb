...
<System.Runtime.InteropServices.ProgId("ClaimPublicText_NET.ClaimPublicText")>
Public NotInheritable Class ClaimPublicText
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: ClaimPublicText
    '
    ' Date: 14/01/01
    '
    ' Description: Describes the ClaimPublicText attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "ClaimPublicText"
    ...
    Private m_lClaimPublicTextID As Integer
    Private m_sTextLine As New FixedLengthString(255)
    ...
    Public Property FileCnt() As Integer
        Get
    ...
    Public Property ClaimPublicTextID() As Integer
        Get

            Return m_lClaimPublicTextID

        End Get
        Set(ByVal Value As Integer)

            m_lClaimPublicTextID = Value
    ...
    Public Property TextLine() As String
        Get
            ...
            Return m_sTextLine.Value

        End Get
        Set(ByVal Value As String)

            m_sTextLine.Value = Value
    ...
    Public Function Add() As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                ' CTAF 020101 - Switched paramters around
    ...
    '
    ' Description: Selects the required ClaimPublicText
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied ClaimPublicText properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                ClaimCnt = gPMFunctions.NullToLong(oFields("claim_cnt"))
                ClaimPublicTextID = gPMFunctions.NullToLong(oFields("claim_Public_text_id"))
                TextLine = gPMFunctions.NullToString(oFields("text_line"))
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="text_line", vValue:=TextLine, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMString)
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="claim_cnt", vValue:=CStr(ClaimCnt), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            m_lReturn = .Parameters.Add(sName:="Claim_Public_text_id", vValue:=CStr(ClaimPublicTextID), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    'With m_oDatabase
    '
    'm_lReturn = .Parameters.Add(sName:="claim_cnt", vValue:=CStr(ClaimCnt), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'm_lReturn = .Parameters.Add(sName:="claim_Public_text_id", vValue:=CStr(ClaimPublicTextID), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    '
    'End With
    '
    'Return result
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            ClaimCnt = .Parameters.Item("claim_cnt").Value
            ClaimPublicTextID = .Parameters.Item("claim_Public_text_id").Value
