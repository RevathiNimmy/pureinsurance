...
Public NotInheritable Class Interface_Renamed
    ...
    Public Shared frmInterface As frmInterface
    ...
    Public ReadOnly Property PMProductFamily() As Integer
        ...
        End Get
    End Property
    Public WriteOnly Property EntityName() As String
        ...
        End Set
    End Property
    Public WriteOnly Property Texttype() As String
        Set(ByVal Value As String)
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.PMKeynameTableName


                        m_sEntityName = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))

                    Case PMNavKeyConst.PMKeyNameTextType


                        m_sTexttype = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))

                    Case PMKeyNameKeyFieldValue


                        m_lKeyFieldValue = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            If Information.IsDate(m_dtNoteDate) Then
