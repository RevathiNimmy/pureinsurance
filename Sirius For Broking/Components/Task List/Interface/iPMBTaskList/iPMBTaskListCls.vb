...
Public NotInheritable Class Interface_Renamed
    ...
    ' which class this is.
    Private Const ACClass As String = "TaskList"
    ...
    Private m_lFSAComplaintFolderCnt As Integer 'FSA Phase III
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            End If
            If sHelpFile <> "" Then
                'Modified by Sumeet Singh on 5/19/2010 5:22:09 PM to do list
                'App.HelpFile = sHelpFile
            End If

            ' Get an instance of the business object
            Dim temp_m_oBusiness As Object
            m_lReturn = g_oObjectManager.GetInstance(temp_m_oBusiness, "bSIRTaskList.Business", vInstanceManager:="ClientManager")
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                m_oBusiness = Nothing
                ' Log Error.
                gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get instance of bSIRTaskList", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise")
                Return result
            End If
            Return result
