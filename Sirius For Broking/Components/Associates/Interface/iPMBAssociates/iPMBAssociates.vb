...
Module MainModule
	...
	Public Const ACApp As String = "iPMBAssociates"
	...
	Public Const ACIAssociatePartyCnt As Integer = 0
	Public Const ACIAssociatePartyShortname As Integer = 1
	Public Const ACIAssociatePartyName As Integer = 2
	Public Const ACIRelationshipTypeId As Integer = 3
	Public Const ACIRelationshipTypeDesc As Integer = 4
	Public Const ACIAssociateCommTransf As Integer = 5
