...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            'Modified by Archana Tokas on 5/3/2010 2:50:26 PM changes as per requirement
            '.set_SearchData(m_vSearchData)
            '.set_Relationships(m_vRelationships)
            .SearchData = m_vSearchData
            .Relationships = m_vRelationships
    ...
    Private Function UnLoadInterface() As Integer
        ...
        m_vSearchData = frmInterface.SearchData
