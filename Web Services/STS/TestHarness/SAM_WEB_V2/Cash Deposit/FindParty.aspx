<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="FindParty.aspx.vb" Inherits="Cash_Deposit_Find_Party" %>
...
<head runat="server">
    ...
    function passresult()
    {
       if (opener != null)
        {
        if (opener.document.getElementById("txtClient") != null && opener.document.getElementById("hfClientKey") != null)
        {
        opener.document.getElementById("txtClient").value = Trim(document.getElementById("txtShortName").value);
        opener.document.getElementById("txtAgent").value = "";
        opener.document.getElementById("BtnAdd").disabled = false;
        opener.document.getElementById('btnFind').disabled = false;
        opener.document.getElementById("hfClientKey").value = Trim(document.getElementById("hfClientKey").value);
        }
        else
        {
                        ...
                        <table style="width: 100%" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Auto" Width="49%">
                            ...
                            <tr>
                                <td colspan="2">
                                    &nbsp;<input id="btnOk" type="button" value="Ok" class="button" onclick="Javascript:passresult()" />
                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" />
                                    <asp:TextBox ID="txtShortName" runat="server" Visible="True" Enabled="False"></asp:TextBox>
                                    <asp:HiddenField ID="hfClientKey" runat="server" /></td>
                            </tr>
                        </table>
