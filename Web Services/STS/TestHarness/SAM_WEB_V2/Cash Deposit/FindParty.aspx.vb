...
Partial Class Cash_Deposit_Find_Party
    ...
    Protected Sub gvSearchResult_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvSearchResult.SelectedIndexChanged
        ...
        Session("hfClientKey") = oFindPartyResponse.Parties(gvSearchResult.SelectedIndex).PartyKey
        hfClientKey.Value = oFindPartyResponse.Parties(gvSearchResult.SelectedIndex).PartyKey
