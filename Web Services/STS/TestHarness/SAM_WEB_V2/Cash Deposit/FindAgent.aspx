<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FindAgent.aspx.vb" Inherits="CashDeposit_FindAgent" %>
...
<head runat="server">
     ...
     function passresult()
    {
        ...
        if (opener.document.getElementById("txtAgent") != null && opener.document.getElementById("hfAgentKey") != null)
        {
        opener.document.getElementById("txtAgent").value = Trim(document.getElementById("txtShortName").value);
        opener.document.getElementById("txtClient").value = "";
        opener.document.getElementById("BtnAdd").disabled = false;
        opener.document.getElementById('btnFind').disabled = false;
        opener.document.getElementById("hfAgentKey").value = Trim(document.getElementById("hfAgentKey").value);
        }
        else
        {
        ...
        <div>
            ...
            <table style="width: 536px">
                ...
                <tr>
                   ...
                   <asp:Button ID="btnOk"  runat="server" Text="Ok" OnClientClick = "passresult()" /> &nbsp;
