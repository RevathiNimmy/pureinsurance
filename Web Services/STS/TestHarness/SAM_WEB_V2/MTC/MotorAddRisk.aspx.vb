...
#Region "Filling the XML"
    ...
    Public Sub CoverNote(ByRef oCoverSelXmlElement As XMLElementToAdd)
        ...
        Dim oCoverSelXmlAttribute(12) As XMLAttributeToAdd
        ...
        If ChkTrailer.Checked Then
            ReDim Preserve oCoverSelXmlAttribute(15)
            oCoverSelXmlAttribute(13) = New XMLAttributeToAdd
            oCoverSelXmlAttribute(13).AttributeName = "NUMBER_OF_TRAILERS"
            oCoverSelXmlAttribute(13).AttributeValue = txtNumberoftrailers.Text

            oCoverSelXmlAttribute(14) = New XMLAttributeToAdd
            oCoverSelXmlAttribute(14).AttributeName = "TRAILER_IDV"
            oCoverSelXmlAttribute(14).AttributeValue = txtTrailersIDV.Text

            oCoverSelXmlAttribute(15) = New XMLAttributeToAdd
            oCoverSelXmlAttribute(15).AttributeName = "TRAILER_REGISTRATION_NUMBER"
            oCoverSelXmlAttribute(15).AttributeValue = txtTrailersIDV.Text
        End If
...
#End Region
    ...
    Protected Sub btnNonelectricAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNonelectricAdd.Click
        ...
        If Session("NONELECTRICALEDIT") = 1 Then
            ...
            dtNonelecmerge.Rows(iCount).Item("PRODUCT_SERIAL_NUMBER") = txtNonelectricalProductserialNumber.Text
        ...
        Else
            ...
            dr.Item("PRODUCT_SERIAL_NUMBER") = txtNonelectricalProductserialNumber.Text
    ...
    Protected Sub gvNonElecTrical_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles gvNonElecTrical.RowUpdating
        ...
        dt.Rows(gvNonElecTrical.EditIndex)("PRODUCT_SERIAL_NUMBER") = DirectCast((row.Cells(3).Controls(0)), TextBox).Text
    ...
    Protected Sub gvNonElecTrical_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvNonElecTrical.SelectedIndexChanged
        ...
        txtNonelectricalProductserialNumber.Text = dt.Rows(iCount).Item("PRODUCT_SERIAL_NUMBER")
