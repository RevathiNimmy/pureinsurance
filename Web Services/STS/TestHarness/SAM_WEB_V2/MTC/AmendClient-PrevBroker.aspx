<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AmendClient-PrevBroker.aspx.vb"
...
<head runat="server">
    ...
    function passresult()
    {
        if (opener != null)
        {
            ...
            {
                opener.document.getElementById("txtPBname").value = document.getElementById("txtShortName").value;
                opener.document.getElementById("txtPBcode").value = document.getElementById("hfCode").value;
                opener.document.getElementById("hdPrevBrokerKey").value = document.getElementById("hfAgentKey").value;
            }
            else
            {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlType" runat="server" Enabled ="false" >
                                                        ...
                                                        <asp:ListItem Value="0" Selected="True" >Broker</asp:ListItem>
