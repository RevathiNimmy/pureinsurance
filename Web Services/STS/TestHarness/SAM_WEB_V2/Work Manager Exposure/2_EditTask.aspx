<%@ Page Language="VB" AutoEventWireup="false" CodeFile="2_EditTask.aspx.vb" Inherits="Work_Manager_Exposure_2_EditTask" %>
...
<head id="Head1" runat="server">
    ...
    function CheckDate()
    {
        ...
        if(CurrentDate=="NO")
        {
          alert("DueDate is lessthan current date")
...
<body>
    <form id="form1" runat="server">
        <div>
                                    ...
                                    <table style="width: 352px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 158px; height: 24px">
                                                <asp:DropDownList ID="ddlTaskGroup" runat="server" Enabled="False">
                                            ...
                                            <td style="width: 3px; height: 24px">
                                                <asp:DropDownList ID="ddlTask" runat="server" Width="200px" Enabled="False">
                                                    <asp:ListItem>All</asp:ListItem>
                                                    <asp:ListItem Value="0">Personal Client</asp:ListItem>
                                                    <asp:ListItem Value="3">Corporate Client</asp:ListItem>
                                                    <asp:ListItem Value="1">Group Client</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlDueDateTime" runat="server" Width="300px" AutoPostBack="True">
                                            ...
                                            <td style="height: 20px; width: 3px;">
                                                <asp:TextBox ID="txtDate" runat="server" Width="159px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 130px; height: 24px;">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="height: 21px">
                                                <asp:CheckBox ID="ChkUrgent" runat="server" />&nbsp; Complete&nbsp;
                                                <asp:CheckBox ID="chkComplete" runat="server" Enabled="False" /></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 130px">
                                                Task Review</td>
                                            <td style="width: 158px">
                                                <asp:CheckBox ID="chkIsTaskreview" runat="server" Enabled="False" 
                                              />
                                             </td>
                                            <td>
                                            </td>
                                    ...
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 29px; width: 208px;">
                                                &nbsp;<asp:DropDownList ID="ddlUserGroup" runat="server" Enabled="False">
                                        ...
                                        <tr>
                                            <td colspan="4" style="height: 11px">
                                                <asp:Button ID="btnTaskLog" runat="server" Text="Task Log" OnClientClick="LoadWindows('../Work Manager Exposure/WMTaskLog.aspx',600,600)"/></td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <asp:Button ID="btnOK" runat="server" Text="OK" OnClientClick="CheckDate()" CommandName="Delete" /></asp:View>
                            <asp:View ID="vAuditDetails" runat="server">
                                <table id="tblAddress" runat="server" style="width: 600px">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 227px; height: 38px;">
                                            At :</td>
                                        <td style="width: 128px; height: 38px;">
                                            <asp:Label ID="lblAt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </asp:View>
            ...
            <input type="hidden" name="currentDate" id="CurrentDate" runat="server" />
        </div>
    </form>
</body>
</html>
