<%@ Page Language="VB" AutoEventWireup="false" CodeFile="2_UpdateTask.aspx.vb" Inherits="Work_Manager_Exposure_2_UpdateTask" %>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="4" style="height: 11px">
                                            <asp:Button ID="btnTaskLog" runat="server" Text="Task Log" /></td>
                                    </tr>
                                </table>
                            </asp:Panel>
                        </asp:View>
