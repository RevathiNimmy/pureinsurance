-<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssignSingleTask.aspx.vb" Inherits="Work_Manager_Exposure_AssignSingleTask" %>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="4" style="height: 11px" align="right">
                                            ...
                                            <asp:Button ID="btnTaskLog" runat="server" Text="Task Log" OnClientClick="LoadWindows('../Work Manager Exposure/WMTaskLog.aspx',600,600)" /></asp:View>
