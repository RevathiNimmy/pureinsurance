<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreateCashListItemReceipt.aspx.vb" Inherits="Claim_Payment_CashListItem" %>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnaccountcode" runat="server"
                                            Text="...." Enabled="False" /><asp:HiddenField ID="hfAccountKey" runat="server" />
                                    </td>
                                    <td>
                                        Allocation Status
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong>
                                            <asp:Label ID="lbltendered" runat="server" Text="Tendered" Visible="False"></asp:Label></strong></td>
                                    <td>
                                        <asp:TextBox ID="txttendered" runat="server" AutoPostBack="True" Visible="False"></asp:TextBox>
                                        </td>
                                           <td>
                                        <strong>
                                            <asp:Label ID="lblchange" runat="server" Text="Change" Visible="False"></asp:Label></strong></td>
                                    <td>
                        ...
                        <asp:View ID="vPayments" runat="server">
                           <%-- <strong>Payment Information<br />
                            ...
                            <%--<asp:Panel ID="pnlPayee" runat="server" Height="50px" Width="608px">
                               ...
                               <%--<asp:Panel ID="pplchequeinformation" runat="server" Height="50px" Width="608px">
                                <strong>Cheque Information</strong><table>
                            ...
                            <asp:Panel ID="pnlcheque" runat="server" Height="50px" Width="568px">
                                    <strong>Cheque Information</strong><table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlBank" runat="server" Enabled="False" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <asp:Panel ID="pnlcreditcard" runat="server" Height="50px" Width="568px">
