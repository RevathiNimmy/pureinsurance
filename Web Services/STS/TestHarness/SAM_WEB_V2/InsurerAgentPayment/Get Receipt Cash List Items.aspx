<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Get Receipt Cash List Items.aspx.vb"
    Inherits="CASHLIST_Get_Receipt_Cash_List_Details" %>
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            <asp:HiddenField runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"CashListItemKey")%>'
                                ID="hd" />
                        </ItemTemplate>
                    </asp:TemplateField>
