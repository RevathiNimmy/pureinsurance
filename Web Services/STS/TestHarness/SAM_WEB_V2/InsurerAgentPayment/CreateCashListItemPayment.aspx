<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreateCashListItemPayment.aspx.vb" Inherits="Claim_Payment_CashListItem" %>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnaccountcode" runat="server" OnClientClick="LoadWindows('FindAccount.aspx')"
                                            Text="...." /><asp:HiddenField ID="hfAccountKey" runat="server" />
                                    </td>
                                    <td>
                                        Allocation Status
                                    </td>
                    ...
                    --%>
                      <%--  </asp:View>--%>
                        ...
                        <asp:View ID="vPayments" runat="server">
                            ...
                            <br />
                            <hr />
                            <asp:Panel ID="pplcheque" runat="server" Height="50px" Width="608px" Visible="False">
