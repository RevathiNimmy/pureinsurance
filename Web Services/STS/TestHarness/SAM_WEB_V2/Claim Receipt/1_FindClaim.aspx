    ...
    <table width="100%" style="height: 100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table style="width: 600px">
            <tr>
                ...
                <table>
                <tr>
                <td style="width: 189px">Policy</td>
                <td style="width: 260px"><asp:TextBox ID="txtPolicyNumber" runat="server"></asp:TextBox> </td>
                </tr>
                <tr>
                <td style="width: 189px">Risk Index </td>
                <td style="width: 260px"> <asp:TextBox ID="txtRiskIndex" runat="server"></asp:TextBox> </td>
                </tr>
                <tr>
                <td style="width: 189px"> Claim  </td>
                <td style="width: 260px"><asp:TextBox ID="txtClaim" runat="server"></asp:TextBox> </td>
                </tr>
                <tr>
                <td style="width: 189px"><input id="btnShortName" style="width: 96px; font-weight: bold;" type="button" value="Short Name" onclick="Javascript:LoadWindows('../Lookup screens/Find Party.aspx',600,600)"/></td>
                <td style="width: 260px"><asp:TextBox ID="txtShortName" runat="server"></asp:TextBox> </td>
                </tr>
                <tr>
               
                <td style="width: 189px; height: 22px;"><asp:CheckBox ID="chkIncludeCloseClaim" runat="server" Text="Include Closed Claim"
                            Width="176px" /> </td>
                </tr>
                    <tr>
                        <td style="width: 189px">
                            Loss Date Start Limit</td>
                        <td style="width: 260px"><asp:TextBox ID="txtInForceFrom" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 189px">
                        ...
                        <asp:TextBox ID="txtInForceTo" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
