...
Partial Class OpenClaim_Recoveries
    ...
    Protected Sub gvRecoveries_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles gvRecoveries.RowUpdating
        ...
        oPerilType(gvPerils.SelectedIndex).Recoveries(gvRecoveries.EditIndex).PartyCode = txtParty.Text
        oPerilType(gvPerils.SelectedIndex).Recoveries(gvRecoveries.EditIndex).PartyTypeCode = ddlRecoveryPartyType.SelectedValue
        Session("oMaintainClaimPerils") = oPerilType
        pnlAddRecovery.Visible = False
        txtInitialReserve.Visible = True
        btnAddRecovery.Visible = True
    ...
    Protected Sub gvRecoveries_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles gvRecoveries.RowEditing
        ...
        ddlRecoveries.SelectedValue = oPerilType(gvPerils.SelectedIndex).Recoveries(e.NewEditIndex).TypeCode.Trim
        ddlRecoveryPartyType.SelectedValue = oPerilType(gvPerils.SelectedIndex).Recoveries(e.NewEditIndex).PartyTypeCode.Trim
        txtParty.Text = oPerilType(gvPerils.SelectedIndex).Recoveries(e.NewEditIndex).PartyCode.Trim
        txtInitialReserve.Visible = False
        btnAddRecovery.Visible = False
        gvRecoveries.DataSource = oPerilType(gvPerils.SelectedIndex).Recoveries
        gvRecoveries.DataBind()
