    ...
    Protected Sub Menu1_MenuItemClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.MenuEventArgs) Handles Menu1.MenuItemClick
        ...
        If (iSelectedIndex = 0) Then
            ...
            With oGetClaimPerilSummaryRequestType
                ...
                If txtIncludeReserveTypes.Text IsNot String.Empty Then
                    .IncludeReserveTypes = txtIncludeReserveTypes.Text
                End If
                .IncludeSalvageRecovery = txtIncludeSalvageecovery.Text
                .IncludeTotals = txtIncludeTotals.Text
                .IncludeTPRecovery = txtIncludeTPRecovery.Text
            End With
             StartDate = Date.Now
        ...
        ElseIf (iSelectedIndex = 1) Then
            ...
            With oGetClaimPerilSummaryRequestType
                ...
                If txtIncludeReserveTypes.Text IsNot String.Empty Then
                    .IncludeReserveTypes = txtIncludeReserveTypes.Text
                End If
                If txtIncludeSalvageecovery.Text IsNot String.Empty Then
                    .IncludeSalvageRecovery = txtIncludeSalvageecovery.Text
                End If
                If txtIncludeTotals.Text IsNot String.Empty Then
                    .IncludeTotals = txtIncludeTotals.Text
                End If
                If txtIncludeTPRecovery.Text IsNot String.Empty Then
                    .IncludeTPRecovery = txtIncludeTPRecovery.Text
                End If
            End With
             StartDate = Date.Now
