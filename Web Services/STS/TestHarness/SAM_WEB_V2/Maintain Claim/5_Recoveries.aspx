...
<body>
    ...
    <table width="100%" style="height: 100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <asp:Panel ID="pnlAddRecovery" runat="server" Height="72px" Visible="False" Width="392px">
            ...
            Party Type: &nbsp; &nbsp;
            <asp:DropDownList ID="ddlRecoveryPartyType" runat="server" AutoPostBack="True" Width="144px">
            ...
            Party Name: &nbsp;&nbsp;
            <asp:TextBox ID="txtParty" runat="server"></asp:TextBox><asp:Button ID="btnShortName"
                runat="server" CausesValidation="False" Text="..." UseSubmitBehavior="False" /><br />
