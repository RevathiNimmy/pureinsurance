...
Imports SAMForInsuranceV2
   ...
   Partial Class Lookup_Screens_FindAgent
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        txtShortName.Attributes.Add("ReadOnly", "True")
    ...
    Protected Sub btnFind_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFind.Click
        ...
        Try
            ...
            WriteToLog(Session, "wfrmFindAgent", "SAMForInsuranceV2", "FindParty", StartDate, Date.Now)
    ...
    Protected Sub gvSearchResult_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvSearchResult.SelectedIndexChanged
        ...
        Session("SelectedAgentCode") = oFindPartyResponse.Parties(gvSearchResult.SelectedIndex).ShortName
        Session("AgentKey") = oFindPartyResponse.Parties(gvSearchResult.SelectedIndex).PartyKey
        Session("AgentName") = oFindPartyResponse.Parties(gvSearchResult.SelectedIndex).ShortName
