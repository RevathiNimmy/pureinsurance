<%@ Page Language="VB" AutoEventWireup="false" CodeFile="wfrmFindParty.aspx.vb" Inherits="Find_Party_Find_Party" %>
...
<head runat="server">
    ...
    if (opener != null)
    {
    opener.document.getElementById("txtPartyShortName").value = document.getElementById("txtShortName").value;
    self.close();
    }
                ...
                <td style="width: 419px">
                    <asp:MultiView ID="mvFindParty" runat="server" ActiveViewIndex="0">
                        ...
                        <asp:View ID="Policy" runat="server">
                            <br />
                            <asp:Button ID="btnPolicyNumber" runat="server" Text="Policy Number" CausesValidation="False" />
                            &nbsp;&nbsp;
