...
Partial Class PolicyRenewal_wrfmAcceptRenewalWithAmend
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Else
            Try
                ...
                WriteToLog(Session, "wrfmAcceptRenewalWithAmend.aspx", "SAMForInsuranceV2", "GetHeaderAndSummariesByKey", StartDate, Date.Now)
    ...
    Private Function GetRenewalStatus(ByVal iInsuranceFileKey As Integer) As String
        ...
        Try
            ...
            WriteToLog(Session, "wrfmAcceptRenewalWithAmend.aspx", "SAMForInsuranceV2", "GetRenewalStatus", StartDate, Date.Now)
    ...
    Private Sub MakeLive()
        ...
        WriteToLog(Session, "wrfmAcceptRenewalWithAmend.aspx", "SAMForInsuranceV2", "GetOptionSetting", StartDate, Date.Now)
        ...
        With oGetOptionsettingsResponse
            ...
            Else
                If .OptionValue = "1" Then
                    If oGetHeaderAndSummariesByKeResponse.PaymentMethodCode = "PayNow" Then
                ...
                Else
                    ...
                    WriteToLog(Session, "wrfmAcceptRenewalWithAmend.aspx", "SAMForInsuranceV2", "BindQuote", StartDate, Date.Now)
    ...
    Private Function CalculateAmount() As Decimal
        ...
        WriteToLog(Session, "wrfmAcceptRenewalWithAmend.aspx", "SAMForInsuranceV2", "GetHeaderAndAgentCommissionByKey", StartDate, Date.Now)
