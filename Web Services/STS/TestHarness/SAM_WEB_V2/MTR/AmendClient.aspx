                            ...
                            <td style="width: 50%" valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMainContact" runat="server" Visible="False"></asp:TextBox></td>
                                    </tr>
                                    <% End If%>
                                </table>
                            </td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            Branch:&nbsp;</td>
                                        <td>
                                            <asp:DropDownList ID="ddBranch" runat="server" Enabled="False">
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Sub Branch:&nbsp;</td>
                                        <td>
                                            <asp:DropDownList ID="ddSubBranch" runat="server" Enabled="False">
                                            </asp:DropDownList></td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td style="width: 50%" valign="top">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNoOfOffices" runat="server" Visible="False"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlNoOfEmployees" runat="server" Visible="False">
                                            </asp:DropDownList></td>
                                    </tr>
                                </table>
                                <% End If%>
