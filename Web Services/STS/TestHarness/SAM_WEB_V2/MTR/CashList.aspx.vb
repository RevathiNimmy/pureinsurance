...
Partial Class Claim_Payment_CashList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            ddlCurrency.SelectedItem.Text = "Euro"
        End If
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        With oBaseRecipetType
            .BankAccountName = ddlBankAccount.SelectedItem.Text.Trim
            .CurrencyCode = ddlCurrency.SelectedValue
            .CashListRef = txtReference.Text
        End With

        Session("BaseReciptType") = oBaseRecipetType
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        If (Session("Process") IsNot Nothing AndAlso Session("Process") = "REN") Then
            Session("StatusMessage") = "Process cancelled by user"
            Response.Redirect(Session("ReturnPage").ToString)
        Else
            Response.Redirect("GetListRisks.aspx")
        End If
    End Sub
End Class
