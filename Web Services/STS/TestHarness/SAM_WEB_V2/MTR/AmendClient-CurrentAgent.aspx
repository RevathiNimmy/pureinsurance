<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AmendClient-CurrentAgent.aspx.vb"
...
<head runat="server">
    ...
    function passresult()
    {
        if (opener != null)
        {
            ...
            {
                opener.document.getElementById("txtcurrentagent").value = document.getElementById("txtShortName").value;
                //opener.document.getElementById("txtLeadAgentCode").value = document.getElementById("txtShortName").value;
                opener.document.getElementById("hdCurrentAgentKey").value = document.getElementById("hfAgentKey").value;
            }
            else
            {
