...
Partial Class MTA_PolicyHeader
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                ...
                With oGetStandardPolicyWordingResponse
                    ...
                    Else
                        If Session("PolicyWording") Is Nothing Then
                            gvStandardWording.DataSource = .DocumentTemplates
                            gvSubAgents.DataBind()
                            Session("PolicyWording") = .DocumentTemplates
                        End If
        ...
        If Not Session("PolicyWording") Is Nothing Then
            gvStandardWording.DataSource = DirectCast(Session("PolicyWording"), BaseGetStandardPolicyWordingsResponseTypeRow())
    ...
    Private Sub UpdateSubagentsAndPolcyWordings()
        ...
        Dim oDocTemplates As BaseGetStandardPolicyWordingsResponseTypeRow()
        oDocTemplates = DirectCast(Session("PolicyWording"), BaseGetStandardPolicyWordingsResponseTypeRow())
