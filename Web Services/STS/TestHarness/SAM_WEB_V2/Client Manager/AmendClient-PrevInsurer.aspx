<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AmendClient-PrevInsurer.aspx.vb"
...
<head runat="server">
    ...
    function passresult1()
    {
        if (opener != null)
        {
            if (document.getElementById("txtShortName") != null && document.getElementById("hfAgentKey") != null)
            {
                opener.document.getElementById("txtPIname").value = document.getElementById("txtShortName").value;
                opener.document.getElementById("txtPIcode").value = document.getElementById("hfCode").value;
                opener.document.getElementById("hdPreviousInsurerKey").value = document.getElementById("hfAgentKey").value;
            }
            else
            {
                    ...
                    <div>
                        <div>
                            &nbsp;<table style="width: 536px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        &nbsp;<input id="btnOk" type="button" value="Ok" onclick="Javascript:passresult1()" />
                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" />
                                        <asp:TextBox ID="txtShortName" runat="server" Visible="True"></asp:TextBox>
                                        <asp:HiddenField ID="hfAgentKey" runat="server" /><asp:HiddenField ID="hfCode" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </div>
