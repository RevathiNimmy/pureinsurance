<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClientManager.aspx.vb" Inherits="Client_Manager_ClientManager" %>
...
<body>
    ...
    <div>
    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Event Details/EventList.aspx">EventDetails</asp:LinkButton>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:LinkButton
                ID="Btnpolicy" runat="server" PostBackUrl="~/Client Manager/List Policy.aspx">Policy</asp:LinkButton>
            <br />
            <asp:LinkButton
                    ID="BtnAccount" runat="server" PostBackUrl="~/Client Manager/FindAccountDetails.aspx" Width="73px">Account</asp:LinkButton>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <asp:LinkButton
                        ID="LinkButton2" runat="server" PostBackUrl="~/Client Manager/ClaimDetails.aspx">Claims</asp:LinkButton><br />
            <br />
    <table width="100%">
                <tr>
                    <td>
                        ...
                        <tr>
                            <td style="width: 50%" valign="top">
                                <table>
                                    ...
                                    <% If Session("CLIENTTYPE") = "Personal Client" Then%>
                                    <tr>
                                        <td>
                            ...
                            <td style="width: 50%" valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtLeadAgentCode" runat="server" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Name:&nbsp;</td>
                                        <td>
                                            <asp:TextBox ID="txtLeadAgentName" runat="server" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width: 50%" valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAccExecutiveCode" runat="server" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Name:&nbsp;</td>
                                        <td>
                                            <asp:TextBox ID="txtAccExecutiveName" runat="server" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table cellpadding="2" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtcurrentagent" runat="server" ReadOnly="True"></asp:TextBox></td>
                                        <td>
                                            Status
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnPrevInsurer" runat="server" OnClientClick="javascript:LoadWindows('AmendClient-PrevInsurer.aspx')"
                                                Text="Code..." /></td>
                                        <td>
                                            <asp:TextBox ID="txtPIcode" runat="server" ReadOnly="True"></asp:TextBox></td>
                                        <td>
                                            <asp:Button ID="btnPrevBroker" runat="server" OnClientClick="javascript:LoadWindows('AmendClient-PrevBroker.aspx')"
                                                Text="Code..." /></td>
                                        <td>
                                            <asp:TextBox ID="txtPBcode" runat="server" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Name</td>
                                        <td>
                                            <asp:TextBox ID="txtPIname" runat="server" ReadOnly="True"></asp:TextBox></td>
                                        <td>
                                            Name</td>
                                        <td>
                                            <asp:TextBox ID="txtPBname" runat="server" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <br />
