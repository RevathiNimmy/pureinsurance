<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FinancialDetails.aspx.vb"
    Inherits="OpenClaim_FinancialDetails" %>
                    ...
                    <td>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="chkIncludeTotals" runat="server" /></td>
                            </tr>
                            <tr>
                                <td style="height: 26px">
                                    <strong>Include TPRecovery</strong></td>
                                <td style="height: 26px">
                                    <asp:CheckBox ID="chkIncludeTPRecovery" runat="server" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Include Salvage Recovery</strong></td>
                                <td>
                                    <asp:CheckBox ID="chkIncludeSalvageecovery" runat="server" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Include Reserve Types</strong></td>
                                <td>
                                    <asp:CheckBox ID="chkIncludeReserveTypes" runat="server" /></td>
                            </tr>
