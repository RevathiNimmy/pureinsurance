                        ...
                        <asp:GridView ID="gvSearchResult" runat="server" AllowPaging="True" AutoGenerateColumns="False">
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkAmendClient" runat="server" CommandName="AmendClient" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"PartyKey")%>'>Amend Client</asp:LinkButton>&nbsp;<br />
                                        &nbsp; &nbsp; &nbsp;/<br />
