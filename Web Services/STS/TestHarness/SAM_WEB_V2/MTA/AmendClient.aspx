        ...
        <div>
            ...
            <asp:MultiView ID="Mv" runat="server" ActiveViewIndex="0">
                    ...
                    <asp:Panel ID="Panel2" runat="server" Height="50px" Width="360px" GroupingText="Address">
                        <asp:GridView ID="GVContacts" runat="server" Height="48px" Width="584px" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="AddressTypeCode" HeaderText="Address Usage" />
                ...
                <asp:View ID="Misc" runat="server">
                    ...
                    <br />
                    <asp:Panel ID="pnlAddLoyaltySchemes" runat="server" Visible="False" Width="125px"
                        BorderColor="DarkGray" BorderWidth="0" GroupingText="Loyalty Scheme Membership">
                        ...
                        <asp:Button ID="btnAddLoyaltyCancel" runat="server" Text="Cancel" CausesValidation="False" />
                        <br />
                    </asp:Panel>
                </asp:View>
