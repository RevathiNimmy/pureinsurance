...
Partial Class GetListRisksRisk
    ...
    Private Sub SetStatus(ByVal iInsuranceFileKey As Integer)
        ...
        WriteToLog(Session, "GetListRisks_Risk.aspx", "SAMForInsuranceV2", "GetHeaderAndSummariesByKey", StartDate, Date.Now)
        ...
        WriteToLog(Session, "GetListRisks_Risk.aspx", "SAMForInsuranceV2", "UpdateRenewalStatus", StartDate, Date.Now)
