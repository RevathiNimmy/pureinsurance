...
Partial Class MTA_ListPolicyVersions
    ...
    Protected Sub gvResult_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvResult.SelectedIndexChanged
        ...
        If (gvResult.SelectedRow.Cells(1).Text = "Under Renewal") Or (gvResult.SelectedRow.Cells(2).Text = "Policy under Renewal") Then
            Response.Write("Please Select valid version of policy ")

        ElseIf (gvResult.SelectedRow.Cells(2).Text <> "MTA Quotation Permanent") Then
