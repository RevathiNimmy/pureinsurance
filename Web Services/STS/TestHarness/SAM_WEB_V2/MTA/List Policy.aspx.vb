        ...
        If (Not IsPostBack) Then
            ...
            Try
                ...
                With oGetPartySummaryResponseType
                    ...
                    Else
                        If .Policies IsNot Nothing And .Policies.Length > 0 Then
                            ...
                            For PolicyCount As Integer = 0 To oGetPartySummaryResponseType.Policies.Length - 1
                                If (oGetPartySummaryResponseType.Policies(PolicyCount).InsuranceFileTypeCode.Trim = "POLICY" And oGetPartySummaryResponseType.Policies(PolicyCount).InsuranceFileTypeCode.Trim <> "QUOTE" And oGetPartySummaryResponseType.Policies(PolicyCount).PolicyStatus.Trim <> "Lapsed" And oGetPartySummaryResponseType.Policies(PolicyCount).PolicyStatus.Trim <> "Cancelled") Then
