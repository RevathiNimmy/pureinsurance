...
Partial Class AddQuote
    ...
    Protected Sub btnAddQuote_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            WriteToLog(Session, "AddRisk.aspx", "SAMForInsuranceV2", "AddRisk", StartDate, Date.Now)
            ...
            'add to session
            Session("RiskResponse") = oAddRiskResponseType
    ...
    Protected Sub btnUpdateRisk_Click1(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~/5_UpdateRisk.aspx")
    End Sub
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Try
            ...
            WriteToLog(Session, "AddRisk.aspx", "SAMForInsuranceV2", "UpdateRisk", StartDate, Date.Now)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            WriteToLog(Session, "AddRisk.aspx", "SAMForInsuranceV2", "GetList", StartDate, Date.Now)
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        ...
        Try
            ...
            WriteToLog(Session, "AddRisk.aspx", "SAMForInsuranceV2", "DeleteRisk", StartDate, Date.Now)
