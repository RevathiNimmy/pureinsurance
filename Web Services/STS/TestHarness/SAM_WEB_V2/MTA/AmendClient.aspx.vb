...
Partial Class MTA_AmendClient
            ...
            If Not (IsPostBack) Then
                ...
                If Not IsPostBack Then
                    ...
                    Try
                        ...
                        WriteToLog(Session, "AmendClient.aspx", "SAMForInsuranceV2", "GetList", StartDate, Date.Now)
                    ...
                    If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                        ...
                        With objBaseparty
                            ...
                            txtClientCode.Text = objBaseparty.ClientDetail.ShortName
                        ...
                        If (objBaseparty.Contacts IsNot Nothing) Then
                            For Each oContactType In objBaseparty.Contacts
                                If Not (oContactType.ContactTypeCode = ContactTypeType.MAIN) Then
                        ...
                        If (objBaseparty.Contacts IsNot Nothing) Then
                            ...
                            For Each oContacts In objBaseparty.Contacts
                                If (oContacts.ContactTypeCode = ContactTypeType.MAIN) Then
                                    txtMainContact.Text = oContacts.Description
                                End If
                            Next
                        End If
                        '''''''''''''''''''''''''''''Convictions''''''''''''''''''''''''''''''
                        If (objBaseparty.ClientDetail.CountyCourtJudgmentsSpecified) Then
                            txtCountyCourtJudge.Text = objBaseparty.ClientDetail.CountyCourtJudgments
                        End If
                        '''''''''''''''''''''''''''Additions Tab'''''''''''''''''''''''''''''''
    ...
    Protected Sub gvDependents_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvDependents.SelectedIndexChanged
        ...
        Catch ex As Exception
            Response.Write("An error occured:<br>" & ex.Message)
        End Try
    End Sub
    ...
    Private Sub getParty()
        Try
            ...
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                'Binding the mandatory fields with the relevant output parameters
                With objBaseparty
                    txtClientCode.Text = .ClientDetail.ShortName
                    txtLastName.Text = .Surname
                    txtForeName.Text = .Forename
        ...
        Try
            ...
            With oUpdatePartyRequestType
                ...
                If (ddBranch.SelectedIndex > 0) Then
                    .BranchCode = ddBranch.SelectedValue
                End If
                If (ddSubBranch.SelectedIndex > 0) Then
                    .SubBranchCode = ddSubBranch.SelectedValue
                End If
                .Item = objBaseparty
    ...
    Protected Sub btnaok_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnaok.Click
        Try
            If (GVContacts.SelectedIndex = -1) Then
                ...
                If (ddlconType.SelectedValue = "3131 XBI") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XBI
                ElseIf (ddlconType.SelectedValue = "3131 XBA") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XBA
                ElseIf (ddlconType.SelectedValue = "3131 002") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131002
                ElseIf (ddlconType.SelectedValue = "3131 XCO") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XCO
                ElseIf (ddlconType.SelectedValue = "3131 001") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131001
                ElseIf (ddlconType.SelectedValue = "3131 XPR") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XPR
                ElseIf (ddlconType.SelectedValue = "3131 XRE") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XRE
                ElseIf (ddlconType.SelectedValue = "3131 XSA") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131XSA
                ElseIf (ddlconType.SelectedValue = "3131 ECK") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item3131ECK
                ElseIf (ddlconType.SelectedValue = "3131 0XR") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item31310XR
                ElseIf (ddlconType.SelectedValue = "3131 0X9") Then
                    objaddr.AddressTypeCode = AddressTypeType.Item31310X9
                End If
                ...
                If (ddlconCountry.SelectedIndex > 0) Then
                    objaddr.CountryCode = ddlconCountry.SelectedValue
                End If
            ...
            Else
                ...
                If (ddlconType.SelectedValue = "3131 XBI") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XBI
                ElseIf (ddlconType.SelectedValue = "3131 XBA") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XBA
                ElseIf (ddlconType.SelectedValue = "3131 002") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131002
                ElseIf (ddlconType.SelectedValue = "3131 XCO") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XCO
                ElseIf (ddlconType.SelectedValue = "3131 001") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131001
                ElseIf (ddlconType.SelectedValue = "3131 XPR") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XPR
                ElseIf (ddlconType.SelectedValue = "3131 XRE") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XRE
                ElseIf (ddlconType.SelectedValue = "3131 XSA") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131XSA
                ElseIf (ddlconType.SelectedValue = "3131 ECK") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item3131ECK
                ElseIf (ddlconType.SelectedValue = "3131 0XR") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item31310XR
                ElseIf (ddlconType.SelectedValue = "3131 0X9") Then
                    oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode = AddressTypeType.Item31310X9
                End If
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        Try
            ...
            If gvConcictions.SelectedIndex = -1 Then
                ...
                If (ddlconvictiontype.SelectedIndex > 0) Then
                    objconv.TypeCode = ddlconvictiontype.SelectedItem.Text
                End If
                If (ddlconvictionstatus.SelectedIndex > 0) Then
                ...
                End If
                If (ddlsentencetime.SelectedIndex > 0) Then
                    objconv.SentenceDurationQualifier = ddlsentencetime.SelectedItem.Text
                End If
                If (ddlAlcoholmethod.SelectedIndex > 0) Then
            ...
            Else
                ...
                Else
                    objconv.Date = SqlDateTime.Null
                End If
                If (ddlsentencetype.SelectedIndex > 0) Then
                    objconv.SentenceTypeCode = ddlsentencetype.SelectedItem.Text
                End If
                objconv.SentenceDescription = txtsdescription.Text
                If (IsDate(txtsdate.Text)) Then
    ...
    Protected Sub btnAddLoyaltyAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddLoyaltyAdd.Click
        Try
            ...
            If gvloyalty.SelectedIndex = -1 Then
                ...
                If (ddlLoyaltySchemes.SelectedIndex > 0) Then
    ...
    Protected Sub btnPolicyOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPolicyOk.Click
        Try
            ...
            If gvpolicies.SelectedIndex = -1 Then
                ...
                If (ddlprostype.SelectedIndex > 0) Then
    ...
    Public Function Setvalues() As Object
        ...
        Try
            ...
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                End If
                ''''''''''''''''''''''''Convictions'''''''''''''''''''''''''''
                If (String.IsNullOrEmpty(txtCountyCourtJudge.Text)) Then
                ...
                If String.IsNullOrEmpty(hdPreviousInsurerKey.Value) Then
                ...
                If String.IsNullOrEmpty(hdPrevBrokerKey.Value) Then
            ...
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                If (String.IsNullOrEmpty(txtMainContact.Text)) Then
                    objBaseparty.MainContact = " "
                Else
                    objBaseparty.MainContact = txtMainContact.Text
                End If


                'If Not (String.IsNullOrEmpty(txtMainContact.Text)) Then
                Dim oContacts As BaseContactType
                Dim i As Integer
                For Each oContacts In objBaseparty.Contacts
                    If (oContacts.ContactTypeCode = ContactTypeType.MAIN) Then
                        SAMHelper.RemoveFromArray(Of BaseContactType)(objBaseparty.Contacts, i)
                    End If
                    i = i + 1
                Next
                ...
                End If
                'If (objBaseparty.Contacts IsNot Nothing) Then
                '    objBaseparty.Contacts(0).Description = txtMainContact.Text
                'End If
                ''''''''''''''''''''''''Convictions'''''''''''''''''''''''''''
                If (String.IsNullOrEmpty(txtCountyCourtJudge.Text)) Then
                    objBaseparty.ClientDetail.CountyCourtJudgmentsSpecified = False
    ...
    Protected Sub GVContacts_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVContacts.SelectedIndexChanged
        Try
            ...
            'If Not (String.IsNullOrEmpty(oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode)) Then
            '    ddlconType.ClearSelection()
            '    ddlconType.SelectedIndex = oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode
            'End If
            If (ddlconCountry.SelectedIndex > 0) Then
                ddlconCountry.SelectedValue = oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).CountryCode
            End If

            Dim sAddressUsage, sTemp As String

            sAddressUsage = oGetPartyResponseType.Item.Addresses(GVContacts.SelectedIndex).AddressTypeCode.ToString()
            sAddressUsage = sAddressUsage.Substring(4, sAddressUsage.Length - 4)
            sTemp = sAddressUsage.Substring(0, 4)
            sAddressUsage = sTemp + " " + sAddressUsage.Substring(4, 3)
            If Not String.IsNullOrEmpty(sAddressUsage) Then
                ddlconType.SelectedValue = sAddressUsage
            End If
            pnlAddAddress.Visible = True
        Catch ex As Exception
            Response.Write("An error occured:<br>" & ex.Message)
    ...
    Protected Sub gvassociates_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvassociates.SelectedIndexChanged
        ...
        Try
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                If Not (String.IsNullOrEmpty(objBaseparty.ClientDetail.Associates(gvassociates.SelectedIndex).RelationshipCode.Trim)) Then
    ...
    Protected Sub gvloyalty_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvloyalty.SelectedIndexChanged
        ...
        Try
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                Dim objBaseparty As New BasePartyCCType
                objBaseparty = DirectCast(oGetPartyResponseType.Item, BasePartyCCType)
                If Not (String.IsNullOrEmpty(objBaseparty.ClientDetail.LoyaltyScheme(gvloyalty.SelectedIndex).LoyaltySchemeCode)) Then
    ...
    Protected Sub gvpolicies_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvpolicies.SelectedIndexChanged
        ...
        Try
            ...
            If oGetPartyResponseType.Item IsNot Nothing AndAlso _
                ...
                Dim objBaseparty As New BasePartyCCType
                objBaseparty = DirectCast(oGetPartyResponseType.Item, BasePartyCCType)
                If Not (String.IsNullOrEmpty(objBaseparty.ClientDetail.ProspectPolicies(gvpolicies.SelectedIndex).ProspectTypeCode)) Then
    ...
    Protected Sub GVContacts_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GVContacts.RowDataBound
        ...
        Try
            If (e.Row.RowType = DataControlRowType.DataRow) Then
                ...
                Dim rowView As BaseAddressWithContactsType
                rowView = CType(e.Row.DataItem, BaseAddressWithContactsType)
                Dim sAddressUsage, sTemp As String

                sAddressUsage = rowView.AddressTypeCode.ToString()
                sAddressUsage = sAddressUsage.Substring(4, sAddressUsage.Length - 4)
                sTemp = sAddressUsage.Substring(0, 4)
                sAddressUsage = sTemp + " " + sAddressUsage.Substring(4, 3)
                Dim row As BaseGetListResponseTypeRow
                For Each row In oResponse.List
                    If (sAddressUsage = row.Code) Then
                        e.Row.Cells(2).Text = row.Description
                    End If
                Next
            End If
