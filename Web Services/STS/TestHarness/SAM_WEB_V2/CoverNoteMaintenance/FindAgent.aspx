<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FindAgent.aspx.vb" Inherits="Lookup_Screens_FindAgent" %>
...
<head runat="server">
    ...
    {
    opener.document.getElementById("txtAgent").value = document.getElementById("txtShortName").value;
