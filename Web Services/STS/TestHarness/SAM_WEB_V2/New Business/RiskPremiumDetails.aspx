<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="RiskPremiumDetails.aspx.vb"
...
<body>
    <form id="form1" runat="server">
                ...
                <td>
                    ...
                    <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="Server">
                        <asp:View ID="View1" runat="Server">
                            <div align="center">
                                <asp:Label ID="lblOutput" runat="server" Width="184px" Font-Bold="True" Visible="false"></asp:Label>
                            </div>
                            ...
                            <asp:Button ID="btnAddMTAQuote" runat="server" Text="Add New" />
                        </asp:View>
        ...
        <asp:Button ID="btnOk" runat="server" Text="Ok" Width="72px" /></td>
                    </tr>
   <tr>
                        <td>
                            &nbsp;
