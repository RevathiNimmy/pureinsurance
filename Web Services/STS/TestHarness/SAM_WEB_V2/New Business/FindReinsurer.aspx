<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"  CodeFile="FindReinsurer.aspx.vb" Inherits="Find_Party_Find_Party" %>
                ...
                <tr style="height: 90%">
                    <td>
                        ...
                        <table style="width: 100%" border="0">
                            <tr>
                                <td colspan="2">
                                    <asp:Menu Visible=false ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2"
                            ...
                            <tr>
                                <td style="width: 419px">
                                    <asp:MultiView Visible=false ID="MultiView1" runat="server" ActiveViewIndex="0">
                                            ...
                                            <table style="width: 320px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="Include Closed Branches" /></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 99px">
                                                        Status</td>
