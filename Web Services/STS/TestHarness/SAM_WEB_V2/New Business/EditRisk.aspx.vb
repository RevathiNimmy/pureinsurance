...
Partial Class MTA_EditRisk
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Session("RiskAction") = "Delete" Then
                btnCancel.Text = "Delete"
                btnOK.Visible = False
                Session("RiskAction") = Nothing
            End If
            ...
            WriteToLog(Session, "EditRisk.aspx", "SAMForInsuranceV2", "GetList",StartDate, Date.Now)
            ...
            Try
                ...
                WriteToLog(Session, "EditRisk.aspx", "SAMForInsuranceV2", "GetRisk",StartDate, Date.Now)
                Dim m_sRiskDataXML As String
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Try
            ...
            WriteToLog(Session, "EditRisk.aspx", "SAMForInsuranceV2", "UpdateRisk",StartDate, Date.Now)
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        ...
        Try
            ...
            WriteToLog(Session, "EditRisk.aspx", "SAMForInsuranceV2", "DeleteRisk",StartDate, Date.Now)
