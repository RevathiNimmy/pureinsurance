<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="PrePayment.aspx.vb" Inherits="New_Business_PrePayment" %>
...
<head runat="server">
    ...
    function Showmodalpopup()
    {
         ...
         var ReturnChildValue = window.showModalDialog("../CurrencyExchange/CurrencyExchange.aspx", window, "dialogWidth:800px;dialogHeight:400px");
                    ...
                    <asp:Panel ScrollBars=Auto runat=server ID=pnl Width="691px">
                     <asp:GridView ID="gvPrePayment" runat="server" CellPadding="4" ForeColor="#333333"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:CheckBox OnCheckedChanged="Checkboxchanged" AutoPostBack=True  ID="CheckBox1" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
