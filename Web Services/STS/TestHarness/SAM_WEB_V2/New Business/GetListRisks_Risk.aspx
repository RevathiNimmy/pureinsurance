<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" EnableSessionState="True" CodeFile="GetListRisks_Risk.aspx.vb"
...
// <!CDATA[
                          ...
                          //JP 07/03/2010 (PaymentTermsClicked)
                          function PaymentTermsClicked()
                          {
                            if (document.getElementById("rblPaymentTerms_2").checked == true)
                            {
                                document.getElementById("btnMakeLive").disabled = true;
                            }
                            else
                            {
                                document.getElementById("btnMakeLive").disabled = false;
                            }
                          }
                ...
                <tr style="height: 90%">
                    <td>
                        ...
                        <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                    ...
                                    <table border="0" cellpadding="4" cellspacing="0" width="900px" class="body">
                                        ...
                                        <tr>
                                            ...
                                            <td align ="left">
                                                ...
                                                <asp:Label ID="lblAgent1" runat="server" Text="Agent"></asp:Label></td>
                                            <td colspan="3">
                                ...
                                <td align="left" colspan="3">
                                    <asp:MultiView ID="MultiView1" runat="server">
                                        <asp:View ID="View1" runat="server">
                                            <div id="bar">
                                                ...
                                                <asp:GridView ID="grdLiskRisk" runat="server" CellPadding="4" ForeColor="#333333"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:ButtonField Visible=true CommandName="Select" Text="Select" ButtonType=Link />
                                                        ...
                                                        <asp:TemplateField HeaderText="Attach cover Note">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkAttachCoverNote" runat="server" AutoPostBack="True" BorderStyle="None"
                                                                    OnCheckedChanged="chkAttachCoverNote_CheckedChanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                            ...
                                            <asp:Button ID="btnEditRisk" runat="server" Text="Edit" Visible="false" />
                                            <asp:Panel ID="Panel1" runat="server" Height="50px" Width="255px" Visible="False">
                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Width="214px">
                                                <asp:ListItem Text="Quick Quote" Value ="0"></asp:ListItem>
                                                <asp:ListItem Text="Full Quote" Value="1"></asp:ListItem>
                                                </asp:RadioButtonList></asp:Panel>
                                            <asp:RadioButtonList ID="rbtnCopyRisk" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                                Visible="False" Width="214px">
                                                <asp:ListItem Text="Comprative" Value="0"></asp:ListItem>
                            ...
                            <tr>
                                <td align="left" colspan="3" style="text-align: left; height: 68px;">
                                    &nbsp;<asp:RadioButtonList ID="rblPaymentTerms" runat="server" RepeatDirection="Horizontal"
                                        Width="216px" onclick="javascript:PaymentTermsClicked()">
                                        <asp:ListItem Value="Inv">Invoice</asp:ListItem>
                                        <asp:ListItem Value="PayNow">Pay Now</asp:ListItem>
                                        <asp:ListItem Value="MarkForCollection">Mark For Collection</asp:ListItem>
                                    </asp:RadioButtonList>
                                    <asp:Button ID="btnSaveQuote" runat="server" Text="Save Quote" />
                                    <asp:Button ID="btnMakeLive" runat="server" Text="Make Live" />
                                    <asp:Button ID="btncopyrisk" runat="server" Text="Copy Risk" />
                                    <asp:Button ID="btnDeleteRisk" runat="server" Text="Delete Risk" /></td>
                            </tr>
                        </table>
