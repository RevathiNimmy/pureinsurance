<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="CashList.aspx.vb" Inherits="Claim_Payment_CashList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CausesValidation="False" /></td></tr>
        <tr>
        <td>
