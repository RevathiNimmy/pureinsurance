<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="FindHandler.aspx.vb" Inherits="Lookup_Screens_FindAgent" %>
...
<head runat="server">
    ...
    opener.document.getElementById("txtHandler").value = document.getElementById("txtShortName").value;
    opener.document.getElementById("hfHandlerCode").value = document.getElementById("hfHandlerCode").value;
    }
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlType" runat="server">
                                                            <asp:ListItem>AccountHandler</asp:ListItem>
                                                        </asp:DropDownList>
