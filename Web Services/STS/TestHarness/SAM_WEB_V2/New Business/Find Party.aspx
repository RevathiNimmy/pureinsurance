<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="Find Party.aspx.vb" Inherits="Find_Party_Find_Party" %>
...
<head runat="server">
    ...
    function passresult()
    {
          ...
          var pk = document.getElementById("PartyKey").value
                        ...
                        <table style="width: 100%" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:TextBox ID="txtShortName" runat="server" Visible="True" Enabled ="false"></asp:TextBox></td>
                                <asp:HiddenField ID="PartyKey" runat="server" Visible="true" />
                            </tr>
                        </table>
