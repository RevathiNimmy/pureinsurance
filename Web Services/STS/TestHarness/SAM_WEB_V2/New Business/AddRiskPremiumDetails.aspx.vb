...
Partial Class MTC_AddRiskPremiumDetails
    ...
    Protected Sub btnAddRiskPremium_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddRiskPremium.Click
        ...
        If Session("Ratings") Is Nothing Then


            Dim oUpdateRatingsDetailsRequest As New UpdateRatingDetailsRequestType
            Dim oUpdateRatingDetailsResponse As New UpdateRatingDetailsResponseType

            ReDim Preserve oRatings(0)
            ...
            End If
            If (txtThisPremium.Text.Trim = String.Empty OrElse Not Decimal.TryParse(txtThisPremium.Text, oRatings(iIndex).ThisPremium)) Then
            ...
            With oUpdateRatingsDetailsRequest
                .RatingDetails = oRatings
                .BranchCode = "HeadOff"
            ...
            Try
                StartDate = Date.Now
                oUpdateRatingDetailsResponse = oSAM.UpdateRatingSections(oUpdateRatingsDetailsRequest)
                WriteToLog(Session, "AddRiskPremiumDetails.aspx", "SAMForInsuranceV2", "UpdateRatingSections", StartDate, Date.Now)
                With oUpdateRatingDetailsResponse
        ...
        Else
            ...
            opUpdateRatingDetailsRequestType.InsuranceFileKey = Session("InsuranceFileKey")
            opUpdateRatingDetailsRequestType.RiskKey = Session("RiskKey")
            opUpdateRatingDetailsRequestType.BranchCode = "HeadOff" 'Session("BranchCode")



            oRequestGetHeaderandSummaries.InsuranceFileKey = Session("InsuranceFileKey")
            oRequestGetHeaderandSummaries.BranchCode = "HeadOff" 'Session("BranchCode")
            StartDate = Date.Now
            oResponseGetHeaderandSummaries = oSAM.GetHeaderAndSummariesByKey(oRequestGetHeaderandSummaries)
            WriteToLog(Session, "AddRiskPremiumDetails.aspx", "SAMForInsuranceV2", "GetHeaderAndSummariesByKey", StartDate, Date.Now)
            opUpdateRatingDetailsRequestType.TimeStamp = oResponseGetHeaderandSummaries.QuoteTimeStamp

            Session("TimeStamp") = oResponseGetHeaderandSummaries.QuoteTimeStamp
                ...
                If (Session("RowIndex") IsNot Nothing) Then
                    ...
                    Else
                        ...
                        If (txtSumInsured.Text.Trim = String.Empty OrElse Not Decimal.TryParse(txtSumInsured.Text, oRatings(iIndex).SumInsured)) Then
                            oRatings(iIndex).SumInsured = 0
                        End If
                        If (txtThisPremium.Text = String.Empty OrElse Not Decimal.TryParse(txtThisPremium.Text, oRatings(iIndex).ThisPremium)) Then
                            oRatings(iIndex).ThisPremium = 0
                        End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Try
                ...
                WriteToLog(Session, "AddRiskPremiumDetails.aspx", "SAMForInsuranceV2", "GetList", StartDate, Date.Now)
                With oResponse
                    If Not (.Errors) Is Nothing Then
                        'errors returned, so throw an exception
                        lblSamErrorMessage.Text = GetMessageFromSamError(.Errors)
                    Else
                        ...
                        ddratingsection.DataValueField = "code"
                ...
                If (Session("Ratings") IsNot Nothing) Then
                    ...
                    If (Session("RowIndex") IsNot Nothing) Then
                        ...
                        Else
                            ...
                            ElseIf ddcountry.Items.FindByValue(oRatings(iIndex).CountryId) IsNot Nothing Then 'JP 04/03/2010
                            ...
                            ElseIf ddstate.Items.FindByValue(oRatings(iIndex).StateId) IsNot Nothing Then 'JP 04/03/2010
                            ...
                            If ddratetype.Items.FindByValue(oRatings(iIndex).RateTypeId) IsNot Nothing Then 'JP 04/03/2010
            ...
            'txtSumInsured.Attributes.Add("onblur", "calculate()")
        End If
