...
Imports System.Data
Partial Class New_Business_MotorAddRiskQQ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            txtYearOfManufacture.Text = Date.Now.Year.ToString()
            ...
            Try
                ...
                WriteToLog(Session, "MotorAddRiskQQ.aspx", "SAMForInsuranceV2", "AddRisk",StartDate, Date.Now)
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        ...
        Try
            ...
            WriteToLog(Session, "MotorAddRiskQQ.aspx", "SAMForInsuranceV2", "DeleteRisk",StartDate, Date.Now)
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        Try
            ...
            WriteToLog(Session, "MotorAddRiskQQ.aspx", "SAMForInsuranceV2", "UpdateRisk",StartDate, Date.Now)
    ...
    Private Sub BuildLists(ByVal oSAM As SAMForInsuranceV2, ByRef objControl As DropDownList, ByVal ESTSLookup As STSListType, ByVal ListCode As String)
        ...
        Try
            ...
            WriteToLog(Session, "MotorAddRiskQQ.aspx", "SAMForInsuranceV2", "GetList",StartDate, Date.Now)
            With oResponse
                If Not (.Errors) Is Nothing Then
                    'errors returned, so throw an exception
                    lblSamErrorMessage.Text = GetMessageFromSamError(.Errors)
