<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="MotorAddRisk.aspx.vb" Inherits="New_Business_MotorCar" %>
                        ...
                        <asp:MultiView ID="MCView" runat="server" ActiveViewIndex="0">
                                ...
                                <asp:Panel ID="Panel1" runat="server" Width="100%">
                                    <table width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtVehicleModel" runat="server" Enabled="False"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtBodyType" runat="server" Enabled="False"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtSeatingcapacity" runat="server" Enabled="False"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td>
                                                <strong>CC</strong></td>
                                            <td>
                                                <asp:TextBox ID="txtCC" runat="server" Enabled="False"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ControlToValidate="txtCC"
                                                    ErrorMessage="*" Font-Bold="True" Font-Size="Large"></asp:RequiredFieldValidator></td>
                                            <td>
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkNewVehicle" runat="server" Width="130px" Text="New Vehicle" />
                                                <asp:Label ID="lblNewVehicle1" runat="server" Font-Bold="True" Font-Size="Large"
                                                    EnableTheming="False" ForeColor="Red" Text="*"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="height: 26px">
                                                ...
                                                <asp:TextBox ID="txtReg4" runat="server" Width="29px" EnableTheming="false" MaxLength="4"></asp:TextBox>&nbsp;<asp:Label
                                                    ID="lblNewVehicle" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"
                                                    EnableTheming="false" Text="*"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtIDV" runat="server" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" rowspan="1">
                                                <asp:Panel ID="pnlfinancierDetails" runat="server" BorderColor="darkgray" BorderStyle="Solid"
                                                    BorderWidth="1">
                                                    <table style="width: 353px">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                <asp:Button ID="btnfinanciercancel" runat="server" CausesValidation="False" Text="Cancel" /></td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                            </td>
                            ...
                            <asp:View ID="VwPreviousInsurance" runat="server">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Panel ID="pnlPIHistory" BorderColor="darkgray" BorderStyle="Solid" BorderWidth="1"
                                                runat="server">
                            ...
                            <asp:View ID="vwAdditionalCover" runat="server">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Panel ID="pnlElectrical" BorderColor="darkgray" runat="server" BorderStyle="Solid"
                                                BorderWidth="1">
                                                <table>
                                                    <tr>
                                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Panel ID="pnlNonelectrical" runat="server" BorderColor="darkgray" BorderStyle="Solid"
                                                BorderWidth="1">
                                                <table>
                                                    <tr>
                                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Panel ID="pnlDriverDetails" runat="server" BorderColor="darkgray" BorderStyle="Solid"
                                                BorderWidth="1">
                                                <table width="100%">
                                                    <tr>
                                                        <td colspan="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 226px">
                                                            <asp:Button ID="btnOkdriverDetails" runat="server" Text="Ok" />
                                                            <asp:Button ID="btnDriverCancel" runat="server" Text="Cancel" CausesValidation="False" /></td>
                                                        <td style="width: 100px">
                                                        </td>
                                                    </tr>
                                                </table>
                            ...
                            <asp:View ID="LegalLiability" runat="server">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Panel ID="pnlPersonalaccidentDetails" BorderColor="darkgray" BorderStyle="Solid"
