...
#Region "Private Methods"
    ...
    Private Sub GetDatasetSchemaTest( _
        ...
        Dim oRequest As New ProxyWS.GetDatasetSchemaRequestType
        Dim oResponse As ProxyWS.GetDatasetSchemaResponseType
        ...
        Try
            ...
            oResponse = oProxy.GetDatasetSchema(oRequest)
            ...
            With oResponse
                ...
                Else
                    ...
                    Assert.AreNotEqual("", .DatasetSchema, "Datset Schema was not returned.")
                End If
            End With
...
#Region "Invalid Data"
    ...
    Public Sub InvalidData_DS_BranchCode()
        GetDatasetSchemaTest(enumMandDataMissing.None, enumInvalidData.DS_BranchCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_DS_DataModelCode()
        GetDatasetSchemaTest(enumMandDataMissing.None, enumInvalidData.DS_DataModelCode)
    End Sub
...
#Region "Mandatory Data Missing"
    ...
    Public Sub InvalidData_Missing_DS_Branch_Code()
        GetDatasetSchemaTest(enumMandDataMissing.DS_BranchCode, enumInvalidData.None)
    End Sub
    <Test()> _
    Public Sub InvalidData_Missing_DS_DataModelCode()
        GetDatasetSchemaTest(enumMandDataMissing.DS_DataModelCode, enumInvalidData.None)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        GetDatasetSchemaTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        GetDatasetSchemaTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        GetDatasetSchemaTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        GetDatasetSchemaTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
