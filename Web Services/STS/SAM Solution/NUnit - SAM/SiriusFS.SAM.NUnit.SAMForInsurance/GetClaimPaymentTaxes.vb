...
<TestFixture()> _
Public Class GetClaimPaymentTaxes
    Inherits BaseTest
...
#Region "Requisite Functions for Test Cases (Missing Data)"
    ...
    Private Sub AllNonMandatoryFieldsMissing(ByVal oPayClaimRequest As ProxyWS.PayClaimRequestType)
        ...
        oPayClaimRequest.ClaimPayment.AdvancedTaxDetails.InsuredPercentage = ""
        ...
        oPayClaimRequest.ClaimPayment.AdvancedTaxDetails.PayeePercentage = ""
...
#End Region
    ...
    Private Sub PayClaimTest( _
        ...
        Dim oRequest As New ProxyWS.GetClaimPaymentTaxesRequestType
        Dim oResponse As ProxyWS.GetClaimPaymentTaxesResponseType
        ...
        Try
            ...
            oResponse = oProxy.GetClaimPaymentTaxes(oRequest)
