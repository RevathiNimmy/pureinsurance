...
<TestFixture()> _
Public Class RunValidationRules
    Inherits BaseTest
...
#Region "Private Test method"
    ...
    Private Sub RunValidationRulesTest( _
...
#Region "Mandatory Data Missing"
    ...
    Public Sub InvalidData_Missing_BranchCode()
        RunValidationRulesTest(eMissingData:=enumMissingData.BranchCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_Missing_ScreenCode()
        RunValidationRulesTest(eMissingData:=enumMissingData.ScreenCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_Missing_XMLDataSet()
        RunValidationRulesTest(eMissingData:=enumMissingData.XMLDataSet)
    End Sub
...
#Region "Invalid List Value"
    ...
    Public Sub InvalidData_BranchCode()
        RunValidationRulesTest(eInvalidLookup:=enumInvalidLookup.BranchCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_ScreenCode()
        RunValidationRulesTest(eInvalidLookup:=enumInvalidLookup.ScreenCode)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        RunValidationRulesTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        RunValidationRulesTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        RunValidationRulesTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        RunValidationRulesTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
