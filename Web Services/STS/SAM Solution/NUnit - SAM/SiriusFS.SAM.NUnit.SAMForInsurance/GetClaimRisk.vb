...
#Region "Private Test Methods"
    ...
    Private Function GetClaimRiskTest( _
        ...
        Optional ByVal nWSETestCaseScenario As WSETestCaseScenario = WSETestCaseScenario.None) As ProxyWS.GetClaimRiskResponseType
        ...
        Try
            With oRequest
                If eMissingData <> enumMissingData.ClaimKey Then
                    If eSTSBusinessError <> enumSTSBusinessError.InvalidClaimKey Then
                        If ClaimId = 0 Then
                            .BaseClaimKey = m_oTestData.GetClaimRiskClaimKey
                        Else
            ...
            '    objGetClaimRequestType.BranchCode = m_oTestData.GetClaimRiskBranchCode
            '    objGetClaimRequestType.ClaimKey = m_oTestData.GetClaimRiskClaimKey
            'Else
    ...
    Public Function SupportMethod(ByVal ClaimId As Integer, _
                                    ByVal BranchCode As String) As ProxyWS.GetClaimRiskResponseType
...
#Region "Success"
    ...
    Public Function Success(ByVal ClaimId As Integer, _
                            ByVal BranchCode As String) As ProxyWS.GetClaimRiskResponseType
        Return GetClaimRiskTest(ClaimId, BranchCode)
    End Function
...
#Region "Missing Data"
    ...
    Public Sub Missing_BranchCode()
        GetClaimRiskTest(eMissingData:=enumMissingData.BranchCode)
    End Sub
    <Test()> _
    Public Sub Missing_ClaimKey()
        GetClaimRiskTest(eMissingData:=enumMissingData.ClaimKey)
    End Sub
...
#Region "Invalid Lookup"
    ...
    Public Sub InvalidData_BranchCode()
        GetClaimRiskTest(eInvalidLookup:=enumInvalidLookup.BranchCode)
    End Sub
...
#Region "STS Business Rules"
    ...
    '    GetClaimRiskTest(eSTSBusinessError:=enumSTSBusinessError.ClaimKey)
    'End Sub
    '<Test()> _
    'Public Sub STSBusiness_InvalidBranchCode()
    '    GetClaimRiskTest(eSTSBusinessError:=enumSTSBusinessError.BranchCode)
    'End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        GetClaimRiskTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        GetClaimRiskTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        GetClaimRiskTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        GetClaimRiskTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
