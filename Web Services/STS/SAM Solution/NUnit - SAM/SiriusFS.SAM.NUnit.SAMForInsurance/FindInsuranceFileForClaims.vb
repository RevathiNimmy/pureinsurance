...
<TestFixture()> _
Public Class FindInsuranceFileForClaims
    Inherits BaseTest
...
#Region "Private Declarations"
    ...
    Private Enum TestCaseScenario
        ...
        MissingDataInsuranceFileRef

        ' Invalid Lookups
        InvalidLookupBranchCode
        InvalidLookupInsuranceFileRef
...
#Region "Call ProxyWS Method"
    ...
    Private Sub FindInsuranceFileTest( _
        ...
        Dim oRequest As New ProxyWS.FindInsuranceFileForClaimsRequestType
        Dim oResponse As ProxyWS.FindInsuranceFileForClaimsResponseType


        ' get test data object for this call
        Dim oTD As FindInsuranceFileForClaimsTestData
        oTD = m_oTestData.FindInsuranceFileForClaims

        Try

            With oRequest
                oRequest.BranchCode = oTD.BranchCode
                oRequest.InsuranceFileRef = oTD.InsuranceRef
                oRequest.SearchDate = oTD.ClaimDate
            End With
            ...
            oResponse = oProxy.FindInsuranceFileForClaims(oRequest)
            ...
            With oResponse
                ...
                ElseIf TestCase = TestCaseScenario.InvalidLookupBranchCode OrElse _
                    TestCase = TestCaseScenario.InvalidLookupInsuranceFileRef Then

                    ProcessInvalidLookup(oResponse, TestCase)

                ElseIf TestCase = TestCaseScenario.MissingDataBranchCode OrElse _
                    TestCase = TestCaseScenario.MissingDataInsuranceFileRef Then
...
#Region "Setup NonErrorScenarios Test Cases"
    ...
    Private Sub AllNonMandatoryFieldsMissing(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
...
#Region "Setup Invalid Lookups Test Cases"
    ...
    Private Sub InvalidLookupBranchCode(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
        oRequest.BranchCode = kInvalidLookupValue
    End Sub
    Private Sub InvalidLookupInsuranceFileRef(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
        oRequest.InsuranceFileRef = kInvalidLookupValue
    End Sub
...
#Region "Setup Missing Data Test Cases"
    ...
    Private Sub MissingDataBranchCode(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
        oRequest.BranchCode = String.Empty
    End Sub

    Private Sub MissingDataInsuranceFileRef(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
        oRequest.InsuranceFileRef = String.Empty
    End Sub
...
#Region "Setup Business Warnings Test Cases"
    ...
    Private Sub BusinessWarningEXAMPLE(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
...
#Region "Setup Business Errors Test Cases"
    ...
    Private Sub BusinessErrorEXAMPLE(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType)
        '    oRequest.Claim.LossFromDate = DateAdd(DateInterval.Day, 1, Date.Today)
    End Sub
...
#Region "Test Case Response Handlers"
    ...
    Private Sub ProcessTestCases(ByVal oRequest As ProxyWS.FindInsuranceFileForClaimsRequestType, ByVal TestCase As TestCaseScenario)
        ...
        Select Case TestCase
            ...
            Case TestCaseScenario.InvalidLookupInsuranceFileRef
                InvalidLookupInsuranceFileRef(oRequest)

                ' Missing Data
            Case TestCaseScenario.MissingDataBranchCode
                MissingDataBranchCode(oRequest)

            Case TestCaseScenario.MissingDataInsuranceFileRef
                MissingDataInsuranceFileRef(oRequest)
    ...
    Private Sub ProcessMissingData(ByVal oResponse As ProxyWS.BaseResponseType, ByVal TestCase As TestCaseScenario)
        ...
        Select Case TestCase
            ...
            Case TestCaseScenario.MissingDataInsuranceFileRef
                Assert.AreEqual("InsuranceFileRef", oError.FieldName, kIncorrectMissingMandatoryFieldMessage)
        End Select
    ...
    Private Sub ProcessInvalidLookup(ByVal oResponse As ProxyWS.BaseResponseType, ByVal TestCase As TestCaseScenario)
        ...
        Select Case TestCase
            ...
            Case TestCaseScenario.InvalidLookupInsuranceFileRef
                Assert.AreEqual("InsuranceFileRef", oError.FieldName, kInvalidLookupFieldMessage)
        End Select
...
#Region "NUNIT Non Error Raising Scenarios"
    ...
    Public Sub AllNonMandatoryFieldsMissing()
        'FindInsuranceFileTest(TestCase:=TestCaseScenario.AllNonMandatoryFieldsMissing)
    End Sub
...
#Region "NUNIT Invalid Lookup Test Cases"
    ...
    Public Sub InvalidLookupBranchCode()
        FindInsuranceFileTest(TestCase:=TestCaseScenario.InvalidLookupBranchCode)
    End Sub

    <Test()> _
    Public Sub InvalidLookupInsuranceFileRef()
        FindInsuranceFileTest(TestCase:=TestCaseScenario.InvalidLookupInsuranceFileRef)
    End Sub
...
#Region "NUNIT Missing Data Test Cases"
    ...
    Public Sub MissingDataBranchCode()
        FindInsuranceFileTest(TestCase:=TestCaseScenario.MissingDataBranchCode)
    End Sub
    <Test()> _
    Public Sub MissingDataInsuranceFileRef()
        FindInsuranceFileTest(TestCase:=TestCaseScenario.MissingDataInsuranceFileRef)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        FindInsuranceFileTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        FindInsuranceFileTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        FindInsuranceFileTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        FindInsuranceFileTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
