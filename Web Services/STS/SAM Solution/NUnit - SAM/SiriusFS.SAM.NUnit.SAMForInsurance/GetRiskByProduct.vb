...
#Region "Private Test Methods"
    ...
    Private Sub GetRiskByProductTest( _
        ...
        Dim oRequest As New ProxyWS.GetRiskByProductRequestType
        Dim oResponse As ProxyWS.GetRiskByProductResponseType
        ...
        Try
            ...
            oResponse = oProxy.GetRiskByProduct(oRequest)
            With oResponse
                ...
                Else
                    ...
                    SAMTest.AssertCallSucceededWithResults(oResponse, oResponse.Risks)
...
#Region "Missing Data"
    ...
    Public Sub InvalidData_Missing_BranchCode()
        GetRiskByProductTest(eMissingData:=enumMissingData.BranchCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_Missing_ProductCode()
        GetRiskByProductTest(eMissingData:=enumMissingData.ProductCode)
    End Sub
...
#Region "Invalid Lookup"
    ...
    Public Sub InvalidData_BranchCode()
        GetRiskByProductTest(eInvalidLookup:=enumInvalidLookup.BranchCode)
    End Sub

    <Test()> _
    Public Sub InvalidData_ProductCode()
        GetRiskByProductTest(eInvalidLookup:=enumInvalidLookup.ProductCode)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        GetRiskByProductTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        GetRiskByProductTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        GetRiskByProductTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        GetRiskByProductTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
