...
#Region "Private Test Methods"
    ...
    Private Sub ProcessClaimReceiptTest( _
        ...
        Dim oRequest As New ProxyWS.ClaimReceiptRequestType
        Dim oResponse As ProxyWS.ClaimReceiptResponseType
        ...
        Try
            ...
            oResponse = oProxy.ClaimReceipt(oRequest)
...
#Region "Requisite Functions for Test Cases (Missing Data)"
    ...
    Private Sub AllNonMandatoryFieldsMissing(ByVal oClaimReceiptRequest As ProxyWS.ClaimReceiptRequestType)
        ...
        oClaimReceiptRequest.ClaimReceipt.Payee.Address.AddressTypeCode = 2
