...
<TestFixture()> _
Public Class GetCurrenciesByBranch
    Inherits BaseTest
...
#Region "Private Test Methods"
    ...
    Private Sub GetCurrenciesByBranchTest( _
        ...
        Dim oRequest As New ProxyWS.GetCurrenciesByBranchRequestType
        Dim oResponse As ProxyWS.GetCurrenciesByBranchResponseType
        ...
        Try
            ...
            oResponse = oProxy.GetCurrenciesByBranch(oRequest)
            With oResponse
                ...
                Else
                    ...
                    SAMTest.AssertCallSucceededWithResults(oResponse, oResponse.Currencies)
...
#Region "Missing Data"
    ...
    Public Sub InvalidData_Missing_BranchCode()
        GetCurrenciesByBranchTest(eMissingData:=enumMissingData.BranchCode)
    End Sub
...
#Region "Invalid Lookup"
    ...
    Public Sub InvalidData_BranchCode()
        GetCurrenciesByBranchTest(eInvalidLookup:=enumInvalidLookup.BranchCode)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        GetCurrenciesByBranchTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        GetCurrenciesByBranchTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        GetCurrenciesByBranchTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        GetCurrenciesByBranchTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
