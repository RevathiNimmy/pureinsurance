...
#Region "Private Methods"
    ...
    Private Sub ForgottenPasswordTest( _
        ...
        Dim oRequest As New ProxyWS.ForgottenPasswordRequestType
        Dim oResponse As ProxyWS.ForgottenPasswordResponseType
        ...
        Try
            With oRequest
                If eMissingData <> enumMissingData.BranchCode Then
                    ...
                    End If
                End If
                .Username = m_oTestData.UserName
            End With

            SetWSETestCaseScenario(nWSETestCaseScenario)
            oResponse = oProxy.ForgottenPassword(oRequest)
...
#Region "Missing Data"
    ...
    Public Sub InvalidData_Missing_BranchCode()
        ForgottenPasswordTest(eMissingData:=enumMissingData.BranchCode)
    End Sub
    <Test()> _
    Public Sub InvalidData_Missing_UserName()
        ForgottenPasswordTest(eMissingData:=enumMissingData.UserName)
    End Sub
...
#Region "Invalid Lookup"
    ...
    Public Sub InvalidData_BranchCode()
        ForgottenPasswordTest(eInvalidLookup:=enumInvalidLookup.BranchCode)
    End Sub
...
#Region "WSE Security"
    ...
    Public Sub WSESecurity_MissingSecurity()
        ForgottenPasswordTest(nWSETestCaseScenario:=WSETestCaseScenario.MissingSecurity)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidUserName()
        ForgottenPasswordTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidUserName)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidPassword()
        ForgottenPasswordTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidPassword)
    End Sub

    <Test()> _
    Public Sub WSESecurity_InvalidTaskCode()
        ForgottenPasswordTest(nWSETestCaseScenario:=WSETestCaseScenario.InvalidTaskCode)
    End Sub
