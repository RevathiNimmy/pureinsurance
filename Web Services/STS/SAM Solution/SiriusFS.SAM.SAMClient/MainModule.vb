...
Module MainModule
    ...
    '
    ' ***************************************************************** '
    Public Sub LogMessage(ByRef iType As gPMConstants.PMELogLevel, ByRef sMsg As String, Optional ByRef vApp As Object = Nothing, Optional ByRef vClass As Object = Nothing, Optional ByRef vMethod As Object = Nothing, Optional ByRef vErrNo As Integer = 0, Optional ByRef vErrDesc As String = "")
        ...
        Dim ErrEx As New Exception("The following error occured in " & vApp & " : " & sMsg)
