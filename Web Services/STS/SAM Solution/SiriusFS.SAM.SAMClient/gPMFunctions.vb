...
Module gPMFunctions
    ...
    Public Function PMStartOfWeek(ByVal dtDate As Date) As Date
        ...
        On Error GoTo Err_PMStartOfWeek
...
Err_PMStartOfWeek:
    ...
    Public Function UnFormatField(ByRef iFormatTypeIn As Short, ByRef iDataTypeOut As Short, ByRef vFieldValue As Object) As Object
        ...
        On Error GoTo Err_UnFormatField
...
Err_LogMessageToFile:
        ...
        ' Log This Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogFatal, sMsg:="Failed to log the following error in Log File : " & sLogFile, vApp:=ACApp, vClass:=ACClass, vMethod:="LogMessageToFile", vErrNo:=Err.Number, vErrDesc:=Err.Description)

        ' We have failed to Log the message in the log file
        ' so display the error we were trying to log.

        ' Log Error.
        LogMessagePopup(iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, vErrNo:=vErrNo, vErrDesc:=vErrDesc)
    ...
    Public Function InsertUserName(ByRef r_sLogFile As String, ByVal v_sUserName As String) As Integer
        ...
        On Error GoTo Err_InsertUserName
...
Err_InsertUserName:
        ...
        ' Log Error Message
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="InsertUserName Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="InsertUserName", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    '
    ' ***************************************************************** '
    Public Sub LogMessagePopup(ByRef iType As Short, ByRef sMsg As String, Optional ByRef vApp As Object = Nothing, Optional ByRef vClass As Object = Nothing, Optional ByRef vMethod As Object = Nothing, Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing)
...
Err_LogMessagePopup:
    ...
    Public Function GetRegSettings(ByRef sResult As String, ByRef sAppName As String, ByRef sSection As String, ByRef sKey As String, Optional ByRef vDefault As Object = Nothing) As Integer
        ...
        On Error GoTo Err_GetRegSettings
...
Err_GetRegSettings:
        ...
        ' Log Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get the registry settings", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRegSettings", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function GetRegAllSettings(ByRef vResult As Object, ByRef sAppName As String, ByRef sSection As String) As Integer
        ...
        On Error GoTo Err_GetRegAllSettings
...
Err_GetRegAllSettings:
        ...
        ' Log Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get all of the registry settings", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRegAllSettings", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function SaveRegSettings(ByRef sSetting As String, ByRef sAppName As String, ByRef sSection As String, ByRef sKey As String) As Integer
        ...
        On Error GoTo Err_SaveRegSettings
...
Err_SaveRegSettings:
        ...
        ' Log Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save the registry settings", vApp:=ACApp, vClass:=ACClass, vMethod:="SaveRegSettings", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function DeleteRegSettings(ByRef sAppName As String, ByRef sSection As String, ByRef sKey As String) As Integer
        ...
        On Error GoTo Err_DeleteRegSettings
...
Err_DeleteRegSettings:
        ...
        ' Log Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to delete the registry settings", vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteRegSettings", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    '		Dim sBuffer As New VB6.FixedLengthString(255)
    '		Dim lBufferSize As Integer
    '		' RDC 19072002 for WTS session ID
    '		Dim lSessionID As Integer

    '		On Error GoTo Err_GetSystemName

    '		GetSystemName = gPMConstants.PMEReturnCode.PMTrue
    ...
    '			' Return error
    '			sSystemName = ""
    '			GetSystemName = gPMConstants.PMEReturnCode.PMFalse
    '		Else
    '			' Set System Name Parameter
    '			sSystemName = Mid(sBuffer.Value, 1, lBufferSize)
    '		End If

    '		' RDC 19072002 retrieve WTS/Cytrix session ID
    '		lResult = GetWTSSessionID(lSessionID)

    '		If lResult <> gPMConstants.PMEReturnCode.PMTrue Then
    '			Exit Function
    '		End If

    '		sSystemName = sSystemName & "_sid" & lSessionID
    ...
    '		' Error Section.
    '		GetSystemName = gPMConstants.PMELogLevel.PMLogOnError
    '		sSystemName = ""

    '		' Log Error.
    '		LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get computer name", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSystemName", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function ConvertWildCardsForSQL(ByRef r_sTextString As String) As Integer
        ...
        On Error GoTo Err_ConvertWildCardsForSQL
...
Err_ConvertWildCardsForSQL:

        ' Error Section.
        ConvertWildCardsForSQL = gPMConstants.PMELogLevel.PMLogOnError

        ' Log Error.
        LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Convert Wild Cards For SQL", vApp:=ACApp, vClass:=ACClass, vMethod:="ConvertWildCardsForSQL", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function ArchitectureInDebug() As Boolean
        ...
        On Error GoTo Err_ArchitectureInDebug
...
Err_ArchitectureInDebug:
    ...
    Public Function SetPMRegSetting(ByVal v_lPMERegSettingRoot As Integer, ByVal v_lPMEProductFamily As Integer, ByVal v_lPMERegSettingLevel As Integer, ByVal v_sSettingName As String, ByVal v_sSettingValue As String, Optional ByVal v_sSubKey As String = "") As Integer
        ...
        On Error GoTo Err_SetPMRegSetting
...
Err_SetPMRegSetting:
    ...
    Public Function GetPMRegSetting(ByVal v_lPMERegSettingRoot As Integer, ByVal v_lPMEProductFamily As Integer, ByVal v_lPMERegSettingLevel As Integer, ByVal v_sSettingName As String, ByRef r_sSettingValue As String, Optional ByVal v_sSubKey As String = "") As Integer
        ...
        On Error GoTo Err_GetPMRegSetting
...
Err_GetPMRegSetting:
    ...
    Public Function FlipArray(ByRef r_vArray(,) As Object) As Integer
        ...
        'UPGRADE_WARNING: Lower bound of array vArray was changed from LBound(),LBound() to 0,0. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1033"'
        ...
        For lRow = LBound(r_vArray, 2) To UBound(r_vArray, 2)
            For lColumn = LBound(r_vArray, 1) To UBound(r_vArray, 1)
                'UPGRADE_WARNING: Couldn't resolve default property of object r_vArray(). Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
                'UPGRADE_WARNING: Couldn't resolve default property of object vArray(). Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
...
Err_FlipArray:
    ...
    Private Function BuildKeyString(ByVal v_ePMEProductFamily As gPMConstants.PMEProductFamily, ByVal v_ePMERegSettingLevel As gPMConstants.PMERegSettingLevel, Optional ByVal v_sSubKey As String = "") As String
        ...
        On Error GoTo Err_BuildKeyString
...
Err_BuildKeyString:
    ...
    Private Function TrimDate(ByRef r_vDate As Object) As Integer
        ...
        On Error GoTo Err_TrimDate

        TrimDate = gPMConstants.PMEReturnCode.PMTrue

        'UPGRADE_WARNING: Couldn't resolve default property of object r_vDate. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
        sDate = CStr(r_vDate)
...
Err_TrimDate:
    ...
    Private Function FormatName(ByVal vString As Object) As Object
        ...
        On Error GoTo FormatName_Error

        'UPGRADE_WARNING: Couldn't resolve default property of object FormatName. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
        FormatName = ""
        ...
        ' copy of input
        'UPGRADE_WARNING: Couldn't resolve default property of object vString. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
        'UPGRADE_WARNING: Couldn't resolve default property of object vTemp. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
        vTemp = Trim(vString)
...
FormatName_Error:
    ...
    Private Sub replaceVbcrWithVbcrlf(ByRef sString As String)
        ...
        On Error GoTo Err_replaceVbcrWithVbcrlf
...
QueryValueExError:
    ...
    Public Function GetNTUsername(ByRef sNTUsername As String) As Integer
        ...
        On Error GoTo Err_GetNTUsername
...
Err_GetNTUsername:
    ...
    Public Function GetNTUsernameEx(ByRef sUsername As Object) As Integer
        ...
        On Error GoTo Err_GetNTUsernameEx
...
Err_GetNTUsernameEx:
    ...
    Public Function GetSystemInfo(ByRef vSysInfo As Object) As Integer
        ...
        On Error GoTo Err_GetSystemInfo
...
Err_GetSystemInfo:
    ...
    '		'AK 220702 - new constants as required by this function
    '		Const WTS_CURRENT_SERVER_HANDLE As Short = 0
    '		Const WTS_CURRENT_SESSION_HANDLE As Short = -1

    '		Const RETURN_FAIL As Short = 0

    '		On Error GoTo Err_GetWTSSessionID

    '		GetWTSSessionID = gPMConstants.PMEReturnCode.PMFalse

    '		lReturn = WTSQuerySessionInformation(WTS_CURRENT_SERVER_HANDLE, WTS_CURRENT_SESSION_HANDLE, WTS_INFO_CLASS.WTSSessionID, lpBuffer, lLength)

    '		If lReturn = RETURN_FAIL Then
    '			lSessionID = 0
    '			Exit Function
    '		Else
    '			CopyMemoryFromAddress(lSessionID, lpBuffer, lLength)
    '			WTSFreeMemory((lpBuffer))
    '		End If

    '		GetWTSSessionID = gPMConstants.PMEReturnCode.PMTrue

    '		Exit Function

    'Err_GetWTSSessionID: 

    '		GetWTSSessionID = gPMConstants.PMEReturnCode.PMError
