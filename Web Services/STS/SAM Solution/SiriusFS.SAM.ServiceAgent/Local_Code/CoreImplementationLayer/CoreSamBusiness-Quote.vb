        ...
        Try
            ...
            Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_UpdateAdditionalMTADetails")
                ...
                If String.IsNullOrEmpty(AddMtaQuoteRequest.AlternateReference) Then
                    cmd.AddInParameter("@AlternateReference", SqlDbType.VarChar, 20).Value = ""
                Else
                    cmd.AddInParameter("@AlternateReference", SqlDbType.VarChar, 20).Value = AddMtaQuoteRequest.AlternateReference
                End If
                ...
                cmd.AddInParameter("@OldPolicyNumber", SqlDbType.VarChar, 20).Value = AddMtaQuoteRequest.OldPolicyNumber
            ...
            If AddMtaQuoteRequest.IsBDXRequest Then
                ...
                End If
            Else
                If AddMtaQuoteRequest.TransactionType = TransactionType.MTC OrElse AddMtaQuoteRequest.TransactionType = TransactionType.MTR Then
                    If Not AddMtaQuoteRequest.IsMarketPlacePolicy Then
                        ProcessCopyMTARisks(con, AddMtaQuoteRequest.BranchCode, newInsuranceFileCnt, AddMtaQuoteRequest.TransactionType, True, True)
                    End If
                Else
                    'EM Copy Risk Change
            ...
            If Not String.IsNullOrEmpty(AddMtaQuoteRequest.mtaReasonDescription) Then
                ...
                CreateEvent(con, insuranceHolderCnt,
                        ...
                        AddMtaQuoteRequest.mtaReasonDescription, "POLCHANGE")
            End If
        ...
        With oAddQuoteIn
            ...
            Else
                ...
                If productDetails.IsMidNightRenewal Then
                    ...
                    .RenewalDate = DateAdd(DateInterval.Day, 1, AddQuoteRequest.CoverEndDate)
                Else
    ...
    Private Sub GetAnniversaryDate(
        ...
        If IsTrueMonthlyPolicy Then
            If RenewalDayNo <> 0 Then
                AnniversaryDate = DateAdd(DateInterval.Year, 1, InceptionDate)
                nDay = Day(AnniversaryDate)
                nDay = RenewalDayNo - nDay
                AnniversaryDate = DateAdd(DateInterval.Day, nDay, AnniversaryDate)
            Else
                If IsMidNightRenewal Then
                    AnniversaryDate = DateAdd(DateInterval.Day, -1, DateAdd(DateInterval.Year, 1, InceptionDate))
                Else
                    AnniversaryDate = DateAdd(DateInterval.Year, 1, InceptionDate)
                End If
            End If
...
ByRef STSError As STSErrorPublisher)
    ...
    Public Overloads Function AddQuoteV2(ByVal con As SiriusConnection, ByVal oAddQuoteV2Request As BaseAddQuoteV2RequestType) As BaseAddQuoteV2ResponseType
        ...
        Try
            ...
            With oAddQuoteV2Request
                ...
                oCreateQuoteBO.DateIssued = IIf(.IssuedDateSpecified, .IssuedDate, System.DBNull.Value)
    ...
    ByRef samErrorsCollection As SAMErrorCollection)
        ...
        ValidatePolicyAlreadyMadeLive(con, request.InsuranceFileKey, bIsPolicyAlreadyMadeLive)
        If bIsPolicyAlreadyMadeLive Then
            samErrorsCollection.AddInvalidData( _
                           SAMInvalidData.QuoteIsAlreadyMadeLive, _
                           SAMInvalidData.QuoteIsAlreadyMadeLive.ToString, _
                           "InsuranceFileKey", _
                           request.InsuranceFileKey.ToString)
        End If
...
#End Region
    ...
    Private Sub ProcessCopyMTARisks(
     ...
     Optional ByVal Is_SAM_Copy_Quote As Boolean = False, Optional ByVal bCalledViaAddMTA As Boolean = False, Optional ByVal bSetUnQuoted As Boolean = False)
        ...
        CopyMTARisks(con, listRisksBusiness, insuranceFileKey, TransactionType, Is_SAM_Copy_Quote, bCalledViaAddMTA, bSetUnQuoted)
...
ByVal renewalStatusTypeCode As String)
        ...
        Try
            ...
            If Not onlyDeleteExistingInstalmentPlan Then
                ...
                comReturnValue = premiumFinanceBusiness.ProcessPlan(
                    InstalmentsMode.NewBusinessOrRenewals,
                    premiumFinanceArrayObject,
                    pfTransactionsArrayObject,
                    pfPlanTransDetailId,
                    NoDeposit,
    ...
    ByRef premiumFinanceDetailsArray As Object(,))
        ...
        premiumFinanceDetailsArray(SharedFiles.bSIRPremFinConst.kBIC, 0) = request.BIC
        premiumFinanceDetailsArray(SharedFiles.bSIRPremFinConst.kIBAN, 0) = request.IBAN
            ...
            Try
                ...
                If sProductCode = "REN" Then
                    ...
                    If Trim(sPaymentMethod.ToUpper()) = "PREMIUMFINANCE" OrElse Trim(sPaymentMethod.ToUpper()) = "INSTALMENT" OrElse
                        ...
                        End If
                        oQuoteRequest.SourceId = oSavePremiumFinanceDetailsRequest.SourceId
                        oQuoteRequest.DataStore.SourceId = oSavePremiumFinanceDetailsRequest.SourceId
                        oQuoteRequest.DataStore.PFPremiumFinanceCnt = nPfpremiumFinanceCnt
                        oQuoteRequest.DataStore.PFPremiumFinanceVersion = nPfpremiumFinanceCntversion
                        ...
                        oPremiumFinanceBusiness.TransType = TransactionTypeCode.Renewals
                        ...
                        oQuoteRequest.InstDepositAmount = oSavePremiumFinanceDetailsRequest.Deposit
                        ...
                        oQuoteRequest.StartDate = oSavePremiumFinanceDetailsRequest.StartDate.Date
                        oQuoteRequest.EndDate = oSavePremiumFinanceDetailsRequest.EndDate.Date
                        oQuoteRequest.PartyBankKey = oSavePremiumFinanceDetailsRequest.PartyBankKey
                        oQuoteRequest.BankAreaCode = oSavePremiumFinanceDetailsRequest.BankAreaCode
                        oQuoteRequest.BankBranch = oSavePremiumFinanceDetailsRequest.BankBranch
                        oQuoteRequest.BankExtn = oSavePremiumFinanceDetailsRequest.BankExtn
                        oQuoteRequest.BankFax = oSavePremiumFinanceDetailsRequest.BankFax
                        oQuoteRequest.BankFaxCode = oSavePremiumFinanceDetailsRequest.BankFaxCode
                        oQuoteRequest.BankName = oSavePremiumFinanceDetailsRequest.BankName
                        oQuoteRequest.BankPhone = oSavePremiumFinanceDetailsRequest.BankPhone
                        oQuoteRequest.EndDate = oSavePremiumFinanceDetailsRequest.EndDate
                        oQuoteRequest.OverrideRate = oSavePremiumFinanceDetailsRequest.OverrideRate
                        oQuoteRequest.OverrideInterestRate = oSavePremiumFinanceDetailsRequest.OverrideInterestRate
                        ...
                        nComReturnValue = oPremiumFinanceBusiness.InsertOrUpdatePremiumFinance(
                            oInstalmentQuotes,
                    ...
                    Else
                        nComReturnValue = oPremiumFinanceBusiness.MarkPlanAsDeleted(.InsuranceFileKey)
                        If nComReturnValue <> PMEReturnCode.PMTrue Then
                            RaiseComMethodException("bSIRPremiumFinance.Business.MarkPlanAsDeleted", nComReturnValue)
                        End If
                    End If
                End If
            Finally
    ...
    Optional ByRef oResponse As BaseBindQuoteResponseType = Nothing, Optional ByRef r_nDepositTransdetailID As Integer = 0)
        ...
        Try
            ...
            ' TotalPremiumAmount, this code has been moved up.
            request.DataStore.TotalPremiumAmount = GetTotalPremiumAmount(con, request.InsuranceFileKey)
            crTotalPremiumOfAllVersions = GetTotalPremiumAmountForALLPolicyVersions(con, request.DataStore.InsuranceRef, request.InsuranceFileKey, crTotalCommissionOfAllVersions)
            DeleteUnselectedRisks(con, request.BranchCode, request.InsuranceFileKey)
            ' validate it is ok to proceed
            ValidatePolicy(con,
                request.TransactionType,
    ...
    ByVal request As BaseBindQuoteRequestType)
        ...
        CreateTaskInstance(con:=con, lTaskInstanceCnt:=iTaskInstanceCnt, lTaskGroupId:=11, lTaskId:=214,
                ...
                sDescription:="Renewal - " + sPolicyNumber + "Failed due to rounding amount greater than 1", lTaskStatus:=PMEWrkManTaskStatus.pmeWMTSNew, lIsUrgent:=1, dtDateCreated:=Date.Today, _
    ...
    ByVal request As BaseBindQuoteRequestType, Optional ByVal iAccountId As Integer = 0, Optional ByRef r_nDepositTransdetailID As Integer = 0)
        ...
        Try
            ...
            If Not request.NoTrans Then
                comReturnValue = premiumFinanceBusiness.ProcessPlan(
                    InstalmentsMode.MidTermAdjustment,
                    premiumFinanceArrayObject,
                    CType(CObj(pfTransactionsArrayObject), Object(,)),
                    pfPlanTransDetailId,
                    NoDeposit,
    ...
    ByVal con As SiriusConnection,
            ...
            ByRef totalCommissionOfAllVersions As Decimal) As Decimal
                                ...
                                If nRenewalStatusTypeId <> -1 And nRenewalStatusTypeId <> 0 Then
                                    ...
                                    ElseIf (nDoNotDeleteRenQuoteOnMTA = 1 And nIsTrueMonthlyPolicy = 1 And nAnniversaryCopy = 0) Then
                                        ...
                                        Else
                                            ...
                                            RunRenewalSelection(con, RunRenewalSelectionRequest)
                    End If
                                    ElseIf (nDoNotDeleteRenQuoteOnMTA = 0) Then
                        ...
                        Else
                            ...
                            If nRenewalStatusTypeId <> -1 And nRenewalStatusTypeId <> 0 Then
                                If nDoNotDeleteRenQuoteOnMTA = 0 Then
                                    comReturnValue = oRenewalBusiness.DeletePolicyFromRenewal(request.InsuranceFileKey)
                                    If comReturnValue <> PMEReturnCode.PMTrue Then
    ...
    Optional ByRef bSettleTransaction As Boolean = False, Optional ByRef iAccountId As Integer = 0)
        ...
        ElseIf iDebitAgainst = 3 Then
            ...
            End If
        End If
        If request.DataStore.AgentType.ToLower = "intermed" And processMode <> PMEProcessMode.PMProcessModeNBQuote And (request.DataStore.PaymentMethod = PolicyPaymentMethod.Invoice Or request.DataStore.PaymentMethod = PolicyPaymentMethod.Instalments) Then
        ...
        If request.SelectedInstalmentQuoteSpecified Then
            ...
            If request.TransactionType = TransactionTypeCode.MTA OrElse
                ...
                If request.DataStore.PFPremiumFinanceCnt <> 0 Then
                    ...
                    If request.AmountToFinance < 0 Then
    ...
    ByVal insurance_file_cnt As Integer)
        ...
        If totalpremiumAmount < 0 Then
            ...
            Dim totalPremiumAmountForAllPolicyVersions As Decimal =
                GetTotalPremiumAmountForALLPolicyVersions(con, insuranceRef, insurance_file_cnt)

            If (Math.Round(totalPremiumAmountForAllPolicyVersions, 2) < (Math.Round(totalpremiumAmount, 2) * (-1))) Then
    ...
    Private Sub CopyMTARisks(
     ...
     Optional ByVal Is_SAM_Copy_Quote As Boolean = False, Optional ByVal bCalledViaAddMTA As Boolean = False, Optional ByVal bSetUnQuoted As Boolean = False)
        ...
        If bCalledViaAddMTA Then
            comReturnValue = listRisksBusiness.CopyRisksMTA(insuranceFileKey, Is_SAM_Copy_Quote:=Is_SAM_Copy_Quote, bFromSAM:=True)
        Else
            'comReturnValue = listRisksBusiness.CopyRisksMTA(insuranceFileKey, bFromSAM:=True)
            comReturnValue = listRisksBusiness.CopyRisksMTA(insuranceFileKey, createLink, Is_SAM_Copy_Quote, True)
        End If
        If comReturnValue <> PMEReturnCode.PMTrue Then
            RaiseComMethodException("bSIRListRisks.Business.CopyRisksMTA", comReturnValue)
    ...
    Public Function GetInstalmentQuotes(ByVal GetInstalmentQuotesRequest As BaseGetInstalmentQuotesRequestType) As BaseGetInstalmentQuotesResponseType
        ...
        Dim arrColHeaders(,) As Object = {{"CompanyNo", "CompanyName", "SchemeNo", "SchemeVersion",
                                            ...
                                            "BankAddressMandatory", "StartLimit", "SingleInstalmentPerMonth", "FirstInstalmentAlignWithDayInMonth", "UseTransCurrncy",
                                            "StartDate", "DelayULimit"},
                                            ...
                                            System.Type.GetType("System.DateTime"), System.Type.GetType("System.Int32")}}
...
ByRef samErrorCollection As SAMErrorCollection)
    ...
    Public Function RunDefaultRulesEdit(ByVal RunDefaultRulesEditInput As BaseRunDefaultRulesEditRequestType) As BaseRunDefaultRulesEditResponseType
        ...
        ' Convert branch code to ID
        Try
            iSourceId% = oBusiness.GetListItemFromCode(Core.STSListType.PMLookup, "Source", RunDefaultRulesEditInput.BranchCode)
        Catch ex As Exception
            STSError.AddInvalidField("BranchCode", CStr(STSErrorCodes.BranchCodeInvalid), [String].Format(STSErrorPublisher.MandatoryInputInvalid, "BranchCode"), RunDefaultRulesEditInput.BranchCode)
        End Try
    ...
    Public Function RunValidationRules(ByVal RunValidationRulesInput As BaseRunValidationRulesRequestType) As BaseRunValidationRulesResponseType
        ...
        Try
            ...
            End If
        Catch ex As Exception
            STSError.AddInvalidField("BranchCode", CStr(STSErrorCodes.BranchCodeInvalid), [String].Format(STSErrorPublisher.MandatoryInputInvalid, "BranchCode"), RunValidationRulesInput.BranchCode)
        End Try
        ...
        Try
            With UpdateQuoteRequest
                ...
                If productDetail.IsMidNightRenewal Then
                    ' default the renewal date to be the day after the policy has ended
                    renewalDate = DateAdd(DateInterval.Day, 1, UpdateQuoteRequest.CoverEndDate)
                Else
   ...
   Optional ByVal TransactionType As String = Nothing, Optional ByRef sDocumentCommnet As String = Nothing) As Integer
        ...
        If TransactionType = "MTA" Or TransactionType = "MTC" Then
            ...
            SQL.Append("select @document_comment=(select distinct case when isnull(document_comment,'')<>''  ")
    ...
    Private Sub GetAllLiveFinancePlansOnAPolicy(ByVal con As SiriusConnection, ByVal request As BaseBindQuoteRequestType)
        ...
        If IsArray(oPremiumFinance) Then
            ReDim request.DataStore.LiveFinancePlans(UBound(oPremiumFinance, 2))
            For iCount As Integer = 0 To UBound(oPremiumFinance, 2)
        ...
        If request.DataStore.LiveFinancePlans IsNot Nothing Then
            ...
            For Each oFinancePlan As BaseLivePremiumFinancePlans In request.DataStore.LiveFinancePlans
                ...
                Else
                    ...
                    Else
                        ReDim Preserve vDebitTransDetail(UBound(vDebitTransDetail) + 1)
                        vDebitTransDetail(UBound(vDebitTransDetail)) = vDebitTransDetailID
...
ByVal request As BaseBindQuoteRequestType)
    ...
    Public Overloads Function UpdateQuoteV2(ByVal con As SiriusConnection,
     ...
     As BaseUpdateQuoteV2ResponseType
        ...
        If (oUpdateQuoteV2Request.BusinessTypeCode.ToUpper <> "DIRECT") Then
        ...
        oUpdateQuoteV2Request.PolicyStatusCode = Nothing
        ...
        Try
            ...
            If (((oUpdateQuoteV2Request.CoverEndDate <> dtOldCoverEndDate) And (sInsuranceFileTypeCode = InsuranceFileType.MTAPermanent Or sInsuranceFileTypeCode = "MTAQUOTE" Or sInsuranceFileTypeCode = InsuranceFileType.Renewal Or sInsuranceFileTypeCode = "MTAQREINS")) _
                Or ((oUpdateQuoteV2Request.CoverEndDate <> dtOldCoverEndDate) And sInsuranceFileTypeCode = InsuranceFileType.Quote) Or (oUpdateQuoteV2Request.CoverStartDate <> dtIntialCoverStartDate)) Then
            ...
            Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_Insurance_File_upd")
                With oUpdateQuoteV2Request
                    ...
                    If (.BusinessTypeCode.ToUpper <> "DIRECT") Then
                    ...
                    cmd.AddInParameter("@alternate_reference", SqlDbType.VarChar, 20).Value =
                    ...
                    Else
                        cmd.AddInParameter("@date_issued", SqlDbType.DateTime).Value = SqlDateTime.Null
                    End If
...
#Region "CheckPendingOOSVersions"
    ...
    ByVal oRequest As BaseCheckPendingOOSVersionsRequestType) As BaseCheckPendingOOSVersionsResponseType
        ...
        If ds IsNot Nothing AndAlso ds.Tables IsNot Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
            oResponse.HasPendingOOSVersions = True
        Else
            oResponse.HasPendingOOSVersions = False
        End If
        Return oResponse
...
#Region "Private Method Update Policy Associates"
    ...
    Private Overloads Function UpdatePolicyAssociatesItem(ByVal con As SiriusConnection,
        ...
        Try
            ...
            If Not oUpdatePolicyAssociatesRequest.Associates Is Nothing AndAlso Val(oUpdatePolicyAssociatesRequest.Associates(0).InsuranceFileKey) = 0 Then
                oSAMErrorCollection.AddInvalidData(SAMInvalidData.MandatoryInputMissing,
                                                                       SAMInvalidData.MandatoryInputMissing.ToString,
                                                                       "InsuranceFileKey")
                oSAMErrorCollection.CheckForErrors()
...
#Region "UpdateRiskStatus"
    Public Overloads Function UpdateRiskStatus(ByVal oRequest As BaseUpdateRiskStatusRequestType) As BaseUpdateRiskStatusResponseType

        Using con As SiriusConnection = SiriusConnection.FromSirius
            Dim oResponse As BaseUpdateRiskStatusResponseType
            oResponse = UpdateRiskStatus(con, oRequest)
            Return oResponse
        End Using
    End Function
        ...
        With oUpdateRiskStatusRequest
            ...
            If Not .InsuranceFileKey = Nothing Then
                If Not oCoreBusiness.CheckInsuranceFile(conUpdateRiskStatus, .InsuranceFileKey, r_lInsuranceFolderKey) Then
                    oErrors.AddInvalidData(SAMConstants.SAMInvalidData.InvalidLookupListValue, _
                                    SAMConstants.SAMInvalidData.InvalidLookupListValue.ToString, _
                                         "InsuranceFileKey")
                    oErrors.CheckForErrors()
                End If
            End If
            ...
            Try
                ...
                If .RiskKey = Nothing And .InsuranceFileKey = Nothing Then
                    oErrors.AddBusinessRule(SAMBusinessErrors.CanNotUpdateLivePolicyDetails, _
                ...
                If (.RiskStatusCode = RiskStatusCode.Unquoted) AndAlso Not .InsuranceFileKey = Nothing Then
                    Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_update_risk_status_unquoted")
                        cmd.AddInParameter("@insurance_file_cnt", SqlDbType.Int).Value = .InsuranceFileKey
