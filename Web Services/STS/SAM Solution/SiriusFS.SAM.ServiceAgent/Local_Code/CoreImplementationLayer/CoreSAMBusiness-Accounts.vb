...
Partial Public Class CoreSAMBusiness
    ...
    ByRef OAllocation As BaseAllocationType)
        ...
        End If
        oSAMErrorCollection.CheckForErrors()
        If (OAllocation.OtherAllocatingTrans.Length = 0) Then
            GetTransForAllocationForAccount(conPayClaim, OAllocation)
        End If
        Dim r_oOtherAllocationTrans(,) As Object
        ReDim r_oOtherAllocationTrans(1, OAllocation.OtherAllocatingTrans.Length - 1)
   ...
   ByRef OAllocation As BaseAllocationType)
    ...
    ByVal oCashList As BaseCoreCashListType, ByVal oCashListItem As BaseCoreCashListItemType)
        ...
        Else
            ...
            ProcessAllocation(oBusiness, conPayClaim, oCashListItem.AllocationDetails, oSAMErrorCollection)
            oSAMErrorCollection.CheckForErrors()
        End If
        ...
        If oCashList.GetType Is GetType(BaseReceiptCashListType) Then
            ...
            (oCashListItem.Amount * -1), lAllocationStatusKey, dAmountAllocated)
        Else
            'Note:(oCashListItem.Amount * -1), this conversion is done based on the backoffice and it is confirmed with Qaurav
            lComReturnValue = obACTCashListItem.GetMultiAllocationStatus(oCashListItem.CashListItemKey,
            ...
            With oReceiptItem
                ...
                If oReceiptItem.InstalmentPlanDetails IsNot Nothing Then
                                        ...
                                        If oReceiptItem.InstalmentPlanDetails(iCount).InstalmentDetails IsNot Nothing Then
                                            For iCount2 As Integer = 0 To oReceiptItem.InstalmentPlanDetails(iCount).InstalmentDetails.GetUpperBound(0)
                                                If oReceiptItem.InstalmentPlanDetails(iCount).InstalmentDetails(iCount2).InstalmentNumber = Cast.ToInt32(dsResult.Tables(0).Rows(iCount1).Item("instalmentnumber"), 0) Then
                                                    If oReceiptItem.InstalmentPlanDetails(iCount).InstalmentDetails(iCount2).Amount <= Cast.ToDouble(dsResult.Tables(0).Rows(iCount1).Item("amount"), 0.0) Then
                    ...
                    If oReceiptItem.InstalmentPlanDetails IsNot Nothing Then
                        ...
                        Next
                    End If
                    If oReceiptItem.Amount > dAmount AndAlso (Not bIsOverPaymentWriteOff) Then
                        oSAMErrorCollection.AddInvalidData(
                                                               SAMConstants.SAMInvalidData.InvalidDateFormat,
            ...
            If oCashListItem.GetType Is GetType(BasePaymentCashListItemType) Then
                ...
                Try
                    ...
                    If (sOption = "1" And bSettlePayment = False) Or bNoAuthority Then
                        ...
                        End If
                    ElseIf oCashListItem.AllocationDetails.AutoAllocate Then
                            ...
                            If Cast.ToInt32(drMedia.Item("is_media_reference_mandatory"), 0) = 1 Then
                                ...
                                Else
                                    ...
                                    Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_ACT_Do_CashListItem_Validate")
                                        ...
                                        cmd.AddInParameter("@mediatype_id", SqlDbType.Int).Value = .MediaTypeKey
                                        cmd.AddInParameter("@media_ref", SqlDbType.VarChar, 50).Value = .MediaReference
            ...
            If oCashList.GetType Is GetType(BasePaymentCashListType) Then
                ...
                If oCashListItem.GetType Is GetType(BasePaymentCashListItemType) Then
                    ...
                    Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_Add_CashListItem_Payment")
                        ...
                        cmd.AddInParameter("@amount", SqlDbType.Money).Value = Cast.NullIfDefault(CType((oPaymentCashListItem.Amount), Double), 0.0)
                        ...
                        cmd.AddInParameter("@media_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(oPaymentCashListItem.MediaReference, Nothing)
                        cmd.AddInParameter("@our_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(oPaymentCashListItem.OurReference, Nothing)
                        ...
                        If oPaymentCashListItem.Bank IsNot Nothing Then
                            cmd.AddInParameter("@payment_name", SqlDbType.VarChar, 60).Value = GetPaymentName(oPaymentCashListItem.Bank.PayeeName)
                        ...
                        Else
                            cmd.AddInParameter("@payment_name", SqlDbType.VarChar, 60).Value = SqlString.Null
                    ...
                    Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_Add_CashListItem_Receipt")
                        ...
                        If Not String.IsNullOrEmpty(oReceiptCashListItem.MediaReference) Then
                            If oReceiptCashListItem.MediaReference.Contains("INSDEPOSIT") Then
                                ...
                                cmd.AddInParameter("@media_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(sMediaRef, Nothing)
                            Else
                                cmd.AddInParameter("@media_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(oReceiptCashListItem.MediaReference, Nothing)
                            End If
                        Else
                            cmd.AddInParameter("@media_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(oReceiptCashListItem.MediaReference, Nothing)
                        End If
                        cmd.AddInParameter("@our_ref", SqlDbType.VarChar, 30).Value = Cast.NullIfDefault(oReceiptCashListItem.OurReference, Nothing)
                        ...
                        If oReceiptCashListItem.Bank IsNot Nothing Then
                            ...
                            cmd.AddInParameter("@payment_name", SqlDbType.VarChar, 60).Value = GetPaymentName(oReceiptCashListItem.Bank.PayerName)
        ...
        Try
            ...
            If sResult = "1" Then
                ...
                If oStepAuthorization.LastStep Then
                    ...
                    If oApproveCashListItemRequest.Declined Then
                        staskDescComplete = "Your payment has been declined " & oApproveCashListItemRequest.Comments & staskDesc & " – Reference " & oApproveCashListItemRequest.Reference
                    Else
                        staskDescComplete = "Your payment has been approved " & staskDesc & " – Reference " & oApproveCashListItemRequest.Reference
                    End If
                    staskDescComplete &= " – The Amount : " & oApproveCashListItemRequest.Amount
                Else
                    icomReturnValue = oStepAuthorization.GetStepGroupCode(r_sGroupCode:=suserGroupCode)
                    If icomReturnValue <> PMEReturnCode.PMTrue AndAlso icomReturnValue <> PMEReturnCode.PMNotFound Then
                        RaiseComMethodException("bACTCashlistitem.StepAuthorization.GetStepGroupCode", icomReturnValue)
                ...
                If oStepAuthorization.LastStep Then
                    icomReturnValue = obusiness.AddTaskToWorkManager(r_lPMWrkTaskInstanceCnt:=lPMWrkTaskInstanceCnt, v_sCustomer:=sCustomer, v_sDescription:=staskDescComplete, v_dtTaskDueDate:=dtTaskDueDate, v_sTaskCode:="SHOWCLITEM", v_sTaskGroupCode:="SLACS", v_iUserID:=Convert.ToInt16(oApproveCashListItemRequest.CreatorUserKey), v_vKeyArray:=vKeyArray)
                Else
                    icomReturnValue = obusiness.AddTaskToWorkManager(r_lPMWrkTaskInstanceCnt:=lPMWrkTaskInstanceCnt, v_sCustomer:=sCustomer, v_sDescription:=staskDescComplete, v_dtTaskDueDate:=dtTaskDueDate, v_sTaskCode:="SHOWCLITEM", v_sTaskGroupCode:="SLACS", v_sUserGroupCode:=suserGroupCode, v_vKeyArray:=vKeyArray)
                End If
                ...
                If oCreatePaymentCashListWithItemsRequest.PaymentCashList.PaymentItem IsNot Nothing Then
                    For Each oCashListItem As BasePaymentCashListItemType In oCreatePaymentCashListWithItemsRequest.PaymentCashList.PaymentItem
                        ...
                        If oCashListItem.IsProduceDocument Then
                            nPartyKey = GetAndValidateSpecifiedTableCode(con, _
                            ...
                            If iDocumentId <> 0 Then
                                ...
                                GenerateCashChequeReceiptAndPaymentDocument(con:=con, v_sBranchCode:=sBranchCode,
                                                                                 v_nSourceId:=SourceId, v_nPartyKey:=nPartyKey, v_sType:="P", v_sDocumentRef:=sDocumentRef)
                            End If
                        End If
                    Next
                End If
        ...
        Else
            ...
            Try
                ...
                If oCreatePaymentCashListWithItemsRequest.PaymentCashList.PaymentItem IsNot Nothing Then
                    For Each oCashListItem As BasePaymentCashListItemType In oCreatePaymentCashListWithItemsRequest.PaymentCashList.PaymentItem
                        oCashListItem.BranchCode = sBranchCode
                        ProcessCashListItem(con, oCoreBusiness, DirectCast(oCreatePaymentCashListWithItemsRequest.PaymentCashList, BaseCoreCashListType), DirectCast(oCashListItem, BaseCoreCashListItemType), oErrors)
    ...
    Public Sub AllocatePaymentsforPolicies(ByVal conCashlistItem As SiriusConnection,
        ...
        If String.IsNullOrEmpty(oAllocatePaymentsforPoliciesRequest.DocumentRef) Then
            oErrors.AddInvalidData(SAMConstants.SAMInvalidData.MandatoryInputMissing,
                                                                                 SAMConstants.SAMInvalidData.MandatoryInputMissing.ToString,
                                                                                  "DocumentRef")
        End If
            ...
            If (oCreateReceiptCashListWithItemsRequest.ReceiptCashList IsNot Nothing) Then
                ...
                Try
                    ...
                    If (oCreateReceiptCashListWithItemsRequest.ReceiptCashList.ReceiptItem IsNot Nothing) Then
                        For Each ReceiptItem As BaseReceiptCashListItemType In oCreateReceiptCashListWithItemsRequest.ReceiptCashList.ReceiptItem
                            Dim dsPolicies As DataSet
                            iPartyKey = GetAndValidateSpecifiedTableCode(conCashlist, _
                                             PMLookupTable.Party, "Party_cnt", "shortname", ReceiptItem.AccountShortCode, oSAMErrorCollection, ReceiptItem.AccountShortCode.ToString())
                            ...
                            If ReceiptItem.Amount <> 0.0 Then
                                ...
                                Dim whereclause As String
                                    whereclause = "c.cashlistitem_id =" + ReceiptItem.CashListItemKey.ToString() + " and SUBSTRING(d.document_ref,1,2) !='JN' and t.account_id"

                                    iDocumentId = GetAndValidateSpecifiedTableCode(conCashlist,
                                         "transdetail t join document d on t.document_id = d.document_id join CashListItem c on c.transdetail_id = t.transdetail_id ", "t.document_id", whereclause, ReceiptItem.AccountKey.ToString(), oSAMErrorCollection, "")
                                    ...
                                    If iDocumentId <> 0 Then
                                        ...
                                        GenerateCashChequeReceiptAndPaymentDocument(con:=conCashlist, v_sBranchCode:=oCreateReceiptCashListWithItemsRequest.BranchCode,
                                                                                v_nSourceId:=oCreateReceiptCashListWithItemsRequest.ReceiptCashList.SourceID, v_nPartyKey:=iPartyKey, v_sType:="R", v_sDocumentRef:=sDocumentRef)
                                    End If
                                End If
                            End If
                            If ReceiptItem.IsProduceDocument Then
                                ...
                                iDocumentId = GetAndValidateSpecifiedTableCode(conCashlist,
                                      "transdetail", "document_id", "transdetail_id", ReceiptItem.TransDetailKey.ToString(), oSAMErrorCollection, "")
            ...
            If dsFindAccounts IsNot Nothing Then
                If dsFindAccounts.Tables(0).Rows.Count > 0 Then
                    ...
                    For Each oRow In dsFindAccounts.Tables(0).Rows
                        oRow.Item(19) = GetAndValidateDescriptionById(con, "Ledger", "ledger_short_name", "ledger_id", oRow.Item(3).ToString)
                        oRow.Item(20) = GetAndValidateDescriptionById(con, "AccountType", "description", "AccountType_id", oRow.Item(4).ToString)
                    Next
    ...
    Public Overloads Function GetReceiptCashListItems(ByVal con As SiriusConnection, ByVal oGetReceiptCashListItemsRequest As BaseGetReceiptCashListItemsRequestType) As BaseGetReceiptCashListItemsResponseType
        ...
        If dsCashListItem IsNot Nothing AndAlso dsCashListItem.Tables.Count > 0 AndAlso dsCashListItem.Tables(0).Rows.Count > 0 Then
            With dsCashListItem.Tables(0)
                ...
                dsResultDataSet.Tables(0).Columns.Add("TaxBandCode", GetType(System.String))
                For iCount = 0 To .Rows.Count - 1
                    ...
                    dsResultDataSet.Tables(0).Rows(iCount)("TaxBandCode") = Cast.ToString(.Rows(iCount).Item("TaxBandCode"), String.Empty)
                Next
                ...
                With oFindPaymentDetails
                    ...
                    If .PolicyClaimNumber IsNot Nothing AndAlso Len(Convert.ToString(.PolicyClaimNumber).Trim) <> 0 Then
                        If ValidateString(Convert.ToString(.PolicyClaimNumber).Trim, "/\-_") = False Then
                            ...
                            Exit Function
                        End If
                        If InStr(Convert.ToString(.PolicyClaimNumber).Trim, "/") = 1 Or InStr(Convert.ToString(.PolicyClaimNumber).Trim, "\") = 1 Or InStr(Convert.ToString(.PolicyClaimNumber).Trim, "-") = 1 Or InStr(Convert.ToString(.PolicyClaimNumber).Trim, "_") = 1 Then
                            oSAMErrorCollection.AddInvalidData(SAMInvalidData.InvalidFormat,
                                       SAMInvalidData.InvalidFormat.ToString,
                                       "PolicyClaimNumber")
                            ValidateFindPaymentDetails = False
                    ...
                    If bIsCheque = True Then
                        ...
                        If .MediaReferenceFrom IsNot Nothing AndAlso Len(Convert.ToString(.MediaReferenceFrom).Trim) <> 0 Then
                            If IsNumeric(.MediaReferenceFrom) <> True Or Len(Convert.ToString(.MediaReferenceFrom).Trim) > 10 Or InStr(Convert.ToString(.MediaReferenceFrom).Trim, ".") > 0 Then
                                oSAMErrorCollection.AddInvalidData(SAMInvalidData.InvalidFormat,
                                                    SAMInvalidData.InvalidFormat.ToString,
                                                    "MediaReferenceFrom")
                                ValidateFindPaymentDetails = False
                        ...
                        If .MediaReferenceTo IsNot Nothing AndAlso Len(Convert.ToString(.MediaReferenceTo).Trim) <> 0 Then
                            If IsNumeric(.MediaReferenceTo) <> True Or Len(Convert.ToString(.MediaReferenceTo).Trim) > 10 Or InStr(Convert.ToString(.MediaReferenceTo).Trim, ".") > 0 Then
                                oSAMErrorCollection.AddInvalidData(SAMInvalidData.InvalidFormat,
                                                    SAMInvalidData.InvalidFormat.ToString,
                                                    "MediaReferenceTo")
                                ValidateFindPaymentDetails = False
                    ...
                    Else
                        If .MediaReferenceFrom IsNot Nothing AndAlso Len(Convert.ToString(.MediaReferenceFrom).Trim) <> 0 Then
                            ...
                            If InStr(Convert.ToString(.MediaReferenceFrom).Trim, "/") = 1 Or InStr(Convert.ToString(.MediaReferenceFrom).Trim, "\") = 1 Or InStr(Convert.ToString(.MediaReferenceFrom).Trim, "-") = 1 Or InStr(Convert.ToString(.MediaReferenceFrom).Trim, "_") = 1 Or InStr(Convert.ToString(.MediaReferenceTo).Trim, ".") = 1 Then
                                oSAMErrorCollection.AddInvalidData(SAMInvalidData.InvalidFormat,
                                                     SAMInvalidData.InvalidFormat.ToString,
                                                     "MediaReferenceFrom")
                                ValidateFindPaymentDetails = False
                        ...
                        If .MediaReferenceTo IsNot Nothing AndAlso Len(Convert.ToString(.MediaReferenceTo).Trim) <> 0 Then
                            ...
                            If InStr(Convert.ToString(.MediaReferenceTo).Trim, "/") = 1 Or InStr(Convert.ToString(.MediaReferenceTo).Trim, "\") = 1 Or InStr(.MediaReferenceTo, "-") = 1 Or InStr(Convert.ToString(.MediaReferenceTo).Trim, "_") = 1 Or InStr(Convert.ToString(.MediaReferenceTo).Trim, ".") = 1 Then
                                oSAMErrorCollection.AddInvalidData(SAMInvalidData.InvalidFormat,
                                                    SAMInvalidData.InvalidFormat.ToString,
                                                    "MediaReferenceTo")
                                ValidateFindPaymentDetails = False
    ...
    Private Function ValidateString(ByVal s_InputString As String, ByVal s_AllowedSpecialChars As String) As Boolean
        ...
        For iLen = 1 To Len(s_InputString)
            ...
            If (iKeyAscii < 48 Or iKeyAscii > 57) And (iKeyAscii < 65 Or iKeyAscii > 90) And (iKeyAscii < 97 Or iKeyAscii > 122) And iKeyAscii <> 37 Then
                If InStr(s_AllowedSpecialChars, Mid(s_InputString, iLen, 1)) > 0 Then
                    ValidateString = True
                Else
...
#Region "Receipt/Payment Document"
    ...
    Private Sub GenerateCashChequeReceiptAndPaymentDocument( _
       ByVal con As SiriusConnection, ByVal v_sBranchCode As String, ByVal v_nSourceId As Integer, ByVal v_nPartyKey As Integer, ByVal v_sType As String, ByVal v_sDocumentRef As String, ByRef v_sDocumentCode As String, ByVal v_nInsuranceFileKey As Integer, ByVal v_nInsuranceFolderKey As Integer)
        ...
        If Not (Trim(sDefaultDocument) = "0") Then
        ...
        If (nDocumentTemplateId > 0) Then
         v_sDocumentCode = GetTemplateCode(con, nDocumentTemplateId)
            ...
            If (v_nInsuranceFileKey = 0) Then
                Dim oSAMErrorCollection As New SAMErrorCollection
                v_nInsuranceFileKey = GetAndValidateSpecifiedTableCode(con,
                                      "document", "insurance_file_cnt", "document_ref", v_sDocumentRef, oSAMErrorCollection, "")

                v_nInsuranceFolderKey = GetAndValidateSpecifiedTableCode(con,
                                      "insurance_file", "insurance_folder_cnt", "insurance_file_cnt", v_nInsuranceFileKey.ToString(), oSAMErrorCollection, "")

            End If
            generateDocumentRequest.DocumentTemplateCode = GetTemplateCode(con, nDocumentTemplateId)
            generateDocumentRequest.InsuranceFolderKey = v_nInsuranceFolderKey
            If Not (v_sDocumentRef.Substring(0, 3) = "SRP" OrElse v_sDocumentRef.Substring(0, 3) = "SPY") Then
