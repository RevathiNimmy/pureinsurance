...
Public Class CoreBusiness
    ...
    Public Overloads Function ProcessAccounts(ByVal con As SiriusConnection, ByVal ProcessAccountsInput As ProcessAccountsIn) As ProcessAccountsOut
        ...
        Try
            ...
            iRet = oGIS.ProcessAccounts( _
                v_sGisDataModelCode:=ProcessAccountsInput.DataModelCode, _
                v_sGisBusinessTypeCode:=ProcessAccountsInput.BusinessTypeCode, _
                v_lInsuranceFileCnt:=ProcessAccountsInput.InsuranceFileCnt, _
                v_sTransactionType:=ProcessAccountsInput.TransactionType, _
                v_bMTAInstallments:=ProcessAccountsInput.MTAInstallments, _
                v_sCancelRefundAmt:=ProcessAccountsInput.CancelRefundAmt, _
                v_bRenewalInstallments:=ProcessAccountsInput.RenewalInstallments, _
    ...
    Public Overloads Function FindParty(ByVal con As SiriusConnection, ByVal FindPartyInput As FindPartyIn) As FindPartyOut
        ...
        Try
            ...
            iRet = oGIS.Initialise(sUserName:=_SiriusUser.Username, _
                                   sPassword:=_SiriusUser.Password, _
                                   iUserID:=CInt(_SiriusUser.UserID), _
                                   iSourceID:=CInt(_SiriusUser.SourceID), _
                                   iLanguageID:=CInt(_SiriusUser.LanguageID), _
                                   iCurrencyID:=CInt(_SiriusUser.CurrencyID), _
                                   iLogLevel:=SiriusUserDefaults.LogLevel, _
                                   sCallingAppName:=sCalling, _
                                   vDatabase:=oDatabase)
        ...
        With FindPartyInput
            iRet = oGIS.FindParty( _
                    v_sGisDataModelCode:=CType(.sGisDataModelCode, String), _
                    v_sGisBusinessTypeCode:=CType(.sGisBusinessTypeCode, String), _
                    v_sPartyType:=CType(.sPartyType, String), _
                    v_sShortname:=CType(.sShortname, String), _
                    v_sResolvedName:=CType(.sResolvedName, String), _
                    v_sUserID:=CType(.sUserID, String), _
                    v_sTelephoneNumber:=CType(.sTelephoneNumber, String), _
                    v_sPostcode:=CType(.sPostcode, String), _
                    r_vResultArray:=vResultArray, _
                    v_vAdditionalDataArray:=vAdditionalData, _
                    v_sAddress1:=CType(.sAddress1, String), _
                    v_lLeadAgentCnt:=.lLeadAgentCnt, _
        ...
        Dim arrColHeaders(,) As Object = {{"PartyKey", "ShortName", _
                                    "ResolvedName", "AddressLine1", _
                                    "PostCode", "ContactTelephoneNumber", _
                                    "DateOfBirth", "AgentKey"}, _
                                    ...
                                    System.Type.GetType("System.String"), _
                                    System.Type.GetType("System.String"), _
                                    System.Type.GetType("System.DateTime"), _
    ...
    Public Overloads Function AddQuote(ByVal con As SiriusConnection, ByVal AddQuoteInput As AddQuoteIn) As AddQuoteOut
        ...
        Try
            With AddQuoteInput
                ...
                iRet = oGIS.AddQuote( _
                    v_sGisDataModelCode:=.DataModelCode, _
                    v_sGisBusinessTypeCode:=.BusinessTypeCode, _
                    v_dtEffectiveDate:=.EffectiveDate, _
                    v_dtExpirationDate:=.ExpirationDate, _
                    v_sInsuredName:=.InsuredName, _
                    v_lPartyCnt:=.PartyCnt, _
                    r_lAgentCnt:=lAgentCnt, _
                    r_lInsuranceFolderCnt:=.InsuranceFolderCnt, _
                    r_lInsuranceFileCnt:=.InsuranceFileCnt, _
                    v_sInsuranceFolderDescription:=.InsuranceFolderDescription, _
                    r_sInsuranceFileRef:=.InsuranceFileRef, _
                    r_lRiskCodeId:=.RiskCodeId, _
                    v_lSourceID:=.SourceId, _
                    r_lInsurerCnt:=.InsurerCnt, _
                    v_lscreenid:=.ScreenId, _
                    v_vAlternateReference:=.AlternateReference, _
                    r_lRiskCnt:=.RiskCnt, _
                    r_lRiskGroupId:=.RiskGroupId, _
                    r_lGisSchemeId:=lGISSchemeID, _
                    v_lCurrencyID:=.CurrencyId, _
                    v_lAnalysisCodeId:=.AnalysisId, _
                    v_sPolicyStatusCode:=.PolicyStatusCode, _
                    v_lPolicyVersion:=.PolicyVersion, _
                    v_sPaymentMethod:="Cash", _
                    v_sBusinessType:=businessType, _
                    v_sRenewalFrequency:="ANNUAL", _
                    v_sInsuranceFileStructure:="PMB", _
                    r_vAdditionalDataArray:=vAdditionalData, _
                    v_lLapsedReasonId:=.LapsedReasonID, _
                    v_dtLapsedDate:=.LapsedDate, _
                    v_sLapsedReasonDescription:=.LapsedReasonDescription, _
                    v_dtInceptionDate:=.InceptionDate, _
                    v_dtInceptionDateTPI:=.InceptionDateTPI, _
                    v_dtRenewalDate:=.RenewalDate, _
                    v_sOldPolicyNumber:=.OldPolicyNumber, _
                    v_sAccountExecutiveShortname:=.AccountExecutiveShortname, _
                    v_sAlternateReference:=.AlternateReference, _
                    v_sAccountHandlerShortname:=.AccountHandlerShortname, _
                    v_sInsuranceFileTypeCode:=.PolicyVersionTypeCode, _
    ...
    Public Overloads Function AddRisk(ByVal con As SiriusConnection, ByVal AddRiskInput As AddRiskIn) As AddRiskOut
        ...
        Try
            ...
            With AddRiskInput
                ...
                iRet = oGIS.AddRisk( _
                    v_sBackOfficeMapperCode:=CType(.BackOfficeMapperCode, String), _
                    v_sGisDataModelCode:=CType(.DataModelCode, String), _
                    v_sGisBusinessTypeCode:=CType(.BusinessTypeCode, String), _
                    v_lInsuranceFolderCnt:=CType(.InsuranceFolderCnt, Integer), _
                    v_lInsuranceFileCnt:=CType(.InsuranceFileCnt, Integer), _
                    v_lPartyCnt:=CType(.PartyCnt, Integer), _
                    v_lRiskTypeId:=CType(.RiskTypeId, Integer), _
                    v_lRiskScreenId:=CType(.RiskScreenId, Integer), _
                    v_sRiskDescription:=CType(.RiskDescription, String), _
                    v_lProductID:=CType(.ProductID, Integer), _
                    r_lRiskFolderCnt:=riskFolderCnt, _
                    r_lRiskCnt:=riskCnt, _
                    r_sXMLDataSetDef:=xmlDataSetDef, _
                    r_sXMLDataset:=xmlDataSet, _
                    r_lPolicyLinkID:=policylinkId, _
                    r_sTopOIKey:=topOIKey, _
                    r_sQuoteRef:=quoteRef, _
                    r_sQuoteRefPassword:=quoteRefPassword, _
    ...
    Public Function UpdateRiskNumber(ByVal con As SiriusConnection, ByVal iInsurancefilecnt As Int32, ByVal iRiskId As Int32) As Integer
        ...
        SAMFunc.InitialiseSBOObject(Con:=con, _
             oObject:=obSIRListRisks, _
             SiriusUser:=_SiriusUser, _
             sObjectName:="bSIRListRisks.Business")

        Try
            iRet = obSIRListRisks.GetNextRiskNo(v_lInsuranceFileCnt:=iInsurancefilecnt, _
        ...
        Try
            ...
            iRet = obSIRListRisks.UpdateRiskNo(v_lRiskCnt:=iRiskId, _
    ...
    Public Overloads Function GetQuoteRisks(ByVal con As SiriusConnection, ByVal GetQuoteRisksInput As GetQuoteRisksIn) As GetQuoteRisksOut
        ...
        If IsArray(vResultArray) = True Then
            Dim arrColHeaders(,) As Object = {{"InsuranceFileKey", "RiskKey", _
                "RiskDesc", "RiskTypeDesc", "CoverStartDate", _
                "ExpiryDate", "RiskStatusDesc", "TotalSumInsured", "TotalThisPremium", _
                "GISScreenKey", "RiskTypeKey", "InsuranceFolderKey", "StatusFlag", _
                "RiskNumber", "VariationNumber", "IsRiskSelected", _
                "Coverage", "InsuredItem", "Extensions", "ScreenCode", "DataModelCode", _
                "TaxPercent", "TaxAmount", "CommAmount", "Comm"}, _
                {System.Type.GetType("System.Int32"), System.Type.GetType("System.Int32"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.String"), _
                System.Type.GetType("System.DateTime"), System.Type.GetType("System.DateTime"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.Double"), _
                System.Type.GetType("System.Double"), System.Type.GetType("System.Int32"), _
                System.Type.GetType("System.Int32"), System.Type.GetType("System.Int32"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.Int32"), _
                System.Type.GetType("System.Int32"), System.Type.GetType("System.Boolean"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.String"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.String"), _
                System.Type.GetType("System.String"), System.Type.GetType("System.Double"), _
                System.Type.GetType("System.Double"), System.Type.GetType("System.Double"), _
    ...
    Public Overloads Function LoadRiskFromDB(ByVal con As SiriusConnection, ByVal LoadRiskFromDBInput As LoadRiskFromDBIn) As LoadRiskFromDBOut
        ...
        Try
            With LoadRiskFromDBInput
                iRet = oGIS.LoadRiskFromDB( _
                                r_sXMLDataSetDef:=.XMLDataSetDef, _
                                r_sXMLDataset:=.XMLDataSet, _
                                r_sGISDataModelCode:=.DataModelCode, _
                                v_lRiskID:=.RiskID, _
    ...
    Public Function ProcessInstalments( _
        ByVal ProcessInstalmentsInput As BaseBindQuoteRequestType, _
        ...
        Try
            ...
            iSourceId% = GetListItemFromCode( _
                Core.STSListType.PMLookup, _
                "Source", _
                ProcessInstalmentsInput.BranchCode)

        Catch ex As Exception
            STSError.AddInvalidField( _
                "BranchCode", _
                STSErrorPublisher.STSErrorCodes.BranchCodeInvalid.ToString, _
                [String].Format(STSErrorPublisher.MandatoryInputInvalid, _
                "BranchCode"), _
                ProcessInstalmentsInput.BranchCode)
        End Try
        ...
        ' Initialise the GIS
        SAMFunc.InitialiseSBOObject( _
            oObject:=oPremiumFinance, _
            siriusUser:=_SiriusUser, _
        ...
        Try
            ...
            With ProcessInstalmentsInput
                ...
                iRet = oPremiumFinance.Calculate_Quotes( _
                    v_lSourceID:=iSourceId%, _
                    v_sProductCode:=gPMConstants.PMTypeOfBusinessNB, _
                    v_dtQuoteDate:=Date.MinValue, _
                    v_dtStartDate:=Date.MinValue, _
                    v_dtEndDate:=Date.MinValue, _
                    v_dtPreferredDate:=.PreferredDate, _
                    v_iDayInMonth:=CShort(.MonthDay), _
                    v_iDayInWeek:=CShort(.WeekDay), _
                    v_crAmountToFinance:=CDec(Cast.DefaultIfNull(.AmountToFinance, 0)), _
                    v_bPaymentProtection:=.PaymentProtection, _
                    v_dInterestOverrideRate:=.OverrideInterestRate, _
                    v_bOverrideCommission:=False, _
                    v_lPartyCnt:=0, _
                    r_vQuoteArray:=arrQuoteArrayObject, _
        ...
        If blSchemeFound = True Then
            ...
            iRet = oPremiumFinance.InsertOrUpdatePremiumFinance( _
                arrQuoteArray, _
                iCnt, _
                Nothing, _
                lPremiumFinanceCnt, _
                lPremiumFinanceVer)
            ...
            iRet = oPremiumFinance.GetSingleFinancePlan( _
                lPremiumFinanceCnt, _
                lPremiumFinanceVer, _
            ...
            oPFArray.SetValue(ProcessInstalmentsInput.BIC, SharedFiles.bSIRPremFinConst.kBIC, 0)
            oPFArray.SetValue(ProcessInstalmentsInput.IBAN, SharedFiles.bSIRPremFinConst.kIBAN, 0)
            ...
            iRet = oPremiumFinance.UpdateExistingRecord( _
                CType(CObj(oPFArrayObject), Object(,)), _
                lPremiumFinanceCntObject, _
            ...
            iRet = oPremiumFinance.SaveInstalmentsPlanMediaTypeDetails( _
                v_lPfPremFinanceCnt:=lPremiumFinanceCnt, _
                v_lPfPremFinanceVersion:=lPremiumFinanceVer, _
            ...
            iRet = oPremiumFinance.CheckAllocationAgainstPolicy( _
                v_lInsuranceFileCnt:=ProcessInstalmentsInput.InsuranceFileKey, _
            ...
            iRet = oPremiumFinance.DeletePFTransID( _
                v_lPremFinanceCnt:=lPremiumFinanceCnt, _
            ...
            iRet = oPremiumFinance.InsertPFTransID( _
                v_lPremFinanceCnt:=lPremiumFinanceCnt, _
                v_lPremFinanceVersion:=lPremiumFinanceVer, _
            ...
            iRet = oPremiumFinance.ProcessPlan( _
                lMode:=3, _
                v_vPremiumFinanceArray:=oPFArray, _
                v_vTransArray:=CType(CObj(TransactionArray), Object(,)), _
                v_iMTAType:=0)
            ...
            iRet = oPremiumFinance.StatusUpdate( _
                vPremiumFinanceCnt:=lPremiumFinanceCntObject, _
                vPremiumFinanceVersion:=lPremiumFinanceVerObject, _
    ...
    Private Sub PopulateCreditCardDetails( _
    ByRef request As BaseBindQuoteRequestType, _
    ByRef premiumFinanceDetailsArray As Object(,))

        If request.PaymentMethodSpecified = True AndAlso _
    ...
    Public Function RunDefaultRulesEdit(ByVal oDefaultRulesIn As DefaultRulesInput) As DefaultRulesOutput
        ...
        Try
            oOutQuote = RunQuote(NBQuoteInput:=oInQuote, _
    ...
    Public Function RunValidationRules(ByVal oValidationRulesIn As ValidationRulesInput, Optional ByVal oSiriusUser As SIRIUSUSER = Nothing) As ValidationRulesOutput
        ...
        oOutQuote = RunQuote(NBQuoteInput:=oValidationRulesIn, _
    ...
    Public Overloads Function RunQuote(ByVal NBQuoteInput As NBQuoteIn, _
    ...
    Public Overloads Function RunQuote(ByVal con As SiriusConnection, ByVal NBQuoteInput As NBQuoteIn, _
                                       ByVal lType As Int32) As NBQuoteOut
    ...
    Public Overloads Function RunQuote( _
    ByVal con As SiriusConnection, _
    ByVal NBQuoteInput As NBQuoteIn, _
    ...
    ByVal transactionTypeID As Integer) As NBQuoteOut
        ...
        Utilities.EncodeTransactionScreenAndType(r_lEncoded:=lQuoteType, _
                                             v_lTransactionType:=transactionTypeID, _
                                             v_lGISScreenId:=NBQuoteInput.RiskScreenId, _
                                             v_lQuoteType:=lType)
        ...
        Try
            ...
            iRet = oGIS.NBQuote( _
                v_sGisDataModelCode:=NBQuoteInput.DataModelCode, _
                v_sGisBusinessTypeCode:=NBQuoteInput.BusinessTypeCode, _
                v_lQuoteType:=lQuoteType, _
                v_dtEffectiveDate:=NBQuoteInput.EffectiveDate, _
                r_sXMLDataset:=NBQuoteInput.XMLDataset, _
                v_lGISSchemeID:=NBQuoteInput.GISSchemeID, _
                v_lRiskGroupID:=NBQuoteInput.RiskGroupID, _
                r_vAdditionalDataArray:=vAdditionalData)
    ...
    Public Overloads Function NBTransact(ByVal con As SiriusConnection, ByVal NBTransactInput As NBTransactIn) As NBTransactOut
        ...
        With NBTransactInput
            ...
            'ReDim Preserve .AdditionalDataArray(UBound(.AdditionalDataArray) + 1)
            '.AdditionalDataArray(UBound(.AdditionalDataArray)) = oData
            ...
            Try
                ...
                Select Case GetListInput.ListType
                    Case Core.STSListType.PMLookup
                        ...
                        GetListOutput.ListItems = GetPMLookupAll(GetListInput.ListCode, GetListInput.ExcludeDeletedRecords, GetListInput.ExcludeEffectiveDate, GetListInput.ParentFieldName, GetListInput.ParentFieldValue, GetListInput.EffectiveDate, GetListInput.Version)
                        'Else
                    ...
                    Case Core.STSListType.UserDefinedTable
                        GetListOutput.ListItems = GetGISUserDefListAll(GetListInput.ListCode, GetListInput.ParentFieldValue)
                    Case Else
    ...
    Private Function GetGISUserDefListAll(ByVal GISUserDefHeaderCode As String, Optional ByVal ParentValue As Int32 = Nothing) As DataSet
    ...
    Public Function GetAndValidateListItemFromCode( _
                        ByVal ListType As Core.STSListType, _
                        ByVal ListCode As String, _
                        ByVal ListItemCode As String, _
                        ByVal FieldName As String, _
                        Optional ByVal oSAMErrorCollection As SAMErrorCollection = Nothing, _
        ...
        If oOut.ListItems Is Nothing Then
            ...
            oSAMErrorCollection.AddInvalidData( _
                SAMInvalidData.InvalidLookupListValue, _
        ...
        If (ListCode = "MTA_Event_Description") Then
            If (Convert.ToString(ListItemCode).ToUpper().StartsWith("OTHER")) Then
                MTAReasonDesc = ListItemCode.Substring(5, ListItemCode.Length - 5)
                ListItemCode = "OTHER"
            End If
        End If
        ...
        Try
            ...
            If r_sDescription <> "NOTPASSED" Then
                ...
                If (ListCode = "MTA_Event_Description") Then
                    If (Convert.ToString(r_sDescription).ToUpper() = "OTHER") Then
        ...
        Catch ex As Exception
            ...
            oSAMErrorCollection.AddInvalidData( _
                SAMInvalidData.InvalidLookupListValue, _
                SAMInvalidData.InvalidLookupListValue.ToString & sListItem, _
                sFieldName, _
                ListItemCode)
            If RaiseErrorInSitu Then
                oSAMErrorCollection.CheckForErrors()
    ...
    Public Function GetAndValidateListItemFromId( _
                        ByVal ListType As Core.STSListType, _
                        ByVal ListCode As String, _
                        ByVal ListItemId As Integer, _
                        ByVal FieldName As String, _
                        Optional ByVal oSAMErrorCollection As SAMErrorCollection = Nothing, _
                        Optional ByRef Description As String = "NOTPASSED", _
    ...
    Public Function GetListItemFromCode( _
                        ByVal ListType As Core.STSListType, _
                        ByVal ListCode As String, _
                        ByVal ListItemCode As String, _
                        Optional ByRef r_sDescription As String = "NOTPASSED") As Int32
    ...
    'Corebusiness
    Public Function GetCurrentIdFromBaseIdAndVersionId(ByVal con As SiriusConnection, _
        ...
        Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_CLM_Get_Id_FromBaseID")
            ...
            Else
                ...
                oSAMErrorCollection.AddBusinessRule(SAMBusinessErrors.CurrentIdLookupUsingBaseIdAndVersionIDFailed, _
                        SAMBusinessErrors.CurrentIdLookupUsingBaseIdAndVersionIDFailed.ToString(), _
                        "Id Lookup on Table :" + TableName + " using base_id " + BaseId.ToString + _
    ...
    Public Function GetListItemFromCaption( _
                        ByVal ListType As Core.STSListType, _
                        ByVal ListCode As String, _
    ...
    Public Function GetListItemFromID( _
                        ByVal ListType As Core.STSListType, _
                        ByVal ListCode As String, _
                        ByVal ListItemID As Int32, _
                        Optional ByRef r_sDescription As String = "NOTPASSED", _
    ...
    Friend Overloads Function AgentSecurityCheck( _
                            ByVal UserName As String, _
                            ByVal PrimaryKey As Integer, _
    ...
    Friend Overloads Function AgentSecurityCheck(ByVal con As SiriusConnection, _
                            ByVal UserName As String, _
                            ByVal PrimaryKey As Integer, _
                            ByVal EntityType As PMEEntityType) As Boolean
    ...
    Public Overloads Sub GetSAMTimestamp( _
                ByVal BranchCode As String, _
                ByVal Lockname As LockName, _
                ByVal LockValue As Int32, _
                ByRef TStamp As Byte(), _
                ByRef bCurrentlyLocked As Boolean, _
       Optional ByRef iLockedByUserID As Integer = -1, _
       Optional ByRef sLockedByUser As String = "")
        Using con As SiriusConnection = New SiriusConnectionPMDAO( _
                                            _SiriusUser.Username, _SiriusUser.SourceID, _
                                            _SiriusUser.LanguageID, _
                                            SiriusUserDefaults.AppName)
            GetTimestamp(con, BranchCode, _
                        Lockname, _
                        LockValue, _
                        TStamp, _
                        bCurrentlyLocked, _
    ...
    Public Overloads Sub GetSAMTimestamp(ByVal Con As SiriusConnection, _
                ByVal BranchCode As String, _
                ByVal Lockname As LockName, _
                ByVal LockValue As Int32, _
                ByRef TStamp As Byte(), _
       ...
       Optional ByRef sLockedByUser As String = "")
        ...
        Try
            ...
            If sOptionValue = "1" AndAlso (Lockname = CoreBusiness.LockName.ClaimId OrElse _
    ...
    Public Overloads Function GetTimestamp( _
                        ByVal BranchCode As String, _
                        ByVal Lockname As LockName, _
                        ByVal LockValue As Int32, _
                        ByRef TStamp As Byte(), _
        ...
        Using con As SiriusConnection = New SiriusConnectionPMDAO( _
            ...
            oResponse = GetTimestamp(con, BranchCode, _
                                        Lockname, _
                                        LockValue, _
                                        TStamp, _
                                        bCurrentlyLocked, _
    ...
    Public Overloads Function GetTimestamp(ByVal Con As SiriusConnection, _
                        ByVal BranchCode As String, _
                        ByVal Lockname As LockName, _
                        ByVal LockValue As Int32, _
                        ByRef TStamp As Byte(), _
                        ByRef bCurrentlyLocked As Boolean, _
               Optional ByRef iLockedByUserID As Integer = -1, _
                Optional ByRef sLockedByUser As String = "", _
    ...
    Public Overloads Sub CheckSAMTSAndLock(ByVal Con As SiriusConnection, ByVal BranchCode As String, ByVal Lockname As LockName, ByVal LockValue As Int32, ByVal TStamp As Byte())
        ...
        Try
            ...
            GetSystemOption(BranchCode, _
                                      SystemOption.EnableExclusiveLocking, _
                                      sOptionValue)
            ...
            If iRet <> PMEReturnCode.PMTrue Then
                Select Case iRet
                    Case PMEReturnCode.PMRecordChanged
                        Dim oSAMErrorCollection As New SAMErrorCollection
                        oSAMErrorCollection.AddBusinessRule(SAMBusinessErrors.RecordChanged, _
                                                            SAMBusinessErrors.RecordChanged.ToString, _
                    ...
                    Case PMEReturnCode.PMRecordInUse
                        ...
                        Dim oSAMErrorCollection As New SAMErrorCollection
                        oSAMErrorCollection.AddBusinessRule(SAMBusinessErrors.RecordLockedByAnotherUser, _
                                                            SAMBusinessErrors.RecordLockedByAnotherUser.ToString, _
    ...
    Public Overloads Function CheckTSAndLock(ByVal BranchCode As String, ByVal Lockname As LockName, ByVal LockValue As Int32, ByVal TStamp As Byte()) As STSErrorType
        Using con As SiriusConnection = New SiriusConnectionPMDAO( _
            ...
            oResponse = CheckTSAndLock(con, BranchCode, _
                                        Lockname, _
                                        LockValue, _
                                        TStamp)
    ...
    Public Overloads Function CheckTSAndLock(ByVal Con As SiriusConnection, ByVal BranchCode As String, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function LockKey(ByVal Con As SiriusConnection, ByVal Lockname As LockName, _
                             ByVal LockValue As Integer, _
                             ByVal _SiriusUser As SIRIUSUSER, _
    ...
    Public Overloads Sub UnlockAndGetSAMTS(ByVal Con As SiriusConnection, ByVal BranchCode As String, ByVal Lockname As LockName, ByVal LockValue As Int32, ByRef TStamp As Byte())
        ...
        Try
            ...
            Else
                ...
                If iRet <> PMEReturnCode.PMTrue Then
                    Dim oSAMErrorCollection As New SAMErrorCollection
                    oSAMErrorCollection.AddBusinessRule(SAMBusinessErrors.RecordNotLockedByCurrentUser, _
                                                        SAMBusinessErrors.RecordNotLockedByCurrentUser.ToString, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetProductOption(ByVal lOptionNumber As Integer, _
                              ByVal lBranchId As Integer, _
    ...
    Public Function GetProductOption(ByVal con As SiriusConnection, ByVal lOptionNumber As Integer, _
                              ByVal lBranchId As Integer, _
                              Optional ByVal iClaimid As Integer = 0) As String
    ...
    Public Function GetProductDocumentOption(ByVal lProductID As Integer, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Sub setDefaultValues(ByVal sTableName As String, _
                                        ByVal sColumnName1 As String, _
                                        ByVal sValue1 As String, _
                                        ByRef r_dsOptionalValues As DataSet, _
                                        Optional ByVal sColumnName2 As String = "", _
    ...
    Public Function ValidWildcardSearch( _
            ByVal v_bDisableWildcardSearchOption As Boolean, _
            ByVal v_bEnablePartialWildcardSearchOption As Boolean, _
            ByRef r_sFieldValue As String, _
    ...
    Friend Overloads Function CheckInsuranceParams(ByVal con As SiriusConnection, _
                                                   ByVal nInsurancefolderCnt As Integer, _
                                                   ByVal nInsuranceFileCnt As Integer, _
                                                   ByVal nRiskCnt As Integer, _
                                                   Optional ByRef r_nInsuranceFolderCnt As Integer = 0, _
                                                   Optional ByRef r_nSourceID As Integer = 0, _
