...
Partial Public Class CoreSAMBusiness
    ...
    Public Overloads Function GetClaimRisk(ByVal con As SiriusConnection, _
        ...
        Try
            ...
            GetClaimRiskScreenDetails(con, GetClaimRiskRequest.BaseClaimKey,
                                         iClaimId,
                                         iScreenId,
                                         iRiskTypeId,
                                         sGisDataModelCode,
                                         ...
                                         iInsuranceFileCnt,
                                         GetClaimRiskRequest.IgnoreIsDirty)
    ...
    ''' <param name=""></param>
    ''' <remarks></remarks>
    Private Sub GetClaimRiskScreenDetails(ByVal con As SiriusConnection,
                                    ByVal iBaseClaimId As Integer,
                                    ByRef r_iClaimId As Integer,
                                    ByRef r_iScreenId As Integer,
                                    ByRef r_iRiskTypeId As Integer,
                                    ByRef r_sGisDataModelCode As String,
                                    ByRef r_iTransactionTypeId As Integer,
                                    ByRef r_sTransactionTypeCode As String,
                                    ByRef r_iInsuranceFileCnt As Integer,
                                    Optional ByVal bIgnoreIsDirty As Boolean = False)
        ...
        Using cmd As SiriusCommand = SiriusCommand.FromProcedure("spu_SAM_CLM_Get_Claim_Risk_Screen_Details")
            ...
            cmd.AddInParameter("@bIgnoreIsDirty", SqlDbType.TinyInt).Value = IIf(bIgnoreIsDirty = True, 1, 0)
