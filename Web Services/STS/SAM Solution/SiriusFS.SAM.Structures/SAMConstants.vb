...
Public Class SAMConstants
    ...
    Public Enum SAMInvalidData
        ...
        SameUserCanNotAuthoriseTwoSteps
        InvalidXpathString
        InvalidCertificateYears
        InvalidCountryCode
        UserUnconfirmedExceptions = 336
        QuoteIsAlreadyMadeLive
        PolicyAlreadyRenewed
        TransactionAutoAllocated
    End Enum
    ...
    Public Enum SAMErrorCodes As Long
        ...
        StartDateIsInThePast = 297
        EndDateIsBeforeStartDate = 298
        FailedToRetrieveDocumentTemplateDetails = 299
        FailedToUpdateDocumentTemplate = 300
    End Enum
