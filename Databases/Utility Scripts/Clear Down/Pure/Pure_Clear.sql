...
DELETE StructureTree where account_id IN (
	...
	WHERE Party.Party_type_id in (1, 2, 4) )
...
DELETE Account WHERE Account_key in (SELECT Party_cnt from Party WHERE Party_type_id in (1, 2, 4))
...
DELETE Document_Spooler
DELETE Party_Conviction WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE Party_Private_Text WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE Party_Prospect WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE Prospect_Policy WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE Party_Other WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE previous_accidents WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
DELETE Party_Supplier_Business WHERE Party_cnt IN (SELECT Party_Cnt FROM Party WHERE party_type_id in (1, 2, 4))
...
DELETE CashDeposit
DELETE Party WHERE party_type_id in (1, 2, 4)
