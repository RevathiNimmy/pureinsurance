...
Friend Partial Class frmInterface
    ...
    Private Const ACFieldPVDocumentDate As Integer = 5
...
Finally_Renamed:
    ...
    Private Sub frmInterface_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        _optSinglePolicy_3.Checked=False
        _optSinglePolicy_4.Checked=True
        ...
        Try
            ...
            For lCount As Integer = 0 To aoResultArray.GetUpperBound(1)
                ...
                oListItem.SubItems.Insert(ACFieldPVDocumentRef, _
                    ...
                    '                              New ListViewItem.ListViewSubItem(oListItem, "0"))
    ...
    Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
        ...
        Select Case SSTabHelper.GetSelectedIndex(Me.tabMain)
            ...
            Case 0 'Single policy
                ...
                If MessageBox.Show("Are you sure to proceed?", ACApp, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
              ...
              If not _optSinglePolicy_4.Checked   then
    ...
    Private Sub ProcessSinglePolicy()
       ...
       If  _optSinglePolicy_3.Checked Then
        ...
        elseIf  _optSinglePolicy_1.Checked Then
            lCount=1
        ElseIf _optSinglePolicy_4.Checked=True then
             lCount=2
         End If
        ...
        Select Case lCount
            ...
            Case 2 'Reverse & Regenerate Transaction
        ...
        Try
            ...
            For Each oListItem As ListViewItem In Me.lvwPolicyVersion.Items
                If oListItem.Checked Then
                    ...
                    Select Case Convert.ToString(oListItem.SubItems(2).Text)
                        Case 2 'new business
                            If sDocumentRef.StartsWith("SND") Then
                                sTransactionType = "NB"
                            Else
                    ...
                    Dim  sReverseDocumentRef As String
                    Dim nRepostDocumentId As Integer

                     m_lReturn =m_oBusiness.GetReverseRepostDocument(CInt(oListItem.Text),txtPMNumber.Text,sReverseDocumentRef,nRepostDocumentId)
                      If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                        iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Get Document refrence", vApp:=ACApp, vClass:=ACClass, vMethod:="ProcessFailedTransaction", vErrNo:=CStr(Information.Err().Number), vErrDesc:=Information.Err().Description)
                        Throw New System.Exception
                       End If


                     m_lReturn = m_oBusiness.AllocateTransactions(v_sOldDocumentRef:=sReverseDocumentRef, v_lNewDocumentid:=nRepostDocumentId)
