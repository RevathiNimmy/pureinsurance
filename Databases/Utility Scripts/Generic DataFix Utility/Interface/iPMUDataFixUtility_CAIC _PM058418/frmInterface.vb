    ...
    Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
        ...
        Select Case SSTabHelper.GetSelectedIndex(Me.tabMain)
            ...
            Case 0 'Single policy
                ...
                ' bValidate=  ValidateDuplicateInsCnt(sInsuranceRef)

                'If Not bValidate Then
                '    MessageBox.Show ("Duplicate policy Id "&  sInsuranceRef.Trim()  & " selected to revserse ",ACApp,MessageBoxButtons.OK,MessageBoxIcon.Information)
                '    Me.cmdOK.Enabled = True
                '    Me.cmdExit.Enabled = True
                '    Exit Sub
                'End If
                
                ' bValidate=  ValidateDuplicate(sInsuranceRef)
                'If Not bValidate Then
                '    MessageBox.Show ("Duplicate Policy Reference "&  sInsuranceRef.Trim()  & " selected to revserse ",ACApp,MessageBoxButtons.OK,MessageBoxIcon.Information)
                '    Me.cmdOK.Enabled = True
                '    Me.cmdExit.Enabled = True
                '    Exit Sub
                'End If
    ...
    Private Sub ReverseAndRegenerateTransaction()
        Try
            ...
            Dim bFirstItem As Boolean = True
             ...
             If MessageBox.Show("Do you want to revserse and regenrate the document?", ACApp, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
                bIsSucesfullyCompleted=False
                Exit Sub
               End if
