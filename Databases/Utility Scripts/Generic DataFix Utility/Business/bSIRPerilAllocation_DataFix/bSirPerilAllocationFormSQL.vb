...
Module BusinessSQL
	...
	Public Const ACUpdateRiskStatusSQL As String = "UPDATE risk SET risk_status_id = {risk_status_id}" & Strings.Chr(13) & Strings.Chr(10) &  _
    ...
    Public Const ACSelectInsuranceFileCntSQL As String = "spu_select_Insurance_FileCnt_DataFix"
    ...
    Public Const kSelectInsuranceFileCntForPTSQL As String = "SELECT ifi.insurance_file_cnt, ifi.cover_start_date, ifi.expiry_date " & Strings.Chr(13) & Strings.Chr(10) & _
                                                "FROM insurance_file_risk_link ifrl " & Strings.Chr(13) & Strings.Chr(10) & _
                                                    "JOIN insurance_file ifi ON ifrl.insurance_file_cnt = ifi.insurance_file_cnt " & Strings.Chr(13) & Strings.Chr(10) & _
                                                "WHERE ifrl.risk_cnt = {risk_cnt}" & Strings.Chr(13) & Strings.Chr(10) & _
                                                    "AND ISNULL(ifi.insurance_file_status_id, 3) in (1,2,3,4,5,6) " & Strings.Chr(13) & Strings.Chr(10) & _
                                                    "AND ifi.insurance_file_type_id IN (2,3,5,9,4,8,6)" & Strings.Chr(13) & Strings.Chr(10) & _
                                                "ORDER BY 1 DESC"
    'End Girija - PN 55432

    Public Const ACSelectInsuranceFileCntMTRStored As Boolean = False
    Public Const ACSelectInsuranceFileCntMTRSQL As String = "SELECT ifi.insurance_file_cnt, ifi.cover_start_date, ifi.expiry_date" & Strings.Chr(13) & Strings.Chr(10) & _
                                                            "FROM insurance_file_risk_link ifrl" & Strings.Chr(13) & Strings.Chr(10) & _
                                                            "JOIN insurance_file ifi ON ifrl.insurance_file_cnt = ifi.insurance_file_cnt" & Strings.Chr(13) & Strings.Chr(10) & _
                                                            "WHERE ifrl.risk_cnt = {risk_cnt}" & Strings.Chr(13) & Strings.Chr(10) & _
                                                            "AND ifi.insurance_file_type_id in(8,12,11)" & Strings.Chr(13) & Strings.Chr(10) & _
                                                            "ORDER BY 1 DESC"
	...
	Public Const ACSelectUWProductOptionsSQL As String = "SELECT is_midnight_renewal, allow_positive_cancellation, ISNULL(unified_renewal_day, 0) " &  _
	...
	Public Const ACGetRoundingInfoSQL As String = "SELECT p.round_prem_to_nearest_unit," & Strings.Chr(13) & Strings.Chr(10) &  _
	                                              "p.rounding_section_id," & Strings.Chr(13) & Strings.Chr(10) &  _
	                                              "rst.code" & Strings.Chr(13) & Strings.Chr(10) &  _
	                                              "FROM Product p LEFT OUTER JOIN rating_section_type rst" & Strings.Chr(13) & Strings.Chr(10) &  _
	                                              "ON p.rounding_section_id = rst.rating_section_type_id" & Strings.Chr(13) & Strings.Chr(10) &  _
