...
Module BusinessSQL
    ...
    Public Const ACGetRiskDetailSQL As String = "SELECT ifrl.insurance_file_cnt, ifrl.risk_cnt, ifrl.status_flag, r.description, IsNull(rs.description,'Null') 'risk status' ,infs.insurance_folder_cnt,D.document_ref,infs.insurance_file_type_id" & Strings.Chr(13) & Strings.Chr(10) & _
                                                ...
                                                "LEFT JOIN Insurance_file infs ON infs.insurance_file_cnt = ifrl.insurance_file_cnt" & Strings.Chr(13) & Strings.Chr(10) &
                                                 "LEFT JOIN Document D ON infs.insurance_file_cnt = D.insurance_file_cnt" & Strings.Chr(13) & Strings.Chr(10) &
                                                 "Where ifrl.insurance_file_cnt = {InsuranceFileCnt}" & Strings.Chr(13) & Strings.Chr(10) &
                                                 "and document_ref not like 'CL%'" & Strings.Chr(13) & Strings.Chr(10) & _
                                                 "and document_ref not like 'SD%' "
    ...
    Public Const ACGetTransDetailByDocSQL As String = "spu_ACT_Sel_TransDetail_By_Doc_FACAlloc_DataFix"
    ...
    Public Const ACGetRiskCntForInsuranceFileCntSQL As String = "SELECT risk_cnt FROM insurance_file_risk_link WHERE insurance_file_cnt= {InsuranceFileCnt} AND status_flag <>'U'"
    ...
    Public Const ACAllocationReverseName As String = "Perform Allocation Reversal"
    Public Const ACAllocationReverseSQl As String = "spu_ACT_Do_Allocation_Reversal"
    ...
    Public Const ACReverseClaimStatsName As String = "spu_claim_stats_reverse"
    Public Const ACReverseClaimStatsSQL As String = "spu_claim_stats_reverse"

    Public Const ACAddExportRevDetailsName As String = "AddExportDetailsClaims"
    Public Const ACAddExportRevDetailsSQL As String = "spu_CopyReversalTransExportDetail"
    ...
    Public Const ACAddStatsGRSDetailsStored As Boolean = True
    Public Const ACAddStatsGRSDetailsName As String = "AddStatsDetailsClaims"
    Public Const ACAddStatsGRSDetailsSQL As String = "spu_clm_add_stats_details_GRS"

    Public Const ACUpdInsuranceFileStored As Boolean = False
    Public Const ACUpdInsuranceFileName As String = "UpdateInsuranceIFle"
    Public Const ACUpdInsuranceFileSQL As String = "UPDATE Insurance_file " & Strings.Chr(13) & Strings.Chr(10) &
                                                       "SET insurance_file_status_id=1 ,insurance_file_type_id=4 " & Strings.Chr(13) & Strings.Chr(10) &
                                                       "WHERE insurance_file_cnt = {insurance_file_cnt}"

    Public Const KSearchBordereauStored As Boolean = True
    Public Const KSearchBordereauName As String = "Add missing tasks"
    Public Const KSearchBordereauSQL As String = "[etana].[SearchBordereau]"

    Public Const KAddMissingTaskStored As Boolean = True
    Public Const KAddMissingTaskName As String = "Add missing tasks"
    Public Const KAddMissingTaskSQL As String = "spu_ICCS_6129_Add_Missing_Task"

    Public Const ACRefreshRI2007SQL As String = "spu_RI_Arrangement_refresh_RI2007_ForUtility"
    Public Const ACRefreshRI2007Name As String = "RefreshRIArrangementRI2007_ForUtility"
    Public Const ACRefreshRI2007Stored As Boolean = True

    'change policy status
    Public Const ACUpdTransCommentStored As Boolean = True
    Public Const ACUpdTransCommentName As String = "Update TransDetail Comment"
    Public Const ACUpdTransCommentSQL As String = "spu_update_TransDetail_Comment"

    'get Claim on policy version
    Public Const ACGetClaimStored As Boolean = False
    Public Const ACGetClaimName As String = "Get Claim on policy version"
    Public Const ACGetClaimSQL As String = "select * from claim where policy_id = {Insurance_File_cnt}"
    ...
    Public Const ACAddClonedStatsDetailsSQL As String = "spu_Copy_Stats_for_Cloned_Reversal_DataFix"
    ...
    Public Const kCopyClonedExportDetailsSQL As String = "spu_Copy_TransExportDetail_for_Cloned_Reversal_DataFix"
    ...
    Public Const ACAddStatsDetailsCloneStored As Boolean = True
    Public Const ACAddStatsDetailsCloneName As String = "AddStatsDetails"

    Public Const ACAddStatsDetailsCloneSQL As String = "spu_add_stats_details_control"
    ...
    Public Const ACFinaliseStatsForUtilityName As String = "Finalise Stats"
    Public Const ACFinaliseStatsForUtilitySQl As String = "spu_CLM_Finalise_stats_For_Utility"
    ...
    Public Const ACUpdateRiskStatusName As String = "update the specified risks with the specified risk status"
    Public Const ACUpdateRiskStatusSQL As String = "UPDATE Risk SET risk_status_id = (Select risk_status_id from risk_status where code = {risk_status_code})  WHERE risk_cnt = {risk_cnt}"

    'get Transaction_Type_Code from Stats_folder via document_ref
    Public Const ACGetTransactionTypeCodeStored As Boolean = False
    Public Const ACGetTransactionTypeCodeName As String = "GetTransactionTypeCode"
    Public Const ACGetTransactionTypeCodeSQL As String = "SELECT transaction_type_code FROM Stats_Folder WHERE document_ref = {DocumentRef}"


    Public Const ACTaxFixStored As Boolean = True
    Public Const ACTaxFixName As String = "FixTax"
    Public Const ACTaxFixSQL As String = "spu_Fix_Tax_PM059028"

    Public Const ACRefreshRISQL As String = "spu_RI_Arrangement_refresh"
    Public Const ACRefreshRIName As String = "RefreshRIArrangementRI2007"
