...
GO
EXECUTE DDLDropTrigger 'tr_Wording_Risk_Type_Link_audit_log'
GO
CREATE TRIGGER tr_Wording_Risk_Type_Link_audit_log ON dbo.Wording_Risk_Type_Link 
...
SELECT @ModuleId=27, @ModuleName='Risk Type Maintenance', @PKColName = 'branch_id',@ValueColName='ScreenHierarchy';
