...
GO
EXECUTE DDLDropTrigger 'tr_treaty_audit_log'
GO
CREATE TRIGGER tr_treaty_audit_log ON dbo.Treaty 
...
SELECT @ModuleId=8,@ModuleName='Treaty Maintenance', @PKColName = 'treaty_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New Treaty Added'
ELSE IF @Type='D'
	SELECT @FieldValue='Treaty Deleted'
