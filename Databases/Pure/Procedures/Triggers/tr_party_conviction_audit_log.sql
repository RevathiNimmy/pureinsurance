...
GO
EXECUTE DDLDropTrigger 'tr_party_conviction_audit_log'
GO
CREATE TRIGGER tr_party_conviction_audit_log ON dbo.party_conviction
...
IF @Type='I'
    SELECT @FieldValue='New Party Conviction Added'
ELSE If @Type='D'
	SELECT @FieldValue='Party Conviction Deleted'
