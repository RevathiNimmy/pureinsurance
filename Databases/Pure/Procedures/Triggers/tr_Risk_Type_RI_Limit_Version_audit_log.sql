...
GO
EXECUTE DDLDropTrigger 'tr_Risk_Type_RI_Limit_Version_audit_log'
GO
CREATE TRIGGER tr_Risk_Type_RI_Limit_Version_audit_log ON dbo.Risk_Type_RI_Limit_Version
...
SELECT @ModuleId = 27, @ModuleName = 'Risk Type Maintenance' ,@PKColName = 'risk_type_ri_limit_version_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New RI Limit Added'
ELSE If @Type='D'
	SELECT @FieldValue='RI Limit Deleted'
