...
GO
EXECUTE DDLDropTrigger 'tr_Party_Agent_Branch_audit_log'
GO
CREATE TRIGGER tr_Party_Agent_Branch_audit_log ON dbo.Party_Agent_Branch 
...
SELECT  @ModuleId=6,@ModuleName='Agent Maintenance', @PKColName = 'source_id',@ValueColName='ScreenHierarchy';
