...
GO
EXECUTE DDLDropTrigger 'tr_GIS_User_Def_Header_audit_log'
GO
CREATE TRIGGER tr_GIS_User_Def_Header_audit_log ON dbo.GIS_User_Def_Header 
...
SELECT @ModuleId=12,@ModuleName='User Maintainable Rate Tables', @PKColName = 'gis_user_def_header_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New LookUp Header Added'
ELSE IF @Type='D'
	SELECT @FieldValue='LookUp Header Deleted'
