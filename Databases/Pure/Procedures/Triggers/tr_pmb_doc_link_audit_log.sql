...
GO
EXECUTE DDLDropTrigger 'tr_pmb_doc_link_audit_log'
GO
CREATE TRIGGER tr_pmb_doc_link_audit_log ON dbo.pmb_doc_link
...
SELECT @ModuleId = 28, @ModuleName = 'Product Risk Maintenance' ,@PKColName = 'PMB_Doc_Link_Id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New Document Link Added'
ELSE If @Type='D'
	SELECT @FieldValue='Document Link Deleted'
