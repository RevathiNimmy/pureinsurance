...
GO
EXECUTE DDLDropTrigger 'tr_Product_Source_audit_log'
GO
CREATE TRIGGER tr_Product_Source_audit_log ON dbo.Product_source 
...
SELECT  @ModuleId=28,@ModuleName='Product Risk Maintenance', @PKColName = 'source_id',@ValueColName='ScreenHierarchy';
