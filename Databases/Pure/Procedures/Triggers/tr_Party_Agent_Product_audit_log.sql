...
GO
EXECUTE DDLDropTrigger 'tr_Party_Agent_Product_audit_log'
GO
CREATE TRIGGER tr_Party_Agent_Product_audit_log ON dbo.Party_Agent_Product
...
SELECT  @ModuleId=6,@ModuleName='Agent Maintenance', @PKColName = 'product_id',@ValueColName='ScreenHierarchy';
...
SELECT @FieldDesc='Product Chosen'
