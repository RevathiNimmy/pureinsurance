...
GO
EXECUTE DDLDropTrigger 'tr_Credit_Control_Step_audit_log'
GO
CREATE TRIGGER tr_Credit_Control_Step_audit_log ON dbo.Credit_Control_Step 
...
SELECT @ModuleId=2,@ModuleName='Credit Control Maintenance', @PKColName = 'credit_control_step_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New Step Added'
ELSE IF @Type='D'
	SELECT @FieldValue='Step Deleted'
