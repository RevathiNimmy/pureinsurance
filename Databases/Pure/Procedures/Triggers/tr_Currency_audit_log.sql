...
GO
EXECUTE DDLDropTrigger 'tr_Currency_audit_log'
GO
CREATE TRIGGER tr_Currency_audit_log ON dbo.Currency
...
SELECT @ModuleId = 20, @ModuleName = 'Currency Maintenance' ,@PKColName = 'currency_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New Currency Added'
ELSE If @Type='D'
	SELECT @FieldValue='Currency Deleted'
