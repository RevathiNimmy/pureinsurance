...
GO
EXECUTE DDLDropTrigger 'tr_PFRF_audit_log'
GO
CREATE TRIGGER tr_PFRF_audit_log ON PFRF 
...
SELECT @ModuleId=1,@ModuleName='Instalment Scheme Maintenance', @PKColName = 'pfrf_id',@ValueColName='ScreenHierarchy';
...
IF @fieldname NOT IN ('UniqueId','UserId','ScreenHierarchy','Protect','AllowProtection','DepositReq')
BEGIN	
