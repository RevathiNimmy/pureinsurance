...
GO
EXECUTE DDLDropTrigger 'tr_party_other_audit_log'
GO
CREATE TRIGGER tr_party_other_audit_log ON dbo.party_other
...
IF @fieldname NOT IN ('UniqueId','UserId','ScreenHierarchy', 'reference_number') AND @UniqueID IS NOT NULL
BEGIN	
