...
GO
EXECUTE DDLDropTrigger 'tr_contact_audit_log'
GO
CREATE TRIGGER tr_contact_audit_log ON dbo.contact
    FOR UPDATE 
AS
SET NOCOUNT ON;
...
SELECT @PKColName = 'contact_cnt',@ValueColName='ScreenHierarchy'
...
IF @fieldname NOT IN ('UniqueId','UserId','ScreenHierarchy', 'date_created') AND @UniqueID IS NOT NULL
BEGIN	
