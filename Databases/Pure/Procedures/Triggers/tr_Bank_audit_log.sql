...
GO
EXECUTE DDLDropTrigger 'tr_Bank_audit_log'
GO
CREATE TRIGGER tr_Bank_audit_log ON dbo.Bank
...
SELECT @ModuleId = 19, @ModuleName = 'Bank Maintenance' ,@PKColName = 'bank_id',@ValueColName='ScreenHierarchy';
...
IF @Type='I'
    SELECT @FieldValue='New Bank Added'
ELSE If @Type='D'
	SELECT @FieldValue='Bank Deleted'
