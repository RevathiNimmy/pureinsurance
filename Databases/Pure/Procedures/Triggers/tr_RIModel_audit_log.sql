...
GO
EXECUTE DDLDropTrigger 'tr_RIModel_audit_log'
GO
CREATE TRIGGER tr_RIModel_audit_log ON dbo.Ri_Model 
...
IF @Type='I'
    SELECT @FieldValue='New RIModel Added'
ELSE IF @Type='D'
	SELECT @FieldValue='RIModel Deleted'
