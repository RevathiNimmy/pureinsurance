...
GO
EXECUTE DDLDropTrigger 'tr_address_audit_log'
GO
CREATE TRIGGER tr_address_audit_log ON dbo.address
    FOR UPDATE 
AS
SET NOCOUNT ON;
...
IF @fieldname NOT IN ('UniqueId','UserId','ScreenHierarchy','address6','address7','address8','address9','address10') AND @UniqueID IS NOT NULL
BEGIN	
