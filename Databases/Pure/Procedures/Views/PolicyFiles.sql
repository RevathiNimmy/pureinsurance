...
create view PolicyFiles as select
    ...
    Policy_Type.code                                TypeCode,
    Policy_Type.description                         TypeDescription,
    Insurance_File_Status.code                      StatusCode,
    Insurance_File_Status.description               StatusDescription,
    ...
    (case when (select code from Insurance_File_Type
        where insurance_file_type_id = Insurance_File.insurance_file_type_id) = 'QUOTE' then 'Yes'
        else 'No'
        end)                                        Quote,
