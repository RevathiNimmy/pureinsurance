...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_add_trans_export_folder_clm'
GO

CREATE PROCEDURE spu_add_trans_export_folder_clm  
    @transaction_export_folder_cnt int OUTPUT,  
    @stats_folder_cnt int  
AS  
  
/*************************************************************************************************  
* Name: sp_add_trans_export_folder_clm  
*  
* Version: 1.00.0000  
*  
***************************************************************************************************/  
BEGIN  
    ...
    SELECT @accounts_export_status = 'C'  
