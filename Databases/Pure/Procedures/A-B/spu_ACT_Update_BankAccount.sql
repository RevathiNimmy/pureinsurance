EXECUTE DDLDropProcedure 'spu_ACT_Update_BankAccount'
GO
...
CREATE PROCEDURE spu_ACT_Update_BankAccount
 @bankaccount_id int,  
...
UPDATE BankAccount  
 ...
 effective_date='2000/1/1',  
 is_deleted=0,  
 next_cheque_number = @next_cheque_number,  
 reconciled_date = @reconciled_date,  
 default_bank_account_id = @default_bank_account_id,  
 is_cash_receive_in_this_currency_only = @is_cash_receive_in_this_currency_only,  
 start_cheque_number = CAST(@start_cheque_number AS bigint),
