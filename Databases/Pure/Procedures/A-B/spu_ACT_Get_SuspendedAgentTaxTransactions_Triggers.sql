...
EXECUTE DDLDropProcedure 'spu_ACT_Get_SuspendedAgentTaxTransactions_Triggers'
GO

-- Object:  Stored Procedure spu_ACT_Get_SuspendedAgentTaxTransactions_Triggers 
-- Script Date: 12 10 2005 12:06:42 PM

CREATE PROCEDURE spu_ACT_Get_SuspendedAgentTaxTransactions_Triggers
    @DocumentId INT
AS
