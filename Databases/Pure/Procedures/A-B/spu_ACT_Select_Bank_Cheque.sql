...
GO
EXECUTE DDLDropProcedure 'spu_ACT_Select_Bank_Cheque'
GO

CREATE PROCEDURE spu_ACT_Select_Bank_Cheque
...
SELECT b.bank_account_name, 
       ...
       a.short_code,
       CASE
		   WHEN ISNULL(P.Resolved_Name, '') <> '' THEN P.Resolved_Name
		   WHEN ISNULL(a.payment_name, '') = '' THEN a.account_name
		   ELSE a.payment_name
		 END, 
       a.address1,
       a.address2,
