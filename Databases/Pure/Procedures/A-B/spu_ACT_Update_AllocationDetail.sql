EXECUTE DDLDropProcedure 'spu_ACT_Update_AllocationDetail'
GO

CREATE PROCEDURE spu_ACT_Update_AllocationDetail
    ...
    @orig_xrate NUMERIC(12,8),
    @effective_xrate NUMERIC(12,8),
...
UPDATE AllocationDetail
    ...
    allocate_to_base=@allocate_to_base,
    orig_base_amount=@orig_base_amount,
    orig_base_amount_unrounded=@orig_base_amount_unrounded,
    orig_ccy_amount=@orig_ccy_amount,
    orig_ccy_amount_unrounded=@orig_ccy_amount_unrounded,
    orig_xrate=@orig_xrate,
    effective_xrate=@effective_xrate,
    os_base_amount=@os_base_amount,
    os_ccy_amount=@os_ccy_amount,
    alloc_base_amount=@alloc_base_amount,
    alloc_ccy_amount=@alloc_ccy_amount,
    fully_matched=@fully_matched,
    write_off_amount=@write_off_amount,
    write_off_reason_id=@write_off_reason_id,
    new_os_ccy_amount=@new_os_ccy_amount,
    new_os_base_amount=@new_os_base_amount,
    loss_gain_amount=@loss_gain_amount,
    is_primary=@is_primary,
    euro_currency_id=@euro_currency_id,
    euro_amount=@euro_amount,
    euro_base_xrate=@euro_base_xrate,
    euro_ccy_xrate=@euro_ccy_xrate,
    alloc_account_amount = @crAlloc_account_amount,
    alloc_system_amount = @crAlloc_system_amount,
	 transdetailex_id = @transdetailex_id
