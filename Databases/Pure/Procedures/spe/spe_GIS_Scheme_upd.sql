...
EXECUTE DDLDropProcedure 'spe_GIS_Scheme_upd'
GO

CREATE PROCEDURE spe_GIS_Scheme_upd
    @gis_scheme_id int,
...
UPDATE GIS_Scheme
    SET
    gis_quote_engine_id=@gis_quote_engine_id,
    ...
    dict_ver =@dict_ver,
    housekeep_day_num=@housekeep_day_num,
    pre_selection_day_num=@pre_selection_day_num,
    reminder_day_num=@reminder_day_num,
    renew_day_num=@renew_day_num,
    is_insurer_lead=@is_insurer_lead,
