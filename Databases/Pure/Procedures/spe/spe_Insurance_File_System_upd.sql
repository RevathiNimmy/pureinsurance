...
EXECUTE DDLDropProcedure 'spe_Insurance_File_System_upd'
GO

CREATE PROCEDURE spe_Insurance_File_System_upd
...
Select @lasttransdate = last_trans_date From Insurance_File_System  
WHERE insurance_file_cnt = @insurance_file_cnt

IF @lasttransdate IS NULL 
