...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spe_Party_Insurer_add'
GO
...
CREATE PROCEDURE spe_Party_Insurer_add  
    @party_cnt int,  
...
BEGIN  
	...
	BEGIN
		SET @insurer_type_id = NULL
	END
INSERT INTO Party_Insurer (  
    party_cnt ,  
    agency_number,  
    binder_indicator,  
    report_indicator,  
    is_reinsurer,  
    reinsurance_type ,  
    is_reinsurance_debit_credit_no,  
    default_comm_rate,  
    tax_group_id,  
    payment_method,  
    payment_frequency,  
    ...
    fsa_insurercreditrating_id,  
    fsa_insurerstatus_id,  
    is_retained,
    claims_rating_agency_id,
    claims_rating_grading,
    claims_rating_date,
    claims_rating_description,
    terms_of_payment_id,
    domiciled_for_tax,
    risk_transfer_agreement,
    Brokerlink_Subaccount,
    Brokerlink_UW_ID,
    is_ri_broker,
    insurer_locking_type_id,
