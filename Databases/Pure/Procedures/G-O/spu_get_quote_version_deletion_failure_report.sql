...
SET ANSI_NULLS ON
GO
EXECUTE DDLDropProcedure 'spu_get_quote_version_deletion_failure_report'
GO
CREATE PROCEDURE spu_get_quote_version_deletion_failure_report
 @DateFrom DATE = NULL,
 @DateTo DATE = NULL
AS
BEGIN
 ...
 SELECT
   ...
   ISNULL(DL.failure_description, '') AS ReasonForFailure,
