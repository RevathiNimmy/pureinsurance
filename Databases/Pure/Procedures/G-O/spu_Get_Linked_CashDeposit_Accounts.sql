...
SET ANSI_NULLS OFF 
GO
EXEC DDLDropProcedure 'spu_Get_Linked_CashDeposit_Accounts'
GO

--Start - Sankar - (UIIC_WPR85_Cash_Deposit_Process) - Paralleling
CREATE  PROCEDURE spu_Get_Linked_CashDeposit_Accounts  
	@Account_ID INT=NULL,
	@Party_Cnt INT=NULL
AS
BEGIN
