...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_SIR_Calculate_Agent_Tax_Amounts_SFB'
GO


CREATE PROCEDURE spu_SIR_Calculate_Agent_Tax_Amounts_SFB    
...
SELECT @RateEffectiveDate=max(agr.effective_date) 
	...
	JOIN insurance_file i on i.insurance_file_cnt  = pa.insurance_file_cnt
