EXEC DDLDropProcedure 'spu_SAM_Get_Document_Template_Defaults_ForCode'
GO

CREATE PROCEDURE spu_SAM_Get_Document_Template_Defaults_ForCode
	@document_template_code VARCHAR(10)
AS
...
WHERE	T.code=@document_template_code
