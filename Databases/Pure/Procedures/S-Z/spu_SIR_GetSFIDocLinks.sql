...
EXEC DDLDropProcedure 'spu_SIR_GetSFIDocLinks'
GO

CREATE PROCEDURE spu_SIR_GetSFIDocLinks(  
...
BEGIN
 ...
 ptd.description,
 dt.description,
 pdl.generate_through_BO,
 pdl.generate_through_SAM,  
 dt.code document_template_code  
 ...
 IF @nCallViaSAM > 0 BEGIN  
  SET @SQL = @SQL + ' AND pdl.generate_through_SAM = ' + CONVERT(VARCHAR(1),@nCallViaSAM) END  
