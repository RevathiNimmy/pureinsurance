...
AS      
      ...
      BEGIN      
           ...
           PT.shortname,PT.Name As PartyName,PT.ShortName As PartyShortName,PT.resolved_name,      
           ...
           WHERE ifa.insurance_file_cnt=@nInsuranceFileKey      
			AND IFA.date_removed IS NULL 
           ORDER BY  Case When IFA.date_removed IS NUll Then 
                       0 Else 1 End,IFA.date_attached Desc,PT.ShortName
