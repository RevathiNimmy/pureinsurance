...
EXECUTE DDLDropProcedure 'spu_SAM_GetHistoricalTransactions'
GO

/*******************************************************************************************************/
/* spu_SAM_GetHistoricalTransactions                                                                   */
/* Get Historical Transactions for specified party                                                     */
/* MKW27/03/06                                                                                         */
/*******************************************************************************************************/
CREATE PROCEDURE spu_SAM_GetHistoricalTransactions
    @party_cnt int = NULL
AS
BEGIN
select 
