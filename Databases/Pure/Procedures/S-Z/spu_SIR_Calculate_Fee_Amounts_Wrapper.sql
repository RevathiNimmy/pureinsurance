...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_SIR_Calculate_Fee_Amounts_Wrapper'
GO


CREATE PROCEDURE spu_SIR_Calculate_Fee_Amounts_Wrapper    
...
OPEN CURSOR_Policy_Fee_U    
 ...
 FETCH NEXT FROM CURSOR_Policy_Fee_U INTO     
  ...
  EXEC spu_SIR_Calculate_Fee_Amounts    
   @policy_fee_u_id ,@Is_Fee_Updated   
