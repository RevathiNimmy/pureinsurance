...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_Claim_RI_Arrangement_Line_add'
GO

CREATE PROCEDURE spu_Claim_RI_Arrangement_Line_add
...
SELECT @ri_arrangement_line_id = @claim_ri_arrangement_line_id
...
--THis is for salvage and recovery
IF @Trans_type = 'C_SA'
    Update  claim_ri_arrangement_line  
