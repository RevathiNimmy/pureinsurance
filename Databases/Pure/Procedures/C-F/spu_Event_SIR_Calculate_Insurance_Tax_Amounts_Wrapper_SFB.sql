...
EXECUTE DDLDropProcedure 'spu_Event_SIR_Calculate_Insurance_Tax_Amounts_Wrapper_SFB'
GO
CREATE PROCEDURE spu_Event_SIR_Calculate_Insurance_Tax_Amounts_Wrapper_SFB  
...
BEGIN  
 ...
 DECLARE CURSOR_Policy_Section  CURSOR FOR   
  ...
  Select insurance_section_Id from event_insurance_COB_Section 
 ...
 FETCH NEXT FROM CURSOR_Policy_Section INTO   
  ...
  EXEC spu_Event_SIR_Calculate_Section_Tax_Amounts_SFB 
   @insurance_section_Id,
   @return_taxes  
