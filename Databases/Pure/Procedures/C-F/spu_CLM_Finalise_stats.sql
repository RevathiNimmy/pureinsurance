...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_CLM_Finalise_stats'
GO

CREATE PROCEDURE spu_CLM_Finalise_stats  
    @claim_id int,  
...
END  
  ...
  If @nIsCloned =1 and @is_Deferred=0
BEGIN
	 Update Stats_Detail   
      SET tax_value = 0,  
      annual_premium=0,  
...
IF ISNULL(@nIsCloned,0) <> 1 OR @document_ref IS NULL
BEGIN  
