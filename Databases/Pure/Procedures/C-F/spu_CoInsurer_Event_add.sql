...
EXECUTE DDLDropProcedure 'spu_CoInsurer_Event_add'
GO
EXECUTE DDLDropProcedure 'spu_Event_CoInsurer_add'
GO

CREATE PROCEDURE spu_CoInsurer_Event_add
    ...
    @coinsurer_cover_percentage FLOAT,
...
INSERT INTO Event_Policy_Coinsurers
(
    insurance_file_cnt,
    party_cnt,
    coinsurer_count,
