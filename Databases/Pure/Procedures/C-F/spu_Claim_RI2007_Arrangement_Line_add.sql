...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_Claim_RI2007_Arrangement_Line_add'
GO

CREATE PROCEDURE spu_Claim_RI2007_Arrangement_Line_add   
    ...
    @reserve money = 0,  
    @payment money = 0,  
    @this_reserve money = 0,  
    @this_payment money = 0,
    @lower_limit money = 0,        
    @retained float = 0, 
