...
EXECUTE DDLDropProcedure 'spu_event_insurance_COB_section_upd'
GO
 
CREATE PROCEDURE spu_event_insurance_COB_section_upd
...
/* Update the values */
UPDATE  event_insurance_COB_section
SET     COB_Rating_section_id=@COB_Rating_section_id,
	Premium_Excluding_Tax=@Premium_Excluding_Tax ,
	Tax_applied=@Tax_applied,
	Premium_Including_Tax= @Premium_Including_Tax,
	Tax_group_id=@Tax_group_id,
	commission_cnt=@Commission_Cnt,
	commission_percentage=@commission_percentage,
	commission_charge=@commission_charge,
	commission_net=@commission_net ,
	commission_tax_applied=@commission_tax_applied ,
	commission_payable=@commission_payable ,
	commission_tax_group_id=@commission_tax_group_id ,
	is_minimum_brokerage=@is_minimum_brokerage ,
	override_rate_table=@override_rate_table ,
	base_premium_excluding_tax=@base_premium_excluding_tax ,
	base_tax_applied=@base_tax_applied ,
	base_premium_including_tax=@base_premium_including_tax ,
	base_commission_charge=@base_commission_charge,
	base_commission_net=@base_commission_net ,
	base_commission_tax_applied=@base_commission_tax_applied ,
	base_commission_payable=@base_commission_payable,
	is_applied=@is_applied
 	 
WHERE Insurance_file_cnt=@Insurance_File_Cnt
AND Insurance_Section_id=@Insurance_Section_id
GO
