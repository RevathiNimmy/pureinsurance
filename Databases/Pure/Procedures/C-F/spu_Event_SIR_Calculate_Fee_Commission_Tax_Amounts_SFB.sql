...
SET ANSI_NULLS ON
GO
Execute DDLDropProcedure 'spu_Event_SIR_Calculate_Fee_Commission_Tax_Amounts_SFB'
GO


CREATE PROCEDURE spu_Event_SIR_Calculate_Fee_Commission_Tax_Amounts_SFB    
 @policy_fee_id int,
...
SELECT    
    @tax_group_id = fa.commission_tax_group_id,    
