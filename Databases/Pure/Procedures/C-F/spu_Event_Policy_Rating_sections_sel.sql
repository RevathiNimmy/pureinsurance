...
EXECUTE DDLDropProcedure 'spu_Event_Policy_Rating_Section_sel'
GO

CREATE PROCEDURE spu_Event_Policy_Rating_Section_sel
...
JOIN Event_Insurance_File I ON I.risk_code_id = RTU.risk_code_id
...
LEFT OUTER JOIN Event_Insurance_COB_Section ICS ON ICS.insurance_file_Cnt = I.insurance_file_Cnt
...
SELECT @InsurerCnt=I.lead_insurer_cnt,@SchemeId=I.scheme,@RiskGroupId =RC.risk_group_id,@RiskCodeId=I.risk_code_id  FROM risk_code RC
                        JOIN Event_Insurance_File I ON I.risk_code_id = RC.risk_code_id
                        WHERE I.Insurance_File_Cnt = @InsuranceFileCnt 
