...
GO
EXECUTE DDLDropProcedure 'spu_Party_Numbering_scheme_GetAndIncrement'
GO
CREATE PROCEDURE spu_Party_Numbering_scheme_GetAndIncrement
...
IF @nStep <> 0 
BEGIN 
    UPDATE numbering_scheme WITH (ROWLOCK) 
