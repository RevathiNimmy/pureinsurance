...
EXECUTE DDLDropProcedure 'spu_Policy_Agent_add'
GO


CREATE PROCEDURE spu_Policy_Agent_add
...
SELECT @agent_count =  agent_count + 1  FROM  policy_agents WHERE EXISTS  ( select agent_count from policy_agents
