...
EXECUTE DDLDropProcedure 'spu_wp_agent_addresses'
go

CREATE PROCEDURE spu_wp_agent_addresses
    @PartyCnt INT,
...
WHILE @@FETCH_STATUS = 0 BEGIN
    ...
    exec spu_wp_get_Agent_address @PartyCnt, @InsuranceFileCnt, @ClaimCnt,@AddressCode,@Address1 OUTPUT,@Address2 OUTPUT,@Address3 OUTPUT,@Address4 OUTPUT,@Postcode OUTPUT,@Country Output
    ...
    BEGIN
    	exec spu_wp_get_Agent_address @PartyCnt,@InsuranceFileCnt,@ClaimCnt,@CorrespondenceCode,@Address1 OUTPUT,@Address2 OUTPUT,@Address3 OUTPUT,@Address4 OUTPUT,@Postcode OUTPUT,@Country Output
    END
