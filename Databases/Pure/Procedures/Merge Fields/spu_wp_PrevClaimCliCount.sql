...
EXECUTE DDLDropProcedure 'spu_wp_PrevClaimCliCount'
GO


CREATE PROCEDURE spu_wp_PrevClaimCliCount
    @PartyCnt INT,
...
-- COUNT HOW MANY CLAIMS THERE ARE FOR THIS CLIENT
SELECT  COUNT(c.claim_id) AS 'how_many'
FROM    claim c,
    insurance_file i,
...
AND     c.claim_version_status_id = 1 -- LIVE (Alix)
