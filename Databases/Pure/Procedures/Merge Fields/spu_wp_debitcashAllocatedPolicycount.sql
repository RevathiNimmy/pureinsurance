DDLDROPPROCEDURE 'spu_wp_debitcashAllocatedPolicycount'
GO
CREATE PROCEDURE spu_wp_debitcashAllocatedPolicycount
    @PartyCnt INT,  
...
(select documenttype_id from documenttype where code in ('SND','SED','SEC','SID','SRD','INC','JN','CLP'))
