...
EXECUTE DDLDropProcedure 'spu_wp_party_contact_email'
GO
 
CREATE PROCEDURE spu_wp_party_contact_email
...
WHERE P.party_cnt=@PartyCnt AND c.contact_cnt=@Instance2

OPEN ContactCursor
FETCH NEXT FROM ContactCursor INTO @contact_id,@area_code,@number,@extension
CLOSE ContactCursor
