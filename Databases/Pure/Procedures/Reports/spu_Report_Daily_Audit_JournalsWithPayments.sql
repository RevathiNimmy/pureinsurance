...
EXECUTE DDLDropProcedure 'spu_Report_Daily_Audit_JournalsWithPayments'
GO
CREATE PROCEDURE spu_Report_Daily_Audit_JournalsWithPayments
    -- TF030500
    @branch_id int,
    @start_date datetime,
    @end_date datetime,
...
--        A.ledger_id ledger,
    ...
    WHERE D.documenttype_id IN (1, 8, 10, 11, 12, 20, 21, 23)
