...
EXECUTE DDLDropProcedure 'spu_Report_Party_Listing'
GO


CREATE PROCEDURE spu_Report_Party_Listing
    @PartyType varchar(255),
    @ReportType varchar(255),
    @OtherPartyLimit varchar(255)
AS
...
--
-- 19/04/2002   SET     added type definition to @OtherPartyLimit
--
------------------------------------------------
-- get UWType
