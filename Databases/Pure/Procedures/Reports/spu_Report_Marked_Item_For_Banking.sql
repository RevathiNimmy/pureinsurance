...
EXECUTE DDLDropProcedure 'spu_report_marked_item_for_banking'
GO

CREATE PROCEDURE spu_report_marked_item_for_banking  
    @account_id INT,  
...
SELECT 
  ...
  JOIN currency cur
       ON td1.currency_id = cur.currency_id	
...
UPDATE #temp_transdetail
SET bank_susp_account = acc.account_name 
FROM account acc
WHERE 
