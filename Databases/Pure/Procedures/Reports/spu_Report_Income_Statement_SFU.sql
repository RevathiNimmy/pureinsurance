...
EXECUTE DDLDropProcedure 'spu_Report_Income_Statement_SFU'
GO
-- *****************  Version 11  *****************
-- User: Jitendra	Date: 23/07/2004
-- Multicrrency feature
--

-- *****************  Version 11  *****************
-- User: Thinh Nguyen	Date: 06/11/2003
-- put in date criteria for "year to date last year" (YTDLY) amount
--
-- 
-- *****************  Version 10  *****************
-- User: Tom.brown    Date: 27/11/02   Time: 10:23
-- Updated in $/Sirius For Underwriting/Crystal Reports/Stored Procedures
-- Fix double-quote to single quote on literals
--
-- *****************  Version 9  *****************
...
--
-- *****************  Version 7  *****************
-- User: Tom.brown    Date: 13/11/02   Time: 10:04
-- Updated in $/Work/SWIssues/Reports/Trial_Balance_Income_Statement
-- Kassim's extra columns and changes to Income Statement
--
-- *****************  Version 8  *****************
-- User: Tom.brown    Date: 17/10/02   Time: 14:46
-- Updated in $/Sirius For Underwriting/Crystal Reports/Stored Procedures
-- Added parameter 'Balance Period' with fixed values 'All Dates' and
-- 'Current Year'.  This is an RSA requirement (who want current year),
-- default will be all dates.
--
-- *****************  Version 7  *****************
-- User: Tom.brown    Date: 14/10/02   Time: 12:01
-- Updated in $/Sirius For Underwriting/Crystal Reports/Stored Procedures
-- Changed selection criteria to use dates instead of period_id.  Also
-- implement the COMM ADJ stuff as used by trial balance.
--
/**********************************************************************************************************************************
...
**
** 03/10/2001   Jude Killip     use sp_Report_FullTreePathNames
**                              ditch old date criteria, use Period
**
** 04/10/2001   Jude Killip     DON'T limit by element!
**
** 30/07/2002   Tom Brown       Select on Period End Date, change CurrentPeriod to SelectedPeriod throughout
***********************************************************************************************************************************/
CREATE PROCEDURE spu_Report_Income_Statement_SFU
        @branch_id int,
...
-- End of $Workfile: sp_Report_Income_Statement.sql $
