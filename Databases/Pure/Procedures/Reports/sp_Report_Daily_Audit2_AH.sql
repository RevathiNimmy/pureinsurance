...
if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_Report_Daily_Audit2_AH]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_Report_Daily_Audit2_AH]
GO


CREATE PROCEDURE sp_Report_Daily_Audit2_AH
