if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_Report_Commission_Earnt_RH]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_Report_Commission_Earnt_RH]
GO
...
CREATE PROCEDURE sp_Report_Commission_Earnt_RH
