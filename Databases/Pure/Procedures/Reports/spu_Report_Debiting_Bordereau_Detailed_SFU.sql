...
EXECUTE Ddldropprocedure [spu_Report_Debiting_Bordereau_Detailed_SFU]
GO
CREATE PROCEDURE [Spu_report_debiting_bordereau_detailed_sfu] 
				@branch_id      INT,
...
--SELECT @WHERE = @WHERE + " AND SD.Stats_detail_type='SUB'"
