Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("gSIRLibrary_NET.gSIRLibrary")>
Public Module gSIRLibrary
    ' ***************************************************************** '
    ...
    'PM220807
    Public Const SIRLookupCover_Note_Book_Status As String = "Cover_Note_Book_Status"
    Public Const SIRLookupCover_Note_Sheet_Status As String = "Cover_Note_Sheet_Status"
    ...
    'RDT271006
    Public Const SIRLookupPolicyStatus As String = "policy_status"
    ' TF250398
    ...
    Public Const SIRLookupTypeofCard As String = "Type_of_Card"
    ' Main Table Names
    ...
    Public Const SIRInsFileTypeAllQuote As String = "ALLQUOTE"
    ...
    Public Const SIRInsFileTypeMTAReinstatement As String = "MTAQREINS"
    ' Telephone Table
    ...
    Public Const SIRInsFileStatusReplacedCloned As String = "REPCL"
    Public Const SIRInsFileStatusVoid As String = "VOID"
    ...
    'SAGICOR WPR14
    Public Const SIRLookupCommissionLevel = "commission_level"
    '*************
    ...
    Public Const SIRLookupBlackListReason As String = "blacklist_reason"
    Public Const SIRLookupPFFrequency As String = "pffrequency"
    ...
    Public Const ACGeneralComplaint As String = "GENCMPLT" 'PN22835
    'sj 01/10/2002 - end
    ...
    Public Const ACNotesCase As String = "N_CASES"
    ...
    Public Const ACEmailMode As Integer = 8 ' To Support Email- Renewals Back Office
    '/* PN 67183 BY SANTOSH PAYASI ON 08FEB2010 - Starts
    Public Const ACUserChoice As Integer = 15 ' To Support User-Choice
    ...
    ' 050506 Datasure
    Public Const SIRLookupSection As String = "COB_Rating_Section"
    ...
    ''' <summary>
    ''' This will return a list of Product Options
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function populateArray() As Integer
        ...
        Try
            ...
            SIROPTMasterOptions(0, 0) = SIRHiddenOptions.SIROPTIsNRMA
            SIROPTMasterOptions(1, 0) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 0) = ""
            SIROPTMasterOptions(3, 0) = ""
            ...
            SIROPTMasterOptions(0, 1) = SIRHiddenOptions.SIROPTValidateAlternativeIdentifier
            ...
            SIROPTMasterOptions(0, 2) = SIRHiddenOptions.SIROPTChaserLettersEnabled
            ...
            SIROPTMasterOptions(0, 3) = SIRHiddenOptions.SIROPTAONAffinity
            ...
            SIROPTMasterOptions(0, 4) = SIRHiddenOptions.SIROPTRestrictedInsurerAccess
            ...
            SIROPTMasterOptions(0, 5) = SIRHiddenOptions.SIROPTClientPolicyLinkage
            ...
            SIROPTMasterOptions(0, 6) = SIRHiddenOptions.SIROPTAsynchronousPosting
            ...
            SIROPTMasterOptions(0, 7) = SIRHiddenOptions.SIROPTClientSummary
            ...
            SIROPTMasterOptions(0, 8) = SIRHiddenOptions.SIROPTEnhancedOrionSecurity
            ...
            'TF150702
            SIROPTMasterOptions(0, 9) = SIRHiddenOptions.SIROPTUseRetailLogicLink
            ...
            'GSD 160702
            SIROPTMasterOptions(0, 10) = SIRHiddenOptions.SIROPTClaimsBuilder
            ...
            'sj 22/07/2002 - start
            SIROPTMasterOptions(0, 11) = SIRHiddenOptions.SIROPTFutureDateAddressChanges
            ...
            ' CTAF 20020805 - start
            SIROPTMasterOptions(0, 12) = SIRHiddenOptions.SIROPTFishInstalled
            ...
            ' ED 20020805 - start
            SIROPTMasterOptions(0, 13) = SIRHiddenOptions.SIROPTAllowRegSearch
            ...
            ' DD 23/08/2002: Start
            SIROPTMasterOptions(0, 14) = SIRHiddenOptions.SIROPTMultiTreeAccounting
            ...
            SIROPTMasterOptions(0, 15) = SIRHiddenOptions.SIROPTLossSchedule
            ...
            ' PW160902: Start
            SIROPTMasterOptions(0, 16) = SIRHiddenOptions.SIROPTRiskVariations
            ...
            'sj 23/09/2002 - start
            SIROPTMasterOptions(0, 17) = SIRHiddenOptions.SIROPTAutomaticCreditProcessing
            ...
            'PWF 30/09/2002
            SIROPTMasterOptions(0, 18) = SIRHiddenOptions.SIROPTAccountSegregation
            ...
            'sj 04/10/2002 - start
            SIROPTMasterOptions(0, 19) = SIRHiddenOptions.SIROPTHidePublicPrivateNotes
            ...
            'PWF 04/10/2002
            SIROPTMasterOptions(0, 20) = SIRHiddenOptions.SIROPTMultiBranchCoreAccounts
            ...
            SIROPTMasterOptions(0, 21) = SIRHiddenOptions.SIROPTAllowChangeOfNCDAtRenewal
            ...
            SIROPTMasterOptions(0, 22) = SIRHiddenOptions.SIROPTIncludeInstalmentsOnRoadmap
            ...
            SIROPTMasterOptions(0, 23) = SIRHiddenOptions.SIROPTHidePolicyDatesOnSchemeSelectScreen
            ...
            'PR 9/10/2002 - start
            SIROPTMasterOptions(0, 24) = SIRHiddenOptions.SIROPTRemoveNone
            ...
            SIROPTMasterOptions(0, 25) = SIRHiddenOptions.SIROPTSpoolAsHTML
            ...
            'ED 31/10/2002 - start
            SIROPTMasterOptions(0, 26) = SIRHiddenOptions.SIROptHideRoadmapLetterQuestion
            ...
            'PW051102 - start
            SIROPTMasterOptions(0, 27) = SIRHiddenOptions.SIROPTAdmiralForceRisks
            ...
            SIROPTMasterOptions(0, 28) = SIRHiddenOptions.SIROPTLimitPersonalClientEditFields
            SIROPTMasterOptions(1, 28) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 28) = ""
            SIROPTMasterOptions(3, 28) = ""
            ...
            SIROPTMasterOptions(0, 29) = SIRHiddenOptions.SIROPTSetToQuoteAfterOverride
            ...
            SIROPTMasterOptions(0, 30) = SIRHiddenOptions.SIROPTAllowInstalmentsOverride
            ...
            'Product Option to switch between Salvage Recovery
            'and Manage Salvage Mode in claims
            SIROPTMasterOptions(0, 31) = SIRHiddenOptions.SIROPTManageSalvage
            ...
            SIROPTMasterOptions(0, 32) = SIRHiddenOptions.SIROPTEnableRiskScreenEditing
            ...
            SIROPTMasterOptions(0, 33) = SIRHiddenOptions.SIROPTEnableClaimVersions
            ...
            SIROPTMasterOptions(0, 34) = SIRHiddenOptions.SIROPTShareDisclosures
            ...
            SIROPTMasterOptions(0, 35) = SIRHiddenOptions.SIROPTEnableBranchSelectAtLogon
            ...
            'PWF 20/01/2003 - Enable branch select at logon
            SIROPTMasterOptions(0, 36) = SIRHiddenOptions.SIROPTIsAUA
            ...
            ' PS186
            SIROPTMasterOptions(0, 37) = SIRHiddenOptions.SIROPTForceNumericClientCode
            ...
            SIROPTMasterOptions(0, 38) = SIRHiddenOptions.SIROPTLinkCommACCToACCExec
            ...
            SIROPTMasterOptions(0, 39) = SIRHiddenOptions.SIROPTCacheTransDetail
            ...
            SIROPTMasterOptions(0, 40) = SIRHiddenOptions.SIROPTDisplayDebitCredit
            ...
            SIROPTMasterOptions(0, 41) = SIRHiddenOptions.SIROPTAccountHandlerIsMultiBranch
            ...
            SIROPTMasterOptions(0, 42) = SIRHiddenOptions.SIROPTNonPrintingGraphics
            ...
            SIROPTMasterOptions(0, 43) = SIRHiddenOptions.SIROPTSiriusViewInDocumaster
            ...
            SIROPTMasterOptions(0, 44) = SIRHiddenOptions.SIROPTUserDefinablePartyFields
            ...
            SIROPTMasterOptions(0, 45) = SIRHiddenOptions.SIROPTInsurerPaymentPayUserCheck
            ...
            SIROPTMasterOptions(0, 46) = SIRHiddenOptions.SIROPTShowRenewalFrequencyForSchemesNB
            ...
            SIROPTMasterOptions(0, 47) = SIRHiddenOptions.SIROPTThirdPartyRecovery
            ...
            'in advance
            SIROPTMasterOptions(0, 48) = SIRHiddenOptions.SIROPTGenerateAdvanceCreditControlForInstalments
            ...
            '    SIROPTMasterOptions(0, 49) = SIROPTRunClaimsAuthorisationScript
            ...
            SIROPTMasterOptions(0, 50) = SIRHiddenOptions.SIROPTDefaultSubBranch
            ...
            SIROPTMasterOptions(0, 51) = SIRHiddenOptions.SIROPTLimitPolicySource
            ...
            SIROPTMasterOptions(0, 52) = SIRHiddenOptions.SIROPTNoBranchAccess
            ...
            SIROPTMasterOptions(0, 53) = SIRHiddenOptions.SIROPTUserGroupBranchLink
            ...
            SIROPTMasterOptions(0, 54) = SIRHiddenOptions.SIROPTBranchSpecificRisks
            ...
            SIROPTMasterOptions(0, 55) = SIRHiddenOptions.SIROPTBusinessFieldOnClientIsMandatory
            ...
            SIROPTMasterOptions(0, 56) = SIRHiddenOptions.SIROPTSubBranchShowingForBroking
            ...
            ' JJ 11/07/2003
            SIROPTMasterOptions(0, 57) = SIRHiddenOptions.SIROPTAONPRClientScreenChanges
            ...
            SIROPTMasterOptions(0, 58) = SIRHiddenOptions.SIROPTInstalmentDisplayStyle
            ...
            SIROPTMasterOptions(0, 59) = SIRHiddenOptions.SIROPTEnableFSACompliance
            ...
            'DC110903 added but cannot fill all info as didnt add option
            SIROPTMasterOptions(0, 60) = SIRHiddenOptions.SIROPTWMAutoRefreshEnabled
            ...
            SIROPTMasterOptions(0, 64) = SIRHiddenOptions.SIROPTAllowElectronicPayment
            ...
            SIROPTMasterOptions(0, 65) = SIRHiddenOptions.SIROPTMultiStepApproval
            ...
            SIROPTMasterOptions(0, 66) = SIRHiddenOptions.SIROOPTNoDeletedTempates
            ...
            'SJ 17/02/2004 - start
            SIROPTMasterOptions(0, 67) = SIRHiddenOptions.SIROPTUnderwritingBranchEnabled
            ...
            'DD 25/03/2004 - start
            SIROPTMasterOptions(0, 68) = SIRHiddenOptions.SIROPTUnderwritingYear
            ...
            SIROPTMasterOptions(0, 69) = SIRHiddenOptions.SIROPTHoldCoverExpiryDate
            ...
            ' CLG 01/09/2004 : RFC71 Added product option to allow spool AND archive of documents to be selected in document link
            SIROPTMasterOptions(0, 70) = SIRHiddenOptions.SIROPTAllowSpoolAndArchive
            ...
            SIROPTMasterOptions(0, 71) = SIRHiddenOptions.SIROPTAllowPartialAllocationOnInsurer
            ...
            SIROPTMasterOptions(0, 72) = SIRHiddenOptions.SIROPTEnhancedChequeProduction
            ...
            SIROPTMasterOptions(0, 73) = SIRHiddenOptions.SIROPTMtaPolicyNumberLock
            SIROPTMasterOptions(1, 73) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 73) = ""
            SIROPTMasterOptions(3, 73) = ""
            SIROPTMasterOptions(4, 73) = "Mta Policy Number Lock"
            SIROPTMasterOptions(5, 73) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 74) = SIRHiddenOptions.SIROPTShowRiskIndexSearchOnFindInsuranceFile
            SIROPTMasterOptions(1, 74) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 74) = ""
            SIROPTMasterOptions(3, 74) = ""
            SIROPTMasterOptions(4, 74) = "Show risk index search on Find Insurance File"
            SIROPTMasterOptions(5, 74) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 75) = SIRHiddenOptions.SIROPTPolicyPackagesEnabled
            SIROPTMasterOptions(1, 75) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 75) = ""
            SIROPTMasterOptions(3, 75) = ""
            SIROPTMasterOptions(4, 75) = "Enable Policy Packages"
            SIROPTMasterOptions(5, 75) = "0 for OFF, 1 for ON"

            'SIROPTMasterOptions(0, 76) = SIROPTrueMonthlyPoliciesEnabled
            'SIROPTMasterOptions(1, 76) = SIRBCHHeadOffice
            'SIROPTMasterOptions(2, 76) = ""
            'SIROPTMasterOptions(3, 76) = ""
            'SIROPTMasterOptions(4, 76) = "" '"Enable True Montly Policies"
            'SIROPTMasterOptions(5, 76) = "" '"0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 77) = SIRHiddenOptions.SIROPTM9PartyCodeFormat
            SIROPTMasterOptions(1, 77) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 77) = ""
            SIROPTMasterOptions(3, 77) = ""
            SIROPTMasterOptions(4, 77) = "Enable M9 format for Party Code"
            SIROPTMasterOptions(5, 77) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 78) = SIRHiddenOptions.SIROPTS4IMotorDataModelEnabled
            SIROPTMasterOptions(1, 78) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 78) = ""
            SIROPTMasterOptions(3, 78) = ""
            SIROPTMasterOptions(4, 78) = "Enable S4I Motor Data Model Template"
            SIROPTMasterOptions(5, 78) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 79) = SIRHiddenOptions.SIROPTS4IHouseholdDataModelEnabled
            SIROPTMasterOptions(1, 79) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 79) = ""
            SIROPTMasterOptions(3, 79) = ""
            SIROPTMasterOptions(4, 79) = "Enable S4I Household Data Model Template"
            SIROPTMasterOptions(5, 79) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 80) = SIRHiddenOptions.SIROPTS4ICommercialCombinedDataModelEnabled
            SIROPTMasterOptions(1, 80) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 80) = ""
            SIROPTMasterOptions(3, 80) = ""
            SIROPTMasterOptions(4, 80) = "Enable S4I Commercial Combined Data Model Template"
            SIROPTMasterOptions(5, 80) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 81) = SIRHiddenOptions.SIROPTS4IMarineDataModelEnabled
            SIROPTMasterOptions(1, 81) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 81) = ""
            SIROPTMasterOptions(3, 81) = ""
            SIROPTMasterOptions(4, 81) = "Enable S4I Marine Data Model Template"
            SIROPTMasterOptions(5, 81) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 82) = SIRHiddenOptions.SIROPTS4IMedicalMalpracticeDataModelEnabled
            SIROPTMasterOptions(1, 82) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 82) = ""
            SIROPTMasterOptions(3, 82) = ""
            SIROPTMasterOptions(4, 82) = "Enable S4I Fleet Data Model Template"
            SIROPTMasterOptions(5, 82) = "0 for OFF, 1 for ON"

            'AON Insurer Payment Import
            SIROPTMasterOptions(0, 83) = SIRHiddenOptions.SIROPTAONInsurerPaymentImport
            SIROPTMasterOptions(1, 83) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 83) = ""
            SIROPTMasterOptions(3, 83) = ""
            SIROPTMasterOptions(4, 83) = "AON Insurer Payment Import"
            SIROPTMasterOptions(5, 83) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, 84) = SIRHiddenOptions.SIROPTAllowDataModelSAMAccess
            SIROPTMasterOptions(1, 84) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, 84) = ""
            SIROPTMasterOptions(3, 84) = ""
            SIROPTMasterOptions(4, 84) = "Allow Data Models the option to be Accessible Via SAM"
            SIROPTMasterOptions(5, 84) = "0 for OFF, 1 for ON"

            'S4BDAT003 DATASURE
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = SIRHiddenOptions.SIROPTEnhancedAccountingBasis
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = "Enable Enhanced Accounting Basis"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnhancedAccountingBasis) = "0 for OFF, 1 for ON"

            'S4BDAT002 DATASURE
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTNewZealandConfiguration) = SIRHiddenOptions.SIROPTNewZealandConfiguration
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTNewZealandConfiguration) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTNewZealandConfiguration) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTNewZealandConfiguration) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTNewZealandConfiguration) = "Enable New Zealand Configuration"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTNewZealandConfiguration) = "0 for OFF, 1 for ON"

            'Float Balance and Pre-Payment
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnablePayNowOptions) = SIRHiddenOptions.SIROPTEnablePayNowOptions
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnablePayNowOptions) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnablePayNowOptions) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnablePayNowOptions) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnablePayNowOptions) = "Enable Pre Payment Functionality"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnablePayNowOptions) = "0 for OFF, 1 for ON"

            'Reinsurance QBE
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableRI2007) = SIRHiddenOptions.SIROPTEnableRI2007
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableRI2007) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableRI2007) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableRI2007) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableRI2007) = "RI 2007 Enabled"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableRI2007) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = SIRHiddenOptions.SIROPTMultiCoRestrictClientView
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = "Multi Company Restrict Client View"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTMultiCoRestrictClientView) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = ""

            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = "Multi Company Work Manager Restriction"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTMultiCoWorkManagerTaskRestriction) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = "Sirius Quotes Branch Level Policy Numbers"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTSiriusQuoteBranchLevelPolicyNumbers) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = SIRHiddenOptions.SIROPTEnableTaxPostingsRollup
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = "Enable Tax Postings Rollup"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableTaxPostingsRollup) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = "Lock Policy Number on Scheme MTA's"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTSchemeMtaPolicyNumberLock) = "0 for Don't Allow, 1 for Allow"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = "Show Risk Index Search on Find Insurance Screen"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTFindInsuranceFileRiskIndexSearch) = "0 for Don't Allow, 1 for Allow"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTHcPbChanges) = SIRHiddenOptions.SIROPTHcPbChanges
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTHcPbChanges) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTHcPbChanges) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTHcPbChanges) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTHcPbChanges) = "Hall and Clarke Product Builder Changes"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTHcPbChanges) = "0 for Don't Allow, 1 for Allow"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = "Auto-Allocate during Claim Payment Workflow"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTAutoAllocateduringClaimPaymentWorkflow) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = "Add Documaster folder per insurance-ref"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTAddDocumasterFolderPerInsuranceRef) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = SIRHiddenOptions.SIROPTEnableUniqueDocumentReference
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = "Enable Unique Document Reference"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableUniqueDocumentReference) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTDisablePDFenhancement) = SIRHiddenOptions.SIROPTDisablePDFenhancement
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTDisablePDFenhancement) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTDisablePDFenhancement) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTDisablePDFenhancement) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTDisablePDFenhancement) = "Disable PDF enhancement"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTDisablePDFenhancement) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = SIRHiddenOptions.SIROPTMultipleRetainedTreaty
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = "Multiple Retained Treaty"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTMultipleRetainedTreaty) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = SIRHiddenOptions.SIROPTSubAgentCertificateYears
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = "Enable Certificate Years"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTSubAgentCertificateYears) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = SIRHiddenOptions.SIROTPRestrictAllocationReversal
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = "Restrict Allocation Reversal"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROTPRestrictAllocationReversal) = "0 for OFF, 1 for ON"

            ' E007
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableRIRegeneration) = SIRHiddenOptions.SIROPTEnableRIRegeneration
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableRIRegeneration) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableRIRegeneration) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableRIRegeneration) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableRIRegeneration) = "Enable RI Regeneration"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableRIRegeneration) = "0 for OFF, 1 for ON"

            ' WPR53
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = SIRHiddenOptions.SIROPTEnable6DPGISPercentage
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = "Enable 6DP GIS percentage field"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnable6DPGISPercentage) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableDebitOrder) = SIRHiddenOptions.SIROPTEnableDebitOrder
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableDebitOrder) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableDebitOrder) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableDebitOrder) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableDebitOrder) = "Enable Debit Order"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableDebitOrder) = "0 for OFF, 1 for ON"

            ' WPR100
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = "Override Portfolio Transfer Validations"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTOverridePortfolioTransferValidations) = "0 for OFF, 1 for ON"

            ' E001
            SIROPTMasterOptions(0, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries
            SIROPTMasterOptions(1, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = ""
            SIROPTMasterOptions(3, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = ""
            SIROPTMasterOptions(4, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = "Enable RI Payments/Recoveries"
            SIROPTMasterOptions(5, SIRHiddenOptions.SIROPTEnableRIPaymentsRecoveries) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = "Enable External Workflow System"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIRROPTEnableExternalWorkflowSystem) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = "Enable Editing in Claim Reinsurance"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIROPTEnableClaimRIEditing) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = "Enable Decimals Suppression"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIROPTEnableDecimalsSuppression) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = "Enable Geospatial Functionality"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIROPTEnableGeospatialFunctionality) = "0 for OFF, 1 for ON"


            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = "Post Instalment WriteOff As Full Document"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIRROPTPostInstalmentWriteOffAsFullDocument) = "0 for OFF, 1 for ON"


            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = "Cloud Hosting"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting) = "0 for OFF, 1 for ON"

            SIROPTMasterOptions(0, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA
            SIROPTMasterOptions(1, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = SIRBCHHeadOffice
            SIROPTMasterOptions(2, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = ""
            SIROPTMasterOptions(3, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = ""
            SIROPTMasterOptions(4, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = "Copy All Risks During MTA"
            SIROPTMasterOptions(5, gPMConstants.SIRHiddenOptions.SIROPTCopyRiskInMTA) = "0 for OFF, 1 for ON"
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            ' gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="populateArray failed", vApp:="SharedFiles", vClass:=ACClass, vMethod:="populateArray", excep:=excep)
    ...
    '
    '*******************************************************'
    Function SIRDateType(ByVal v_vDate As Object) As SIREDateType
        ...
        Try
            ...
            If Convert.IsDBNull(v_vDate) Or (v_vDate Is Nothing) Then
                Return SIREDateType.sireNullDate
            Else
                Dim dateTime As DateTime = Nothing
                If DateTime.TryParse(v_vDate, dateTime) Then
    ...
    Public Function FindVarField(ByRef sRecordName As String, ByRef sFieldName As String, ByRef vVarDataBlock(,) As Object, ByRef lPosition As Integer) As Integer
        ...
        Try
            ...
            If Not (vVarDataBlock Is Nothing) Then
