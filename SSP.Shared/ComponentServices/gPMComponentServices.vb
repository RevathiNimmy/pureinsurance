Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("gPMComponentServices_NET.gPMComponentServices")>
Public Module gPMComponentServices
    ...
    Public Function CheckDatabase(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_lPMProductFamily As Integer, ByRef r_bNewInstanceCreated As Boolean, ByRef r_oCheckedDatabase As Object, Optional ByVal v_vDatabase As dPMDAO.Database = Nothing) As Integer
        ...
        If bNewInstanceRequired Then
            ...
            lReturn = CType(NewDatabase(v_sUsername:=ToSafeString(v_sUsername), v_iSourceID:=ToSafeInteger(v_iSourceID), v_iLanguageID:=ToSafeInteger(v_iLanguageID), v_lPMProductFamily:=v_lPMProductFamily, r_oDatabase:=r_oCheckedDatabase), gPMConstants.PMEReturnCode)
...
Err_CheckDatabase:
        ...
        gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to check Database for DSN - ", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckDatabase", excep:=New Exception(Information.Err().Description & " Position = " & sPosInFunction), oDicParms:=oDict)
        Return result
    End Function
    ...
    Public Function NewDatabase(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_lPMProductFamily As Integer, ByRef r_oDatabase As dPMDAO.Database) As Integer
        ...
        Try
            ...
            Return r_oDatabase.OpenDatabase(sSiriusUsername:=ToSafeString(v_sUsername), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), sCallingAppName:=ACApp)
        Catch
        End Try
        result = gPMConstants.PMEReturnCode.PMError
        r_oDatabase = Nothing
        ...
        oDict.Add("v_iSourceID", v_iSourceID)
        oDict.Add("v_iLanguageID", v_iLanguageID)
        gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create a new instance of PMDAO for DSN - " & sDSN, vApp:=ACApp, vClass:=ACClass, vMethod:="NewDatabase", excep:=New Exception(Information.Err().Description), oDicParms:=oDict)
        Return result
    End Function
    ...
    Public Function CreateBusinessObject(ByRef r_oObject As Object, ByVal v_sClassName As String, ByVal v_sCallingAppName As String, ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, Optional ByVal v_oDatabase As dPMDAO.Database = Nothing) As Integer
        ...
        Try
            ...
            r_oObject = bPMFunc.CreateLateBoundObject(v_sClassName)
            ...
            If v_oDatabase Is Nothing Then
                ...
                'lReturnCode = CType(r_oObject, SSP.S4I.Interfaces.IBusiness).Initialise(sUserName:=ToSafeString(v_sUsername), sPassword:=ToSafeString(v_sPassword), iUserID:=ToSafeInetger(v_iUserID), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), iCurrencyID:=v_iCurrencyID, iLogLevel:=v_iLogLevel, sCallingAppName:=v_sCallingAppName)
                lReturnCode = r_oObject.Initialise(sUserName:=ToSafeString(v_sUsername), sPassword:=ToSafeString(v_sPassword), iUserID:=ToSafeInteger(v_iUserID), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), iCurrencyID:=ToSafeInteger(v_iCurrencyID), iLogLevel:=ToSafeInteger(v_iLogLevel), sCallingAppName:=ToSafeString(v_sCallingAppName))

            Else
                ' Yes, so Initialise with

                lReturnCode = r_oObject.Initialise(sUserName:=ToSafeString(v_sUsername), sPassword:=ToSafeString(v_sPassword), iUserID:=ToSafeInteger(v_iUserID), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), iCurrencyID:=ToSafeInteger(v_iCurrencyID), iLogLevel:=ToSafeInteger(v_iLogLevel), sCallingAppName:=ToSafeString(v_sCallingAppName), vDatabase:=CType(v_oDatabase, dPMDAO.Database))
            End If
        ...
        Catch excep As System.Exception
            ...
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create object instance (" & v_sClassName & ")", vApp:=ACApp, vClass:=ACClass, vMethod:="CreateBusinessObject", excep:=excep, oDicParms:=oDict)
    ...
    Public Function UpdateUserProperty(ByVal v_sUsername As String, ByVal v_sPropertyName As String, ByVal v_vPropertyValue As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Update Property Named - " & v_sPropertyName, vApp:=ACApp, vClass:=ACClass, vMethod:="UpdateUserProperty", excep:=excep)
    ...
    Public Function GetUserProperty(ByVal v_sUsername As String, ByVal v_sPropertyName As String, ByRef r_vPropertyValue As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Get Property Named - " & v_sPropertyName, vApp:=ACApp, vClass:=ACClass, vMethod:="GetUserProperty", excep:=excep)
    ...
    Public Function DeleteUserProperty(ByVal v_sUsername As String, ByVal v_sPropertyName As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Get Property Named - " & v_sPropertyName, vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteUserProperty", excep:=excep)
    ...
    Public Function calccombinedkey(ByVal v_lSourceID As Integer, ByVal v_lKeyID As Integer, ByRef r_lCombinedKeyID As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            oDict.Add("v_lKeyID", v_lKeyID)
            oDict.Add("r_lCombinedKeyID", r_lCombinedKeyID)
            gPMFunctions.LogMessageToFile(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Unable to calculate a combined key for SourceID - " & v_lSourceID &
    ...
    Public Function CheckPMProductInstalled(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_lPMProductFamily As Integer, ByRef r_bInstalled As Boolean) As Integer
        ...
        Try
            ...
            lReturn = CType(NewDatabase(v_sUsername:=ToSafeString(v_sUsername), v_iSourceID:=ToSafeInteger(v_iSourceID), v_iLanguageID:=ToSafeInteger(v_iLanguageID), v_lPMProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusArchitecture, r_oDatabase:=oDatabase), gPMConstants.PMEReturnCode)
        ...
        Catch excep As System.Exception
            ...
            oDict.Add("v_iSourceID", v_iSourceID)
            oDict.Add("v_iLanguageID", v_iLanguageID)
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to check Product Installation for Product Code - " & sPMProductCode, vApp:=ACApp, vClass:=ACClass, vMethod:="CheckPMProductInstalled", excep:=excep, oDicParms:=oDict)
    ...
    Public Function GetSysAdminAccessStatus(ByVal v_sUsername As String, ByVal v_iUserID As Integer, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByRef lStatus As Integer, ByRef oDatabase As dPMDAO.Database) As Integer
        ...
        Catch excep As System.Exception
            ...
            oDict.Add("v_iSourceID", v_iSourceID)
            oDict.Add("v_iLanguageID", v_iLanguageID)
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSysAdminAccessStatus Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSysAdminAccessStatus", excep:=excep, oDicParms:=oDict)
    ...
    Private Function UpdateProperty(ByVal v_sGroupName As String, ByVal v_sPropertyName As String, ByVal v_vPropertyValue As Object) As Integer
        ...
        oPM = bPMFunc.CreateLateBoundObject("bPMPropertyManager.BusinessXML")
        ...
        lReturn = oPM.UpdateProperty(v_sGroupName:=v_sGroupName.ToString, v_sPropertyName:=v_sPropertyName.ToString, v_vPropertyValue:=v_vPropertyValue)
        If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
    ...
    Public Function NewDeleteAllUserProperties(ByVal v_sUsername As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Delete All Properties for User - " & v_sUsername, vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteAllUserProperties", excep:=excep)
    ...
    Public Function NewDeleteProperty(ByVal v_sGroupName As String, ByVal v_sPropertyName As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            'gPMFunctions.LogMessageToFile(sUsername:=ToSafeString(v_sUsername), iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Delete Property Value : " & v_sGroupName & "." & v_sPropertyName, vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteProperty", vErrNo:=CStr(Information.Err().Number), vErrDesc:=excep.Message)
    ...
    Private Function GetProperty(ByVal v_sGroupName As String, ByVal v_sPropertyName As String, ByRef r_vPropertyValue As Object) As Integer
        ...
        lReturn = oPM.GetProperty(v_sGroupName:=v_sGroupName.ToString, v_sPropertyName:=v_sPropertyName.ToString, r_vPropertyValue:=r_vPropertyValue)
        If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
    ...
    Private Function DeleteProperty(ByVal v_sGroupName As String, ByVal v_sPropertyName As String) As Integer
        ...
        lReturn = oPM.DeleteProperty(v_sGroupName:=v_sGroupName.ToString, v_sPropertyName:=v_sPropertyName.ToString)
        If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
    ...
    Private Function DeleteGroup(ByVal v_sGroupName As String) As Integer
        ...
        lReturn = oPM.DeleteGroup(v_sGroupName:=v_sGroupName.ToString)
        If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
