...
<System.Runtime.InteropServices.ProgId("iGISSharedConstants_NET.iGISSharedConstants")>
Public Module iGISSharedConstants
    ' ***************************************************************** '
    ...
    Public Const GISDataTypeCode As Integer = 23
    Public Const GISDataTypeInteger As Integer = 24
    ...
    Public Const GISRegStateFilesPathAlternative As String = "StateFilesPathAlternative" ' SPW190902
    ...
    Public Const GISRegLoadSaveDBModeFastWithQuotesXML As Integer = 4
    ' RFC310701
    ...
    Public Const GISObjColIsSelectScreen As Integer = 8
    Public Const GISObjColIsNonGIS As Integer = 9
    Public Const GISObjColEditFlags As Integer = 10

    ' RDT - Reordered and added Edit Flags value
    ...
    Public Const GISPropColPolarisPropId As Integer = 8
    Public Const GISPropColEditFlags As Integer = 9
    Public Const GISPropColSpecialsType As Integer = 10
    Public Const GISPropColSpecialsTypeReference As Integer = 11
    ' List ID is same as Specials Type Reference
    Public Const GISPropColListId As Integer = 11
    ...
    'SPW Datacash Address Array Constants - 190704
    Public Const GISDatacashAddressHouseNo As Integer = 0
    Public Const GISDatacashAddressStreet As Integer = 1
    Public Const GISDatacashAddressTown As Integer = 2
    Public Const GISDatacashAddressCounty As Integer = 3
    Public Const GISDatacashAddressPostcode As Integer = 4
    ...
    Public Const ACDataSetDTXSDSuffix As String = "DTXSD"
    ...
    'RDT Constants for the SpecialTypes
    Public Const ACSpecialsTypeSumsInsured As Integer = 4
    Public Const ACSpecialsTypeStandardWordings As Integer = 5

    'RDT Constants for the SumsInsuredType
    Public Const ACSumsInsuredTypeHighVal As Integer = 1
    ...
    Public Function GISToPMDataType(ByVal v_iGISDataType As Integer, ByRef r_iPMDataType As Integer) As Integer
        ...
        Try
            ...
            Select Case v_iGISDataType
                ...
                Case GISDataTypeShortList, GISDataTypeLongList, GISDataTypeText, GISDataTypeComment
        ...
        Try
            ...
            If v_sSearchCharType = "C" Then
                ...
                Do While iCharPosition > 0
                    ...
                    'iCharPosition = (iCharPosition + iReplaceStringLength, r_sString, v_vSearchChar)
                    iCharPosition = r_sString.IndexOf(v_vSearchChar, iCharPosition + iReplaceStringLength)
                Loop
            ...
            ElseIf v_sSearchCharType = "A" Then
                ...
                If r_sString.Length > 0 Then
                    ...
                    For iCharPosition = 1 To r_sString.Length
                        If AscW(Mid(r_sString, iCharPosition, 1)(0)) = ToSafeDouble(v_vSearchChar) Then
    ...
    ' ***************************************************************** '
    ' Name: GetStateFilesPathAlternative
    '
    ' Description:
    '
    ' SPW170902 - Created
    ' ***************************************************************** '
    Public Function GetStateFilesPathAlternative(ByRef r_sStateFilesPathAlternative As String) As Integer
        ...
        Try
            ...
            lReturn = CType(gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLClient, v_sSettingName:=GISRegStateFilesPathAlternative, r_sSettingValue:=r_sStateFilesPathAlternative, v_sSubKey:=GISRegSubKey), gPMConstants.PMEReturnCode)


            If r_sStateFilesPathAlternative.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to find State Files Path (" & GISRegStateFilesPathAlternative & ") Registry Setting.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetStateFilesPathAlternative")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            If Not r_sStateFilesPathAlternative.EndsWith("\") Then
                r_sStateFilesPathAlternative = r_sStateFilesPathAlternative & "\"
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetStateFilesPathAlternativeFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetStateFilesPathAlternative", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    ' ***************************************************************** '
    ' Name: SetStateFilesPath
    '
    ' Description:
    '
    ' SPW190202 - Created
    ' ***************************************************************** '
    Public Function SetStateFilesPath(ByRef r_sStateFilesPath As String) As Integer
        ...
        Try
            ...
            lReturn = CType(gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLClient, v_sSettingName:=GISRegStateFilesPath, v_sSettingValue:=r_sStateFilesPath, v_sSubKey:=GISRegSubKey), gPMConstants.PMEReturnCode)


            If r_sStateFilesPath.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to find State Files Path (" & GISRegStateFilesPath & ") Registry Setting.", vApp:=ACApp, vClass:=ACClass, vMethod:="SetStateFilesPath")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetStateFilesPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="SetStateFilesPath", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    ' ***************************************************************** '
    ' Name: SetStateFilesPathAlternative
    '
    ' Description:
    '
    ' SPW190202 - Created
    ' ***************************************************************** '
    Public Function SetStateFilesPathAlternative(ByRef r_sStateFilesPathAlternative As String) As Integer
        ...
        Try
            ...
            lReturn = CType(gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLClient, v_sSettingName:=GISRegStateFilesPathAlternative, v_sSettingValue:=r_sStateFilesPathAlternative, v_sSubKey:=GISRegSubKey), gPMConstants.PMEReturnCode)


            If r_sStateFilesPathAlternative.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to find State Files Path (" & GISRegStateFilesPathAlternative & ") Registry Setting.", vApp:=ACApp, vClass:=ACClass, vMethod:="SetStateFilesPathAlternative")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetStateFilesPathAlternativeFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="SetStateFilesPathAlternative", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    ' ***************************************************************** '
    ' Name: GetDataSetDTXSDFileName
    '
    ' Description: Calculates the Location and File Name of the XML
    '              files for a given Data Model.
    '
    ' ***************************************************************** '
    Public Function GetDataSetDTXSDFileName(ByVal v_sDataModelCode As String, ByRef r_sDataSetDTXSDFile As String) As Integer
        ...
        Try
            ...
            ' MUST have a Data Model Code
            If v_sDataModelCode.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetDTXSDFileName", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetDTXSDFileName")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            r_sDataSetDTXSDFile = sPath & v_sDataModelCode.Trim().ToUpper() & ACDataSetDTXSDSuffix & ACXSDFileExtension
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetDTXSDFileNameFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetDTXSDFileName", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
