Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("PBGetAddressFromAddressCnt_NET.PBGetAddressFromAddressCnt")>
Public Module PBGetAddressFromAddressCnt
    ...
    Public Function GetAddressFromAddressCnt(ByRef r_oDatabase As Object, ByVal lAddressCnt As String, ByRef vAddressArray(,) As Object) As Integer
        ...
        Try
            ...
            sSQL = ""
            sSQL = sSQL & "SELECT a.address_cnt, a.address1, a.address2, a.address3, a.address4, a.postal_code, c.description, a.address_id" & Strings.ChrW(13) & Strings.ChrW(10)
            sSQL = sSQL & "FROM address a, country c" & Strings.ChrW(13) & Strings.ChrW(10)
            sSQL = sSQL & "WHERE a.country_id = c.country_id" & Strings.ChrW(13) & Strings.ChrW(10)
            sSQL = sSQL & "AND a.address_cnt = " & lAddressCnt & Strings.ChrW(13) & Strings.ChrW(10)

            r_oDatabase.SQLSelect(sSQL:=ToSafeString(sSQL), sSQLName:=ACGetAddressName, bStoredProcedure:=ACGetAddressStored, vResultArray:=CType(vAddressArray, Object))
