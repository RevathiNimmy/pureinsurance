...
Public Module DOCGeneralFunc
    ...
    'Public Function GetDOCRegSettings(Optional ByRef vTimerInterval As Object = Nothing, Optional ByRef vHistoryRoot As Object = Nothing, Optional ByRef vScanDirectory As Object = Nothing, Optional ByRef bOverWrite As Boolean = False, Optional ByRef hWndParent As Integer = 0, Optional ByRef bKofaxOrTwain As Boolean = False) As gPMConstants.PMEReturnCode

    '    Dim result As gPMConstants.PMEReturnCode = gPMConstants.PMEReturnCode.PMFalse
    '    Dim sTmp As String = ""
    '    Dim iButton As Integer
    '    Dim bMultipleRoots As Boolean
    '    Dim sSelectBoxTitle As String
    '    Dim sDriveKey As String = ""
    ...
    '            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCTimerIntervalKey, r_sSettingValue:=sTmp, v_sSubKey:=DOCDaemonSection)
    ...
    '                m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCTimerIntervalKey, v_sSettingValue:=vTimerInterval, v_sSubKey:=DOCDaemonSection)
    ...
    '                    ' Log Error Message
    '                    bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Timer Interval", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    '            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCHistoryRootKey, r_sSettingValue:=sTmp, v_sSubKey:=DOCDaemonSection)
    ...
    '                m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCMultipleHistoryRootKey, r_sSettingValue:=sTmp, v_sSubKey:=DOCDaemonSection)
    ...
    '                    m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCMultipleHistoryNextDriveKey, v_sSettingValue:="Drive1", v_sSubKey:=DOCMultipleHistoryRootSection)
    ...
    '                        If iCounter = 1 Then
    '                            m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCHistoryRootKey, v_sSettingValue:=vHistoryRoot, v_sSubKey:=DOCDaemonSection)
    ...
    '                                ' Log Error Message
    '                                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Journal Root", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    '                            m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=sDriveKey, v_sSettingValue:=vHistoryRoot, v_sSubKey:=DOCMultipleHistoryRootSection)
    ...
    '                                ' Log Error Message
    '                                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Multiple Journal Root", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    '            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCScanDirKey, r_sSettingValue:=sTmp, v_sSubKey:=DOCScanSection)
    ...
    '                'Save to the registry
    '                m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCScanDirKey, v_sSettingValue:=vScanDirectory, v_sSubKey:=DOCScanSection)
    ...
    '                    ' Log Error Message
    '                    bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Scan Directory", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    '        If Not False Then
    '            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCTwainSettingsKey, r_sSettingValue:=sTmpKofaxOrTwain, v_sSubKey:=DOCKofaxOrTwain)
    ...
    '            End If
    '            'Save to the registry
    '            m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCTwainSettingsKey, v_sSettingValue:=CStr(bKofaxOrTwain), v_sSubKey:=DOCKofaxOrTwain)
    ...
    '                ' Log Error Message
    '                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Kofax or Twain Setting", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    '        ' Log Error Message
    '        bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=gPMConstants.PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function CopyFile(ByRef sFileIn As String, ByRef sFileOut As String) As Integer
        ...
        Try
            ...
            File.Copy(sFileIn, sFileOut, True)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to copy file '" & sFileIn & "' to '" & sFileOut & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="CopyFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function RmDirectory(ByRef sDirectory As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to remove directory " & sDirectory, vApp:=ACApp, vClass:=ACClass, vMethod:="RmDirectory", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function KillFile(ByRef sFile As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to delete file " & sFile, vApp:=ACApp, vClass:=ACClass, vMethod:="KillFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)

            Return result

        End Try
    End Function
    'This is from MSDN tip to remove a path
    'The following program will delete all the files in a directory.
    'Note that in this example it is assumed that a directory named
    'TEST exists on drive C. All files, including nested subdirectories and
    'their files, will be removed from disk with this program.
    Public Function KillDir(ByRef DirName As String) As Integer
        Dim result As Integer = 0
        Const ATTR_NORMAL As FileAttribute = FileAttribute.Normal
        Const ATTR_DIRECTORY As FileAttribute = FileAttribute.Directory
        ...
        Try
            ...
            FileName = FileSystem.Dir("*.*", ATTR_NORMAL)
            Do While FileName <> ""
            ...
            Do
                FileName = FileSystem.Dir("*.*", ATTR_DIRECTORY)
                ...
                KillDir(FileName)
            Loop
            Directory.SetCurrentDirectory("E:\TEMP") 'OriginalDir
            Directory.Delete(DirName)
            Return result

        Catch excep As System.Exception

            'Debug.WriteLine(TabLayout(excep.Message, Information.Err().Number, DirName))
            result = gPMConstants.PMEReturnCode.PMFalse
    ...
    Public Function BrowseFolder(ByRef sFolder As String, ByRef sTitle As String, ByRef hWndParent As Integer) As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            Else
                ...
                sBuffer = sBuffer.Substring(0, sBuffer.IndexOf(Strings.ChrW(0)))
                sFolder = sBuffer
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=gPMConstants.PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="BrowseFolder", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    'Public Function ChangeDOCRegSettings(Optional ByRef vTimerInterval As Object = Nothing, Optional ByRef vHistoryRoot As Object = Nothing, Optional ByRef vScanDirectory As Object = Nothing, Optional ByRef hWndParent As Integer = 0) As gPMConstants.PMEReturnCode
    ...
    '        sMsg = "Your settings are as follows:" & Strings.ChrW(10).ToString() & Strings.ChrW(10).ToString()
    ...
    '        If Not Information.IsNothing(vTimerInterval) Then
    '            sMsg = sMsg & DOCTimerIntervalKey & " = " & vTimerInterval & " Minutes." & Strings.ChrW(10).ToString()
    '        End If

    '        'history root

    '        If Not Information.IsNothing(vHistoryRoot) Then
    '            sMsg = sMsg & DOCHistoryRootKey & " = '" & vHistoryRoot & "'" & Strings.ChrW(10).ToString()
    '        End If

    '        'Scan Directory

    '        If Not Information.IsNothing(vScanDirectory) Then
    '            sMsg = sMsg & DOCScanDirKey & " = '" & vScanDirectory & "'" & Strings.ChrW(10).ToString()
    '        End If

    '        sMsg = sMsg & Strings.ChrW(10).ToString() & "Do you wish to make changes ?"
    ...
    '            sMsg = "Your new settings are as follows:" & Strings.ChrW(10).ToString() & Strings.ChrW(10).ToString()
    ...
    '        ' Log Error Message
    '        bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=gPMConstants.PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="ChangeDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    '        Return result
    ...
    Public Function MakePath(ByRef sPath As String) As Integer
        ...
        Try
            ...
            If gPMFunctions.NullToString(cloudHostingOptionValue) = "1" Then
                'Only allow \tmp\ path to be created 
                If Not sPath.Contains("\tmp\") Then
                    Return result
                End If
            End If
            ...
            For I As Integer = iStart To sPath.Length
                ...
                Else
                    Directory.CreateDirectory(sNextDir)
                    sNextDir = sNextDir & "\"
                End If
            Next I
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Make Path: " & sPath, vApp:=ACApp, vClass:=ACClass, vMethod:="MakePath", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetFileName(ByRef sFullPath As String, ByRef sFile As String, ByRef sDir As String) As Integer
        ...
        Try
            ...
            If (I < iMinPathLen) Or (I = iLen) Then
                ...
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get file name from '" & sFullPath & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFileName", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get file name from '" & sFullPath & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFileName", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    'JH200599 this is now in bPMFunc
    '' ***************************************************************** '
    '' Name: ValidateSQL
    ''
    ...
    '' ***************************************************************** '
    ''
    'Public Function ValidateSQL(sSQLStatement As String) As Long
    '
    '' sp todo - remove thsi - only temp till it goes in pmdao
    '
    'Dim I As Integer
    'Dim sTmpSQL As String
    '
    '
    '    On Error GoTo Err_ValidateSQL
    '
    '    ValidateSQL = PMTrue
    '
    ...
    '                    LogMessage _
    ''                        iType:=PMLogError, _
    ''                        sMsg:="Invalid SQL - " & sSQLStatement$, _
    ''                        vApp:=ACApp, _
    ''                        vClass:=ACClass, _
    ''                        vMethod:="ValidateSQL", _
    ''                        vErrNo:=Err.Number, _
    ...
    '                If Mid$(sSQLStatement, I, 1) = "'" Then
    '
    '                    sTmpSQL = sTmpSQL & "''"
    '
    '                Else
    '
    '                    sTmpSQL = sTmpSQL & Mid$(sSQLStatement, I, 1)
    '
    '                End If
    '
    '            Next I%
    ...
    '        'Log to File
    '        bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:=gPMConstants.PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="ExtractNumFromKey", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function LogMessageScan(ByRef iType As Integer, ByRef sMsg As String, Optional ByRef vApp As Object = Nothing, Optional ByRef vClass As Object = Nothing, Optional ByRef vMethod As Object = Nothing, Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing, Optional ByRef bStandAlone As Boolean = False) As Integer
        ...
        Try
            ...
            Else
                ...
                bPMFunc.LogMessage(sUsername:="", iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, vErrNo:=vErrNo, vErrDesc:=vErrDesc)
    ...
    Private Function GetFilenameFromPath(ByRef sPath As String, ByRef sFilename As String) As Integer
        ...
        If iLen = 0 Then
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetFilenameFromPath passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFilenameFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Private Function GetDirectoryFromPath(ByRef sPath As String, ByRef sDirectory As String) As gPMConstants.PMEReturnCode
        ...
        If iLen = 0 Then
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromPath passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get filename from path.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Private Function GetDirectoryFromUNC(ByRef sUNC As String, ByRef sDirectory As String) As Integer
        ...
        If iLen = 0 Then
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromUNC passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromUNC", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If

        If Not sUNC.StartsWith("\\") Then
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromUNC not passed a UNC path.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromUNC", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Private Function MakeDirectory(ByRef sDirectory As String) As Integer
        ...
        Dim sDriveLetter As New StringsHelper.FixedLengthString(2)
        Dim sPath As String = ""
    ...
    Public Function CacheFile(ByRef oZipper As Object, ByRef sFilename As String, ByRef sNewFilename As String, ByRef sCachePath As String, Optional ByRef bZipped As Boolean = False) As Integer
        ...
        Try
            ...
            Dim cloudHostingOptionValue As String = ""
            m_lReturn = bPMFunc.getProductOptionValue(v_sUsername:="", v_sPassword:="", v_iUserID:=0, v_iMainSourceID:=0, v_iLanguageID:=0, v_iCurrencyID:=0, v_iLogLevel:=0, v_sCallingAppName:="", v_vOptionNumber:=gPMConstants.SIRHiddenOptions.SIROPTEnableCloudHosting, v_vBranch:=1, r_vUnderwriting:=cloudHostingOptionValue)
            Dim cloudHostingEnabled As Boolean = (gPMFunctions.NullToString(cloudHostingOptionValue) = "1")
            Dim s3FileName = sTarget.Replace("\", "/")

            sTarget = sCachePath & sTarget

            ' Check that it isnt cached already
            If FileSystem.Dir(sTarget, FileAttribute.Normal) = "" Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error.
                    result = gPMConstants.PMEReturnCode.PMFalse
                    bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromPath process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                    Return result
                End If
                sDocFinalPath = sTemp
                ' make the directory
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error.
                    result = gPMConstants.PMEReturnCode.PMFalse
                    bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="MakeDirectory process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                    Return result
                End If
                ...
                If cloudHostingEnabled Then
                    ...
                    "")
                    result = repository.DownloadFileAsync(s3FileName, sDocFinalPath).Result
                ...
                If Not bZipped Then
                    ...
                    If Not cloudHostingEnabled Then
                        ' its not cached, cache it
                        m_lReturn = CopyFile(sFilename, sTarget)
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            ' Log Error.
                            result = gPMConstants.PMEReturnCode.PMFalse
                            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="CopyFile process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                            Return result
                        End If
                    End If
                Else
                    ...
                    'm_lReturn = oZipper.UnZipFile(sFilename, sTarget)
                    Dim bZipSuccess As Boolean = False
                    If cloudHostingEnabled Then
                        bZipSuccess = oZipper.UnZipFile(ToSafeString(sTarget), ToSafeString(sDocFinalPath))
                    Else
                        bZipSuccess = oZipper.UnZipFile(ToSafeString(sFilename), ToSafeString(sDocFinalPath))
                    End If
                    If Not bZipSuccess Then
                        ' Log Error.
                        result = gPMConstants.PMEReturnCode.PMFalse
                        bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="UnZipFile process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                        Return result
                    Else

                        Dim ofiles As String() = Directory.GetFiles(sDocFinalPath)
                        If ofiles IsNot Nothing AndAlso ofiles.Count > 0 Then
                            If String.IsNullOrEmpty(sExt) Then
                                sTarget = ofiles(0).ToString
                            Else
                                For iCounter As Integer = 0 To ofiles.Length
                                    If Mid(ofiles(iCounter).ToString, ofiles(iCounter).ToString.IndexOf("."), Len(ofiles(iCounter).ToString)).ToUpper = sExt.ToUpper Then
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="CacheFile process failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetDMEDIR(ByRef sDMEDir As String) As Integer
        ...
        Try
            ...
            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=DOCDMEDIRKey, r_sSettingValue:=sDMEDir)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get " & DOCDMEDIRKey & " from Registry", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDMEDIR", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:=gPMConstants.PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="GetDMEDIR", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetRegistryValue(ByRef sKey As String, ByRef sSubKey As String, ByRef sValue As String, ByRef iLocation As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=sKey, r_sSettingValue:=sValue, v_sSubKey:=sSubKey)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' oh no, error
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get value from the registry.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRegistryValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function SetRegistryValue(ByRef sKey As String, ByRef sSubKey As String, ByRef sValue As String, ByRef iLocation As Integer) As Integer
        ...
        Try
            ...
            ' Set the registry
            m_lReturn = gPMFunctions.SetPMRegSetting(v_lPMERegSettingRoot:=eRegSettingRoot, v_lPMEProductFamily:=eProductFamily, v_lPMERegSettingLevel:=eRegSettingLevel, v_sSettingName:=sKey, v_sSettingValue:=sValue, v_sSubKey:=sSubKey)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' oh no, error
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to set value in the registry.", vApp:=ACApp, vClass:=ACClass, vMethod:="SetRegistryValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '        ' Log Error Message
    '        bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetComboTextFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="SetComboText", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '              **** Note - this function must not be called from business
    '              components as it uses object manager to create other
    '              business components via Client Manager.
    '
    ...
    Public Function IsSiriusInstalled(ByRef r_bSiriusInstalled As Boolean) As Integer
        ...
        'Modified by Deepak Sharma on 4/20/2010 5:32:24 PM refer developer guide no. 101(Guide)
        ...
        Try
            ...
            oObjectManager = bPMFunc.CreateLateBoundObject("bObjectManager.ObjectManager")
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMCancel Then
                    ' Log Error Message
                    bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get instance of ObjectManager", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                End If
                Return result
            End If

            ' Get an instance of bDOCCommitServer
            Dim temp_oDocCommit As Object = Nothing
            m_lReturn = oObjectManager.GetInstance(temp_oDocCommit, "bDOCCommitServer.Commit", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            oDocCommit = temp_oDocCommit
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogInfo, sMsg:="Failed to get instance of bDOCCommitServer.Commit", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                Return result
            End If

            ' Get if Sirius is installed

            m_lReturn = oDocCommit.IsSBOInstalled(bInstalled:=ToSafeBoolean(r_bSiriusInstalled))
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogInfo, sMsg:="Failed to call IsSBOInstalled on oDocCommit", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                Return result
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="IsSiriusInstalled Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    '              **** Note - this function must not be called from business
    '              components as it uses object manager to create
    '              business components via Client Manager.
    '
    ' Edit History  :
    ...
    '                 2. Added the sUserName parameter to LogMessage
    ' ***************************************************************** '
    Public Function SetCacheStatus(ByRef bCacheDisabled As Boolean) As Integer
        ...
        'Modified by Deepak Sharma on 4/20/2010 5:32:39 PM refer developer guide no. 101(Guide)
        ...
        Try
            ...
            ' get object manager
            oObj = bPMFunc.CreateLateBoundObject("bObjectManager.ObjectManager")
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise Object Manager", vApp:=ACApp, vClass:=ACClass)
            ...
            m_lReturn = oObj.GetInstance(temp_oOptions, "bDOCOptions.form", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            oOptions = temp_oOptions

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create/initialise bDOCOptions.form", vApp:=ACApp, vClass:=ACClass)
            ...
            m_lReturn = oOptions.GetSetting(sTable:="DOC_System", sColumn:="cache_disabled", sValue:=ToSafeString(sValue))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get cache enabled/disabled status", vApp:=ACApp, vClass:=ACClass, vMethod:="SetCacheStatus", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
            Return result
    ...
    Public Function ZipCheck(ByVal sFilename As String, ByRef bZipped As Boolean) As Integer
        ...
        Try
            ...
            sZIPSIG = Strings.ChrW(&H50S).ToString() & Strings.ChrW(&H4BS).ToString() & Strings.ChrW(3).ToString() & Strings.ChrW(4).ToString()
            ...
            'Modified by Deepak Sharma on 4/20/2010 5:12:16 PM refer developer guide no. 125(Guide)
            'Do While sID.ToString().Length < 4 'And Not oFile.AtEndOfStream
            '    sID.Append(oFile.ReadByte())
            'Loop
            'Added by Deepak Sharma on 4/20/2010 5:12:37 PM refer developer guide no. 125(Guide)

            Dim bytes() As Byte = New Byte(3) {}
            Dim numBytesToRead As Integer = 4
            Dim numBytesRead As Integer = 0

            While (numBytesToRead > 0)

                Dim n As Integer = oFile.Read(bytes, numBytesRead,
                    numBytesToRead)
            ...
            sID = Encoding.ASCII.GetString(bytes)

            Dim sContents As String = ""
            Dim sreader As New StreamReader(oFile)
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to check if file zipped", vApp:=ACApp, vClass:=ACClass, vMethod:="ZipCheck", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
            Return result
    ...
    Public Function GetUniqueName(ByRef r_sName As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetUniqueName Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetUniqueName", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function DeleteFile(ByVal v_sFileName As String) As Integer
        ...
        Try
            ...
            If File.Exists(v_sFileName) Then
                ' Delete file fails
                ' Log Error Message
                bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Unable to Delete file '" & v_sFileName & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Else
                result = gPMConstants.PMEReturnCode.PMTrue
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to Delete file '" & v_sFileName & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
