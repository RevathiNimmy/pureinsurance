Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("bACTFunc_NET.bACTFunc")>
Public Module bACTFunc
    ...
    ' CHANGES:
    ' ---------------------------------------------------------------------------
    Public Function GetLedgerIDFromShortName(ByVal v_oDatabase As dPMDAO.Database, ByRef r_lLedgerID As Integer, ByVal v_sShortName As String, ByVal v_lSubBranchID As Integer) As gPMConstants.PMEReturnCode
    ...
    '
    Public Function GetLedgerID(ByVal v_oDatabase As dPMDAO.Database, ByRef r_lLedgerID As Integer, ByVal v_sLedgerCode As String, ByVal v_lSubBranchID As Integer) As gPMConstants.PMEReturnCode
        ' ---------------------------------------------------------------------------
