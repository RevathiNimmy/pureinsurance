Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("GeneralConst_NET.GeneralConst")>
Public Module GeneralConst
    ...
    Public Const kSystemOptionSharepointOnlineClientId As Integer = 5258
    Public Const KSystemOptionSharepointOnlineTenantId As Integer = 5259
End Module