...
<System.Runtime.InteropServices.ProgId("GISSharedConstants_NET.GISSharedConstants")>
Public Module GISSharedConstants
    ' ***************************************************************** '
    ...
    ' RDC 10122002
    ' Dataset types
    Public Const GISDatasetTypeRisk As Integer = 1
    Public Const GISDatasetTypeClaim As Integer = 2
    Public Const GISDatasetTypeParty As Integer = 3
    Public Const GISDatasetTypePolicy As Integer = 4
    ...
    Public Const GISRegDCConfPath As String = "DC_ConfPath" ' SPW 230505
    Public Const GISRegDCSwitchedOn As String = "DC_SwitchedOn" ' SPW 230505
    Public Const GISRegDCCardInfoPath As String = "DC_CardInfoPath" ' SPW 230505
    Public Const GISRegDCCV2AVSPolicy As String = "DC_CV2AVSPolicy" ' SPW 230505
    Public Const GISRegDCTimeoutSecs As String = "DC_TimeoutSecs" ' CL190500 (home)
    Public Const GISRegDC3rdManCheck As String = "DC_3rdManCheck" ' SPW 230505
    Public Const GISRegDCAccountDescription As String = "DC_AccountDescription" 'SPW 230505
    Public Const GISRegDataSetBOMRequired As String = "BOMRequired" 'PN28024


    Public Const GISRegDCCurrency As String = "DC_Currency" ' CTAF 20030724
    ...
    Public Const GISQEMSchArraySize As Integer = 19 'JD081104
    ...
    Public Const GISQEMSchInsurerCode As Integer = 19 'JRD081104
    ...
    Public Const GISDataCashCV2AVSStatus As Integer = 7 'SPW 230505
    Public Const GISDataCashCV2AVSReversalStatus As Integer = 8 'SPW 230505
    Public Const GISDataCashCV2AVSPolicy As Integer = 9 'SPW 230505
    ...
    Public Const ACDataSetXSDSuffix As String = "XSD"
    Public Const ACXMLFileExtension As String = ".XML"
    Public Const ACXSLFileExtension As String = ".XSL"
    Public Const ACXSDFileExtension As String = ".XSD"
    ' ***************************************************************** '
    ...
    'SPW 170505 required for gnet 1.8 upgrade to keep quickstart features
    Public Const ACGISTemplateFileSuffix As String = "TEMPLATE"
    ...
    ' RFC100303 - This is added to the value of Policy Binder ID when generating the
    ' OI Key value. This is to stop it clashing with the OI Value for other objects.
    Public Const GISPolicyBinderOIOffset As Integer = 500000
    ...
    Public Function GetBrandName(ByVal v_sBrandCode As String, ByRef r_sBrandName As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetBrandName", vApp:=ACApp, vClass:=ACClass, vMethod:="GetBrandName", vErrDesc:=excep.Message)
    ...
    Public Function GISToPMDataType(ByVal v_iGISDataType As Integer, ByRef r_iPMDataType As Integer) As Integer
        ...
        Try
            ...
            Select Case v_iGISDataType
                ...
                Case GISDataTypeNumeric, GISDataTypeNumericOutput, GISDataTypeCurrency, GISDataTypePercentage
                    r_iPMDataType = gPMConstants.PMEDataType.PMDecimal
                Case GISDataTypeShortList, GISDataTypeLongList, GISDataTypeText, GISDataTypeComment, GISDataTypecode
                ...
                Case GISDataTypeShortListCode, GISDataTypeLongListCode
                    ...
                    'SJ 15/07/2004 - start
                    '      Case GISDataTypeOption, GISDataTypeCurrency, GISDataTypePercentage
                    '        r_iPMDataType = PMDecimal
                Case GISDataTypeOption, GISDataTypeInteger
                    r_iPMDataType = gPMConstants.PMEDataType.PMLong
                    'SJ 15/07/2004 - end

                Case Else
                    result = gPMConstants.PMEReturnCode.PMFalse
                    LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Unknown GIS Data Type : " & v_iGISDataType, vApp:=ACApp, vClass:=ACClass, vMethod:=CStr(result))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GISToPMDataTypeFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GISToPMDataType", vErrDesc:=excep.Message)
    ...
    Public Function GetDataSetFileNames(ByVal v_sDataModelCode As String, ByRef r_sDataSetDefFile As String, ByRef r_sDataSetFile As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetFileNamesFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetFileNames", vErrDesc:=excep.Message)
    ...
    Public Function GetDefaultsFileName(ByVal v_sGisDataModelCode As String, ByRef GISDefaultsFile As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDefaultsFileNameFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDefaultsFileName", vErrDesc:=excep.Message)
    ...
    Public Function GetSaveXSLFileName(ByVal v_sGisDataModelCode As String, ByRef r_sSaveXSLFileName As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSaveXSLFileNameFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSaveXSLFileName", vErrDesc:=excep.Message)
    ...
    ' ***************************************************************** '
    ' Name: GetSetIDXSLFileName
    '
    ' Description: Determines the Location and File Name of the GIS
    '              Set ID XSL file for the current Data Model.
    '
    ' Date:        12/08/2001
    '
    ' History:     RFC - Created
    '
    ' ***************************************************************** '
    Public Function GetSetIDXSLFileName(ByVal v_sGisDataModelCode As String, ByRef r_sSetIDXSLFileName As String) As Integer
        ...
        Try
            ...
            ' MUST have a Data Model Code
            If v_sGisDataModelCode.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="No Data Model Code Supplied...", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSetIDXSLFileName")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            r_sSetIDXSLFileName = sPath & v_sGisDataModelCode.Trim().ToUpper() & ACGISSetIDXSLFileSuffix & ACXSLFileExtension
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSetIDXSLFileNameFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSetIDXSLFileName", vErrDesc:=excep.Message)
    ...
    Public Function GetDataSetsPath(ByVal v_sDataModelCode As String, ByRef r_sDataSetsPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetsPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetsPath", vErrDesc:=excep.Message)
    ...
    Public Function GetLoadSPPath(ByVal v_sDataModelCode As String, ByRef r_sLoadSPPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetLoadSPPath failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetLoadSPPath", vErrDesc:=excep.Message)
    ...
    Public Function GetEDISendPath(ByRef r_sEDISendPath As String, ByVal v_sDataModelCode As String) As Integer
        ...
        Try
            ...
            lReturn = GetRegSettingFromDataBusModel(v_sDataModelCode:=v_sDataModelCode, v_sSettingName:=GISRegEDISendPath, r_sSettingValue:=r_sEDISendPath, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer)

            ' RFC170400 - If we did not find a Data Model Specific Setting
            If r_sEDISendPath.Trim() = "" Then

                ' Then Look in the default Place.
                lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer, v_sSettingName:=GISRegEDISendPath, r_sSettingValue:=r_sEDISendPath, v_sSubKey:=GISRegSubKey)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetEDISendPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetEDISendPath", vErrDesc:=excep.Message)
    ...
    Public Function GetFailedTransReportPath(ByRef r_sFailedTransReportPath As String, ByVal v_sDataModelCode As String, ByVal v_sBusinessTypeCode As String) As Integer
        ...
        Try
            ...
            lReturn = GetRegSettingFromDataBusModel(v_sDataModelCode:=v_sDataModelCode, v_sSettingName:=GISRegFailedTransReportPath, r_sSettingValue:=r_sFailedTransReportPath, v_sBusinessTypeCode:=v_sBusinessTypeCode, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer, v_sSubKey:=GISRegReports)

            ' RJG 31/07/2000 - If we did not find a Data Model Specific Setting
            If r_sFailedTransReportPath.Trim() = "" Then

                ' Then Look in the default Place.
                lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer, v_sSettingName:=GISRegFailedTransReportPath, r_sSettingValue:=r_sFailedTransReportPath, v_sSubKey:=GISRegSubKey)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetFailedTransReportPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFailedTransReportPath", vErrDesc:=excep.Message)
    ...
    Public Function GetBackOfficeReportPath(ByRef r_sBackOfficeReportPath As String, ByVal v_sDataModelCode As String, ByVal v_sBusinessTypeCode As String) As Integer
        ...
        Try
            ...
            ' RJG 31/07/2000 - Get the Data Model Specific Failed Trans Report Path
            lReturn = GetRegSettingFromDataBusModel(v_sDataModelCode:=v_sDataModelCode, v_sSettingName:=GISRegBackOfficeReportPath, r_sSettingValue:=r_sBackOfficeReportPath, v_sBusinessTypeCode:=v_sBusinessTypeCode, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer, v_sSubKey:=GISRegReports)

            ' RJG 31/07/2000 - If we did not find a Data Model Specific Setting
            If r_sBackOfficeReportPath.Trim() = "" Then

                ' Then Look in the default Place.
                lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLServer, v_sSettingName:=GISRegBackOfficeReportPath, r_sSettingValue:=r_sBackOfficeReportPath, v_sSubKey:=GISRegSubKey)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetBackOfficeReportPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetBackOfficeReportPath", vErrDesc:=excep.Message)
    ...
    Public Function IsGISInDebug() As Boolean
        ...
        Catch excep As System.Exception
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get GIS Debud setting from registry. Default to Debug = True.", vApp:=ACApp, vClass:=ACClass, vMethod:="IsGISInDebug", vErrDesc:=excep.Message)
        End Try
    ...
    Public Function GetGISLogLevel() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get GIS Log Level setting from registry.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetGISLogLevel", vErrDesc:=excep.Message)
    ...
    Public Function GetHTTPPostPage(ByRef r_sHTTPPostPage As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetHTTPPostPageFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetHTTPPostPage", vErrDesc:=excep.Message)
    ...
    Public Function GetExternalDTDPath(ByVal sDataModelCode As String, ByRef r_sExternalDTDPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetExternalDTDPath Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetExternalDTDPath", vErrDesc:=excep.Message)
    ...
    Public Function GetRegSettingFromDataBusModel(ByVal v_sDataModelCode As String, ByVal v_sSettingName As String, ByRef r_sSettingValue As String, Optional ByVal v_sBusinessTypeCode As String = "", Optional ByVal v_lPMERegSettingLevel As gPMConstants.PMERegSettingLevel = gPMConstants.PMERegSettingLevel.pmeRSLServer, Optional ByVal v_sSubKey As String = "") As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetRegSettingFromDataBusModel Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRegSettingFromDataBusModel", vErrDesc:=excep.Message)
    ...
    '
    ' ***************************************************************** '
    Public Function CheckGISDSN(ByVal v_sDataModelCode As String, ByRef r_oDatabase As dPMDAO.Database, ByRef r_bNew As Boolean) As Integer
        ...
        Try
            ...
            lReturn = CType(GetRegSettingFromDataBusModel(v_sDataModelCode:=v_sDataModelCode, v_sSettingName:=GISRegDSN, r_sSettingValue:=sDSN), gPMConstants.PMEReturnCode)
            ...
            If r_oDatabase Is Nothing Then
                r_bNew = True
            Else
                r_bNew = Not (r_oDatabase.CurrentDSN = sDSN)
            End If

            If r_bNew Then
                r_oDatabase = New dPMDAO.Database
                ' RDC 28062002 use Comp Serv to open database
                lReturn = CType(gPMComponentServices.NewDatabase(v_sUsername:="", v_iSourceID:=1, v_iLanguageID:=1, v_lPMProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusArchitecture, r_oDatabase:=r_oDatabase), gPMConstants.PMEReturnCode)
                If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Return lReturn
                End If
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CheckGISDSN Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckGISDSN", vErrDesc:=excep.Message)
    ...
    Public Function SaveOnQuote(ByVal v_sGisDataModelCode As String, ByVal v_sGisBusinessTypeCode As String) As Boolean
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get GIS SaveOnQuote from registry. Default = True", vApp:=ACApp, vClass:=ACClass, vMethod:="SaveOnQuote", vErrDesc:=excep.Message)
        End Try
    ...
    Public Function SaveOnMTAQuote(ByVal v_sGisDataModelCode As String, ByVal v_sGisBusinessTypeCode As String) As Boolean
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get GIS SaveOnMTAQuote from registry. Default = True", vApp:=ACApp, vClass:=ACClass, vMethod:="SaveOnMTAQuote", vErrDesc:=excep.Message)
        End Try
    ...
    Public Function AuditOnQuote(ByVal v_sGisDataModelCode As String, Optional ByVal v_sGisBusinessTypeCode As String = "") As Boolean
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get GIS AuditOnQuote from registry. Default = True", vApp:=ACApp, vClass:=ACClass, vMethod:="AuditOnQuote", vErrDesc:=excep.Message)
        End Try
    ...
    Public Function ReplaceCharacter(ByRef r_sString As String, ByVal v_vSearchChar As String, ByVal v_sReplaceChar As String, ByVal v_sSearchCharType As String) As Integer
        Dim result As Integer = 0
        Dim iCharPosition As Integer = 0
        Dim iReplaceStringLength As Integer = 0
        Try
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ReplaceCharacter Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ReplaceCharacter", vErrDesc:=excep.Message)
    ...
    Public Function GetLookupsPath(ByVal v_sDataModelCode As String, ByRef r_sLookupsPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetLookupsPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetLookupsPath", vErrDesc:=excep.Message)
    ...
    Public Function GetQEMMethodsVersionNum(ByVal v_sDataModelCode As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetQEMMethodsVersionNumFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetQEMMethodsVersionNum", vErrDesc:=excep.Message)
    ...
    Public Function GetLoadSaveDBMode(ByVal v_sDataModelCode As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetLoadSaveDBModeFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetLoadSaveDBMode", vErrDesc:=excep.Message)
    ...
    Public Function GetStateFilesPath(ByRef r_sStateFilesPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetStateFilesPathFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetStateFilesPath", vErrDesc:=excep.Message)
    ...
    Public Function GetStateTimeoutMins(ByRef r_lStateTimeoutMins As Integer) As Integer
        ...
        Try
            ...
            lReturn = gPMFunctions.GetPMRegSetting(v_lPMERegSettingRoot:=gPMConstants.PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=gPMConstants.PMEProductFamily.pmePFSiriusSolutions, v_lPMERegSettingLevel:=gPMConstants.PMERegSettingLevel.pmeRSLClient, v_sSettingName:=GISRegStateTimeoutMins, r_sSettingValue:=s, v_sSubKey:=GISRegSubKey)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetStateTimeoutMins Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetStateTimeoutMins", vErrDesc:=excep.Message)
    ...
    '
    ' ***************************************************************** '
    Public Sub LogMessageFile(ByRef iType As Integer, ByRef sMsg As String, Optional ByRef vApp As String = "", Optional ByRef vClass As String = "", Optional ByRef vMethod As String = "", Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing)
        Try
            'gPMFunctions.LogMessageToFile(sUsername:="", iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, excep:=New Exception(CStr(vErrDesc)))
        Catch
            Exit Sub
        End Try
    End Sub
    ...
    '
    ' ***************************************************************** '
    Public Sub DebugLogMessageFile(ByRef iType As Integer, ByRef sMsg As String, Optional ByRef vApp As String = "", Optional ByRef vClass As String = "", Optional ByRef vMethod As String = "", Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing)
        ...
        Try
            ...
            If vInDebug Then
                ...
                '				gPMFunctions.LogMessageToFile(sUserName:="", iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, vErrNo:=CStr(vErrNo), vErrDesc:=CStr(vErrDesc))
                'gPMFunctions.LogMessageToFile(sUsername:="", iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, excep:=New Exception(CStr(vErrDesc)))
            End If
    ...
    Public Function GetLoadSaveSafeInserts(ByVal v_sDataModelCode As String) As Boolean
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetLoadSaveSafeInsertsFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetLoadSaveSafeInserts", vErrDesc:=excep.Message)
        End Try
    ...
    ' ***************************************************************** '
    ' Name: GetDataSetXSDFileName
    '
    ' Description: Calculates the Location and File Name of the XML
    '              files for a given Data Model.
    '
    ' ***************************************************************** '
    Public Function GetDataSetXSDFileName(ByVal v_sDataModelCode As String, ByRef r_sDataSetXSDFile As String) As Integer
        ...
        Try
            ...
            ' MUST have a Data Model Code
            If v_sDataModelCode.Trim() = "" Then
                LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetXSDFileName", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetXSDFileName")
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            r_sDataSetXSDFile = sPath & v_sDataModelCode.Trim().ToUpper() & ACDataSetXSDSuffix & ACXSDFileExtension
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessageFile(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetDataSetXSDFileNameFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDataSetXSDFileName", vErrDesc:=excep.Message)
    ...
    ''' <summary>
    ''' Get data backbone file in case CCM is enabled
    ''' </summary>
    ''' <param name="sCCMBackboneFilePath"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetCCMBackboneFileName(ByRef sCCMBackboneFilePath As String) As Integer
        ...
        Try
            ...
            'Get the Path where they live
            nResult = CType(GetCCMBackBoneFilePath(sCCMBackboneFilePath:=sPath), gPMConstants.PMEReturnCode)
            If nResult <> PMEReturnCode.PMTrue Then
                Return PMEReturnCode.PMFalse
            End If

            sCCMBackboneFilePath = sPath & "KCM\"

        Catch excep As System.Exception
            nResult = PMEReturnCode.PMError
            ' Log Error Message
            LogMessageFile(iType:=PMELogLevel.PMLogOnError, sMsg:="GetCCMBackboneFileName Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetCCMBackboneFileName", vErrDesc:=excep.Message)
        End Try

        Return nResult
    End Function

    Private Function GetCCMBackBoneFilePath(ByRef sCCMBackboneFilePath As String) As Integer
        Dim nResult As Integer = gPMConstants.PMEReturnCode.PMTrue
        nResult = GetPMRegSetting(v_lPMERegSettingRoot:=PMERegSettingRoot.pmeRSRLocalMachine, v_lPMEProductFamily:=PMEProductFamily.pmePFSiriusSolutions, _
                                               v_lPMERegSettingLevel:=PMERegSettingLevel.pmeRSLCommon, v_sSettingName:=GISRegDataSetPath, r_sSettingValue:=sCCMBackboneFilePath, _
                                               v_sSubKey:=GISRegSubKey)

        If sCCMBackboneFilePath.Trim() = "" Then
            LogMessageFile(iType:=PMELogLevel.PMLogError, sMsg:="Failed to find Data Backbone Path (" & GISRegDataSetPath & ") Registry Setting.", vApp:=ACApp, vClass:=ACClass, _
                           vMethod:="GetCCMBackBoneFilePath")
            Throw New ApplicationException("Failed to find Data Backbone Path (" & GISRegDataSetPath & ") Registry Setting.")
        End If

        If Not sCCMBackboneFilePath.EndsWith("\") Then
            sCCMBackboneFilePath = sCCMBackboneFilePath & "\"
        End If
