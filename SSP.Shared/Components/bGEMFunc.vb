...
<System.Runtime.InteropServices.ProgId("bGEMFunc_NET.bGEMFunc")> _
 Public Module bGEMFunc
    ...
    Public Function GetGeminiDatabase(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByRef lOpenStatus As Integer, ByRef bCloseDatabase As Boolean, Optional ByRef vDatabase As dPMDAO.Database = Nothing) As Object
        ...
        Try
            ...
            Else
                ...
                lOpenStatus = oDatabase.OpenDatabase(vDSN:=gPMConstants.PMGeminiDSN, sSiriusUsername:=ToSafeString(v_sUsername), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), sCallingAppName:=ToSafeString(ACApp))
    ...
    Public Function GetGISDatabase(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByRef lOpenStatus As Integer, ByRef bCloseDatabase As Boolean, Optional ByRef vDatabase As dPMDAO.Database = Nothing) As Object
        ...
        Try
            ...
            Else
                ...
                ' Open the Database
                lOpenStatus = oDatabase.OpenDatabase(sSiriusUsername:=ToSafeString(v_sUsername), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), sCallingAppName:=ToSafeString(ACApp), vDSN:="GIS")
    ...
    Public Function GetSiriusArchitectureDatabase(ByVal v_sUsername As String, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByRef lOpenStatus As Integer, ByRef bCloseDatabase As Boolean, Optional ByRef vDatabase As dPMDAO.Database = Nothing) As Object
        ...
        Try
            ...
            Else
                ...
                'AK 100802 - scalability
                lOpenStatus = oDatabase.OpenDatabase(sSiriusUsername:=ToSafeString(v_sUsername), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), sCallingAppName:=ToSafeString(ACApp), vDSN:=gPMConstants.PMSiriusArchitectureDSN)
	...
	Public Function GetGeminiBusiness(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sClassName As String, Optional ByVal v_vDatabase As Object = Nothing, Optional ByVal v_vBeginTrans As Object = Nothing) As Object
        ...
        Dim oNewObject As Object = Nothing

        Try
            Dim oObject As Object = System.Reflection.Assembly.GetAssembly(Type.GetType(v_sClassName + "," + v_sClassName.Substring(0, v_sClassName.LastIndexOf(".")))).FullName
            oNewObject = Activator.CreateInstance(oObject, v_sClassName).Unwrap()
            If Not (oNewObject Is Nothing) Then

                lReturn = oNewObject.Initialise(sUserName:=ToSafeString(v_sUsername), sPassword:=ToSafeString(v_sPassword), iUserID:=ToSafeInteger(v_iUserID), iSourceID:=ToSafeInteger(v_iSourceID), iLanguageID:=ToSafeInteger(v_iLanguageID), iCurrencyID:=ToSafeInteger(v_iCurrencyID), iLogLevel:=ToSafeInteger(v_iLogLevel), sCallingAppName:=ToSafeString(ACApp), vDatabase:=v_vDatabase)
