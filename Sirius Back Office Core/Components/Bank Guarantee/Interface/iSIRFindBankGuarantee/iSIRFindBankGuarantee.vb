...
Public NotInheritable Class Interface_Renamed
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMNavKeyConst.PMKeyNameInsReference
                        ...
                        m_vInsuranceFileRef = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .Task = m_iTask
            .PartyCode = m_sPolicyHolder
            .InsuranceFileRef = m_vInsuranceFileRef
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            m_sPolicyHolder = .PartyCode
            m_vInsuranceFileRef = .InsuranceFileRef
