...
Imports SSP.Shared
<System.Runtime.InteropServices.ProgId("SIRPartyLifestyle_NET.SIRPartyLifestyle")> _
Public NotInheritable Class SIRPartyLifestyle
    ...
    Public Function Add() As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                ' Add party_cnt as is not Output parameter
    ...
    '
    ' Description: Selects the required SIRPartyLifestyle
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied SIRPartyLifestyle properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                If Convert.IsDBNull(oFields("name")) Or Informations.IsNothing(oFields("name")) Then
                ...
                If Convert.IsDBNull(oFields("category")) Or Informations.IsNothing(oFields("category")) Then

                    Category = Nothing
                Else

                    Category = oFields("category")
                End If
                ...
                If Convert.IsDBNull(oFields("gender_code")) Or Informations.IsNothing(oFields("gender_code")) Then

                    GenderCode = Nothing
                Else

                    GenderCode = oFields("gender_code")
                End If

                If Convert.IsDBNull(oFields("occupation_code")) Or Informations.IsNothing(oFields("occupation_code")) Then

                    OccupationCode = Nothing
                Else

                    OccupationCode = oFields("occupation_code")
                End If

                If Convert.IsDBNull(oFields("secondary_occupation_code")) Or Informations.IsNothing(oFields("secondary_occupation_code")) Then

                    SecondaryOccupationCode = Nothing
                Else

                    SecondaryOccupationCode = oFields("secondary_occupation_code")
                End If

                If Convert.IsDBNull(oFields("is_smoker")) Or Informations.IsNothing(oFields("is_smoker")) Then

                    IsSmoker = Nothing
                Else

                    IsSmoker = oFields("is_smoker")
                End If
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="category", vValue:=Category, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            ...
            m_lReturn = .Parameters.Add(sName:="gender_code", vValue:=GenderCode, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMString)
            ...
            m_lReturn = .Parameters.Add(sName:="is_smoker", vValue:=IsSmoker, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMInteger)
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            PartyLifestyleID = .Parameters.Item("party_lifestyle_id").Value
