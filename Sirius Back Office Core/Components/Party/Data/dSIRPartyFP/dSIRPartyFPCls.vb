...
Imports SSP.Shared
<System.Runtime.InteropServices.ProgId("SIRPartyFP_NET.SIRPartyFP")>
Public NotInheritable Class SIRPartyFP
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: SIRPartyFP
    '
    ' Date: 16/10/2000
    '
    ' Description: Describes the Finance_Provider attributes.
    '
    ...
    Private Const ACClass As String = "SIRPartyFP"
    ...
    Private m_lFinanceProviderNumber As Integer
    ...
    Public Property FinanceProviderNumber() As Integer
        Get

            Return m_lFinanceProviderNumber

        End Get
        Set(ByVal Value As Integer)

            m_lFinanceProviderNumber = Value
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                FinanceProviderNumber = gPMFunctions.NullToLong(oFields("finance_provider_number"))
                ...
                If Convert.IsDBNull(oFields("mailbox_number")) Or Informations.IsNothing(oFields("mailbox_number")) Then

                    MailboxNumber = Nothing
                Else

                    MailboxNumber = oFields("mailbox_number")
                End If
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="finance_provider_number", vValue:=CStr(FinanceProviderNumber), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            ...
            m_lReturn = .Parameters.Add(sName:="mailbox_number", vValue:=MailboxNumber, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMString)
