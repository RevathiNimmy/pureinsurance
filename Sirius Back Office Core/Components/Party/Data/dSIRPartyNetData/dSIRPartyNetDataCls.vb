...
Imports SSP.Shared
<System.Runtime.InteropServices.ProgId("SIRPartyNetData_NET.SIRPartyNetData")> _
Public NotInheritable Class SIRPartyNetData
    ...
    Private m_vCurrentInsRenewalDate As Object
    ...
    Public Property CurrentInsRenewalDate() As Object
        Get

            Return m_vCurrentInsRenewalDate
        ...
        Set(ByVal Value As Object)
            ...
            m_vCurrentInsRenewalDate = Value
    ...
    '
    ' Description: Selects the required SIRPartyNetData
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied SIRPartyNetData properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                If Convert.IsDBNull(oFields("userid")) Or Informations.IsNothing(oFields("userid")) Then

                    Userid = Nothing
                Else

                    Userid = oFields("userid")
                End If

                If Convert.IsDBNull(oFields("current_ins_renewal_date")) Or Informations.IsNothing(oFields("current_ins_renewal_date")) Then

                    CurrentInsRenewalDate = Nothing
                Else

                    CurrentInsRenewalDate = oFields("current_ins_renewal_date")
                End If
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="current_ins_renewal_date", vValue:=CurrentInsRenewalDate, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMDate)
