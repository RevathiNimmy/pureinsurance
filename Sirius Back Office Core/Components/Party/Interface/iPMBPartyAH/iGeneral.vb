...
Friend NotInheritable Class General
    ...
    Public m_frmInterface As frmInterface
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        'developer guide no. 69
                        If m_frmInterface.HandlerType = "AH" Then

                            'developer guide no. 69
                            m_frmInterface.PartyCnt = ReflectionHelper.GetMember(m_oBusiness, "PartyCnt")
                            'developer guide no. 69
                            m_lReturn = CType(m_frmInterface.SaveBranchPickListData(), gPMConstants.PMEReturnCode)
                            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                                gPMFunctions.RaiseError("ProcessCommand", "SaveBranchPickListData", gPMConstants.PMELogLevel.PMLogError)
                            End If
                        End If
    ...
    Private Function DisableForm(ByRef lDisabled As Integer) As Integer
        ...
        For Each ctlFormControl As Control In ContainerHelper.Controls(m_frmInterface)
            ...
            Select Case (ctlFormControl.Name)
                Case "cmdAdd", "cmdEdit", "cmdDelete", "cmdAddAd", "cmdEditAd", "cmdDeleteAd", "lvwContacts", "lvwAddress"
