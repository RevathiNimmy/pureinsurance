...
Public NotInheritable Class Interface_Renamed
    ...
    Public Property QASForename() As String
        Get
            Return m_sQASForename
        End Get
        Set(ByVal Value As String)
            m_sQASForename = Value
        End Set
    End Property
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            ' developer guide no. 107(latest guide)
            PartyBuilderHandler.g_oObjectManager = New bObjectManager.ObjectManager()

            ' Call the initialise method.
            'developer guide no. 107(latest guide)
            m_lReturn = PartyBuilderHandler.g_oObjectManager.Initialise(sCallingAppName:=ACApp)
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' developer guide no. 107(latest guide)
                PartyBuilderHandler.g_oObjectManager = Nothing
            ...
            'developer guide no. 107(latest guide)
            With PartyBuilderHandler.g_oObjectManager
            ...
            ' 02082002 CMG/PB Scalability change
    ...
    Protected Sub Dispose(disposing As Boolean)
        If Not Me.disposedValue Then
            ...
            If disposing Then
                ...
                End If
                If PartyBuilderHandler.g_oObjectManager IsNot Nothing Then
                    PartyBuilderHandler.g_oObjectManager.Dispose()
                    PartyBuilderHandler.g_oObjectManager = Nothing
                End If
            End If
        End If
