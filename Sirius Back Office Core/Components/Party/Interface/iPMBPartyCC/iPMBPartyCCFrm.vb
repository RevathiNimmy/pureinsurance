...
Partial Friend Class frmInterface
    ...
    Private uctControl As PartyCCControl.uctPartyCCControl
    'DC260106 PN25052
    ...
    Public ReadOnly Property uctPartyCCControl1() As Object
        Get

            'developer guide no. 187
            Return uctControl
        End Get
    End Property
    'sj 27/08/2002 - end
    ...
    Private Sub cmdApply_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdApply.Click
        ...
        Try
            ...
            m_sShortName = uctPartyCCControl1.ShortName


            m_lPartyCnt = uctPartyCCControl1.PartyCnt
            ...
            If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
                ...
                uctPartyCCControl1.Task = gPMConstants.PMEComponentAction.PMEdit


                m_lReturn = uctPartyCCControl1.ApplyParty()
    ...
    Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
        ...
        'Modified by Archana Tokas on 4/23/2010 10:16:33 AM no arguments needs to be passed
        PMHelpFunc.g_sProductFamily = g_sProductFamily
        m_lReturn = SSfunc.ShowHelp(cmdHelp, MainModule.ScreenHelpID)
    ...
    Private Sub frmInterface_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            uctControl = New uctPartyCCControl
            'sj 27/08/2002 - start
            ' Add the PartyCC user control
            m_lReturn = iPMFunc.CreateUserControl(v_sProgID:="uctPartyCC.uctPartyCCControl", v_sObjectName:="uctPartyCCControl1", v_oForm:=Me, r_oContainer:=picHolder, r_oControl:=uctControl)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                iPMFunc.SetMousePointer(gPMConstants.PMEMousePointerStatus.PMMouseNormal)
                ' Log Error.
                iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create user control - PartyCCControl.", vApp:=ACApp, vClass:=ACClass, vMethod:="Form_Load", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            End If
            'sj 27/08/2002 - end
            ...
            If Not (m_sQASOrgName Is Nothing) Then
                If m_sQASOrgName.Trim() <> "" Then 'Alix - 03/02/2003
                    uctPartyCCControl1.OrgName = m_sQASOrgName
                End If
            End If
            'address bit
            ...
            If oQASNData.Add1.Length > 0 Then
                'bSuccess = uctPartyCCControl1.AddQASAddress(QAS:=oQASNData)

                bSuccess = uctPartyCCControl1.AddQASAddress(v_sAdd1:=oQASNData.Add1, v_sAdd2:=oQASNData.Add2, v_sAdd3:=oQASNData.Add3, v_sAdd4:=oQASNData.Add4, v_sPostCode:=oQASNData.Postcode)
            End If
    ...
    Private Sub frmInterface_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        Try
            ...
            'developer guide no. 8(Latest Guide)
        ...
        Try
            ...
            With uctPartyCCControl1
                ...
                If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    ' Check the return value.
                    'DC260106 PN27052 if cancel out of custom data screen will also close the form                    
    ...
    Private Sub cmdCancel_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdCancel.Click
        ...
        Try
            ...
            If m_bApplyWasClicked Then
                'DC250106 PN27040 if cancel out of custom data screen will also close the form
                m_lReturn = PartyBuilderHandler.OpenPartyBuilderScreen(iTask:=m_iTask, lPartyCnt:=m_lPartyCnt)
                ...
                If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Or m_lReturn = gPMConstants.PMEReturnCode.PMCancel Then
                    ...
                    Me.Hide()
                End If
            ElseIf m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then  ' Sankar - PN 61149
                'developer guide no. 231
                Me.Hide()
            End If
