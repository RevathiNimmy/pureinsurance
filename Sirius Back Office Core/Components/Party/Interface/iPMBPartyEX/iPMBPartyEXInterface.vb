...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            'added to pass the instance of object manager to PartyBuilderHandler
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMKeyNameSpecialParty

                        m_sPartyType = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
    ...
    Private Function LoadInterface() As Integer
        ...
        With objfrmInterface
            ...
            .IsNRMA = m_bIsNRMA
            '.EffectiveDate = m_dtEffectiveDate     'REMARKED 990930 MK
    ...
    ' ***************************************************************** '
    ' Name: CheckNRMA (Standard Method)
    '
