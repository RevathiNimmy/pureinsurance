...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            'RDT PN18099 - Moved to start of method so that the lists are populated before the data is loaded.
            ...
            If ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMEdit Or ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMView Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Return gPMConstants.PMEReturnCode.PMFalse
                End If
            ElseIf ReflectionHelper.GetMember(m_frmInterface, "Task") = gPMConstants.PMEComponentAction.PMAdd Then
    ...
    Private Function DisableForm(ByRef lDisabled As Integer) As Integer
        ...
        For Each ctlFormControl As Control In ContainerHelper.Controls(m_frmInterface)
            ...
            Select Case (ctlFormControl.Name)
                Case "cmdAddAd", "cmdEditAd", "cmdDeleteAd", "cmdAddCon", "cmdDeleteCon", "cmdEditCon", "lvwContacts", "cboCurrency", "lvwRiskCodes", "cmdEditRisk"
                    ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
                Case "lvwAddresses"
                    ControlHelper.SetEnabled(ctlFormControl, lDisabled)
                Case "uctPartyTax1", "uctPartyBankControl1"
                    ReflectionHelper.SetMember(ctlFormControl, "ReadOnly_Renamed", lDisabled)
                Case "Toolbar1"

                    Dim tsToolbar1 As ToolStrip = DirectCast(ctlFormControl, ToolStrip)
                    If Not tsToolbar1 Is Nothing Then
                        For Each item As ToolStripItem In tsToolbar1.Items
                            If Not item Is Nothing Then
                                item.Enabled = Not lDisabled
                            End If
                        Next
                    End If
            End Select
