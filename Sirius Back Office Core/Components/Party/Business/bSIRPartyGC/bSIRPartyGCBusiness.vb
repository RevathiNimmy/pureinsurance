...
Public NotInheritable Class Business
    ...
    ' Collection of SIRPartyGCs (Private)
    Private m_oSIRPartyGCs As bSIRPartyGC.SIRPartyGCs
    ...
    Public Property CurrentRecord() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            Select Case Value
                ...
                Case Is > m_oSIRPartyGCs.Count()
                    m_lCurrentRecord = m_oSIRPartyGCs.Count()
                Case Else
    ...
    Public Function Initialise(ByVal sUserName As String, ByVal sPassword As String, ByVal iUserID As Integer, ByVal iSourceID As Integer, ByVal iLanguageID As Integer, ByVal iCurrencyID As Integer, ByVal iLogLevel As Integer, ByVal sCallingAppName As String, Optional ByVal bStandAlone As Boolean = False, Optional ByVal vDatabase As Object = Nothing) As Long
        ...
        Try
            ...
            ' Create SIRPartyGCs Collection
            m_oSIRPartyGCs = New bSIRPartyGC.SIRPartyGCs()
    ...
    '
    ' Description: Gets the Lookup values for a SIRPartyGC.
    '
    '
    ' ***************************************************************** '
    'developer guide no. 71(latest guide)
    Public Function GetLookupValues(ByRef iLookupType As Integer, ByRef vTableArray(,) As Object, ByRef iLanguageID As Integer, ByRef vResultArray(,) As Object) As Integer
        ...
        Dim result As Integer = 0
        Dim oSIRPartyGC As bSIRPartyGC.SIRPartyGC = Nothing
        Dim dtEffectiveDate As Date

        Dim vTabArray(4, 12) As Object
        Dim vPartyBusinessId As Object = Nothing
        ...
        Dim vPartyGroupTypeID As Object = Nothing
        ...
        Try
            ...
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 0) = gSIRLibrary.SIRLookupPartyBusiness
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 1) = gSIRLibrary.SIRLookupArea
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 2) = gSIRLibrary.SIRLookupCurrency
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 3) = gSIRLibrary.SIRLookupReminderType
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 4) = gSIRLibrary.SIRLookupServiceLevel
            ...
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 7) = gSIRLibrary.SIRLookupPartyGroupType
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 8) = gSIRLibrary.SIRLookupSeasonalGift
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 9) = gSIRLibrary.SIRLookupStrengthCode
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 10) = gSIRLibrary.SIRLookupRenewalStopCode
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 11) = gSIRLibrary.SIRLookupBlackListReason
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupTableName, 12) = gSIRLibrary.SIRLookupPFFrequency
            vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupWhereClause, 12) = "is_available_on_client_screen = 1"
            ...
            Else
                ...
                oSIRPartyGC = m_oSIRPartyGCs.Item(m_lCurrentRecord)
            End If
            ...
            Select Case iLookupType
                Case gPMConstants.PMELookupType.PMLookupAll
                    ...
                    vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 12) = 0
                ...
                Case gPMConstants.PMELookupType.PMLookupAllEffective
                    ...
                    With oSIRPartyGC
                        ...
                        m_lReturn = .GetProperties(iStatus:=gPMConstants.PMEComponentAction.PMView, vPartyBusinessId:=vPartyBusinessId, vPartyGroupTypeID:=vPartyGroupTypeID)

                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 0) = vPartyBusinessId

                        m_lReturn = .bSIRParty.GetLookupProperties(vCurrentRecord:=ToSafeInteger(m_lCurrentRecord), vAreaId:=vAreaId, vCurrencyId:=vCurrencyID,
                                                                   vReminderTypeId:=vReminderTypeId, vServiceLevelId:=vServiceLevelId, vRenewalStopCodeId:=vRenewalStopCodeId,
                                                                    vCorrespondenceTypeId:=Nothing,
                                                                   vSeasonalGiftID:=vSeasonalGiftID, vPaymentTermCode:=vTermsOfPaymentId)


                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 1) = vAreaId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 2) = vCurrencyID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 3) = vReminderTypeId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 4) = vServiceLevelId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 5) = vProspectStatusID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 6) = vPolicyTypeID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 7) = vPartyGroupTypeID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 8) = vSeasonalGiftID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 9) = ""
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 10) = vRenewalStopCodeId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 11) = 0
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 12) = vTermsOfPaymentId
                ...
                Case gPMConstants.PMELookupType.PMLookupSingle
                    ...
                    With oSIRPartyGC
                        ...
                        m_lReturn = .bSIRParty.GetLookupProperties(vCurrentRecord:=ToSafeInteger(m_lCurrentRecord), vAreaId:=vAreaId, vCurrencyId:=vCurrencyID,
                                                                   vReminderTypeId:=vReminderTypeId, vServiceLevelId:=vServiceLevelId,
                                                                   vSeasonalGiftID:=Nothing, vCorrespondenceTypeId:=Nothing,
                                                                   vRenewalStopCodeId:=vRenewalStopCodeId, vPaymentTermCode:=vTermsOfPaymentId)

                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 1) = vAreaId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 2) = vCurrencyID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 3) = vReminderTypeId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 4) = vServiceLevelId
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 5) = 2 ' vProspectStatusID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 6) = vPolicyTypeID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 7) = vPartyGroupTypeID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 8) = vSeasonalGiftID
                        vTabArray(gPMConstants.PMELookupInArrayColPos.PMLookupKey, 9) = ""
    ...
    '
    ' Description: Adds a single SIRPartyGC directly into the database.
    '        Note: The SIRPartyGC will NOT be added to the collection.
    '
    ' ***************************************************************** '
    ...
    'FSA Phase III
    Public Function DirectAdd(Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPartyGroupTypeID As Object = Nothing, Optional ByRef vIsRegisteredCharity As Object = Nothing, Optional ByRef vCharityNumber As Object = Nothing, Optional ByRef vNumberofMembers As Object = Nothing, Optional ByRef vSourceID As Object = Nothing, Optional ByRef vShortname As Object = Nothing, Optional ByRef vName As Object = Nothing, Optional ByRef vResolvedName As Object = Nothing, Optional ByRef vIsAlsoAgent As Object = Nothing, Optional ByRef vIsProspect As Object = Nothing, Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vFileCode As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vPaymentMethodCode As Object = Nothing, Optional ByRef vReminderTypeId As Object = Nothing, Optional ByRef vAreaId As Object = Nothing, Optional ByRef vServiceLevelId As Object = Nothing, Optional ByRef vCreditCardCode As Object = Nothing, Optional ByRef vPaymentTermCode As Object = Nothing, Optional ByRef vCCJs As Object = Nothing, Optional ByRef vSeasonalGiftID As Object = Nothing, Optional ByRef vCorrespondenceTypeId As Object = Nothing, Optional ByRef vRenewalStopCodeId As Object = Nothing, Optional ByRef vInvariantKey As Object = Nothing, Optional ByRef vSwiftPartyID As Object = Nothing, Optional ByRef vLoyaltyNumber As Object = Nothing, Optional ByRef vAlternativeIdentifier As Object = Nothing, Optional ByRef vMarketingSegmentInd As Object = Nothing, Optional ByRef vTradingName As Object = Nothing, Optional ByRef vSubBranchId As Object = Nothing, Optional ByRef vTobLetter As Object = Nothing, Optional ByRef vTpsInd As Object = Nothing, Optional ByRef vEmpsInd As Object = Nothing, Optional ByRef vMailShot As Object = Nothing, Optional ByRef vTurnover As Object = Nothing, Optional ByRef vIsFeeClient As Object = Nothing) As Integer

        Dim result As Integer = 0
        Dim oSIRPartyGC As bSIRPartyGC.SIRPartyGC
        ...
        Try
            ...
            ' Create a new SIRPartyGC
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            m_lReturn = oSIRPartyGC.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=m_sCallingAppName, vDatabase:=m_oDatabase)
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.DirectAdd(vPartyTypeID:=ToSafeInteger(lPartyTypeID), vShortname:=vShortname,
                                                        ...
                                                        vSwiftPartyID:=vSwiftPartyID, vConsultantCnt:=vConsultantCnt,
                                                        vLoyaltyNumber:=vLoyaltyNumber, vAlternativeIdentifier:=vAlternativeIdentifier,
                                                        vMarketingSegmentInd:=vMarketingSegmentInd, vTradingName:=vTradingName,
            ...
            vPartyCnt = oSIRPartyGC.bSIRParty.PartyCnt

            ' Populate SIRPartyGC Attributes
            ...
            m_lReturn = oSIRPartyGC.SetProperties(iStatus:=gPMConstants.PMEComponentAction.PMAdd, vPartyCnt:=vPartyCnt, vPartyGroupTypeID:=vPartyGroupTypeID, vIsRegisteredCharity:=vIsRegisteredCharity, vCharityNumber:=vCharityNumber, vNumberofMembers:=vNumberofMembers, vTpsInd:=vTpsInd, vEmpsInd:=vEmpsInd, vMailShot:=vMailShot, vTurnover:=vTurnover, vIsFeeClient:=vIsFeeClient)
            ...
            ' Add the SIRPartyGC to the Database
            m_lReturn = oSIRPartyGC.AddItem()
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oSIRPartyGC = Nothing
                Return result
    ...
    '
    ' Description: Deletes a single SIRPartyGC directly from the database.
    '        Note: The SIRPartyGC will NOT be deleted from the collection.
    '
    ' ***************************************************************** '
    Public Function DirectDelete(Optional ByRef vPartyCnt As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Set SIRPartyGC Primary Key

            m_lReturn = oSIRPartyGC.SetProperties(iStatus:=gPMConstants.PMEComponentAction.PMDelete, vPartyCnt:=vPartyCnt)
            ...
            ' Delete the SIRPartyGC from the Database
            m_lReturn = oSIRPartyGC.DeleteItem()
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oSIRPartyGC = Nothing
                Return result
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.DirectDelete(vPartyCnt:=vPartyCnt)
    ...
    '
    ' Description: Gets the required SIRPartyGCs and populate the Collection
    '
    ' ***************************************************************** '
    ...
    Public Function GetDetails(Optional ByRef vLockMode As Object = 0, Optional ByRef vPartyCnt As Object = Nothing) As Integer
        ...
        Try
            ...
            If (Not Informations.IsNothing(vPartyCnt)) AndAlso (Not Double.TryParse(CStr(vPartyCnt), NumberStyles.Number, CultureInfo.CurrentCulture.NumberFormat, dbNumericTemp2)) Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
            ...
            If Not Informations.IsNothing(vPartyCnt) Then
                ...
                ' Add SIRPartyGC to collection
                If m_oSIRPartyGCs.Count = 0 Then
                    m_oSIRPartyGCs.Add(Nothing)
                End If
                m_lReturn = m_oSIRPartyGCs.Add(oNewSIRPartyGC:=oSIRPartyGC)
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Return gPMConstants.PMEReturnCode.PMFalse
                End If
                ...
                'developer guide no. 37(guide)
                m_lReturn = oSIRPartyGC.bSIRParty.GetDetails(vLockMode:=vLockMode, vPartyCnt:=vPartyCnt)
            ...
            Else
                ...
                For lSub As Integer = 1 To lRecordCount
                    ...
                    m_lReturn = oSIRPartyGC.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=m_sCallingAppName)
    ...
    Public Function GetConvictionDetails(ByRef vPartyCnt As Object, ByRef vConviction(,) As Object) As Integer
        ...
        Try
            ...
            'No Need to log details
            'log if no relationships, but dont fail
            'If Not Informations.IsArray(vConviction) Then

            'bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="There are no Conviction details for this party, party_cnt=" & CInt(vPartyCnt), vApp:=ACApp, vClass:=ACClass, vMethod:="GetConvictionDetails", vErrNo:=Informations.Err().Number, vErrDesc:=Informations.Err().Description)
            'Return result
            'End If
    ...
    'mkw090204 PN10359. Add TPS, Emps and Mailshot fields.
    'FSA Phase III
    Public Function GetNext(Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPartyGroupTypeID As Object = Nothing, Optional ByRef vIsRegisteredCharity As Object = Nothing, Optional ByRef vCharityNumber As Object = Nothing, Optional ByRef vNumberofMembers As Object = Nothing, Optional ByRef vSourceID As Object = Nothing, Optional ByRef vShortname As Object = Nothing, Optional ByRef vName As Object = Nothing, Optional ByRef vResolvedName As Object = Nothing, Optional ByRef vIsAlsoAgent As Object = Nothing, Optional ByRef vIsProspect As Object = Nothing, Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vFileCode As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vPaymentMethodCode As Object = Nothing, Optional ByRef vReminderTypeId As Object = Nothing, Optional ByRef vAreaId As Object = Nothing, Optional ByRef vServiceLevelId As Object = Nothing, Optional ByRef vCreditCardCode As Object = Nothing, Optional ByRef vPaymentTermCode As Object = Nothing, Optional ByRef vCCJs As Object = Nothing, Optional ByRef vPartyID As Object = Nothing, Optional ByRef vSeasonalGiftID As Object = Nothing, Optional ByRef vCorrespondenceTypeId As Object = Nothing, Optional ByRef vRenewalStopCodeId As Object = Nothing, Optional ByRef vSwiftPartyID As Object = Nothing, Optional ByRef vLoyaltyNumber As Object = Nothing, Optional ByRef vAlternativeIdentifier As Object = Nothing, Optional ByRef vMarketingSegementInd As Object = Nothing, Optional ByRef vTradingName As Object = Nothing, Optional ByRef vSubBranchId As Object = Nothing, Optional ByRef vTobLetter As Object = Nothing, Optional ByRef vTpsInd As Object = Nothing, Optional ByRef vMailShot As Object = Nothing, Optional ByRef vEmpsInd As Object = Nothing, Optional ByRef vTurnover As Object = Nothing, Optional ByRef vIsFeeClient As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_lCurrentRecord < m_oSIRPartyGCs.Count() Then
            ...
            ' Get the SIRPartyGC Property Values



            'developer guide no. 101(guide)
            m_lReturn = oSIRPartyGC.GetProperties(iStatus, vPartyCnt:=vPartyCnt, vPartyGroupTypeID:=vPartyGroupTypeID, vIsRegisteredCharity:=vIsRegisteredCharity, vCharityNumber:=vCharityNumber, vNumberofMembers:=vNumberofMembers, vTpsInd:=vTpsInd, vEmpsInd:=vEmpsInd, vMailShot:=vMailShot, vTurnover:=vTurnover, vIsFeeClient:=vIsFeeClient)
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.GetDetails(vPartyCnt:=vPartyCnt)
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.GetNext(vSourceID:=vSourceID,
                                         vPartyID:=vPartyID,
                                         vShortname:=vShortname,
                                         vResolvedName:=vResolvedName,
                                         vName:=vName,
                                         vIsAlsoAgent:=vIsAlsoAgent,
                                         vIsProspect:=vIsProspect,
                                         vAgentCnt:=vAgentCnt,
                                         vConsultantCnt:=vConsultantCnt,
                                         vFileCode:=vFileCode,
                                         vCurrencyID:=vCurrencyID,
                                         vPaymentMethodCode:=vPaymentMethodCode,
                                         vReminderTypeId:=vReminderTypeId,
                                         vAreaId:=vAreaId,
                                         vServiceLevelId:=vServiceLevelId,
                                         vCreditCardCode:=vCreditCardCode,
                                         vPaymentTermCode:=vPaymentTermCode,
                                         vCCJs:=vCCJs, vSeasonalGiftID:=vSeasonalGiftID,
                                         vCorrespondenceTypeId:=vCorrespondenceTypeId,
                                         vRenewalStopCodeId:=vRenewalStopCodeId,
                                         vSwiftPartyID:=vSwiftPartyID,
                                         vLoyaltyNumber:=vLoyaltyNumber, vAlternativeIdentifier:=vAlternativeIdentifier,
    ...
    ' Name: EditAdd (Public)
    '
    ' Description: Adds the supplied SIRPartyGC into the Collection.
    ...
    '                MarketingSegmentInd, TradingName and SubBranchId
    'mkw090204 PN10359. Add TPS, Emps and Mailshot fields.
    'FSA Phase III vTobLetter
    Public Function EditAdd(ByRef lRow As Object, Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPartyGroupTypeID As Object = Nothing, Optional ByRef vIsRegisteredCharity As Object = Nothing, Optional ByRef vCharityNumber As Object = Nothing, Optional ByRef vNumberofMembers As Object = Nothing, Optional ByRef vSourceID As Object = Nothing, Optional ByRef vShortname As Object = Nothing, Optional ByRef vName As Object = Nothing, Optional ByRef vResolvedName As Object = Nothing, Optional ByRef vIsAlsoAgent As Object = Nothing, Optional ByRef vIsProspect As Object = Nothing, Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vFileCode As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vPaymentMethodCode As Object = Nothing, Optional ByRef vReminderTypeId As Object = Nothing, Optional ByRef vAreaId As Object = Nothing, Optional ByRef vServiceLevelId As Object = Nothing, Optional ByRef vCreditCardCode As Object = Nothing, Optional ByRef vPaymentTermCode As Object = Nothing, Optional ByRef vCCJs As Object = Nothing, Optional ByRef vSeasonalGiftID As Object = Nothing, Optional ByRef vCorrespondenceTypeId As Object = Nothing, Optional ByRef vRenewalStopCodeId As Object = Nothing, Optional ByRef vSwiftPartyID As Object = Nothing, Optional ByRef vLoyaltyNumber As Object = Nothing, Optional ByRef vAlternativeIdentifier As Object = Nothing, Optional ByRef vMarketingSegementInd As Object = Nothing, Optional ByRef vTradingName As Object = Nothing, Optional ByRef vSubBranchId As Object = Nothing, Optional ByRef vTobLetter As Object = Nothing, Optional ByRef vTpsInd As Object = Nothing, Optional ByRef vMailShot As Object = Nothing, Optional ByRef vEmpsInd As Object = Nothing, Optional ByRef vTurnover As Object = Nothing, Optional ByRef vIsFeeClient As Object = Nothing) As Integer
        ...
        Try
            ...
            'Get party type id for a Group client
            m_lReturn = m_oLookup.GetEffectiveIDFromCode(v_sTableName:=gSIRLibrary.SIRLookupPartyType, v_sCode:=gSIRLibrary.SIRPartyTypeGroupClient, v_dtEffectiveDate:=DateTime.Now, r_lID:=lPartyTypeID)
            ...
            If m_oSIRPartyGCs.Count() <> (lRow - 1) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.EditAdd(lRow:=lRow,
                        vPartyTypeID:=ToSafeInteger(lPartyTypeID),
                        vSourceID:=vSourceID,
                        vShortname:=vShortname,
                        vName:=vName,
                        vResolvedName:=vResolvedName,
                        ...
                        vCreditCardCode:=vCreditCardCode,
                        vPaymentTermCode:=vPaymentTermCode,
                        vCCJs:=vCCJs, vSeasonalGiftID:=vSeasonalGiftID, vCorrespondenceTypeId:=vCorrespondenceTypeId,
    ...
    '
    ' Description: Validates that this action is valid on the SIRPartyGC
    '              specified and updates the SIRPartyGC with the new values.
    '
    ' ***************************************************************** '
    'DC 28/06/00 Added Correspondence Type Id
    ...
    '                MarketingSegmentInd, TradingName and SubBranchId
    'mkw090204 PN10359. Add TPS, Emps and Mailshot fields.
    Public Function EditUpdate(ByRef lRow As Object, Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPartyGroupTypeID As Object = Nothing, Optional ByRef vIsRegisteredCharity As Object = Nothing, Optional ByRef vCharityNumber As Object = Nothing, Optional ByRef vNumberofMembers As Object = Nothing, Optional ByRef vSourceID As Object = Nothing, Optional ByRef vShortname As Object = Nothing, Optional ByRef vName As Object = Nothing, Optional ByRef vResolvedName As Object = Nothing, Optional ByRef vIsAlsoAgent As Object = Nothing, Optional ByRef vIsProspect As Object = Nothing, Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vFileCode As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vPaymentMethodCode As Object = Nothing, Optional ByRef vReminderTypeId As Object = Nothing, Optional ByRef vAreaId As Object = Nothing, Optional ByRef vServiceLevelId As Object = Nothing, Optional ByRef vCreditCardCode As Object = Nothing, Optional ByRef vPaymentTermCode As Object = Nothing, Optional ByRef vCCJs As Object = Nothing, Optional ByRef vPartyID As Object = Nothing, Optional ByRef vSeasonalGiftID As Object = Nothing, Optional ByRef vCorrespondenceTypeId As Object = Nothing, Optional ByRef vRenewalStopCodeId As Object = Nothing, Optional ByRef vSwiftPartyID As Object = Nothing, Optional ByRef vLoyaltyNumber As Object = Nothing, Optional ByRef vAlternativeIdentifier As Object = Nothing, Optional ByRef vMarketingSegementInd As Object = Nothing, Optional ByRef vTradingName As Object = Nothing, Optional ByRef vSubBranchId As Object = Nothing, Optional ByRef vTobLetter As Object = Nothing, Optional ByRef vTpsInd As Object = Nothing, Optional ByRef vMailShot As Object = Nothing, Optional ByRef vEmpsInd As Object = Nothing, Optional ByRef vTurnover As Object = Nothing, Optional ByRef vIsFeeClient As Object = Nothing) As Integer
        ...
        Try
            ...
            If (lRow < 1) Or (lRow > m_oSIRPartyGCs.Count()) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            ' Get a reference to the row to Edit
            oSIRPartyGC = m_oSIRPartyGCs.Item(lRow)

            ' Check the Status of the SIRPartyGC

            'If status is Add (i.e. It is not in the database),then leave status as Add
            'or If status is Delete, report an error
            'Otherwise set to Edit

            Select Case oSIRPartyGC.DatabaseStatus
            ...
            ' Update SIRPartyGC Attributes

            'developer guide no. 101(guide)
            m_lReturn = oSIRPartyGC.SetProperties(iStatus:=iStatus,
                    vPartyCnt:=vPartyCnt,
                    vPartyGroupTypeID:=vPartyGroupTypeID,
                    vIsRegisteredCharity:=vIsRegisteredCharity,
                    vCharityNumber:=vCharityNumber,
                    vNumberofMembers:=vNumberofMembers,
                    vTpsInd:=vTpsInd,
                    vEmpsInd:=vEmpsInd,
                    vMailShot:=vMailShot,
                    vTurnover:=vTurnover,
                    vIsFeeClient:=vIsFeeClient)
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.EditUpdate(lRow:=lRow,
                    vPartyCnt:=vPartyCnt,
                    vSourceID:=vSourceID,
                    vPartyID:=vPartyID,
                    vShortname:=vShortname,
                    ...
                    vPaymentTermCode:=vPaymentTermCode,
                    vCCJs:=vCCJs, vSeasonalGiftID:=vSeasonalGiftID,
                    vCorrespondenceTypeId:=vCorrespondenceTypeId, vRenewalStopCodeId:=vRenewalStopCodeId, vSwiftPartyID:=vSwiftPartyID,
                    vLoyaltyNumber:=vLoyaltyNumber, vAlternativeIdentifier:=vAlternativeIdentifier,
                    vMarketingSegementInd:=vMarketingSegementInd, vTradingName:=vTradingName,
                    vSubBranchId:=vSubBranchId, vTobLetter:=vTobLetter)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ...
            ' Release reference to SIRPartyGC
            oSIRPartyGC = Nothing
    ...
    '
    ' Description: Validate that the specified SIRPartyGC can be deleted
    ...
    Public Function EditDelete(ByVal lRow As Integer) As Integer
        ...
        Try
            ...
            If oSIRPartyGC.DatabaseStatus = gPMConstants.PMEComponentAction.PMAdd Then
                oSIRPartyGC.DatabaseStatus = gPMConstants.PMEComponentAction.PMDummyDelete
            Else
                oSIRPartyGC.DatabaseStatus = gPMConstants.PMEComponentAction.PMDelete
            End If


            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.EditDelete(lRow:=ToSafeInteger(lRow))
    ...
    Public Function Cancel() As Integer
        ...
        Try
            ...
            For lSub As Integer = 1 To m_oSIRPartyGCs.Count()
                Select Case m_oSIRPartyGCs.Item(lSub).DatabaseStatus
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            ' Loop round Collection
            For lSub = 1 To m_oSIRPartyGCs.Count()
                oSIRPartyGC = m_oSIRPartyGCs.Item(lSub)
                ...
                Select Case oSIRPartyGC.DatabaseStatus
                    ...
                    Case gPMConstants.PMEComponentAction.PMAdd
                        ...
                        m_lReturn = oSIRPartyGC.bSIRParty.Update()
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("oSIRPartyGC.bSIRParty.Update", "Failed", gPMConstants.PMELogLevel.PMLogError)
                        End If

                        ' Retrieve Primary Key of Core Item added

                        m_lPartyCnt = oSIRPartyGC.bSIRParty.PartyCnt
                        oSIRPartyGC.PartyCnt = m_lPartyCnt

                        m_lReturn = oSIRPartyGC.AddItem()
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("oSIRPartyGC.AddItem", "Failed", gPMConstants.PMELogLevel.PMLogError)
                        End If

                        'Add the created event
                        m_lReturn = CreateEvent(r_lEventCnt:=tosafeinteger(lEventCnt), v_lPartyCnt:=PartyCnt, v_lEventTypeId:=PMBConst.PMBEventNewClient, v_dtEventDate:=DateTime.Today)
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Case gPMConstants.PMEComponentAction.PMEdit
                        ...
                        ' Update Item
                        m_lReturn = oSIRPartyGC.UpdateItem()
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("oSIRPartyGC.UpdateItem", "Failed", gPMConstants.PMELogLevel.PMLogError)
                        End If
                        ...
                        If m_sOldClientCode <> m_sNewClientCode Then
                            ...
                            m_lReturn = CreateEvent(r_lEventCnt:=tosafeinteger(lEventCnt), v_lPartyCnt:=oSIRPartyGC.bSIRParty.PartyCnt, v_lEventTypeId:=PMBConst.PMBEventClientNotes, v_dtEventDate:=DateTime.Today, v_vDescription:=tosafestring(sDescription).ToString())
                            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                                gPMFunctions.RaiseError("CreateEvent", "Failed", gPMConstants.PMELogLevel.PMLogError)
                            End If
                        End If
                    ...
                    Case gPMConstants.PMEComponentAction.PMDelete
                        ...
                        m_lReturn = CreateEvent(r_lEventCnt:=tosafeinteger(lEventCnt), v_lPartyCnt:=oSIRPartyGC.bSIRParty.PartyCnt, v_lEventTypeId:=PMBConst.PMBEventDelClient, v_dtEventDate:=DateTime.Today)
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("CreateEvent", "Failed", gPMConstants.PMELogLevel.PMLogError)
                        End If

                        'Now keep a copy of the deleted item
                        m_lReturn = oSIRPartyGC.CopyToEvent(v_lEventCnt:=tosafeinteger(lEventCnt))

                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("oSIRPartyGC.CopyToEvent", "v_lEventCnt:=" & lEventCnt, gPMConstants.PMELogLevel.PMLogError)
                        End If

                        ' Delete Item
                        m_lReturn = oSIRPartyGC.DeleteItem()
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            gPMFunctions.RaiseError("oSIRPartyGC.DeleteItem", "Failed", gPMConstants.PMELogLevel.PMLogError)
                        End If
            ...
            ' Retain the Primary Key of the SIRPartyGC
            With oSIRPartyGC
                PartyCnt = .PartyCnt
            End With
            ...
            If bTransStarted Then
                ...
                Do While lSub <= m_oSIRPartyGCs.Count()

                    ' With the item
                    With m_oSIRPartyGCs.Item(lSub)
    ...
    Public Function GetPartyCnt(Optional ByRef vPartyRef As Object = Nothing, Optional ByRef vPartyCnt As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - need to for to core for shortname
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.GetPartyCnt(vPartyRef:=vPartyRef, vPartyCnt:=vPartyCnt)
    ...
    Public Function GetOtherDetails(Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vAgentRef As Object = Nothing, Optional ByRef vAgentName As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vConsultantRef As Object = Nothing, Optional ByRef vConsultantname As Object = Nothing, Optional ByRef vInsurerCnt As Object = Nothing, Optional ByRef vInsurerRef As Object = Nothing, Optional ByRef vInsurername As Object = Nothing, Optional ByRef vBrokerCnt As Object = Nothing, Optional ByRef vBrokerRef As Object = Nothing, Optional ByRef vBrokername As Object = Nothing, Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vAssociates As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - ned to go to core for agent
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            m_lReturn = oSIRPartyGC.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=m_sCallingAppName, vDatabase:=m_oDatabase)

            m_lReturn = oSIRPartyGC.bSIRParty.GetOtherDetails(vAgentCnt:=vAgentCnt, vAgentRef:=vAgentRef, vAgentName:=vAgentName)
            ...
            If (Not Informations.IsNothing(vConsultantCnt)) AndAlso (Not Object.Equals(vConsultantCnt, Nothing)) AndAlso (Not (Convert.IsDBNull(vConsultantCnt) OrElse Informations.IsNothing(vConsultantCnt))) Then
                m_lReturn = oSIRPartyGC.bSIRParty.GetOtherDetails(vAgentCnt:=vConsultantCnt, vAgentRef:=vConsultantRef, vAgentName:=vConsultantname)
            End If

            If (Not Informations.IsNothing(vInsurerCnt)) AndAlso (Not Object.Equals(vInsurerCnt, Nothing)) AndAlso (Not (Convert.IsDBNull(vInsurerCnt) OrElse Informations.IsNothing(vInsurerCnt))) Then
                m_lReturn = oSIRPartyGC.bSIRParty.GetOtherDetails(vAgentCnt:=vInsurerCnt, vAgentRef:=vInsurerRef, vAgentName:=vInsurername)
            End If

            If (Not Informations.IsNothing(vBrokerCnt)) AndAlso (Not Object.Equals(vBrokerCnt, Nothing)) AndAlso (Not (Convert.IsDBNull(vBrokerCnt) OrElse Informations.IsNothing(vBrokerCnt))) Then
                m_lReturn = oSIRPartyGC.bSIRParty.GetOtherDetails(vAgentCnt:=vBrokerCnt, vAgentRef:=vBrokerRef, vAgentName:=vBrokername)
            End If

            m_lReturn = oSIRPartyGC.bSIRParty.GetAssociates(vPartyCnt:=vPartyCnt, vAssociates:=vAssociates)
    ...
    Public Function GetAddressDetails(ByRef vAddresses As Object) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - need to hit core for address stuff
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.GetAddressDetails(vPartyCnt:=ToSafeInteger(m_lPartyCnt), vAddresses:=vAddresses)
    ...
    Public Function GetAddressTypeLookups(ByRef vAddressTypes As Object) As Integer
        ...
        Try
            ...
            'MsgBox "m_lReturn " & m_lReturn & " for oSIRPartyGC.Initialise"

            'developer guide no
            m_lReturn = oSIRPartyGC.bSIRParty.GetAddressTypeLookups(vAddressTypes:=vAddressTypes)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
    ...
    Public Function GetContactDetails(ByRef vContacts As Object) As Integer
        ...
        Try
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.GetContactDetails(vPartyCnt:=ToSafeInteger(m_lPartyCnt), vContacts:=vContacts)
    ...
    Public Function GetMainContact(ByRef lMainContactCnt As Object, ByRef sMainContactDesc As Object) As Integer
        ...
        Try
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.GetMainContact(vPartyCnt:=ToSafeInteger(m_lPartyCnt), lMainContactCnt:=lMainContactCnt, sMainContactDesc:=sMainContactDesc)
    ...
    Public Function GetRelationshipTypeLookups(ByRef vRelationships As Object) As Integer
        ...
        Try
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.GetRelationshipTypeLookups(vRelationships:=vRelationships)
    ...
    Public Function UpdateAddresses(ByRef vPartyCnt As Object, Optional ByRef vAddAddresses As Object = Nothing, Optional ByRef vDeleteAddresses As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - need to hit core for address updates
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.UpdateAddresses(vPartyCnt:=ToSafeInteger(m_lPartyCnt), vAddAddresses:=vAddAddresses, vDeleteAddresses:=vDeleteAddresses)
    ...
    Public Function UpdateAssociates(ByRef vPartyCnt As Object, ByRef vAssociates As Object) As Integer
        ...
        Try
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.UpdateAssociates(vPartyCnt:=ToSafeInteger(m_lPartyCnt), vAssociates:=vAssociates)
    ...
    '
    ' ***************************************************************** '
    Public Function UpdateMainContact(ByRef vPartyCnt As Object, ByRef lMainContactCnt As Integer, ByRef sMainContactDesc As Object) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - need to hit core for main contact updates
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.UpdateMainContact(vPartyCnt:=ToSafeInteger(m_lPartyCnt), lMainContactCnt:=ToSafeInteger(lMainContactCnt), sMainContactDesc:=sMainContactDesc)
    ...
    Public Function UpdateGemini(ByRef vPartyCnt As Object, ByRef vTask As Object) As Integer
        ...
        Try
            ...
            ' Create New SIRPartyGC - need to hit core to update gemini
            oSIRPartyGC = New bSIRPartyGC.SIRPartyGC()
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.UpdateGemini(vPartyCnt:=vPartyCnt, vTask:=vTask)
    ...
    Public Function UpdateContacts(ByRef vPartyCnt As Object, Optional ByRef vAddContacts As Object = Nothing, Optional ByRef vDeleteContacts As Object = Nothing) As Integer
        ...
        Try
            ...
            'developer guide no. 37(guide)
            m_lReturn = oSIRPartyGC.bSIRParty.UpdateContacts(vPartyCnt:=ToSafeInteger(m_lPartyCnt), vAddContacts:=vAddContacts, vDeleteContacts:=vDeleteContacts)
    ...
    ''' </summary>
    ''' <param name="r_lEventCnt"></param>
    ''' <param name="v_lPartyCnt"></param>
    ''' <param name="v_dtEventDate"></param>
    ''' <param name="v_lEventTypeId"></param>
    ''' <param name="v_vInsuranceFolderCnt"></param>
    ''' <param name="v_vInsuranceFileCnt"></param>
    ''' <param name="v_vClaimCnt"></param>
    ''' <param name="v_vDocumentCnt"></param>
    ''' <param name="v_vOldAddressCnt"></param>
    ''' <param name="v_vNewAddressCnt"></param>
    ''' <param name="v_vCampaignId"></param>
    ''' <param name="v_vDocumentTypeId"></param>
    ''' <param name="v_vReportTypeId"></param>
    ''' <param name="v_vDescription"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function CreateEvent(ByRef r_lEventCnt As Integer, ByVal v_lPartyCnt As Integer, ByVal v_dtEventDate As Date, ByVal v_lEventTypeId As Integer, Optional ByVal v_vInsuranceFolderCnt As Object = Nothing, Optional ByVal v_vInsuranceFileCnt As Object = Nothing, Optional ByVal v_vClaimCnt As Object = Nothing, Optional ByVal v_vDocumentCnt As Object = Nothing, Optional ByVal v_vOldAddressCnt As Object = Nothing, Optional ByVal v_vNewAddressCnt As Object = Nothing, Optional ByVal v_vCampaignId As Object = Nothing, Optional ByVal v_vDocumentTypeId As Object = Nothing, Optional ByVal v_vReportTypeId As Object = Nothing, Optional ByVal v_vDescription As Object = Nothing) As Integer
        ...
        m_lReturn = m_oEvent.DirectAdd(vEventCnt:=r_lEventCnt,
            vPartyCnt:=tosafeinteger(v_lPartyCnt),
            vInsuranceFolderCnt:=v_vInsuranceFolderCnt,
            vInsuranceFileCnt:=v_vInsuranceFileCnt,
            ...
            vEventType:=v_lEventTypeId,
            vUserId:=m_iUserID,
            vEventDate:=v_dtEventDate,
            vDescription:=v_vDescription)
    ...
    Public Function GetCorePartyDetails(ByRef vPartyCnt As Object, Optional ByRef vPartyTypeID As Object = Nothing, Optional ByRef vPartyStructureID As Object = Nothing, Optional ByRef vSourceID As Object = Nothing, Optional ByRef vIsAlsoAgent As Object = Nothing, Optional ByRef vPartyID As Object = Nothing, Optional ByRef vShortname As Object = Nothing, Optional ByRef vName As Object = Nothing, Optional ByRef vResolvedName As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vLanguageID As Object = Nothing, Optional ByRef vCollectTypeID As Object = Nothing, Optional ByRef vAccumTreatmentTypeID As Object = Nothing, Optional ByRef vStatsTreatmentTypeID As Object = Nothing, Optional ByRef vPartyCategoryID As Object = Nothing, Optional ByRef vAgentCnt As Object = Nothing, Optional ByRef vConsultantCnt As Object = Nothing, Optional ByRef vCreatedByID As Object = Nothing, Optional ByRef vDateCreated As Object = Nothing, Optional ByRef vLastModified As Object = Nothing, Optional ByRef vModifiedByID As Object = Nothing, Optional ByRef vPaymentMethodCode As Object = Nothing, Optional ByRef vPaymentTermCode As Object = Nothing, Optional ByRef vCreditCardCode As Object = Nothing, Optional ByRef vFileCode As Object = Nothing, Optional ByRef vABCCount As Object = Nothing, Optional ByRef vStatements As Object = Nothing, Optional ByRef vReminderTypeId As Object = Nothing, Optional ByRef vRenewals As Object = Nothing, Optional ByRef vStatus As Object = Nothing, Optional ByRef vLAstActionType As Object = Nothing, Optional ByRef vIsTravelAgent As Object = Nothing, Optional ByRef vIsProspect As Object = Nothing, Optional ByRef vIsDeleted As Object = Nothing, Optional ByRef vABICodeOn406 As Object = Nothing, Optional ByRef vABICodeOn81 As Object = Nothing, Optional ByRef vABICodeList As Object = Nothing, Optional ByRef vAreaId As Object = Nothing, Optional ByRef vServiceLevelId As Object = Nothing, Optional ByRef vInvariantKey As Object = Nothing, Optional ByRef vRecordStatus As Object = Nothing, Optional ByRef vCCJs As Object = Nothing, Optional ByRef vUserDefinedDataId As Object = Nothing, Optional ByRef vSeasonalGiftID As Object = Nothing, Optional ByRef vCorrespondenceTypeId As Object = Nothing, Optional ByRef vRenewalStopCodeId As Object = Nothing, Optional ByRef vSwiftPartyID As Object = Nothing, Optional ByRef vLoyaltyNumber As Object = Nothing, Optional ByRef vAlternativeIdentifier As Object = Nothing, Optional ByRef vMarketingSegementInd As Object = Nothing, Optional ByRef vTradingName As Object = Nothing, Optional ByRef vSubBranchId As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oSIRPartyGC.Initialise Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetCorePartyDetails")
    ...
    Public Function GetFutureDatedAddresses(ByRef r_vFutureDatedAddresses As Object, Optional ByVal v_vPartyCnt As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oSIRPartyGC.Initialise Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFutureDatedAddresses")

                Return gPMConstants.PMEReturnCode.PMFalse
            End If


            m_lReturn = oSIRPartyGC.bSIRParty.GetFutureDatedAddresses(r_vFutureDatedAddresses:=r_vFutureDatedAddresses, v_vPartyCnt:=v_vPartyCnt)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
    ...
    Public Function CreateFutureDatedAddresses(ByVal v_lPartyCnt As Integer, ByVal v_vFutureDatedAddresses As Object) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oSIRPartyGC.Initialise Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CreateFutureDatedAddresses")

                Return gPMConstants.PMEReturnCode.PMFalse
            End If


            m_lReturn = oSIRPartyGC.bSIRParty.CreateFutureDatedAddresses(v_lPartyCnt:=ToSafeInteger(v_lPartyCnt), v_vFutureDatedAddresses:=v_vFutureDatedAddresses)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
    ...
    Public Function GetAccountID(Optional ByRef vPartyRef As Object = Nothing, Optional ByRef vAccountID As Object = Nothing) As Integer
        ...
        Try
            ...
            m_lReturn = oSIRPartyGC.bSIRParty.GetAccountID(vPartyRef:=vPartyRef, vAccountID:=vAccountID)
    ...
    Public Function CheckDuplicateShortname(ByVal v_sShortname As String, ByRef v_vMatchArray As Object) As Integer
        ...
        Try
            ...
            m_lReturn = oSIRPartyGC.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=m_sCallingAppName, vDatabase:=m_oDatabase)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="oSIRPartyGC.Initialise Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckDuplicateShortname")

                Return gPMConstants.PMEReturnCode.PMFalse
            End If


            result = oSIRPartyGC.bSIRParty.CheckDuplicateShortname(ToSafeString(v_sShortname), v_vMatchArray)
    ...
    Public Function GetPartyDetails(ByVal v_lPartyCnt As Integer, ByRef r_vResults As Object) As Integer
        ...
        Try
            ...
            nReturn = m_oSIRParty.GetPartyDetails(v_lPartyCnt:=tosafeinteger(v_lPartyCnt), r_vResults:=r_vResults)
    ...
    Public Function UpdatePartyDetails(ByVal v_lPartyCnt As Integer, ByVal v_vPartyDetails As Object) As Integer
        ...
        Try
            ...
            nReturn = m_oSIRParty.UpdatePartyDetails(v_lPartyCnt:=tosafeinteger(v_lPartyCnt), v_vPartyDetails:=v_vPartyDetails)
