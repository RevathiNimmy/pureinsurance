...
Public NotInheritable Class Business
    ...
    ' Collection of SIRPartyNetDatas (Private)
    Private m_oSIRPartyNetDatas As bSIRPartyNetData.SIRPartyNetDatas
    ...
    Public Property CurrentRecord() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            Select Case Value
                Case Is < 1
                    m_lCurrentRecord = 0
                Case Is > m_oSIRPartyNetDatas.Count()
                    m_lCurrentRecord = m_oSIRPartyNetDatas.Count()
                Case Else
    ...
    Public ReadOnly Property RecordCount() As Integer
        Get
            ...
            Return m_oSIRPartyNetDatas.Count()
    ...
    Public Function Initialise(ByRef sUserName As String, ByRef sPassword As String, ByRef iUserID As Integer, ByRef iSourceID As Integer, ByRef iLanguageID As Integer, ByRef iCurrencyID As Integer, ByRef iLogLevel As Integer, ByRef sCallingAppName As String, Optional ByRef vDatabase As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Create SIRPartyNetDatas Collection
            m_oSIRPartyNetDatas = New bSIRPartyNetData.SIRPartyNetDatas()
    ...
    '
    ' Description: Adds a single SIRPartyNetData directly into the database.
    '        Note: The SIRPartyNetData will NOT be added to the collection.
    '
    ' ***************************************************************** '
    Public Function DirectAdd(Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPassword As Object = Nothing, Optional ByRef vMothersMaidenName As Object = Nothing, Optional ByRef vTpIntroducerCode As Object = Nothing, Optional ByRef vTpUserCode As Object = Nothing, Optional ByRef vMemorableDate As Object = Nothing, Optional ByRef vAQuestion As Object = Nothing, Optional ByRef vTheAnswer As Object = Nothing, Optional ByRef vUserid As Object = Nothing, Optional ByRef vCurrentInsRenewalDate As Object = Nothing) As Integer

        Dim result As Integer = 0
        Dim oSIRPartyNetData As bSIRPartyNetData.SIRPartyNetData

        Try

            result = gPMConstants.PMEReturnCode.PMTrue

            ' Create a new SIRPartyNetData
            oSIRPartyNetData = New bSIRPartyNetData.SIRPartyNetData()
            m_lReturn = CType(oSIRPartyNetData.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=m_sCallingAppName, vDatabase:=m_oDatabase), gPMConstants.PMEReturnCode)

            ' Populate SIRPartyNetData Attributes


            m_lReturn = CType(oSIRPartyNetData.SetProperties(iStatus:=gPMConstants.PMEComponentAction.PMAdd, vPartyCnt:=vPartyCnt, vPassword:=CStr(vPassword), vMothersMaidenName:=vMothersMaidenName, vTpIntroducerCode:=vTpIntroducerCode, vTpUserCode:=vTpUserCode, vMemorableDate:=vMemorableDate, vAQuestion:=vAQuestion, vTheAnswer:=vTheAnswer, vUserid:=vUserid, vCurrentInsRenewalDate:=vCurrentInsRenewalDate), gPMConstants.PMEReturnCode)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oSIRPartyNetData = Nothing
                Return result
            End If

            ' Add the SIRPartyNetData to the Database
            m_lReturn = CType(oSIRPartyNetData.AddItem(), gPMConstants.PMEReturnCode)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oSIRPartyNetData = Nothing
                Return result
    ...
    '
    ' Description: Deletes a single SIRPartyNetData directly from the database.
    '        Note: The SIRPartyNetData will NOT be deleted from the collection.
    '
    ' ***************************************************************** '
    Public Function DirectDelete(Optional ByRef vPartyCnt As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Set SIRPartyNetData Primary Key

            m_lReturn = CType(oSIRPartyNetData.SetProperties(iStatus:=gPMConstants.PMEComponentAction.PMDelete, vPartyCnt:=vPartyCnt), gPMConstants.PMEReturnCode)
            ...
            ' Delete the SIRPartyNetData from the Database
            m_lReturn = CType(oSIRPartyNetData.DeleteItem(), gPMConstants.PMEReturnCode)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oSIRPartyNetData = Nothing
                Return result
    ...
    '
    ' Description: Gets the required SIRPartyNetDatas and populate the Collection
    '
    ' ***************************************************************** '
    Public Function GetDetails(Optional ByRef vLockMode As Integer = 0, Optional ByRef vPartyCnt As Integer = 0) As Integer
        ...
        Try
            ...
            If Not Informations.IsNothing(vPartyCnt) Then
                ...
                ' Add SIRPartyNetData to collection
                If m_oSIRPartyNetDatas.Count = 0 Then
                    m_oSIRPartyNetDatas.Add(Nothing)
                End If
                m_lReturn = CType(m_oSIRPartyNetDatas.Add(oNewSIRPartyNetData:=oSIRPartyNetData), gPMConstants.PMEReturnCode)
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Return gPMConstants.PMEReturnCode.PMFalse
                End If
    ...
    '
    ' ***************************************************************** '
    Public Function GetNext(Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPassword As Object = Nothing, Optional ByRef vMothersMaidenName As Object = Nothing, Optional ByRef vTpIntroducerCode As Object = Nothing, Optional ByRef vTpUserCode As Object = Nothing, Optional ByRef vMemorableDate As Object = Nothing, Optional ByRef vAQuestion As Object = Nothing, Optional ByRef vTheAnswer As Object = Nothing, Optional ByRef vUserid As Object = Nothing, Optional ByRef vCurrentInsRenewalDate As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_lCurrentRecord < m_oSIRPartyNetDatas.Count() Then
            ...
            oSIRPartyNetData = m_oSIRPartyNetDatas.Item(m_lCurrentRecord)

            ' Get the SIRPartyNetData Property Values


            'developer guide no. 98
            m_lReturn = CType(oSIRPartyNetData.GetProperties(iStatus, vPartyCnt:=vPartyCnt, vPassword:=vPassword, vMothersMaidenName:=vMothersMaidenName, vTpIntroducerCode:=vTpIntroducerCode, vTpUserCode:=vTpUserCode, vMemorableDate:=vMemorableDate, vAQuestion:=vAQuestion, vTheAnswer:=vTheAnswer, vUserid:=vUserid, vCurrentInsRenewalDate:=vCurrentInsRenewalDate), gPMConstants.PMEReturnCode)
    ...
    ' Name: EditAdd (Public)
    '
    ' Description: Adds the supplied SIRPartyNetData into the Collection.
    '              After the Add, lKey should be equal to the number
    '              of items in the collection.
    '
    ' ***************************************************************** '
    Public Function EditAdd(ByRef lRow As Integer, Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPassword As Object = Nothing, Optional ByRef vMothersMaidenName As Object = Nothing, Optional ByRef vTpIntroducerCode As Object = Nothing, Optional ByRef vTpUserCode As Object = Nothing, Optional ByRef vMemorableDate As Object = Nothing, Optional ByRef vAQuestion As Object = Nothing, Optional ByRef vTheAnswer As Object = Nothing, Optional ByRef vUserid As Object = Nothing, Optional ByRef vCurrentInsRenewalDate As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_oSIRPartyNetDatas.Count() <> (lRow - 1) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
    ...
    '
    ' Description: Validates that this action is valid on the SIRPartyNetData
    '              specified and updates the SIRPartyNetData with the new values.
    '
    ' ***************************************************************** '
    Public Function EditUpdate(ByRef lRow As Integer, Optional ByRef vPartyCnt As Object = Nothing, Optional ByRef vPassword As Object = Nothing, Optional ByRef vMothersMaidenName As Object = Nothing, Optional ByRef vTpIntroducerCode As Object = Nothing, Optional ByRef vTpUserCode As Object = Nothing, Optional ByRef vMemorableDate As Object = Nothing, Optional ByRef vAQuestion As Object = Nothing, Optional ByRef vTheAnswer As Object = Nothing, Optional ByRef vUserid As Object = Nothing, Optional ByRef vCurrentInsRenewalDate As Object = Nothing) As Integer
        ...
        Try
            ...
            If (lRow < 1) Or (lRow > m_oSIRPartyNetDatas.Count()) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            ' Get a reference to the row to Edit
            oSIRPartyNetData = m_oSIRPartyNetDatas.Item(lRow)

            ' Check the Status of the SIRPartyNetData

            'If status is Add (i.e. It is not in the database),then leave status as Add
            'or If status is Delete, report an error
            'Otherwise set to Edit

            Select Case oSIRPartyNetData.DatabaseStatus
            ...
            ' Update SIRPartyNetData Attributes


            m_lReturn = CType(oSIRPartyNetData.SetProperties(iStatus:=iStatus, vPartyCnt:=vPartyCnt, vPassword:=CStr(vPassword), vMothersMaidenName:=vMothersMaidenName, vTpIntroducerCode:=vTpIntroducerCode, vTpUserCode:=vTpUserCode, vMemorableDate:=vMemorableDate, vAQuestion:=vAQuestion, vTheAnswer:=vTheAnswer, vUserid:=vUserid, vCurrentInsRenewalDate:=vCurrentInsRenewalDate), gPMConstants.PMEReturnCode)
            ...
            ' Release reference to SIRPartyNetData
            oSIRPartyNetData = Nothing
    ...
    '
    ' Description: Validate that the specified SIRPartyNetData can be deleted
    ...
    Public Function EditDelete(ByVal lRow As Integer) As Integer
        ...
        Try
            ...
            If oSIRPartyNetData.DatabaseStatus = gPMConstants.PMEComponentAction.PMAdd Then
                oSIRPartyNetData.DatabaseStatus = gPMConstants.PMEComponentAction.PMDummyDelete
            Else
                oSIRPartyNetData.DatabaseStatus = gPMConstants.PMEComponentAction.PMDelete
            End If
    ...
    Public Function Cancel() As Integer
        ...
        Try
            ...
            For lSub As Integer = 1 To m_oSIRPartyNetDatas.Count()
                Select Case m_oSIRPartyNetDatas.Item(lSub).DatabaseStatus
    ...
    Public Function Update() As Integer
        ...
        Dim result As Integer = 0
        Dim lSub As Integer
        Dim oSIRPartyNetData As bSIRPartyNetData.SIRPartyNetData = Nothing
        ...
        Try
            ...
            For lSub = 1 To m_oSIRPartyNetDatas.Count()
                oSIRPartyNetData = m_oSIRPartyNetDatas.Item(lSub)
                ...
                Select Case oSIRPartyNetData.DatabaseStatus
                    ...
                    Case gPMConstants.PMEComponentAction.PMEdit
                        ...
                        ' Update Item
                        m_lReturn = CType(oSIRPartyNetData.UpdateItem(), gPMConstants.PMEReturnCode)
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            result = gPMConstants.PMEReturnCode.PMFalse
                            Exit For
                        End If
            ...
            ' Retain the Primary Key of the SIRPartyNetData
            With oSIRPartyNetData
                PartyCnt = .PartyCnt
            End With
            ...
            If bTransStarted Then
                ...
                If result = gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Do While lSub <= m_oSIRPartyNetDatas.Count()

                        ' With the item
                        With m_oSIRPartyNetDatas.Item(lSub)
                            ...
                            Select Case .DatabaseStatus
                                ...
                                Case gPMConstants.PMEComponentAction.PMDelete, gPMConstants.PMEComponentAction.PMDummyDelete
                                    ...
                                    m_oSIRPartyNetDatas.Delete(lSub)
