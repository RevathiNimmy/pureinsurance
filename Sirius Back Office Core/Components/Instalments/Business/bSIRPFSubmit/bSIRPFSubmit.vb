...
Module MainModule
    ...
    Public Const ACApp As String = "bSIRPFSubmit"
    ...
    'Constants defining positions of Insurance File Data
    ...
    Public Const ACPolicyTypeID As Integer = 43 'MKW PN13643
    ...
    Public Const k_PFQuoteUBound As Integer = k_PFQuoteRefundType
    ...
    Public Function NullIfEmpty(ByVal Expression As Object) As Object
        ...
        Try
            ...
            If (CStr(Expression)).Length Then
                Return Expression
            Else
    ...
    '   PF240901 - Created
    ' ***************************************************************** '
    Public Function BlankIfEmpty(ByVal Expression As String) As String

        Try
            If Expression.Length Then
