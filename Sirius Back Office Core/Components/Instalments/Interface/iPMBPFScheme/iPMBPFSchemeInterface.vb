...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        ' Check for errors.
        If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
            ' Pull the information out of the interface
            ' ISS1074
            m_lCompanyNo = frmInterface.CompanyNo
            m_lSchemeNo = frmInterface.SchemeNo
            m_lSchemeVersion = frmInterface.SchemeVersion
            m_sSchemeName = frmInterface.SchemeName

            m_lPartyCnt = frmInterface.PartyCnt
            m_sPartyCode = frmInterface.PartyCode
            m_sPartyName = frmInterface.PartyName
        Else
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .Task = m_iTask
            .TaskMode = m_iTask 'VB 14/02/2005 PN18426
