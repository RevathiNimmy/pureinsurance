...
Public NotInheritable Class Interface_Renamed
    ...
    Public m_sSchemeType As String = ""
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .Productfamily = m_sProductFamily
            .SchemeType = m_sSchemeType
            .PFRFID = m_lPFRFID
            .SpreadCommission = m_bSpreadCommission
            .UniqueId = m_sUniqueId
            .ParentScreenHierarchy = m_sParentScreenHierarchy
            ' {* USER DEFINED CODE (End) *}
        End With
