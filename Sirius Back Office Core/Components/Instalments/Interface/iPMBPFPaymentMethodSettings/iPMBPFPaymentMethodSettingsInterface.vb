...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_nPFPaymentMethod_cnt As Integer
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.PMKeyNamePaymentMethod

                        m_nPFPaymentMethod_cnt = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
    ...
    Public Function GetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 0) = PMNavKeyConst.PMKeyNamePaymentMethod

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 0) = m_nPFPaymentMethod_cnt
    ...
    Private Function ProcessInterface() As Integer
        ...
        ' Display the interface if required
