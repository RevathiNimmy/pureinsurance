...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_lScreenType As Integer ' 0 - export, 1 - post, 2 - recall, 3 - payment (CN)
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case "SCREEN_TYPE"
                        ...
                        m_lScreenType = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))

                        ' Party_cnt required when form is in payment mode (SCREEN_TYPE = 4)
                    Case "party_cnt"
