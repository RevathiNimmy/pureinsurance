...
Friend NotInheritable Class CollectionWrapper
    ...
    Private _m_cCollection As Hashtable = Nothing
    Private Property m_cCollection() As Hashtable
        Get
            If _m_cCollection Is Nothing Then
                _m_cCollection = New Hashtable
            End If
    ...
    '
    ' ***************************************************************** '
    Public Function Add(ByVal v_vItem() As Object, Optional ByVal v_vKey As String = "", Optional ByRef r_vExists As Boolean = False) As Integer
    ...
    '
    ' ***************************************************************** '
    Public Function Item(ByVal v_vKey As String, Optional ByRef r_vItem() As Object = Nothing, Optional ByRef r_vExists As Boolean = False) As Integer
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:=m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Item Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Item", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    ' ***************************************************************** '
    Public Function Remove(ByVal v_vKey As String, Optional ByRef r_vExists As Boolean = False) As Integer
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:=m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Remove Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Remove", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
