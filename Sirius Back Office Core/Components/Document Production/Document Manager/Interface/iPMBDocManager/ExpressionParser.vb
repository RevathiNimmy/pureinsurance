...
Imports System.Text
'Modified by Sudhanshu Behera on 5/28/2010 10:52:06 AM refer developer guide no. 129
Imports SharedFiles
Module ExpressionParser
    ...
    Public Function RemoveWhiteSpaces(ByVal v_sInputString As String) As String
        ...
        Try
            ...
            v_sInputString = Replace(v_sInputString, Chr(148), Chr(34))
            v_sInputString = Replace(v_sInputString, Chr(147), Chr(34))
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="RemoveWhiteSpaces Failed for : " & v_sInputString, vApp:=ACApp, vClass:=ACClass, vMethod:="RemoveWhiteSpaces", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetVariableValue(ByVal sName As String) As String
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetVariableValue Failed for : " & sName, vApp:=ACApp, vClass:=ACClass, vMethod:="GetVariableValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function SetVariableValue(ByVal sName As String, ByVal vValue As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetVariableValue Failed for : " & sName, vApp:=ACApp, vClass:=ACClass, vMethod:="SetVariableValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function ParseFunctionNameAndParams(ByVal v_vInputString As String, ByRef r_sFunctionName As String, ByRef r_vParamArray() As Object) As Integer
        ...
        Try
            ...
            If strArguments.Length > 0 Then
                ...
                If strFunctionName.ToUpper() = "CNUM" Or strFunctionName.ToUpper() = "LEN" Then
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ParseFunctionNameAndParams Failed for : " & v_vInputString, vApp:=ACApp, vClass:=ACClass, vMethod:="ParseFunctionNameAndParams", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function CallBuiltinFunction(ByVal v_sFunctionName As String, ByVal v_vParamArray() As Object, ByRef r_bResultIsNumeric As Boolean) As String
        ...
        Try
            ...
            Select Case strTemp
                ...
                Case "DATEDIFF"
                    ...
                    If IsValidArguments(v_vParamArray, iNoOfArgumentNeeded) Then
                        'v_vParamArray(0) = Replace(v_vParamArray(0), Chr(34), "")
                        'v_vParamArray(1) = ToSafeDate(Replace(v_vParamArray(1), Chr(34), ""))
                        'v_vParamArray(2) = ToSafeDate(Replace(v_vParamArray(2), Chr(34), ""))
                        vReturnValue = DateDiff(ToSafeString(Replace(v_vParamArray(0), Chr(34), "")), ToSafeDate(Replace(v_vParamArray(1), Chr(34), "")), ToSafeDate(Replace(v_vParamArray(2), Chr(34), "")))
                    End If
                Case "DATEPART"
                    '    DatePart(Interval, Date)           Returns part of a date (e.g. day, month, year)
                    iNoOfArgumentNeeded = 2
                    ...
                    If IsValidArguments(v_vParamArray, iNoOfArgumentNeeded) Then
                        Val = DirectCast([Enum].Parse(GetType(DateInterval), v_vParamArray(0)), DateInterval)
                        vReturnValue = DateAndTime.DatePart(val, ToSafeDate(v_vParamArray(1)), FirstDayOfWeek.Sunday, FirstWeekOfYear.Jan1)
                    End If
                Case "FORMATDATETIME"
                    '    FormatDateTime(Date,Format)        Formats a date to a given format
                    iNoOfArgumentNeeded = 2
        ...
        Catch excep As System.Exception
            result = ""
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CallBuiltInFunction Failed for : " & v_sFunctionName, vApp:=ACApp, vClass:=ACClass, vMethod:="CallBuiltInFunction", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
            Return result
        End Try
    End Function
    ...
    Private Function RemoveDoubleQuotes(ByVal v_sValue As String) As String
        ...
        Catch ex As Exception
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=" Failed for RemoveDoubleQuotes: " & v_sValue, vApp:=ACApp, vClass:=ACClass, vMethod:="RemoveDoubleQuotes", vErrNo:=Information.Err().Number, vErrDesc:=ex.Message)
            Return ""
        End Try
    ...
    Public Function IsBuiltInFunction(ByVal v_sFunctionName As String) As Boolean
        ...
        If TempName = "CONCAT" OrElse TempName = "MOD" OrElse TempName = "CHR" OrElse TempName = "INSTR" OrElse TempName = "LCASE" OrElse _
            TempName = "UCASE" OrElse TempName = "LEN" OrElse TempName = "MID" OrElse TempName = "STRCOMP" OrElse TempName = "STRING" OrElse _
            TempName = "LEFT" OrElse TempName = "RIGHT" OrElse TempName = "LTRIM" OrElse TempName = "RTRIM" OrElse TempName = "DATE" OrElse _
            TempName = "TIME" OrElse TempName = "DATEADD" OrElse TempName = "DATEDIFF" OrElse TempName = "DATEPART" OrElse _
            TempName = "FORMATDATETIME" OrElse TempName = "WEEKDAYNAME" OrElse TempName = "MONTHNAME" OrElse TempName = "ISDATE" OrElse _
            TempName = "FORMATCURRENCY" OrElse TempName = "CNUM" OrElse TempName = "CSTR" OrElse TempName = "REPLACE" OrElse _
            TempName = "CDATE" OrElse TempName = "MONTH" OrElse TempName = "FORMATNUMBER" OrElse TempName = "ROUND" Then
            Return True
        Else
            Return False
        End If
    ...
    Public Function ProperSplit(ByVal v_sInputString As String, Optional ByVal v_sDelimter As String = ",") As Object
        ...
        Try
            ...
            If iStringLength > 0 Then
                ...
                Do While iDelimPosition <> 0
                    ...
                    If sDatafield.Substring(0, 1) = Strings.Chr(147).ToString() Then
                        sDatafield = v_sInputString.Substring(1)
                    End If

                    If sDatafield.Substring(sDatafield.Length - 1) = Strings.Chr(148).ToString() Then
                        sDatafield = sDatafield.Substring(0, sDatafield.Length - 1)
                    End If
                ...
                aData1(iIndex) = RemoveDoubleQuotes(v_sInputString)
            Else
            End If
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ProperSplit Failed for : " & v_sInputString, vApp:=ACApp, vClass:=ACClass, vMethod:="ProperSplit", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Function NoOfOccurences(ByVal v_sSource As String, ByVal v_sStringToMatch As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="NoOfOccurences Failed for : " & v_sSource & " : " & v_sStringToMatch, vApp:=ACApp, vClass:=ACClass, vMethod:="NoOfOccurences", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function NthInstanceOf(ByVal sString As String, ByVal sSearched As String, Optional ByVal Instance As Integer = 1, Optional ByVal nStartFrom As Integer = 1, Optional ByVal eCompareMethod As CompareMethod = CompareMethod.Text, Optional ByVal bFromLastMatch As Boolean = False) As Integer
        ...
        Catch excep As System.Exception
            ...
            iPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="NthInstanceOf Failed for : " & sString & " : " & sSearched, vApp:=ACApp, vClass:=ACClass, vMethod:="NthInstanceOf", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
