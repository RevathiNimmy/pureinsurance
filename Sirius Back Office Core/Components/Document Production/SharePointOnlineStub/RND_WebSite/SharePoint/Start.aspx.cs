...
public partial class SharePoint_Start : System.Web.UI.Page
{
    protected enum CredentialType
    {
        Network,
        Sharepoint
    };
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //List list = mySite.Lists.GetByTitle("EEEE");

        //list.RootFolder.UniqueContentTypeOrder = getContentType();
    ...
    private void AddFile()
    {
        ...
        { lblMessage.Text = "RootFolder Name missing"; txtRootFolder.Focus(); return; }
        if (string.IsNullOrEmpty(txtfilename.Text))
        { lblMessage.Text = "FileName missing"; txtfilename.Focus(); return; }

        //Verify Folder if not created, Create on sharepoint
        createSharePointOnlineFolder();
        ...
        try
        {
            ...
            context.Credentials = SetNetworkCredentials();
    ...
    private void createSharePointOnlineFolder()
    {
        try
        {
            ClientContext clientContext = new ClientContext(textBox1.Text);
            clientContext.Credentials = SetNetworkCredentials();
    ...
    protected void btnCraeteList_Click(object sender, EventArgs e)
    {
        ...
        createContext.Credentials = SetNetworkCredentials();
    ...
    protected void btnDeleteList_Click(object sender, EventArgs e)
    {
        ...
        deleteContext.Credentials = SetNetworkCredentials();
    ...
    private NetworkCredential SetNetworkCredentials()
    {
        CredentialCache.DefaultNetworkCredentials.Domain = "ssp-worldwide.com";
    ...
    {
        return new SharePointOnlineCredentials("yogender.singh@siriusfs.com", SecureStore("Password@1"));
    }

    private SecureString SecureStore(string password)
    {
