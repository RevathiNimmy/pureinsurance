<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Start.aspx.cs" Inherits="SharePoint_Start" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="border: 1px solid #cccccc; height: 200px; margin-bottom:40px; margin-top:20px;">
            ...
            <div style="width: 95%; float: left;">
                Set Root Folder, SubFolder and File name before uploading to share point<br />
                <div style="width: 35%; float: left; font-size: smaller;">https://ssplimited.sharepoint.com/sites/Test/PureDocuments/</div>
                <div style="width: 25%; float: left;">
                    <asp:TextBox ID="txtRootFolder" runat="server" placeholder="Root Folder" Style="width: 85%;"></asp:TextBox>/
                </div>
                <div style="width: 15%; float: left;">
                    <asp:TextBox ID="txtSubFolder" runat="server" placeholder="Sub folders(ex-general/Document)" Style="width: 85%;"></asp:TextBox>/
                </div>
                <div style="width: 25%; float: left;">
                    <asp:TextBox ID="txtfilename" runat="server" placeholder="filename(ex-xyz.pdf/txt)" Style="width: 85%;"></asp:TextBox>
                </div>
            </div>
            <div style="width: 95%; float: left; margin-top:30px;margin-left:15px;">
            <asp:Button ID="btnAddFile" runat="server" Text="add new File" OnClick="btnAddFile_Click" />
                </div>
        </div>
