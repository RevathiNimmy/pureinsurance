...
Public NotInheritable Class NavigatorV3
    ...
    Public Function NavigatorV3_SetKeys(ByRef vKeyArray(,) As Object) As Integer Implements aPMNav.NavigatorV3.SetKeys
        ...
        Try
            ...
            'Modified by Sudhanshu Behera on 5/4/2010 4:44:50 PM refer developer guide no. 24 (guide)
            'm_oInterface.set_PolicySharesArray(PolicySharesArray)
            m_oInterface.PolicySharesArray = PolicySharesArray
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
