...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMBSpoolerOLE.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMBSpoolerOLE.frmInterface, ByRef oBusiness As Object) As gPMConstants.PMEReturnCode
    ...
    '
    ' ***************************************************************** '
    Public Function GetInterfaceDetails() As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            '    ' Copy the document.
            '    If (m_frmInterface.Mode = ACNormalMode) Then
    ...
    '
    ' ***************************************************************** '
    Public Function ProcessCommand() As gPMConstants.PMEReturnCode
    ...
    '
    ' ***************************************************************** '
    Private Function DisableForm(ByRef lDisabled As Integer) As gPMConstants.PMEReturnCode
        ...
        'UPGRADE_WARNING: (2065) Form property m_frmInterface.Controls has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
