...
Partial Public Class frmInterface
    ...
    Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
        ...
        'm_lReturn = CType(SSfunc.ShowHelp(dlgHelp, cmdHelp.HelpContextID), gPMConstants.PMEReturnCode)
    ...
    Private Function RefreshList() As Integer
        ...
        Try
            ...
            For iLoop1 As Integer = 0 To m_vDataArray.GetUpperBound(1)
                ...
                If CDbl(m_vDataArray(ACArrayDocumentTypeID, iLoop1)) > 6 Then
            ...
            'If any in the list, then select first one
    ...
    '
    'For 'iLoop1 As Integer = 0 To m_vDataArray.GetUpperBound(1)
    'If CInt(m_vDataArray(ACArrayDocumentTypeID, iLoop1)) = v_iID Then
    'r_iIndex = iLoop1
    'Exit For
    'End If
    'Next iLoop1
    ...
    Private Function GetNextID(ByRef r_lID As Integer) As Integer
        ...
        Try
            ...
            For iLoop1 As Integer = 0 To m_vDataArray.GetUpperBound(1)
                ...
                lCurrentID = CInt(m_vDataArray(ACArrayDocumentTypeID, iLoop1))
    ...
    Private Function ProcessDetails(ByVal v_iTask As Integer) As Integer
        ...
        Try
            ...
            If v_iTask = gPMConstants.PMEComponentAction.PMEdit Then
                ...
                With oDetail
                    .DocumentTypeID = CInt(m_vDataArray(ACArrayDocumentTypeID, iIndex))
                    .Code = CStr(m_vDataArray(ACArrayCode, iIndex))
                    .Description = CStr(m_vDataArray(ACArrayDescription, iIndex))
                    .IsEditableAfterMerging = CInt(m_vDataArray(ACArrayIsEditableAfterMerging, iIndex))
                End With
            ...
            If oDetail.Status <> gPMConstants.PMEReturnCode.PMCancel Then
                ...
                If v_iTask = gPMConstants.PMEComponentAction.PMAdd Then
                    ...
                    If Information.IsArray(m_vDataArray) Then
                        ...
                        ReDim Preserve m_vDataArray(6, iIndex)
                    Else
                        iIndex = 0
                        ReDim m_vDataArray(6, iIndex)
                    End If
                    ...
                    ' Get the next free number so that new document type can be set up to this one
                    m_vDataArray(ACArrayDocumentTypeID, iIndex) = lNextFreeID
                ...
                m_vDataArray(ACArrayIsEditableAfterMerging, iIndex) = oDetail.IsEditableAfterMerging
