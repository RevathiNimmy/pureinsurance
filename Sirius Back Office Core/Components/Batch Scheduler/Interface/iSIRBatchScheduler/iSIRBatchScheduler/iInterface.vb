...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        m_lReturn = CType(ShowInterface(lDisplayState:=Microsoft.VisualBasic.Compatibility.VB6.FormShowConstants.Modal), gPMConstants.PMEReturnCode)
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        Microsoft.VisualBasic.Compatibility.VB6.ShowForm(m_frmInterface, lDisplayState)

        If lDisplayState = Microsoft.VisualBasic.Compatibility.VB6.FormShowConstants.Modal Then
