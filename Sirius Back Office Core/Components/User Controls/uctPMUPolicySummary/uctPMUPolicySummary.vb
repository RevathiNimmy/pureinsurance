...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("uctPMUPolicySummary_NET.uctPMUPolicySummary")> _
Partial Public Class uctPMUPolicySummary
    ...
    ' which class this is.
    Private Const ACClass As String = "uctPMUPolicySummaryControl"
    ...
    'TN20010112 Start
    'Private m_lLeadInsurerCnt As Long
    ...
    Private m_vThisPremium As Double
    ...
    Public Property InsuranceFileCnt() As Integer
        ...
        End Set
    End Property
    'To hold that whether the CheckBox of Include Closed Branch
    'was checked or not in FindParty
    <Browsable(False)> _
    Public ReadOnly Property IsIncludeClosedBranchChecked() As Boolean
        Get
    ...
    Public Function ShowHelpScreen(Optional ByRef cmdHelp As Object = Nothing, Optional ByRef ScreenHelpID As Object = Nothing) As Integer
        ...
        'Modified by Archana Tokas on 4/27/2010 5:33:54 PM refer developer guide no. 20
    ...
    Private Function LockPolicy() As Integer
            ...
            Select Case m_lReturn
                ...
                Case gPMConstants.PMEReturnCode.PMFalse
                    ...
                    If sLockedBy = "ERROR" Then
                        ...
                        ' Log Error.
                        gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Error trying to lock record", vApp:=ACApp, vClass:=ACClass, vMethod:="LockPolicy", excep:=New Exception(Information.Err().Description))
                        Return result
                    Else
                        result = gPMConstants.PMEReturnCode.PMFalse
                ...
                Case Else
                    result = gPMConstants.PMEReturnCode.PMFalse
                    ' Log Error.
                    gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to lock the policy", vApp:=ACApp, vClass:=ACClass, vMethod:="LockPolicy", excep:=New Exception(Information.Err().Description))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="LockPolicy Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="LockPolicy", excep:=excep)
    ...
    Private Function UnlockPolicy() As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Error trying to unlock the policy", vApp:=ACApp, vClass:=ACClass, vMethod:="UnlockPolicy", excep:=New Exception(Information.Err().Description))
                Return result
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="UnlockPolicy Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="UnlockPolicy", excep:=excep)
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            If sHelpFile <> "" Then
                'Modified by Archana Tokas on 4/27/2010 5:34:03 PM refer developer guide no solution 39
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Failed to process the interface.
                result = gPMConstants.PMEReturnCode.PMFalse
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get PMLock", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise", excep:=New Exception(Information.Err().Description))
    ...
    Public Function LoadControl() As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' Log Error Message
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to set the process modes for the business object", vApp:=ACApp, vClass:=ACClass, vMethod:="Form_Load")
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to load interface", vApp:=ACApp, vClass:=ACClass, vMethod:="Form_Load", excep:=excep)
    ...
    Public Function GetPolicy() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get the interface details", vApp:=ACApp, vClass:=ACClass, vMethod:="GetPolicy", excep:=excep)
    ...
    Public Function ValidateInsurer() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ValidateInsurerFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="ValidateInsurer", excep:=excep)
    ...
    Private Function BusinessToData() As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to retreive the details from the business object", vApp:=ACApp, vClass:=ACClass, vMethod:="BusinessToData")
            End If
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to set the values from the array", vApp:=ACApp, vClass:=ACClass, vMethod:="BusinessToData")
            End If
            'Get additional details required for display that not stored on this
            'record
            'TN20010112 Start
            '    m_lReturn& = m_oBusiness.GetOtherDetails(vInsurerCnt:=m_lLeadInsurerCnt, vInsurerName:=m_sInsurerRef, _
            ''                                             vBrokerCnt:=Null, vBrokerName:="", _
            ''                                             vRiskId:=m_vRiskCodeId, vRiskDesc:=m_sRiskDesc, vRiskGroupId:=m_vRiskGroupId, _
            ''                                             vAnalysisId:=Null, vAnalysisDesc:="", _
            ''                                             vHandlerCnt:=m_vAccountHandlerCnt, vHandlerName:=m_sAccountHandlerDesc, _
            ''                                             vAgentCnt:=Null, vAgentName:="", _
            ''                                             vInsuranceFileCnt:=m_lInsuranceFileCnt, vRelatedPolicyCnt:="", _
            ''                                             vRelatedPolicyCode:=Null, vRelationshipType:="", _
            ''                                             vPolicyTypeId:=Null, vPolicyTypeDesc:="", _
            ''                                             vSchemeId:=Null, vSchemeDesc:="")



            m_lReturn = m_oBusiness.GetOtherDetails(vInsurerCnt:=DBNull.Value, vInsurerName:="", vBrokerCnt:=DBNull.Value, vBrokerName:="", vRiskId:=m_vRiskCodeId, vRiskDesc:=m_sRiskDesc, vRiskGroupId:=m_vRiskGroupId, vAnalysisId:=DBNull.Value, vAnalysisDesc:="", vHandlerCnt:=m_vAccountHandlerCnt, vHandlerName:=m_sAccountHandlerDesc, vAgentCnt:=m_lLeadAgentCnt, vAgentName:=m_sLeadAgentName, vInsuranceFileCnt:=m_lInsuranceFileCnt, vRelatedPolicyCnt:="", vRelatedPolicyCode:=DBNull.Value, vRelationshipType:="", vPolicyTypeId:=DBNull.Value, vPolicyTypeDesc:="", vSchemeId:=m_lProductID, vSchemeDesc:=m_sProductName)
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to retrieve the agent details from the business object ", vApp:=ACApp, vClass:=ACClass, vMethod:="BusinessToData")
            End If
    ...
    Public Function BusinessToInterface() As Integer
        ...
        Try
            ...
            m_lReturn = m_oFormFields.FormatControl(ctlControl:=txtLeadAgent, vControlValue:=m_sLeadAgentName)
            ...
            m_lReturn = m_oFormFields.FormatControl(ctlControl:=txtProduct, vControlValue:=m_sProductName)
    ...
    Public Function DeleteClick() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="DeleteClick Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="DeleteClick", excep:=excep)
    ...
    Private Function DeletePolicy() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="DeletePolicy Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="DeletePolicy", excep:=excep)
    ...
    Private Function DisplayCaptions() As Integer
        ...
        'Start (Girija chokkalingam) - (Tech Spec - S4IRD001 - US Localisation.doc) - (5.14.1.1)
        Dim result As Integer = 0
        ...
        'End (Girija chokkalingam) - (Tech Spec - S4IRD001 - US Localisation.doc) - (5.14.1.1)
        ...
        Try
            ...
            lblPolicyNo.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACPolicyNo, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


            lblLeadAgent.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACLeadAgent, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


            lblProduct.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACProduct, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


            lblAccountHandler.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACAccountHandler, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


            lblcoverFrom.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACCoverFrom, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            ...
            lblPremiumPayable.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACPremiumPayable, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


            lblCoverTo.Text = CStr(iPMFunc.GetResData(iLangID:=iLanguageId, lId:=ACCoverTo, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
    ...
    Private Function DisplayLookupDetails() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to display the lookup details", vApp:=ACApp, vClass:=ACClass, vMethod:="DisplayLookupDetails", excep:=excep)
    ...
    Public Function EditClick() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="EditClick Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="EditClick", excep:=excep)
    ...
    Private Function GetBusiness() As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get details from the business object", vApp:=ACApp, vClass:=ACClass, vMethod:="GetBusiness")
    ...
    Private Function GetLookupDetails(ByRef sLookupTable As String, ByRef ctlLookup As Control) As Integer
        ...
        Try
            ...
            If Not bFoundMatch Then
                ...
                ' Log Error.
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get details for the table," & sLookupTable, vApp:=ACApp, vClass:=ACClass, vMethod:="GetLookupDetails")
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get all of the lookup details", vApp:=ACApp, vClass:=ACClass, vMethod:="GetLookupDetails", excep:=excep)
    ...
    '              the lookup function.
    'Update History
    ' Change 1.0 JT PN13238 Change to Lookuptype to AllWiithDeleted
    ' ***************************************************************** '
        ...
        Try
            ...
            Select Case (m_iTask)
                ...
                Case gPMConstants.PMEComponentAction.PMEdit
                    ...
                    m_lReturn = m_oBusiness.GetLookupValues(iLookupType:=gPMConstants.PMELookupType.PMLookupAllWithDeleted, vTableArray:=m_vLookupValues, iLanguageID:=g_iLanguageID, vResultArray:=m_vLookupDetails)
                    'Made comment since in edit also we might show Closed Branch
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    'This won't work because there is a bug in bPMLookup when the value is null
                    ...
                    '
                    ' use this for now
                    'If IsIncludeClosedBranchChecked = True Then
    ...
    Private Function GetRiskScreen(ByRef vRiskGroupId As Object) As Integer
        ...
        Try
            ...
            If m_lPolicyTypeId <> PMBConst.PMBPolicyTypeGeneral Then
                Return result
            End If
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                result = gPMConstants.PMEReturnCode.PMFalse
                Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
                oDict.Add("vRiskGroupId", vRiskGroupId)
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get bSIRRiskGroup", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise", excep:=New Exception(Information.Err().Description), oDicParms:=oDict)
            End If
        ...
        Catch excep As System.Exception
            ...
            Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
            oDict.Add("vRiskGroupId", vRiskGroupId)
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get Risk Screen from business object", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRiskScreen", excep:=excep, oDicParms:=oDict)
                ...
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            ...
                            ' Log Error.
                            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to add the details", vApp:=ACApp, vClass:=ACClass, vMethod:="ProcessCommand")
                        End If
                    End If
                ...
                Case gPMConstants.PMEComponentAction.PMEdit
                    ...
                    Else
                        ...
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            ...
                            ' Log Error.
                            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to update the details", vApp:=ACApp, vClass:=ACClass, vMethod:="ProcessCommand")
                        End If
                    End If
            End Select
    ...
    Private Function SetFieldValidation() As Integer
        ...
        Try
            ...
            End If
            'lead agent Name
            m_lReturn = m_oFormFields.AddNewFormField(ctlControl:=txtLeadAgent, lFieldType:=gPMConstants.PMEDataType.PMString, lFormat:=gPMConstants.PMEFormatStyle.PMFormatString, lMandatory:=gPMConstants.PMEMandatoryStatus.PMNonMandatory)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
            'product
            m_lReturn = m_oFormFields.AddNewFormField(ctlControl:=txtProduct, lFieldType:=gPMConstants.PMEDataType.PMString, lFormat:=gPMConstants.PMEFormatStyle.PMFormatString, lMandatory:=gPMConstants.PMEMandatoryStatus.PMNonMandatory)
    ...
    Private Function SetValuesFromArray(ByVal v_vFieldArray() As Object) As Integer
        ...
        Try
            ...
            If Convert.IsDBNull(v_vFieldArray(InsuranceFileConst.ACLeadAgentCnt)) Or IsNothing(v_vFieldArray(InsuranceFileConst.ACLeadAgentCnt)) Then
                m_lLeadAgentCnt = 0
            Else

                m_lLeadAgentCnt = CInt(v_vFieldArray(InsuranceFileConst.ACLeadAgentCnt))
            End If

            If Convert.IsDBNull(v_vFieldArray(InsuranceFileConst.ACProductID)) Or IsNothing(v_vFieldArray(InsuranceFileConst.ACProductID)) Then
                m_lProductID = 0
            Else
            ...
            m_vThisPremium = CStr(ToSafeDouble(v_vFieldArray(InsuranceFileConst.ACThisPremium), 0) + ToSafeDouble(v_vFieldArray(InsuranceFileConst.ACFeesTaxes), 0))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            gPMFunctions.LogMessageToFile(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetValuesFromArray Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="SetValuesFromArray", excep:=excep)
