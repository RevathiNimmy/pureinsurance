    ...
    Public Function CheckForUnderwritingBranch(ByVal v_iSourceId As Integer, Optional ByRef r_bUnderwritingBranchEnabled As Boolean = False, Optional ByRef r_bIsUnderwritingBranch As Boolean = False) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getProductOptionValue Failed for option " & gPMConstants.SIRHiddenOptions.SIROPTUnderwritingBranchEnabled, vApp:=ACApp, vClass:=ACClass, vMethod:="CheckForUnderwritingBranch", oDicParms:=oDict)
            ...
            If Conversion.Val(vValue) = 1 Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
                    oDict.Add("v_iSourceId", v_iSourceId)
                    gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get instance of PMSource", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckForUnderwritingBranch", oDicParms:=oDict)
                    oPMSource = Nothing
                    Return result
                End If
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
                    oDict.Add("v_iSourceId", v_iSourceId)
                    gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="m_oSource.GetDetails Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckForUnderwritingBranch", oDicParms:=oDict)
                    oPMSource = Nothing
                    Return result
                End If
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
                    oDict.Add("v_iSourceId", v_iSourceId)
                    gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="m_oSource.GetNext Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckForUnderwritingBranch", oDicParms:=oDict)
                    oPMSource = Nothing
                    Return result
                End If
        ...
        Catch excep As System.Exception
            ...
            Dim oDict As New System.Collections.Generic.Dictionary(Of String, Object)
            oDict.Add("v_iSourceId", v_iSourceId)
            gPMFunctions.LogMessageToFile(sUserName:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CheckForUnderwritingBranch Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CheckForUnderwritingBranch", excep:=excep, oDicParms:=oDict)
