...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As frmFrequencyScheduler
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            ' There is never anything to commit here
    ...
    ' Name: DisableForm
    '
    ' Description: Sets all of the interface details to the disable state passed.
    ' ***************************************************************** '
