...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            If (m_frmInterface.cboAddUsageType.ItemCode = "BROKERLINK") And (m_frmInterface.Task = gPMConstants.PMEComponentAction.PMEdit) And (vUnderwriting = "A") Then
                m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView
                bBrokerLink = True
            End If
            ...
            If m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView Then
                ...
                m_lReturn = CType(DisableForm(lDisabled:=True, bDisableAll:=bBrokerLink), gPMConstants.PMEReturnCode)
    ...
    '
    ' ***************************************************************** '
    Private Function DisableForm(ByRef lDisabled As Integer, Optional ByRef bDisableAll As Boolean = False) As Integer
        ...
        For Each ctlFormControl As Control In ContainerHelper.Controls(m_frmInterface)
            ...
            ElseIf (TypeOf ctlFormControl Is CheckBox) Then
                ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
            ElseIf (TypeOf ctlFormControl Is PMAddressControl.uctPMAddressControl) And bDisableAll Then
                ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
            ElseIf (TypeOf ctlFormControl Is PMLookupControl.cboPMLookup) And bDisableAll Then
                ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
            ElseIf (TypeOf ctlFormControl Is GroupBox) And bDisableAll Then
                ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
            End If
        Next ctlFormControl
