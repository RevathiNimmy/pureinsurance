...
Public NotInheritable Class Interface_Renamed
    ...
    ' File Name     : iSIRPolicySummaryInterface.cls
    ' Date          : 17-10-2002
    ' Author        : Ram Chandrabose
    ' Description   : Interface class for iSIRPolicySummary.dll
    '
    ' Edit History  :
    ' RAM20021016   : Created
    ' ***************************************************************** '
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_oFormInterface = New frmMainSFU()
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_oFormInterface
            ...
            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "CallingAppName", m_sCallingAppName)

            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "Task", m_iTask)

            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "Navigate", m_lNavigate)

            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "ProcessMode", m_lProcessMode)

            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "TransactionType", m_sTransactionType)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "EffectiveDate", m_dtEffectiveDate)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "InsuranceFolderCnt", m_lInsuranceFolderCnt)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "InsuranceFileCnt", m_lInsuranceFileCnt)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "InsuranceRef", m_sInsuranceRef)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "PartyCnt", m_lPartyCnt)


            ReflectionHelper.SetMember(MainModule.m_oFormInterface, "PartyShortName", m_sPartyShortName)
        End With
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        If lDisplayState = FormShowConstants.Modal Then
            ...
            If ReflectionHelper.GetMember(MainModule.m_oFormInterface, "ErrorNumber") <> 0 Then

                result = ReflectionHelper.GetMember(MainModule.m_oFormInterface, "ErrorNumber")
            End If
        End If
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With m_oFormInterface
            ...
            m_lStatus = ReflectionHelper.GetMember(MainModule.m_oFormInterface, "Status")
    ...
    Public Function switchTo() As Integer
        ...
        Try
            ...
            ReflectionHelper.Invoke(MainModule.m_oFormInterface, "switchTo", New Object() {})
