...
Friend NotInheritable Class General
    ...
    Public Function Initialise(ByRef frmInterface As frmInterface, ByRef oBusiness As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise the object", vApp:=ACApp, vClass:=ACClass, vMethod:=ACMethod, vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Dim result As Integer = 0
        Const ACMethod As String = "GetInterfaceDetails"
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get the interface details", vApp:=ACApp, vClass:=ACClass, vMethod:=ACMethod, vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function ProcessCommand(ByRef r_bChangesMade As Boolean) As Integer
        ...
        Dim result As Integer = 0
        Const ACMethod As String = "ProcessCommand"
        ...
        Try
            ...
            If m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel Then
                If r_bChangesMade Then
                    ...
                    sTitle = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionCancelDetailsTitle, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    sMessage = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionCancelDetails, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to process command", vApp:=ACApp, vClass:=ACClass, vMethod:=ACMethod, vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Private Function DisableForm(ByRef lDisabled As Integer) As Integer
        ...
        Dim result As Integer = 0
        Const ACMethod As String = "DisableForm"
    ...
    Public Sub New()
        ...
        '
        ' Log Error Message
        'iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise the interface general class", vApp:=ACApp, vClass:=ACClass, vMethod:=ACMethod, vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
        '
        'Exit Sub
        '
        'End Try
