...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMBTextFileDesc.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMBTextFileDesc.frmInterface, ByRef oBusiness As Object) As Integer
