...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("SIRTextFile_NET.SIRTextFile")> _
Public NotInheritable Class SIRTextFile
    ...
    Public Function Add() As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                'In this case it's AddKeyInputParam, not AddInputParam
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                'AK 010802 - scalability changes - check for null values

                If Not (Convert.IsDBNull(oFields("entity_type_id")) Or IsNothing(oFields("entity_type_id"))) Then
                    'developer guide no. 145
                    EntityTypeId = oFields("entity_type_id")
                Else
                    EntityTypeId = 0
                End If

                If Not (Convert.IsDBNull(oFields("entity_cnt")) Or IsNothing(oFields("entity_cnt"))) Then
                    'developer guide no. 145
                    EntityCnt = oFields("entity_cnt")
                Else
                    EntityCnt = 0
                End If

                If Convert.IsDBNull(oFields("slot_number")) Or IsNothing(oFields("slot_number")) Then
                    'developer guide no. 145
                ...
                If Not (Convert.IsDBNull(oFields("file_number")) Or IsNothing(oFields("file_number"))) Then
                    'developer guide no. 145
                    FileNumber = oFields("file_number")
                Else
                    FileNumber = 0
                End If
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="file_number", vValue:=CStr(FileNumber), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="entity_type_id", vValue:=CStr(EntityTypeId), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="entity_cnt", vValue:=CStr(EntityCnt), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="slot_number", vValue:=CStr(SlotNumber), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyOutputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="file_number", vValue:=CStr(0), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            FileNumber = .Parameters.Item("file_number").Value
