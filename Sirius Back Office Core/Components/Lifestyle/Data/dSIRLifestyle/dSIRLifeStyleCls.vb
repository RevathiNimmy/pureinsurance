...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("PMBLifeStyle_NET.PMBLifeStyle")> _
Public NotInheritable Class PMBLifeStyle
    ...
    '
    ' Description: Selects the required PMBLifeStyle
    '
    ' ***************************************************************** '
    ...
    '
    ' Description: Sets the supplied PMBLifeStyle properties from a database
    '              record.
    ' ***************************************************************** '
    ...
    Public Function SetPropertiesFromDB(ByRef oFields As DataRow) As Integer
        ...
        Try
            ...
            With oFields
                ...
                PartyLifestyleID = oFields("party_lifestyle_id")

                If Convert.IsDBNull(oFields("name")) Or IsNothing(oFields("name")) Then
                ...
                If Convert.IsDBNull(oFields("category")) Or IsNothing(oFields("category")) Then
                ...
                If Convert.IsDBNull(oFields("date_of_birth")) Or IsNothing(oFields("date_of_birth")) Then
                ...
                If Convert.IsDBNull(oFields("gender_code")) Or IsNothing(oFields("gender_code")) Then
                ...
                If Convert.IsDBNull(oFields("occupation_code")) Or IsNothing(oFields("occupation_code")) Then
                ...
                If Convert.IsDBNull(oFields("secondary_occupation_code")) Or IsNothing(oFields("secondary_occupation_code")) Then
                ...
                If Convert.IsDBNull(oFields("is_smoker")) Or IsNothing(oFields("is_smoker")) Then
