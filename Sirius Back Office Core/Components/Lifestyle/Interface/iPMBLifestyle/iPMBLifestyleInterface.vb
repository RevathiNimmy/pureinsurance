...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .PartyLifestyleID = m_lPartyLifestyleID
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            m_lPartyLifestyleID = .PartyLifestyleID

            m_sPartyName = .PartyName
            m_lCategory = .Category
            m_dtDateOfBirth = .DateOfBirth
            m_sGenderCode = .GenderCode
            m_sOccupationCode = .OccupationCode
            m_sSecondaryOccupationCode = .SecondaryOccupationCode
            m_iIsSmoker = .IsSmoker
