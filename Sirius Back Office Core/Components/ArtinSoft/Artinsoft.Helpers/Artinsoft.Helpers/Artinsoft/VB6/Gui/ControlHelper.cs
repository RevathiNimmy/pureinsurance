...
namespace Artinsoft.VB6.Gui
{
    ...
    public class ControlHelper
    {
        ...
        /// </summary>
        private static Dictionary<Control, ControlGraphics> printHash = new Dictionary<Control, ControlGraphics>();
        ...
        public static bool GetEnabled(Control ctrl)
        {
            ...
            return Convert.ToBoolean(Artinsoft.VB6.Utils.ReflectionHelper.GetMember(ctrl, "Enabled"));
        }
        ...
        public static void SetEnabled(Control ctrl, bool value)
        {
            ...
            //fsaborio. Correccion para invocar el metodo enable correcto (casos donde se sobreescribio como new Enabled)
            Artinsoft.VB6.Utils.ReflectionHelper.SetMember(ctrl, "Enabled", value);
        }
        ...
        /// </summary>
        private static Dictionary<Control, Dictionary<string, List<Delegate>>> EventsDisabled = new Dictionary<Control, Dictionary<string, List<Delegate>>>();
