...
namespace Artinsoft.VB6.Gui
{
    ...
    public partial class CommandButtonHelper : Component, IExtenderProvider, ISupportInitialize
    {
        ...
        private static Dictionary<System.Windows.Forms.Button, System.Drawing.Image> DownPictures = new Dictionary<Button, System.Drawing.Image>();
        private static Dictionary<System.Windows.Forms.Button, System.Drawing.Image> UpPictures = new Dictionary<Button, System.Drawing.Image>();
        private static Dictionary<System.Windows.Forms.Button, System.Drawing.Image> DisabledPictures = new Dictionary<Button, System.Drawing.Image>();
        private static Dictionary<System.Windows.Forms.Button, System.Drawing.Color> MaskColor = new Dictionary<Button, Color>();
        ...
        private static Dictionary<Button, Dictionary<newPropertiesEnum, object>> newProperties = new Dictionary<Button, Dictionary<newPropertiesEnum, object>>();
        private static Dictionary<Button, Dictionary<String, List<Delegate>>> EventsPatched = new Dictionary<Button, Dictionary<string, List<Delegate>>>();
        ...
        /// </summary>
        private static Dictionary<System.Windows.Forms.Button, int> Styles = new Dictionary<Button, int>();
