...
namespace Artinsoft.VB6.Gui
{
    ...
    public partial class MenuHelper : Component, IExtenderProvider
    {
        ...
        /// </summary>
        private static List<System.Windows.Forms.MenuStrip> CheckDropDownBehavior = new List<MenuStrip>();
        ...
        {
            return CheckDropDownBehavior.Contains(mainMenu);
        }
        ...
        public void SetCheckDropDownBehavior(System.Windows.Forms.MenuStrip mainMenu, bool value)
        {
            ...
            if ((value) && !(CheckDropDownBehavior.Contains(mainMenu)))
            {
                ...
                CheckDropDownBehavior.Add(mainMenu);
            }
            else if (!(value) && (CheckDropDownBehavior.Contains(mainMenu)))
            {
                foreach (ToolStripItem item in mainMenu.Items)
                {
                    menuItem = item as ToolStripMenuItem;
                ...
                mainMenu.ItemAdded -= new ToolStripItemEventHandler(ToolStripItem_ItemAdded);
                mainMenu.ItemRemoved -= new ToolStripItemEventHandler(ToolStripItem_ItemRemoved);
                CheckDropDownBehavior.Remove(mainMenu);
            }
        }
