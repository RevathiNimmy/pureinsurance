    ...
    public partial class MSDataGridHelper : Component, IExtenderProvider
    {
        ...
        private static Splits GetSplits(object obj)
        {
            if (CheckIfIsAMSDataGrid(obj))
                return Artinsoft.VB6.Utils.ReflectionHelper.GetMember(obj, "Splits") as Splits;
        ...
        {
            if (CheckIfIsAMSDataGrid(obj))
                return Artinsoft.VB6.Utils.ReflectionHelper.GetMember(obj, "Columns") as Columns;
