...
namespace Artinsoft.VB6.Gui
{
    ...
    public class TreeViewHelper
    {
        ...
        /// </summary>
        private static Dictionary<TreeView, Dictionary<String, List<Delegate>>> EventsPatched = new Dictionary<TreeView, Dictionary<string, List<Delegate>>>();
        /// <summary>
        /// List of properties and values that are supplied by this Helper.
        /// </summary>
        private static Dictionary<TreeView, Dictionary<newPropertiesEnum, object>> newProperties = new Dictionary<TreeView, Dictionary<newPropertiesEnum, object>>();
        ...
        {
            Image res = Artinsoft.VB6.Resources.Artinsoft_VB6.DefaultDragImage.ToBitmap();
