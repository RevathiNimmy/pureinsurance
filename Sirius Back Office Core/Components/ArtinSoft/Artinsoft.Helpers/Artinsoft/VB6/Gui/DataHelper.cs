...
namespace Artinsoft.VB6.Gui
{
    ...
    public partial class DataHelper : UserControl, System.ComponentModel.ISupportInitialize, IExtenderProvider
    {
        ...
        private static Dictionary<Control, DataHelperBindingInfo> _DataHelperBinding = new Dictionary<Control, DataHelperBindingInfo>();
                    ...
                    if (!string.IsNullOrEmpty(TableName))
                    {
                        ...
                        foreach (System.Data.DataColumn dColumn in dbDataSet.Tables[0].Columns)
                        {
                            ...
                            if (dColumn.AllowDBNull)
                            {
                                ...
                                //FSQSABORIO 20080228. Mejora al migrador 146. Se cambio el tipo a DbType.Int32 para este parametro en especificio
        ...
        private class ODBCRecordsetClass : RecordsetClass
        {
            ...
            public ODBCRecordsetClass(String connString, String sqlSelectString)
            {
                ...
                {
                    MessageBox.Show(string.Format("Error creating ODBC connection. Connection String {0}, SQL {1}", connString, sqlSelectQuery), "Connection Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            /// <summary>
    ...
    internal class ConnectionStringEditor : UITypeEditor
    {
        ...
        {
            return dcd.DisplayConnectionString;
        }
        else
            return value;*/
            return value;
