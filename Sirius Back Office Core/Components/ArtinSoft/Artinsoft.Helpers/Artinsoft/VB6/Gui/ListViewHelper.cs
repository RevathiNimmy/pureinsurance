...
namespace Artinsoft.VB6.Gui
{
    ...
    public partial class ListViewHelper : Component, IExtenderProvider, ISupportInitialize
    {
        ...
        /// </summary>
        private static Dictionary<ListView, Dictionary<String, List<Delegate>>> EventsPatched = new Dictionary<ListView, Dictionary<string, List<Delegate>>>();
        /// <summary>
        /// List of properties and values that are supplied by this Helper.
        /// </summary>
        private static Dictionary<ListView, Dictionary<newPropertiesEnum, object>> newProperties = new Dictionary<ListView, Dictionary<newPropertiesEnum, object>>();
        /// <summary>
        ...
        {
            SetLargeIconsProperty(lView, value, OnInitialization);
        }
        ...
        {
            SetSmallIconsProperty(lView, value, OnInitialization);
        }
        ...
        {
            SetColumnHeaderIconsProperty(lView, value, OnInitialization);
        }
        ...
        public static void SetLargeIconsProperty(ListView lView, object value)
        {
            SetLargeIconsProperty(lView, value, false);
        }
        /// <summary>
        /// Sets the name of the VB6 ListView in the form to use for the list of large icons.
        /// </summary>
        ...
        private static void SetLargeIconsProperty(ListView lView, object value, bool delayProcessing)
        {
            if ((value is string) || ImageListHelper.IsValid(value))
            {
                if (CheckForProperty(lView, newPropertiesEnum.LargeIcons))
                {
                    ...
                    if (!delayProcessing)
                        ProcessLargeIconsProperty(lView);
                    else
                    {
        ...
        /// <param name="lView">The ListView to set.</param>
        /// <param name="value">The new name for the VB6 ListView.</param>
        public static void SetSmallIconsProperty(ListView lView, object value)
        {
            SetSmallIconsProperty(lView, value, false);
        }
        /// <summary>
        /// Sets the name of the VB6 ListView in the form to use for the list of small icons.
        /// </summary>
        ...
        /// <param name="delayProcessing">Delays the processing of the property to after the EndInit</param>
        private static void SetSmallIconsProperty(ListView lView, object value, bool delayProcessing)
        {
            if ((value is string) || ImageListHelper.IsValid(value))
            {
                if (CheckForProperty(lView, newPropertiesEnum.SmallIcons))
                {
                    ...
                    if (!delayProcessing)
                        ProcessSmallIconsProperty(lView);
                    else
                    {
                        if (!PendingListIconsToProcess.Contains(lView))
                            PendingListIconsToProcess.Add(lView);
        ...
        public static void SetColumnHeaderIconsProperty(ListView lView, object value)
        {
            SetColumnHeaderIconsProperty(lView, value, false);
        }
        /// <summary>
        /// Sets the name of the VB6 listview in the form to use for the column headers.
        /// </summary>
        ...
        /// <param name="value">The new value for the property.</param>
        /// <param name="delayProcessing">Delays the processing of the property to after the EndInit.</param>
        private static void SetColumnHeaderIconsProperty(ListView lView, object value, bool delayProcessing)
        {
            if ((value is string) || ImageListHelper.IsValid(value))
            {
                if (CheckForProperty(lView, newPropertiesEnum.ColumnHeaderIcons))
                {
                    ...
                    if (!delayProcessing)
                        ProcessColumnHeaderIconsProperty(lView);
                    else
                    {
                        if (!PendingListIconsToProcess.Contains(lView))
                            PendingListIconsToProcess.Add(lView);
        ...
        /// </summary>
        /// <param name="lView">The ListView to set the property.</param>
        private static void ProcessColumnHeaderIconsProperty(ListView lView)
        {
            ...
            if (value is string)
            {
                ...
                if (!string.IsNullOrEmpty(name))
                {
                    if (CheckForProperty(lView, newPropertiesEnum.InternalColumnHeaderImageListHelper))
                    {
                        ...
                        {
                            imgHelper = GetImageListHelper(lView, name);
                            imgHelper.Name = name;
        ...
        /// </summary>
        /// <param name="lView">The ListView to set the property.</param>
        private static void ProcessSmallIconsProperty(ListView lView)
        {
            ImageListHelper imgHelper = null;
            ...
            if (value is string)
            {
                ...
                {
                    imgHelper = GetImageListHelper(lView, (string)value);
        ...
        /// </summary>
        /// <param name="lView">The ListView to set the property.</param>
        private static void ProcessLargeIconsProperty(ListView lView)
        {
            ImageListHelper imgHelper = null;
        ...
        private static ImageListHelper GetImageListHelper(ListView lView, string VB6ImageListName)
        {
            ImageListHelper imgHelper = new ImageListHelper();
            Form parentForm = lView.FindForm();
            if (parentForm != null)
                imgHelper.LoadVB6ImageList(ContainerHelper.Controls(parentForm)[VB6ImageListName]);
        ...
        /// <summary>
        /// Cleans the internal dictionaries from old references of ListViews alreay disposed.
        /// </summary>
        ...
        private static void PatchItemClickEvent(ListView lView)
        {
            ...
            {
                MessageBox.Show(string.Format(Artinsoft.VB6.Resources.Artinsoft_VB6.Artinsoft_VB6_Help_ListViewHelper_PatchItemClickEvent_Err_Msg, e.Message));
            }
        }
