...
Friend Partial Class frmPartyCCView
	...
	' which class this is.
	Private Const ACClass As String = "frmPartyCCView"
    ...
    Public Function LoadInterface() As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            If m_bFilterOutOtherBranches And g_iSourceID <> uctPartyCCControl1.PartySourceID Then
            ...
            If uctPartyCCControl1.ShortName.Trim() = String.Empty Then
                m_sShortName = objCM.m_sShortName
            Else
                m_sShortName = uctPartyCCControl1.ShortName.Trim()
            End If
    ...
    Private Sub cmdEdit_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdEdit.Click
        ...
        m_lReturn = uctPartyCCControl1.EditClick()
    ...
    Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
        ...
        'm_lReturn& = uctPartyCCControl1.ShowHelpScreen
        '
        ' Check the return value.
        '
        'Catch excep As System.Exception
    ...
    Private Sub frmPartyCCView_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmPartyCCView_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmPartyCCView_Paint(ByVal eventSender As Object, ByVal eventArgs As PaintEventArgs) Handles MyBase.Paint
    ...
    Private Sub frmPartyCCView_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        Try
            ...
            '    ' Terminate the control
            '    m_lReturn& = uctPartyCCControl1.Terminate()
            '    If (m_lReturn& <> PMTrue) Then
            '        ' Log Error.
            '        LogMessage _
            ''            iType:=PMLogOnError, _
            ''            sMsg:="Failed to terminate the uctPartyCCControl.", _
            ''            vApp:=ACApp, _
            ''            vClass:=ACClass, _
    ...
    Private Sub frmPartyCCView_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
        ...
        If Me.WindowState <> FormWindowState.Minimized Then
            ...
            'sj 18/06/2002 - end
            'sj 02/07/2002 - start
            Me.Height = 545 ' VB6.TwipsToPixelsY(8055)
            'sj 02/07/2002 - end
            Me.Width = 734 ' VB6.TwipsToPixelsX(10890)
        End If

    End Sub

    Private Sub frmPartyCCView_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
    ...
    ' Start - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.5)
    Public Sub mnuGotoInsuredAccounts_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGotoInsuredAccounts.Click
        ...
        End If
    End Sub
    ' End - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.5)
    ...
    Private Sub frmPartyCCView_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
