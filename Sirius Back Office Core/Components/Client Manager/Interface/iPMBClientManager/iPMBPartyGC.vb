...
Imports SharedFiles
Friend Partial Class frmPartyGC
	...
	' which class this is.
	Private Const ACClass As String = "frmPartyGC"
    ...
    Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
        ...
        'mk 990924 todelete    m_lReturn& = uctPartyGCControl1.ShowHelpScreen
        '
    ...
    Private Sub frmPartyGC_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
        If Not (ActivateHelper.myActiveForm Is eventSender) Then
            ...
            Me.Text = "Group Client : [" & Me.ResolvedName.Trim() & "]"
    ...
    Private Sub frmPartyGC_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Me.Height = 6360 - 255
            'Me.Width = 9435
            'Me.Height = VB6.TwipsToPixelsY(7875)
    ...
    Private Sub frmPartyGC_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        Try
            ...
            'In case when MDI has been closed dont do unload(restrict QueryUnload event to occur again)
    ...
    Public Sub mnuGoToEvents_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGoToEvents.Click
        ...
        Try
            ...
            ' Call Toolbar Control function
            m_lReturn = objCM.ShowEvents(v_lPartyCnt:=m_lPartyCnt, v_sShortName:=m_sShortName, v_sPartyType:="G", v_sResolvedName:=m_sResolved)
    ...
    ' Start - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.6)
    Public Sub mnuGotoInsuredAccounts_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGotoInsuredAccounts.Click
        ...
        End If
    End Sub
    ' End - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.6)
    ...
    Public Sub mnuGotoTextFiles_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGotoTextFiles.Click
        ...
        Try
            ...
            ' Call Toolbar Control function
            m_lReturn = objCM.ShowTextFiles(v_lPartyCnt:=m_lPartyCnt, v_sShortName:=m_sShortName, v_sPartyType:="G", v_sResolvedName:=m_sResolved)
    ...
    Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
        ...
        Try
            ...
            uctPartyGCControl1.CurrentResolvedName = objCM.g_sResolvedName
            ...
            If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
                ...
                vFileName = uctPartyGCControl1.ShortName & "|" & uctPartyGCControl1.LongName & "|" & CStr(m_lPartyCnt) & "G"

                objCM.AddRecentFile(m_parentMdiForm, vFileName)
                objCM.SaveRecentFiles(m_parentMdiForm)
                ' Everything OK, so we can hide the interface.

                nReturn = uctPartyGCControl1.AddPartyHistory()
    ...
    Private Sub frmPartyGC_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
        ...
        If Me.WindowState <> FormWindowState.Minimized Then
            'eck19052005
            Me.Height = VB6.TwipsToPixelsY(8230)
            Me.Width = VB6.TwipsToPixelsX(11095)
        End If

    End Sub

    Private Sub frmPartyGC_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
    ...
    Private Sub frmPartyGC_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
