...
Partial Friend Class frmListRiskUnderWriting
    Inherits System.Windows.Forms.Form
    ' ***************************************************************** '
    ' Form Name: frmListRiskUnderWriting
    '
    ' Date: 12/09/2000
    '
    ...
    ' which class this is.
    Private Const ACClass As String = "frmListRiskUnderwriting"
    ...
    'UPGRADE_NOTE: (7001) The following declaration (cmdAdd_Click) seems to be dead code More Information: http://www.vbtonet.com/ewis/ewi7001.aspx
    ...
    'm_lReturn = objcm.ShowPolicyDetail(v_lPartyCnt:=m_lPartyCnt, v_sPartyType:=m_sPartyType, v_lInsuranceFolderCnt:=0, v_lInsFileCnt:=0, v_lInsuranceFileStructureId:=0, v_sShortName:=m_sShortName, v_sInsReference:="", v_bFromEvent:=False, v_lPolicyTypeId:=0, v_vGeminiPolicyStatus:=DBNull.Value)
    '
    ...
    Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
        ...
        Try
            ...
            m_lReturn = uctPMUListRisk1.ShowHelpScreen(cmdHelp, objCM.ScreenHelpID)
    ...
    Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
        ...
        Try
            ...
            ' Tell the user control to not show the multi-currency window
            ' for this scenario
            m_lReturn = uctPMUListRisk1.OKClick(False)
    ...
    Private Sub cmdCancel_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdCancel.Click
        ...
        Try
            ...
            ' Process the next set of actions depending
            ' upon the interface task etc.
            m_lReturn = uctPMUListRisk1.CancelClick()
    ...
    Private Sub frmListRiskUnderWriting_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
        If Not (ActivateHelper.myActiveForm Is eventSender) Then
            ActivateHelper.myActiveForm = eventSender

            objCM.m_ofrmMDI.StatusBar1.Items.Item(0).Text = Me.Footer
            objCM.m_ofrmMDI.StatusBar1.Items.Item(1).Text = CStr(Me.InsuranceFileCnt)
            objCM.m_ofrmMDI.StatusBar1.Items.Item(2).Text = Me.InsuranceRef
            objCM.m_ofrmMDI.Text = "[" & Me.InsuranceRef.Trim() & "] Sirius Client Manager"
            Me.Text = "Risk List : [" & Me.InsuranceRef.Trim() & "]"
    ...
    Private Sub frmListRiskUnderWriting_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            With uctPMUListRisk1
                ...
                .ProcessMode = 0
                .InsFileCnt = Me.InsuranceFileCnt
            End With

            m_lReturn = uctPMUListRisk1.Initialise()
            ...
            m_lReturn = uctPMUListRisk1.LoadControl()
            If m_lReturn = gPMConstants.PMEReturnCode.PMFalse Then
                iPMFunc.SetMousePointer(gPMConstants.PMEMousePointerStatus.PMMouseNormal)
                ' Log Error.
            ...
            lStatus = uctPMUListRisk1.Status
    ...
    Private Sub frmListRiskUnderWriting_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub frmListRiskUnderWriting_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmListRiskUnderWriting_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
    ...
    Public Function RefreshList() As Integer
        ...
        Try
            ...
            ' Call GetRisks on the user control

            Return uctPMUListRisk1.GetRisks()
    ...
    Private Sub uctPMUListRisk1_lvwSearchDetailsDblClick(ByVal Sender As Object, ByVal e As uctPMUListRisk.lvwSearchDetailsDblClickEventArgs) Handles uctPMUListRisk1.lvwSearchDetailsDblClick
        'TN20010117 added v_lIsReInsuranceAtRiskLevel and v_lInsuranceFolderCnt
        'MSS280901 - Added above for UW merge

        Try

            ' Call Toolbar Control function
            'm_lReturn = CType(ShowRiskUnderwriting(v_lInsuranceFileCnt:=e.v_lInsFileCnt, v_lRiskCodeId:=e.v_lRiskID, v_lRiskGisScreenId:=e.v_lRiskGisScreenId, v_lRiskTypeId:=e.v_lRiskTypeId, v_bFromEvent:=Me.FromEvent, v_lIsReInsuranceAtRiskLevel:=e.v_lIsReInsuranceAtRiskLevel, v_lInsuranceFolderCnt:=e.v_lInsuranceFolderCnt), gPMConstants.PMEReturnCode)
            m_lReturn = CType(objCM.ShowRiskUnderwriting(v_lInsuranceFileCnt:=e.v_lInsFileCnt, v_lRiskCodeId:=e.v_lRiskID, v_lRiskGisScreenId:=e.v_lRiskGisScreen, v_lRiskTypeId:=e.v_lRiskTypeId, v_bFromEvent:=Me.FromEvent, v_lIsReInsuranceAtRiskLevel:=e.v_lIsReInsuranceAtRiskLevel, v_lInsuranceFolderCnt:=e.v_lInsuranceFolderCnt), gPMConstants.PMEReturnCode)
            'TN20010117 added v_lIsReInsuranceAtRiskLevel and v_lInsuranceFolderCnt
            'MSS280901 - Added above for merge
