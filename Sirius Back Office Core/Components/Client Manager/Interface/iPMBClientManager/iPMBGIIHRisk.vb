...
Imports SharedFiles
Friend Partial Class frmGIIHRisk
	Inherits System.Windows.Forms.Form
	' ***************************************************************** '
	' Form Name: frmGIIHRisk
	'
	' Date: 08/06/1998
	'
	...
	' which class this is.
	Private Const ACClass As String = "frmGIIHRisk"
	...
	Private Sub cmdCancel_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdCancel.Click
		...
		Try 
			...
			m_lReturn = uctGIIHRiskDataControl1.CancelClick()
	...
	Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
		...
		Try 
			...
			' Process the next set of actions depending
			' upon the interface task etc.
			uctGIIHRiskDataControl1.ShowHelpScreen()
	...
	Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
		...
		Try 
			...
			m_lReturn = uctGIIHRiskDataControl1.OKClick()
	...
	Private Sub frmGIIHRisk_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmGIIHRisk_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Me.RiskGroupId = objCM.m_ofrmMDI.RiskGroupId

            With uctGIIHRiskDataControl1
                .Task = m_iTask
    ...
    Private Sub frmGIIHRisk_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        Try
            ...
            uctGIIHRiskDataControl1.Dispose()
    ...
    Private Sub frmGIIHRisk_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmGIIHRisk_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
    ...
    ' Start - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.11)
    Public Sub mnuGotoInsuredAccounts_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGotoInsuredAccounts.Click
        ...
        End If
    End Sub
    ' End - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.11)
