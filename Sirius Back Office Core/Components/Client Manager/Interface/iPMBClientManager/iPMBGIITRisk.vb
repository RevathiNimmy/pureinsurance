...
Imports SharedFiles
Friend Partial Class frmGIITRisk
	Inherits System.Windows.Forms.Form
	
	' ***************************************************************** '
	' Form Name: frmGIITRisk
	'
	' Date: 08/06/1998
	'
	...
	' which class this is.
	Private Const ACClass As String = "frmGIITRisk"
	...
	Private Sub cmdCancel_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdCancel.Click
		...
		Try 
			...
			m_lReturn = uctGIITRiskDataControl1.CancelClick()
	...
	Private Sub cmdHelp_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdHelp.Click
		...
		Try 
			...
			' Process the next set of actions depending
			' upon the interface task etc.
			uctGIITRiskDataControl1.ShowHelpScreen()
	...
	Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
		...
		Try 
			...
			m_lReturn = uctGIITRiskDataControl1.OKClick()
	...
	Private Sub frmGIITRisk_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmGIITRisk_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmGIITRisk_FormClosing(ByVal eventSender As Object, ByVal eventArgs As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        Try
            ...
            uctGIITRiskDataControl1.Dispose()
	...
	Private Sub frmGIITRisk_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
	...
	Private Sub frmGIITRisk_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
    ...
    ' Start - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.13)
    Public Sub mnuGotoInsuredAccounts_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles mnuGotoInsuredAccounts.Click
        ...
        End If
    End Sub
    ' End - (Sankar) - (Tech Spec - QBENZCR001 - Client Manager view Account Transactions.doc) - (5.1.13)
