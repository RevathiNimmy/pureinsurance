...
Public Module MainModule
    ...
    Public Const ACApp As String = "ExternalWorkFlowConfiguration"
    ...
    Public Const ACParamsCount As Integer = 15
    ...
    Sub Main()
        ...
        If Procesos.Length > 1 Then
            ...
            If iInstances > 1 Then
                MessageBox.Show("ExternalWork Flow Configuration is already running. Only one instance may be run at a time.", "ExternalWork Flow Configuration", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Exit Sub
            End If
        End If
