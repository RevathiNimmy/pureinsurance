...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            ' CTAF 021100 - DisplayLookupDetails before setting the properties on
            '               the form
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            'Start - Prakash Varghese - PN 61186
            'If form has been cancelled, we don't need to call InterfaceToBusiness.
