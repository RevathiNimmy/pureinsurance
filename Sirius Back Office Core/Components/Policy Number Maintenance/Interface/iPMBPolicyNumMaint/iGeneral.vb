...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMBPolicyNumMaint.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMBPolicyNumMaint.frmInterface, ByRef oBusiness As Object) As Integer
