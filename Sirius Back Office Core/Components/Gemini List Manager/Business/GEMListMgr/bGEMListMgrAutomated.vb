...
Imports System
'Modified by Vijay Pal on 5/20/2010 10:23:54 AM refer developer guide no. 129
Imports SharedFiles
Friend NotInheritable Class Automated
    ...
    Public Function GetSummary(ByRef vSummaryArray As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSummary Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSummary", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
