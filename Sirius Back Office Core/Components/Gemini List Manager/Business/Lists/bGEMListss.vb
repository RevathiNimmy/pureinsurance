...
<System.Runtime.InteropServices.ProgId("Listss_NET.Listss")> _
Public NotInheritable Class Listss
    ...
    ' Date: 10/02/1999
    '
    ' Description: Maintains the Listss Collection.
    '
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "Listss"

    ' PUBLIC Data Members (Begin)
    ' PUBLIC Data Members (End)

    ' PRIVATE Data Members (Begin)
    ' Define the Lists Collection
    Private m_Listss As Collection
    ...
    ' Name: Add
    '
    ' Description: Adds a single Lists into the Listss Collection
    '
    '
    ' ***************************************************************** '
    Public Function Add(ByRef oNewLists As bGEMLists.Lists) As Integer
        ...
        Try
            ...
            ' Add the supplied Lists into the Listss Collection
            ' Do not specify a key as we do not know the Lists ID for
            ' new ones entered until they are added to the DB.
            m_Listss.Add(oNewLists)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Add Lists to Collection", vApp:=ACApp, vClass:=ACClass, vMethod:="Add", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    ' Name: Count
    '
    ' Description: Returns the number of Listss in the collection.
    '
    '
    ' ***************************************************************** '
    ...
    ' Name: Delete
    '
    ' Description: Delete a Lists from the Collection.
    '
    '
    ' ***************************************************************** '
    ...
    ' Name: Item
    '
    ' Description: Returns the selected Lists from the Collection.
    '
    '
    ' ***************************************************************** '
    Public Function Item(ByRef vKey As Integer) As bGEMLists.Lists

        Dim result As bGEMLists.Lists = Nothing
        Try


            Return m_Listss(vKey)
    ...
    ' Name: DeleteAll
    '
    ' Description: Delete all Listss from the Collection
    '
    '
    ' ***************************************************************** '
    Public Sub DeleteAll()
        ...
        Try
            ...
            ' Determine the number of Lists in the collection
            lFieldCount = Count()
    ...
    ' Name: Clear
    '
    ' Description: Clear the Lists Collection.
    '
    '
    ' ***************************************************************** '
    Public Sub Clear()
        ...
        Try
            ...
            ' Set Lists Collection to Nothing
            m_Listss = Nothing


            ' Added by Scalability Update Program - 10/08/2002
            m_Listss = New Collection()
    ...
    Friend Sub New()
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise the Lists class", vApp:=ACApp, vClass:=ACClass, vMethod:="Class_Initialise", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
