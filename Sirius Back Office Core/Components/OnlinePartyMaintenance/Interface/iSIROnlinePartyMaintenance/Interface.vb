...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function GetPrivileges() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_oBusiness, "bPMUserGroup.Business", vInstanceManager:="ClientManager")
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get bPMUserGroup.Business", vApp:=ACApp, vClass:=ACClass, vMethod:="GetPrivileges")
    ...
    Private Function GetSysAdminStatus() As Integer
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ...
            gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get bPMUserGroup.Business", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSysAdminStatus")
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Or lStatus = 0 Then
            ...
            MessageBox.Show("You do not have permission to access " & _
                            "User Group Maintenance." & Strings.Chr(13) & Strings.Chr(10) & Strings.Chr(13) & Strings.Chr(10) & _
                            "Please contact your System Administrator.", Application.ProductName)
    ...
    Private Function LoadInterface() As Integer
        ...
        ' Assign theparameters to the interface properties.
        With frmInterface
