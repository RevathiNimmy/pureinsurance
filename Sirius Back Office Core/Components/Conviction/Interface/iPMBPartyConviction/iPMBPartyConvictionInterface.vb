...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_vConvictionDate As String = ""
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            .PartyConvictionID = m_lPartyConvictionID
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With frmInterface
            ...
            m_lPartyConvictionID = .PartyConvictionID

            m_sCode = .Code
            m_vConvictionDate = .ConvictionDate
            m_sDescription = .Description
            m_cFineAmt = .FineAmount
            m_sSentenceCode = .SentenceCode
            m_sSentenceDescription = .SentenceDescription
            m_lSentenceDuration = CInt(.SentenceDuration)
            m_sSentenceDurationQualifier = .SentenceDurationQualifier
            m_dtSentenceEffectiveDate = .SentenceEffectiveDate
            m_sStatusCode = .StatusCode
            m_lAlcoholLevel = .AlcoholLevel
            m_sAlcoholMeasurementMethod = .AlcoholMeasurementMethod
            m_lDrivingLicencePenaltyPoints = .DrivingLicencePenaltyPoints
