...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMBPartyConviction.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iPMBPartyConviction.frmInterface, ByRef oBusiness As Object) As Integer
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            result = gPMConstants.PMEReturnCode.PMTrue
            'EK 12/12/99 Add deletion processing
            ' Check the task.
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        m_frmInterface.PartyConvictionID = m_oBusiness.PartyConvictionID
    ...
    Private Function DisableForm(ByRef lDisabled As Integer) As Integer
        ...
        For Each ctlFormControl As Control In ContainerHelper.Controls(m_frmInterface)
            ...
            ElseIf (TypeOf ctlFormControl Is RadioButton) Then
                ControlHelper.SetEnabled(ctlFormControl, Not lDisabled)
            ElseIf (TypeOf ctlFormControl Is PMListMgrDropdown.uctDropdown) Then
