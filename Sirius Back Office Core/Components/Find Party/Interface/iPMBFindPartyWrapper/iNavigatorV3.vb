...
Imports System.IO
'Modified by Alkesh Kumar on 07/05/2010 18:59:34 refer developer guide no. 129
Imports SharedFiles
...
Public NotInheritable Class NavigatorV3
    ...
    'Modified by Alkesh Kumar on 07/05/2010 19:00:52 refer developer guide no. 108
    'Private m_oInterface As Interface
    Private m_oInterface As iPMBFindParty.Interface_Renamed
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            'Modified by Alkesh Kumar on 07/05/2010 19:07:04 refer developer guide no. 129
            'Set m_oInterface = New Interface
            m_oInterface = New iPMBFindParty.Interface_Renamed
            'Modified by arun.kumar on 6/23/2010 10:58:51 AM refer developer guide no 9. 
            'm_lReturn = CType(CType(m_oInterface, SSP.S4I.Interfaces.ILocalInterface).Initialise(), gPMConstants.PMEReturnCode)
            m_lReturn = CType(m_oInterface.Initialise(), gPMConstants.PMEReturnCode)
