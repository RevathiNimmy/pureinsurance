...
Public NotInheritable Class NavigatorV3
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, 0) = "delete_mode"
            ...
            m_oInterface.NotEditable = 1

            'PN18517 Do Not Prompt for DPA Questions on client deletion.
            m_oInterface.IgnoreDPAQuestions = True
