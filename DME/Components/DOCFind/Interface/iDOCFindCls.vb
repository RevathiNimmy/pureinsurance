...
Public NotInheritable Class Interface_Renamed
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef iDOCAccessLevel As Integer) As Integer
...
#End If
            ...
            g_iDOCaccesslevel = iDOCAccessLevel
    ...
    ' ***************************************************************** '
    ' Name: Find (Standard Method)
    '
    ' Description: Entry point for the object to start its processing.
    '
    ' ***************************************************************** '
    Public Function Find(ByRef lStartFoldNum As Integer, ByRef sStartFoldName As String, ByRef vDocsFound As Object) As Integer
        ...
        Try
            ...
            'store start folder globally
            g_lStartFoldNum = lStartFoldNum
            g_sStartFoldName = sStartFoldName
            ...
            'return any docs found
            If Information.IsArray(g_vDocsFound) Then


                vDocsFound = g_vDocsFound
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to start the object", vApp:=ACApp, vClass:=ACClass, vMethod:="Find", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
