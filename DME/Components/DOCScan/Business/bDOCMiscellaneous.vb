...
#End If
    ...
    '
    ' Log Error Message
    'iPMFunc.LogMessage(sUsername:=m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="UpdateHistory", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    '
    'Return result
    '
    'End Try
