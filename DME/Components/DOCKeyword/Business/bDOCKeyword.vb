...
Friend NotInheritable Class Keyword
    ...
    ' Date: 16/01/1998
    '
    ' Description: Describes the Keyword attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "Keyword"
    ...
    Private m_sKeyword As New FixedLengthString(30)
    Private m_sDeleted As New FixedLengthString(1)
    ...
    Public Property Keyword() As String
        Get
            ...
            Return m_sKeyword.Value

        End Get
        Set(ByVal Value As String)

            m_sKeyword.Value = Value
    ...
    Public Property Deleted() As String
        Get
            ...
            Return m_sDeleted.Value

        End Get
        Set(ByVal Value As String)

            m_sDeleted.Value = Value
