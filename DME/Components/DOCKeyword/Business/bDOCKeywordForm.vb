...
#End If
    ...
    '
    ' Description: Adds a single Keyword directly into the database.
    '        Note: The Keyword will NOT be added to the collection.
    '
    ' ***************************************************************** '
    Public Function DirectAdd(Optional ByRef vKeywordID As Integer = 0, Optional ByRef vKeyword As Object = Nothing, Optional ByRef vDeleted As Object = Nothing) As Integer

        Dim result As Integer = 0
        Dim oKeyword As bDOCKeyword.Keyword
        ...
        Try
            ...
            oKeyword = New bDOCKeyword.Keyword()

            ' Populate Keyword Attributes


            m_lReturn = SetProperties(oKeyword, gPMConstants.PMEComponentAction.PMAdd, vKeywordID:=vKeywordID, vKeyword:=CStr(vKeyword), vDeleted:=CStr(vDeleted))
            ...
            ' Return the ID of the Keyword Added

            If Not Information.IsNothing(vKeywordID) Then
                vKeywordID = oKeyword.KeywordID
            End If
    ...
    '
    ' ***************************************************************** '
    Private Function AddItem(ByRef oKeyword As bDOCKeyword.Keyword) As Integer
        ...
        m_lReturn = AddInputParam(oKeyword:=oKeyword)

        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If

        ' Add KeywordID as an OUTPUT param for an insert
        m_lReturn = m_oDatabase.Parameters.Add(sName:="Keyword_id", vValue:=oKeyword.KeywordID, iDirection:=CShort(gPMConstants.PMEParameterDirection.PMParamOutput), iDataType:=CShort(gPMConstants.PMEDataType.PMLong))
        ...
        oKeyword.KeywordID = m_oDatabase.Parameters.Item("Keyword_id").Value
    ...
    '
    ' Description: Sets the supplied Keyword property values.
    '
    ' ***************************************************************** '
    Private Function SetProperties(ByRef oKeyword As bDOCKeyword.Keyword, ByRef iStatus As Integer, Optional ByRef vKeywordID As Integer = 0, Optional ByRef vKeyword As String = "", Optional ByRef vDeleted As String = "") As Integer
        ...
        If iStatus = gPMConstants.PMEComponentAction.PMAdd Then
            ...
            m_lReturn = CheckMandatory(vKeywordID:=vKeywordID, vKeyword:=vKeyword, vDeleted:=vDeleted)
            ...
            m_lReturn = DefaultParameters(bDefaultAll:=False, vKeywordID:=vKeywordID, vKeyword:=vKeyword, vDeleted:=vDeleted)
        ...
        ' Validate Parameters
        m_lReturn = Validate(vKeywordID:=vKeywordID, vKeyword:=vKeyword, vDeleted:=vDeleted)
        ...
        With oKeyword
            ...
            If Not Information.IsNothing(vKeyword) Then
                If .Keyword.Trim() <> vKeyword.Trim() Then
                    .Keyword = vKeyword
                    bDataChanged = True
                End If
            End If
            ...
            If Not Information.IsNothing(vDeleted) Then
                If .Deleted.Trim() <> vDeleted.Trim() Then
                    .Deleted = vDeleted
                    bDataChanged = True
                End If
            End If
    ...
    '
    ' ***************************************************************** '
    Private Function AddInputParam(ByRef oKeyword As bDOCKeyword.Keyword) As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="keyword", vValue:=oKeyword.Keyword, iDirection:=CShort(gPMConstants.PMEParameterDirection.PMParamInput), iDataType:=CShort(gPMConstants.PMEDataType.PMString))

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="deleted", vValue:=oKeyword.Deleted, iDirection:=CShort(gPMConstants.PMEParameterDirection.PMParamInput), iDataType:=CShort(gPMConstants.PMEDataType.PMString))
    ...
    '
    ' Description: Sets the Default Values for a Keyword.
    '
    ' ***************************************************************** '
    Private Function DefaultParameters(ByRef bDefaultAll As Boolean, Optional ByRef vSubType As Object = Nothing, Optional ByRef vKeywordID As Object = Nothing, Optional ByRef vKeyword As String = "", Optional ByRef vDeleted As String = "") As Integer
        ...
        If (Information.IsNothing(vKeywordID)) Or (vKeywordID.Equals(0)) Or (bDefaultAll) Then
            vKeywordID = 0
        End If



        If (Information.IsNothing(vKeyword)) Or (String.IsNullOrEmpty(vKeyword)) Or (bDefaultAll) Then
            vKeyword = ""
        End If



        If (Information.IsNothing(vDeleted)) Or (String.IsNullOrEmpty(vDeleted)) Or (bDefaultAll) Then
            vDeleted = "N"
        End If
    ...
    '
    ' ***************************************************************** '
    Private Function CheckMandatory(Optional ByRef vKeywordID As Object = Nothing, Optional ByRef vKeyword As Object = Nothing, Optional ByRef vDeleted As Object = Nothing) As Integer
        ...
        If (Information.IsNothing(vKeyword)) Or (Object.Equals(vKeyword, Nothing)) Then
            Return gPMConstants.PMEReturnCode.PMMandatoryMissing
        End If

        '    If (IsMissing(vDeleted) = True) _
        ''    Or (IsEmpty(vDeleted) = True) Then
    ...
    '
    ' Description: Checks the Keyword for Consistency.
    '
    ' ***************************************************************** '
    Private Function Validate(Optional ByRef vKeywordID As Object = Nothing, Optional ByRef vKeyword As Object = Nothing, Optional ByRef vDeleted As Object = Nothing) As Integer
        ...
        If Not Double.TryParse(CStr(vKeywordID), NumberStyles.Number, CultureInfo.CurrentCulture.NumberFormat, dbNumericTemp) Then
            Return gPMConstants.PMEReturnCode.PMFalse
        End If
