...
#If PD_EARLYBOUND = 1 Then
			'UPGRADE_TODO: (1035) #If #EndIf block was not upgraded because the expression PD_EARLYBOUND = 1 did not evaluate to True or was not evaluated. More Information: http://www.vbtonet.com/ewis/ewi1035.aspx
...
#End If
    ...
    '
    ' ***************************************************************** '
    Public Function Start(ByRef lDocNum As Integer, ByRef sNewName As String) As Integer
        ...
        Try
            ...
            'todo
            If lDocNum = 0 Then
                MessageBox.Show("0 not valid doc_num", Application.ProductName)
                Throw New Exception()
            End If

            'store the doc num and initialise variable for the new name
            g_lDocNum = lDocNum
            g_sNewName = ""
