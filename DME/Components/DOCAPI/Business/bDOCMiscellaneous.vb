...
#End If
    ...
    Public Function GetDataPath(ByRef lVolumeID As Integer, ByRef sDataPath As String) As Integer
        ...
        Try
            ...
            'get device id
            m_sSQL = "SELECT device_id, directory FROM DOC_volume " &
    ...
    Public Function ConstructDocRef(ByRef lDocNum As Integer, ByRef sDocRef As String) As Integer
        ...
        Try
            ...
            Mid(sDocRef, 10 - ToSafeString(lDocNum).Trim().Length, ToSafeString(lDocNum).Trim().Length) = ToSafeString(lDocNum).Trim()
    ...
    Public Function RenameDoc(ByRef lDocNum As Integer, ByRef sNewName As String) As Integer
        ...
        Dim sFoldCode As String = ""
        Dim sDrawCode As String = ""
        Dim sCabCode As String = ""
...
#End If
        ...
        Try
            ...
            m_lReturn = CType(gPMComponentServices.CheckDatabase(m_sUsername, m_iSourceID, m_iLanguageID, gPMConstants.PMEProductFamily.pmePFSiriusArchitecture, False, oDatabase), gPMConstants.PMEReturnCode)
