...
#End If
    ...
    Public Function ConstructDocRef(ByRef lDocNum As Integer, ByRef sDocRef As String) As Integer
        ...
        Try
            ...
            Mid(sDocRef, 10 - (lDocNum).ToString().Trim().Length, (lDocNum).ToString().Trim().Length) = (lDocNum).ToString().Trim()
    ...
    '
    ' ***************************************************************** '
    'UPGRADE_NOTE: (7001) The following declaration (UpdateHistory) seems to be dead code More Informations: http://www.vbtonet.com/ewis/ewi7001.aspx
    ...
    Public Function AddDocToHistory(ByRef lDocNum As Integer, ByRef lFoldNum As Integer, ByRef sDocName As String, ByRef dDocDate As Date, ByRef sPageName As String, ByRef sDocType As String, ByRef sPageType As String) As Integer
        ...
        Try
            ...
            m_lReturn = m_oHistory.DirectAdd(vTask:=ToSafeString(DOCADDDOCUMENT), vCabinetCode:=ToSafeString(sCabExCode), vCabinetName:="", vDrawerCode:=ToSafeString(sDrawExCode), vDrawerName:="", vFolderCode:=ToSafeString(sFoldExCode), vFolderName:="", vDocRef:=ToSafeString(sDocRef), vRequestDate:=dDocDate.ToString("yyyyMMdd"), vRequestTime:=dDocDate.ToString("HHMMss"), vEventType:=ToSafeString(sDocType), vDescription:=ToSafeString(sDocName), vVolume:=DOCHD1_NAME, vPageFile:=ToSafeString(sTmpName), vdoctype:=sPageType.ToUpper())
