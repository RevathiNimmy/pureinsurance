...
Module DOCGeneralFunc
    ...
    Public Function GetDOCRegSettings(Optional ByRef vTimerInterval As String = "", Optional ByRef vHistoryRoot As String = "", Optional ByRef vScanDirectory As String = "", Optional ByRef bOverWrite As Boolean = False, Optional ByRef hWndParent As Integer = 0, Optional ByRef bKofaxOrTwain As Boolean = False) As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            If Not Information.IsNothing(vTimerInterval) Then
                ...
                If vTimerInterval = "" Then
                    ...
                    If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                        ...
                        ' Log Error Message
                        LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Timer Interval", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                        ...
                        If vHistoryRoot = "" Then
                            ...
                            If iCounter = 1 Then
                                ...
                                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                                    ...
                                    ' Log Error Message
                                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Journal Root", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                            ...
                            If bMultipleRoots Then
                                ...
                                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                                    ...
                                    ' Log Error Message
                                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Multiple Journal Root", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            ...
            If Not Information.IsNothing(vScanDirectory) Then
                ...
                If vScanDirectory = "" Then
                    ...
                    If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                        ...
                        ' Log Error Message
                        LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Scan Directory", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            ...
            If Not False Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    ' Log Error Message
                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to save Kofax or Twain Setting", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="GetDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function CopyFile(ByRef sFileIn As String, ByRef sFileOut As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to copy file '" & sFileIn & "' to '" & sFileOut & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="CopyFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function RmDirectory(ByRef sDirectory As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to remove directory " & sDirectory, vApp:=ACApp, vClass:=ACClass, vMethod:="RmDirectory", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function KillFile(ByRef sFile As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to delete file " & sFile, vApp:=ACApp, vClass:=ACClass, vMethod:="KillFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function BrowseFolder(ByRef sFolder As String, ByRef sTitle As String, ByRef hWndParent As Integer) As gPMConstants.PMEReturnCode
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="BrowseFolder", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    '
    ' ***************************************************************** '
    Public Function ChangeDOCRegSettings(Optional ByRef vTimerInterval As String = "", Optional ByRef vHistoryRoot As String = "", Optional ByRef vScanDirectory As String = "", Optional ByRef hWndParent As Integer = 0) As Object
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="ChangeDOCRegSettings", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
            Return result
    ...
    Public Function MakePath(ByRef sPath As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Make Path: " & sPath, vApp:=ACApp, vClass:=ACClass, vMethod:="MakePath", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function GetFileName(ByRef sFullPath As String, ByRef sFile As String, ByRef sDir As String) As Integer
        ...
        Try
            ...
            If (I < iMinPathLen) Or (I = iLen) Then
                ...
                ' Log Error Message
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get file name from '" & sFullPath & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFileName", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get file name from '" & sFullPath & "'", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFileName", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function ExtractNumFromKey(ByRef sKey As String, ByRef lNum As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            'Log to File
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="ExtractNumFromKey", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function LogMessageScan(ByRef iType As Integer, ByRef sMsg As String, Optional ByRef vApp As Object = Nothing, Optional ByRef vClass As Object = Nothing, Optional ByRef vMethod As Object = Nothing, Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing, Optional ByRef bStandAlone As Boolean = False) As Integer
        ...
        Try
            ...
            If bStandAlone Then
                ...
                LogMessagePopup(iType:=iType, sMsg:=sMsg, vApp:=CStr(vApp), vClass:=CStr(vClass), vMethod:=CStr(vMethod), excep:=New Exception(CStr(vErrDesc)))

            Else


                LogMessage(sUsername:="", iType:=iType, sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, vErrNo:=vErrNo, vErrDesc:=vErrDesc)
    ...
    Private Function GetFilenameFromPath(ByRef sPath As String, ByRef sFilename As String) As Integer
        ...
        If iLen = 0 Then
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetFilenameFromPath passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetFilenameFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Private Function GetDirectoryFromPath(ByRef sPath As String, ByRef sDirectory As String) As gPMConstants.PMEReturnCode
        ...
        If iLen = 0 Then
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromPath passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get filename from path.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromPath", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Private Function GetDirectoryFromUNC(ByRef sUNC As String, ByRef sDirectory As String) As Integer
        ...
        If iLen = 0 Then
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromUNC passed zero length string.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromUNC", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If

        If Not sUNC.StartsWith("\\") Then
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromUNC not passed a UNC path.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDirectoryFromUNC", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            Return gPMConstants.PMEReturnCode.PMError
        End If
    ...
    Public Function CacheFile(ByRef oZipper As Object, ByRef sFilename As String, ByRef sNewFilename As String, ByRef sCachePath As String, Optional ByRef bZipped As Boolean = False) As Integer
        ...
        Try
            ...
            If Not oFSO.FileExists(sTarget) Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error.
                    result = gPMConstants.PMEReturnCode.PMFalse
                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="GetDirectoryFromPath process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                    Return result
                End If
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    ' Log Error.
                    result = gPMConstants.PMEReturnCode.PMFalse
                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="MakeDirectory process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                    Return result
                End If
                ...
                If Not bZipped Then
                    ...
                    If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                        ' Log Error.
                        result = gPMConstants.PMEReturnCode.PMFalse
                        LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="CopyFile process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                        Return result
                    End If
                ...
                Else
                    ...
                    If Not m_lReturn Then
                        ...
                        LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="UnZipFile process failed.", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="CacheFile process failed", vApp:=ACApp, vClass:=ACClass, vMethod:="CacheFile", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function GetDMEDIR(ByRef sDMEDir As String) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get " & DOCDMEDIRKey & " from Registry", vApp:=ACApp, vClass:=ACClass, vMethod:="GetDMEDIR", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:=PMErrorText, vApp:=ACApp, vClass:=ACClass, vMethod:="GetDMEDIR", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function GetRegistryValue(ByRef sKey As String, ByRef sSubKey As String, ByRef sValue As String, ByRef iLocation As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to get value from the registry.", vApp:=ACApp, vClass:=ACClass, vMethod:="GetRegistryValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function SetRegistryValue(ByRef sKey As String, ByRef sSubKey As String, ByRef sValue As String, ByRef iLocation As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to set value in the registry.", vApp:=ACApp, vClass:=ACClass, vMethod:="SetRegistryValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function SetComboText(ByRef Cbo As ComboBox, ByRef sText As String, ByRef iList As Integer) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="SetComboTextFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="SetComboText", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function IsSiriusInstalled(ByRef r_bSiriusInstalled As Boolean) As Integer
        Dim result As Integer = 0
        Dim bDOCCommitServer As Object
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                If m_lReturn <> gPMConstants.PMEReturnCode.PMCancel Then
                    ' Log Error Message
                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get instance of ObjectManager", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                End If
                Return result
            End If
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogInfo, sMsg:="Failed to get instance of bDOCCommitServer.Commit", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                Return result
            End If
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogInfo, sMsg:="Failed to call IsSBOInstalled on oDocCommit", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                Return result
            End If
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="IsSiriusInstalled Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="IsSiriusInstalled", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function SetCacheStatus(ByRef bCacheDisabled As Boolean) As Integer
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Log Error Message
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise Object Manager", vApp:=ACApp, vClass:=ACClass)
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Log Error Message
                LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create/initialise bDOCOptions.form", vApp:=ACApp, vClass:=ACClass)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get cache enabled/disabled status", vApp:=ACApp, vClass:=ACClass, vMethod:="SetCacheStatus", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
            Return result
    ...
    Public Function ZipCheck(ByVal sFilename As String, ByRef bZipped As Boolean) As Integer
        ...
        Catch excep As System.Exception
            ...
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to check if file zipped", vApp:=ACApp, vClass:=ACClass, vMethod:="ZipCheck", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
            Return result
    ...
    Public Function ClearFolder(ByVal sFolder As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ClearFolder failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ClearFolder", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
