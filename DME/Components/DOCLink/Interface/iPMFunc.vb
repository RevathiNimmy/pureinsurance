...
Module iPMFunc
    ...
    Private Declare Function SendNotifyMessage Lib "user32" Alias "SendNotifyMessageA" (ByVal hwnd As Integer, ByVal msg As Integer, ByVal wParam As Integer, ByVal lParam As Integer) As Integer
    ...
    '
    ' ***************************************************************** '
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, Optional ByRef vApp As Object = Nothing, Optional ByRef vClass As Object = Nothing, Optional ByRef vMethod As Object = Nothing, Optional ByRef vErrNo As Object = Nothing, Optional ByRef vErrDesc As Object = Nothing, Optional ByRef sUsername As String = "")
        ...
        Try
            ...
            Try
                ...
                If Not (oMessage Is Nothing) Then
                    ...
                    ' Log the message
                    lReturn = oMessage.LogMessage(iType:=CShort(iType), sMsg:=sMsg, vApp:=vApp, vClass:=vClass, vMethod:=vMethod, vErrNo:=vErrNo, vErrDesc:=vErrDesc)
            ...
            Catch
                ...
                LogMessagePopup(iType:=iType, sMsg:=sMsg, vApp:=CStr(vApp), vClass:=CStr(vClass), vMethod:=CStr(vMethod), excep:=ex)
...
#End If
            ...
            If lResult <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to initialise the object manager", vApp:=ACApp, vClass:=ACClass, vMethod:="getProductOption", excep:=New Exception(Information.Err().Description))
            ...
            lResult = oObjectManager.GetInstance(temp_oProductOption, "bSIRProductOptions.Business", vInstanceManager:=PMGetViaClientManager)
            ...
            If lResult <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to initialise bSIRProductOptions object", vApp:=ACApp, vClass:=ACClass, vMethod:="getProductOption", excep:=New Exception(Information.Err().Description))
            ...
            If lResult <> gPMConstants.PMEReturnCode.PMTrue Then
                ...
                LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Failed to retrieve product options", vApp:=ACApp, vClass:=ACClass, vMethod:="getProductOption", excep:=New Exception(Information.Err().Description))
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="retrieveProductOptions Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="retrieveProductOptions", excep:=excep)
...
#End If
            ...
            lResult = CType(oObjectManager.Initialise(sCallingAppName:=ACApp), gPMConstants.PMEReturnCode)
            ...
            lResult = CType(oObjectManager.GetInstance(temp_oSystemOptions, "bSIROptions.Business", vInstanceManager:=PMGetViaClientManager), gPMConstants.PMEReturnCode)
    ...
    Private Function IsIn(ByVal vComp As String, ByVal ParamArray vTo() As Object) As Boolean
        ' ---------------------------------------------------------------------------
        ' PROCEDURE NAME: IsIn
    ...
    Public Function getProductOptionValue(ByVal v_vOptionNumber As gPMConstants.SIRHiddenOptions, ByVal v_vBranch As Integer, ByRef r_vUnderwriting As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getProductOptionValue Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getProductOptionValue", excep:=excep)
    ...
    Public Function getUnderwritingOrAgency(ByRef r_vUnderwriting As String) As Integer
        ...
        Try
            ...
            r_vUnderwriting = "A"
            result = getProductOption(gPMConstants.SIRHiddenOptions.SIROPTUnderwriting, SIRBCHHeadOffice, r_vUnderwriting, True)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getUnderwritingOrAgency Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getUnderwritingOrAgency", excep:=excep)
    ...
    Public Function getUnderwritingType(ByRef r_vUnderwriting As String) As Integer
        ...
        Try
            ...
            result = getProductOption(gPMConstants.SIRHiddenOptions.SIROPTUnderwriting, SIRBCHHeadOffice, r_vUnderwriting, False)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getUnderwritingType Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getUnderwritingType", excep:=excep)
    ...
    '
    ' ***************************************************************** '
    Public Function Set_System_Default_Printer(ByVal sPrinter_Name As String) As Integer
        Dim result As Integer = 0
        Try
            ...
            Dim tmpPtr As IntPtr = Marshal.StringToHGlobalAnsi("windows")
            Try
                SendNotifyMessage(HWND_BROADCAST, WM_WININICHANGE, 0, tmpPtr)
            Finally
