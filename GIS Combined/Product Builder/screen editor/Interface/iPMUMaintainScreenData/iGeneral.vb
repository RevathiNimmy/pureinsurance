...
'Modified by Alkesh Kumar on 10/05/2010 16:19:38 refer developer guide no. 
Imports SharedFiles
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iPMUMaintainScreenData.frmInterface

    ' Private instance of the business object.
    Private m_oBusiness As Object
    'Private m_oBusiness As bSIRMaintainUserData.Business
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef r_frmInterface As iPMUMaintainScreenData.frmInterface, ByRef oBusiness As Object) As Integer
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            ' Check the task.
            'In this program we always want to get the business.

            '    If (m_frmInterface.Task = PMEdit Or _
            'm_frmInterface.Task = PMView) Then
            ...
            If m_frmInterface.Task = gPMConstants.PMEComponentAction.PMView Then
                ...
                m_lReturn = PBRiskScreenCommon2.DisableForm(lDisabled:=True, vForm:=m_frmInterface)
            ...
            Select Case (m_frmInterface.Task)
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    Else
                        ...
                        m_lReturn = m_frmInterface.UpdateBusiness()
