...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_lScreenType As Integer 'determines which object/screen type we are editing
    ...
    Public Property ScreenType() As Integer
        Get
            Return IIf(m_lScreenType = 0, GISDataModelType.GISOTRisk, m_lScreenType)
        End Get
    ...
    Public Property GISDataModelCode() As String
        ...
        End Get
        Set(ByVal Value As String)
            m_sGISDataModelCode = Value.TrimEnd()
        End Set
    End Property
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            'get the claim mode
            g_bGetEnableClaimVersions = gCLMLibrary.GetEnableClaimVersions()
    ...
    Protected Sub Dispose(disposing As Boolean)
        If Not Me.disposedValue Then
            ...
            If disposing Then
                If g_iObjectManagerCount < 1 Then
                    g_oObjectManager = Nothing
                Else
                    g_iObjectManagerCount -= 1
                End If
                If g_iObjectManagerCount < 1 Then
                    ...
                    If Not (g_oObjectManager Is Nothing) Then
                        ...
                        If g_iObjectManagerCount < 2 Then
                            g_oObjectManager = Nothing
                        Else
                            g_iObjectManagerCount -= 1
                        End If
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.PMKeyNameScreenId

                        m_lScreenId = CInt(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                    Case "description"

                        m_sScreenDesc = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                    Case "source_id"
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_frmInterface
            ...
            .GISDMType = m_lGISDMType
            .ScreenType = ScreenType

            ' {* USER DEFINED CODE (End) *}
        End With

        'CType(m_frmInterface, SSP.S4I.Interfaces.ILocalInterface).Initialise()
        m_frmInterface.Initialise()
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        m_frmInterface.Timer1.Enabled = True
