...
Public NotInheritable Class Interface_Renamed
    ...
    Private objInterface As frmInterface
    ...
    Private m_vRiskCodesList As Object 'CT

    ' {* USER DEFINED CODE (Begin) *}
    Private m_lRiskCodeId As Integer
    Private m_sRiskCodeDescription As String = "" ' {* USER DEFINED CODE (End) *}
    ...
    'added to signal calling iPMUMaintainScreenDataS
    ...
    End Property
    ' {* USER DEFINED CODE (Begin) *}
    Public WriteOnly Property RiskCodeId() As Integer
        Set(ByVal Value As Integer)
        ...
        End Set
    End Property
    Public WriteOnly Property RiskCodeDescription() As String
        Set(ByVal Value As String)

            ' Set the calling application name.
            m_sRiskCodeDescription = Value

        End Set
    End Property


    Public Property RiskCodesList() As Object
        Get
            Return m_vRiskCodesList 'CT
        End Get
        Set(ByVal Value As Object)


            m_vRiskCodesList = Value 'CT
        End Set
    End Property
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    ...
                    Case PMNavKeyConst.PMKeyNameRiskTypeCode

                        m_sRiskCodeDescription = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow))
                End Select
    ...
    Private Function LoadInterface() As Integer
        ...
        'Akash: Object of class is used instead of Class Name
        'With frmInterface
        With objInterface
            ...
            .SwiftIntegration = m_bSwiftIntegration
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        VB6.ShowForm(objInterface, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            If objInterface.ErrorNumber <> 0 Then
                result = objInterface.ErrorNumber
            End If
        End If
