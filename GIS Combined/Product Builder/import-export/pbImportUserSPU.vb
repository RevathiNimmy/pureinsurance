...
Module pbImportUserSPU
	...
	Public Function ImportUserSPU(ByRef r_oDatabase As dPMDAO.Database, ByVal v_iFileNumber As Short, ByVal v_aIeControl As Object, ByVal v_aIeTableDefinitions As Object, ByVal v_iIntegerData As Short) As Integer
		...
		On Error GoTo Err_ImportUsersSPU
...
Err_ImportUsersSPU:
        ...
        ' Log Error Message
        iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ImportUserSPU Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ImportUserSPU", vErrNo:=Err.Number, vErrDesc:=Err.Description)
    ...
    Public Function RunSPUScript(ByRef r_oDatabase As dPMDAO.Database, ByVal sFileInformation As String) As Object
        ...
        On Error GoTo Err_RunSPUScript
        sSQLFile = ""
...
Err_RunSPUScript:
        ...
        ' Log Error Message
        iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="RunSPUScript Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="RunSPUScript", vErrNo:=Err.Number, vErrDesc:=Err.Description)
