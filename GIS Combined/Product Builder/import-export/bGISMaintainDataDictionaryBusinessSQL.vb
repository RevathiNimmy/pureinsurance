...
Module BusinessSQL
	...
	Public Const ACGetLookupSQL As String = "SELECT tn.{table_name}_id, cap.caption, tn.code " &  _
	                                        "FROM {table_name} tn, pmcaption cap " &  _
	                                        "WHERE tn.is_deleted = 0 " &  _
	                                        "AND tn.effective_date <= {Effective_Date} " &  _
	                                        "AND tn.caption_id = cap.caption_id " &  _
	                                        "AND cap.language_id = {Language_ID} " &  _
	                                        "ORDER BY 2"
