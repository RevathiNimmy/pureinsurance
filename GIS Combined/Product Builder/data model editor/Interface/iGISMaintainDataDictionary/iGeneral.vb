...
Friend NotInheritable Class General
    ...
    Private m_frmInterface As iGISMaintainDataDictionary.frmInterface
    ...
    '
    ' ***************************************************************** '
    Public Function Initialise(ByRef frmInterface As iGISMaintainDataDictionary.frmInterface, ByRef oBusiness As Object) As Integer
