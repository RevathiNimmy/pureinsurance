...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_ofrmRuleDataModel As frmRuleDataModel

    'Developer Guide No. 69
    Private m_ofrmInterface As frmInterface
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.PMKeyNameProductID
                        '                m_lProductID = CLng(vKeyArray(PMKeyValue, lRow&))
                    Case PMNavKeyConst.PMKeyNameProductCode
                        '                m_sProductDescription = CStr(vKeyArray(PMKeyValue, lRow&))
                End Select
    ...
    Private Function ProcessInterface() As Integer
        ...
        m_ofrmRuleDataModel = New frmRuleDataModel
        'AJM 09/05/01 - get data model id
        m_ofrmRuleDataModel.ShowDialog()
        'Developer Guide No. 69
        If m_ofrmRuleDataModel.Status <> gPMConstants.PMEReturnCode.PMCancel Then
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_ofrmInterface
            ...
            ' {* USER DEFINED CODE (Begin) *}
            'AJM 09/05/01 - set data model id
            'Developer Guide No. 69
            .DataModelId = m_ofrmRuleDataModel.DataModelId
            ' {* USER DEFINED CODE (End) *}
        End With
