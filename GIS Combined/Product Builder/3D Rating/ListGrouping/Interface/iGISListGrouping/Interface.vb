...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bGISListGrouping.Business", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            g_oBusiness = temp_g_oBusiness
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                ' Log Error Message
                iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogFatal, sMsg:="Failed to get instance of bGISListGrouping.Business", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                Return result
            End If
    ...
    Public Function Start() As Integer
        ...
        Try
            ...
            'Modified by Vijay Pal on 5/26/2010 5:01:24 PM refer developer guide no. 68
            'Load(oForm)
