...
Public NotInheritable Class NavigatorV3
    ...
    ' RDC 23042002 missing from shared version of class
    ...
    ' RDC 23042002 missing from shared version of class   START
    ...
    Public WriteOnly Property PMNavCancelAction() As String
        ...
        End Set
    End Property
    ' RDC 23042002 missing from shared version of class   END
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            'PSL Issue 2380 Should Default to Edit
    ...
    Public Function NavigatorV3_Start() As Integer Implements aPMNav.NavigatorV3.Start
        ...
        Try
            ...
            'DP 17/02/2003 - added for STG multiInsurer
            If Not (m_cList Is Nothing) Then
                m_oInterface.List = m_cList
            End If
            m_oInterface.vArray = VB6.CopyArray(m_aArray)
