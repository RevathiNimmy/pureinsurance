...
Public NotInheritable Class Interface_Renamed
    ...
    Public Property AccumulationIds() As Object
        Get
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get options", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise")
    ...
    Private Function LoadInterface() As Integer
        ...
        'Developer Guide No. 69
        m_lReturn = CType(m_ofrmInterface.SetStatus(m_sProcessStatus.Value, m_sMapStatus.Value, m_sStepStatus.Value), gPMConstants.PMEReturnCode)
    ...
    Private Function UnLoadInterface() As Integer
        ...
        With m_ofrmInterface
            ...
            m_vAccumulationIds = .AccumulationIds
            ' {* USER DEFINED CODE (End) *}
        End With
