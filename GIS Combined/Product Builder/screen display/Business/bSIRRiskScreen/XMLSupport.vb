...
Module XMLSupport
    ...
    Private Function GetArrayInfo(ByRef TheArray As Object, ByRef ArrayInfo As SAFEARRAY) As Integer
        ...
        'If Not Informations.IsArray(TheArray) Then Return result
        ...
        '             'Modified by Archana Tokas on 24/03/2010 10:47:03 refer developer guide no.no solution 48
        '             'Dim handle4 As GCHandle = GCHandle.Alloc(VarPtr(TheArray) + 8, GCHandleType.Pinned)
        '             Dim handle4 As GCHandle = GCHandle.Alloc(Str(TheArray) + 8, GCHandleType.Pinned)
        '	Try 
        ...
        '		' So caller knows there is Informations available for the array in
        '		' output SAFEARRAY
        '		result = ArrayInfo.cDims
        '	End If
        'End With

        'developer guide no. Work around of above code. Need to be checked at run time. since Artinsoft/array starting from 0 element
        'rgsabound(1) changed to rgsabound(0) and rgsabound(2) changed to rgsabound(1).
    ...
    Public Sub StoreItemArray(ByRef vDataStore() As Object, ByRef lLastPos As Integer, ByVal v_sItemName As String, ByVal v_vItemData As Object)
        Try
            ...
            If Not Informations.IsArray(v_vItemData) Then
                ...
                Append(vDataStore, lLastPos, "<" & v_sItemName & " value='" & Convert.ToString(vValue) & "' datatype='" & sTypeName.ToLower() & "'" & (If(sVarContents <> "", " varcontents='" & sVarContents & "'/>", "/>")))
                Exit Sub
            End If
            ...
            sDataType = v_vItemData.GetType().Name.ToString
                ...
                If iDims > 1 Then
                    For lColumn As Integer = lColumnLowBound To lColumns
                        ...
                        Else
                            ...
                            'developer guide no 270.
                            Append(vDataStore, lLastPos, "<COL value='" & Convert.ToString(vArrayItem) & "' datatype='" & sTypeName & "'" & (If(sVarContents <> "", " varcontents='" & sVarContents & "'/>", "/>")))
                        End If
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", StoreItemArray, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Sub StoreItem(ByRef vDataStore() As Object, ByRef lLastPos As Integer, ByVal v_sItemName As String, ByVal v_vItemData As Object)
        Try
            ...
            Append(vDataStore, lLastPos, "<" & v_sItemName & " value='" & CStr(vValue) & "' datatype='" & sTypeName.ToLower() & "'" & (If(sVarContents <> "", " varcontents='" & sVarContents & "'/>", "/>")))

        Catch excep As System.Exception



            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", StoreItem, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function ExportItemArray(ByVal oNode As XmlNode) As Object
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ExportItemArray, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Sub StoreMessageArray(ByRef vDataStore() As Object, ByRef lLastPos As Integer, ByRef oMessages As PMXMLWarningMsg)
        ...
        'to be added for 64 bit by shipali
        'If oMessages.List Is Nothing Then
        '    Append(vDataStore, lLastPos, "<WARNINGS/>")
        '    Exit Sub
        'End If
        If oMessages.List Is Nothing Then
            Append(vDataStore, lLastPos, "<WARNINGS/>")
            oMessageList = Nothing
        Else
            oMessageList = (oMessages.List).Clone()
        End If



        Try
            If oMessageList Is Nothing Then
                lUBound = -1
            Else
...
Err_StoreMessageArray:
        ...
        Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", StoreMessageArray, " + "Error: " & Informations.Err().Number & " - " & Informations.Err().Description)
    ...
    Public Sub StoreErrorArray(ByRef vDataStore() As Object, ByRef lLastPos As Integer, ByRef oErrors As PMXMLErrorTypes)
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", StoreErrorArray, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Private Sub StoreInvalidDataErrors(ByRef vDataStore() As Object, ByRef lLastPos As Integer, ByRef oErrors As PMXMLErrorTypes)
        ...
        oInvalidData = oErrors.InvalidData.Details


        Try

            'developer guide no. Nothing.GetUpperBound(0) gives error. Informations.Err() Is not working.
            'lUBound = oInvalidData.GetUpperBound(0)
            'If Informations.Err().Number <> 0 Then
            If Informations.IsNothing(oInvalidData) Then
...
Err_StoreInvalidDataErrors:
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", StoreInvalidDataErrors, " + "Error: " & Informations.Err().Number & " - " & Informations.Err().Description)
    ...
    Public Function ExportMessageArray(ByVal oNodes As XmlNodeList, ByRef bHasMessages As Boolean) As PMXMLWarningMsg
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ExportMessageArray, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function ExportErrorArray(ByVal oNodes As XmlNodeList, ByRef bHasErrors As Boolean, ByRef bHasInvalidDataErrors As Boolean, ByRef bHasBusinessRuleErrors As Boolean, ByRef bHasBackOfficeErrors As Boolean, ByRef bHasInternalExceptionErrors As Boolean) As PMXMLErrorTypes
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ExportErrorArray, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function FormatDateCanonical(ByVal v_dtDate As Date) As String
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", FormatDateCanonical, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function FormatSafeXMLString(ByVal v_sString As String) As String
        Try
            ...
            v_sString = v_sString.Replace("&", "&amp;")
            v_sString = v_sString.Replace("'", "&apos;")
            v_sString = v_sString.Replace(Strings.ChrW(34).ToString(), "&quot;")
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", FormatSafeXMLString, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function UnformatSafeXMLString(ByVal v_sString As String) As String
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", UnformatSafeXMLString, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function ExportItem(ByVal oNode As XmlNode) As String
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ExportItem, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    '
    ' Description:  Get formatted data and Informations about that data
    '
    ' History:      27/05/2004  RVH Created
    '******************************************************************************
    Private Function GetFormattedValue(ByVal v_vValue As Object, ByRef r_sDataType As String, ByRef r_sVarContents As String) As Object
        ...
        'developer guide no 253.
        If v_vValue Is Nothing Then
            sTypeName = ""
        Else
            sTypeName = v_vValue.GetType().Name.ToString()
        End If
        ...
        If Convert.IsDBNull(v_vValue) Or Informations.IsNothing(v_vValue) Then
            r_sVarContents = "null"
        End If
    ...
    Public Function AddInvalidDataError(ByVal MethodName As String, ByVal FieldName As String, ByVal Code As gPMConstants.PMEReturnCode, ByVal Description As String, ByVal SuppliedValue As Object, ByRef oInvalidData As PMXMLErrorInvalidData) As Object
        ...
        oInvalidDataError = (oInvalidData.Details).Clone()
...
Err_AddInvalidDataError:
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", AddInvalidDataError, " + "Error: " & Informations.Err().Number & " - " & Informations.Err().Description)
    ...
    Public Function AddBusinessRuleError(ByVal MethodName As String, ByVal Code As gPMConstants.PMEReturnCode, ByVal Description As String, ByVal Detail As Object, ByRef oBusinessRule As PMXMLErrorBusinessRule) As Object
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", AddBusinessRuleError, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
            Return Nothing
        End Try
    ...
    Public Function AddBackOfficeError(ByVal MethodName As String, ByVal ReturnValue As Integer, ByVal Description As String, ByRef oBackOffice As PMXMLErrorBackOffice) As Object
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", AddBackOfficeError, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
        End Try
    ...
    Public Function AddInternalExceptionError(ByVal MethodName As String, ByVal Description As String, ByRef oInternalException As PMXMLErrorInternalException) As Object
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", AddInternalExceptionError, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function ComposeErrorString(ByRef oErrors As PMXMLErrorTypes) As String
        Try
            ...
            If oErrors.BackOffice.Count > 0 Then
                sError = sError & "[" & oErrors.BackOffice.Detail.MethodName & "] " & CStr(oErrors.BackOffice.Detail.ReturnValue) & " - " & oErrors.BackOffice.Detail.Description & Strings.ChrW(10).ToString()
            End If

            If oErrors.BusinessRule.Count > 0 Then
                If sError.Length Then
                    sError = sError & Strings.ChrW(10).ToString()
                End If

                sError = sError & "[" & oErrors.BusinessRule.Detail.MethodName & "] " & CStr(oErrors.BusinessRule.Detail.Code) & " - " & oErrors.BusinessRule.Detail.Description & " (" & CStr(oErrors.BusinessRule.Detail.Detail) & ")" & Strings.ChrW(10).ToString()
            End If
            ...
            If oErrors.InternalException.Count > 0 Then
                If sError.Length Then
                    sError = sError & Strings.ChrW(10).ToString()
                End If
                sError = sError & "[" & oErrors.InternalException.Detail.MethodName & "] " & oErrors.InternalException.Detail.Description & Strings.ChrW(10).ToString()
            End If
            ...
            If oErrors.InvalidData.Count > 0 Then
                ...
                For lError As Integer = 0 To oErrors.InvalidData.Count - 1
                    ...
                    sError = sError & "[" & oErrors.InvalidData.Details(lError).MethodName & "] " & CStr(oErrors.InvalidData.Details(lError).Code) & " - " & oErrors.InvalidData.Details(lError).Description & " (" & oErrors.InvalidData.Details(lError).FieldName & ":" & CStr(oErrors.InvalidData.Details(lError).SuppliedValue) & ")" & Strings.ChrW(10).ToString()
                Next lError
            End If
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ComposeErrorString, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function ComposeWarningString(ByRef oWarnings As PMXMLWarningMsg) As String
        Try
            ...
            If oWarnings.Count > 0 Then
                For lWarning As Integer = 0 To oWarnings.Count - 1
                    sWarning = sWarning & "[" & oWarnings.List(lWarning).MethodName & "] " & oWarnings.List(lWarning).Title & " - (" & CStr(oWarnings.List(lWarning).Number) & ") " & oWarnings.List(lWarning).message & Strings.ChrW(10).ToString()
                Next lWarning
            End If
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", ComposeWarningString, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
...
Err_AddWarning:
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", AddWarning, " + "Error: " & Informations.Err().Number & " - " & Informations.Err().Description)
    ...
    Public Sub Append(ByRef vDataStore() As Object, ByRef LastPos As Integer, ByVal AppendData As String)
        Try
            ...
            If Not Informations.IsArray(vDataStore) Then
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", Append, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
