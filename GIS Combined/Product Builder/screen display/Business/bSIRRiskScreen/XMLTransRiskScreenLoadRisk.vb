...
Module XMLTransRiskScreenLoadRisk
    ...
    Public Structure RiskScreenLoadRiskIn
        ...
        Dim lInsuranceFolderCnt As Object
    ...
    Public Function SerializeRiskScreenLoadRiskIn(ByRef oTypeIn As RiskScreenLoadRiskIn) As String
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", SerializeRiskScreenLoadRiskIn, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function SerializeRiskScreenLoadRiskOut(ByRef oTypeOut As RiskScreenLoadRiskOut) As String
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", SerializeRiskScreenLoadRiskOut, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function DeserializeRiskScreenLoadRiskIn(ByVal sXML As String) As RiskScreenLoadRiskIn
        Try
            ...
            Catch parseError As System.Xml.XmlException
                ...
                Throw New System.Exception(gPMConstants.PMEReturnCode.PMXMLParseError.ToString() + ", DeserializeRiskScreenLoadRiskIn, " + "XML Parse Error: " & " - " & parseError.Message)
            End Try

            'developer guide no.Changed as per vb code.Reomved CInt(), CBool(), CDate() from below code.
            oType.iTask = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/iTask"))
            oType.iSourceID = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/iSourceID"))
            oType.lNavigate = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lNavigate"))
            oType.lProcessMode = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lProcessMode"))
            oType.sTransactionType = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sTransactionType"))
            oType.dtEffectiveDate = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/dtEffectiveDate"))
            oType.bSubScreen = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/bSubScreen"))
            oType.lScreenId = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lScreenId"))
            oType.lRiskId = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lRiskId"))
            oType.lRiskTypeId = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lRiskTypeId"))
            oType.sGisDataModelCode = Trim(ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sGisDataModelCode")))
            oType.lGISDataModelType = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lGISDataModelType"))
            oType.lObjectType = CInt(ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lObjectType")))
            oType.sGISXMLDataset = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sGISXMLDataset"))
            oType.sMyOIKey = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sMyOIKey"))
            oType.sMyObjectName = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sMyObjectName"))
            oType.sParentOIKey = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sParentOIKey"))
            oType.sParentObjectName = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/sParentObjectName"))
            ...
            oType.lCaseID = gPMFunctions.ToSafeInteger(ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskIn/lCaseID")))
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", DeserializeRiskScreenLoadRiskIn, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
    ...
    Public Function DeserializeRiskScreenLoadRiskOut(ByVal sXML As String) As RiskScreenLoadRiskOut
        Try
            ...
            oType.sGISXMLDataset = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sGISXMLDataset"))
            oType.sMyOIKey = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sMyOIKey"))
            oType.sMyObjectName = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sMyObjectName"))
            oType.sParentOIKey = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sParentOIKey"))
            oType.sParentObjectName = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sParentObjectName"))
            ...
            oType.sReferReasons = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sReferReasons"))
            oType.sDeclineReasons = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sDeclineReasons"))
            oType.sMessages = ExportItem(oXML.SelectSingleNode("RiskScreenLoadRiskOut/sMessages"))
        ...
        Catch excep As System.Exception
            ...
            Throw New System.Exception(gPMConstants.PMEReturnCode.PMError.ToString() + ", DeserializeRiskScreenLoadRiskOut, " + "Error: " & Informations.Err().Number & " - " & excep.Message)
