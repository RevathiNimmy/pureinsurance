...
Module MainModule
	...
	Public Const ACApp As String = "iGISUserDefHeader"
	...
	Public Const ACCaptionDate As Integer = 102
	Public Const ACCaptionRate As Integer = 103
	Public Const ACCaptionAmount As Integer = 104
