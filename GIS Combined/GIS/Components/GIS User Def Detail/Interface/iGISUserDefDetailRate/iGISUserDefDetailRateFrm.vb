...
Friend Partial Class frmInterface
	...
	Private m_oGeneral As iGISUserDefDetailRate.General
	...
	Private Function DisplayCaptions() As Integer
		...
		Try 
            ...
            lblDetail.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCaptionHeader, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
	...
	Private Sub Form_Initialize_Renamed()
		...
		Try 
			...
			m_oGeneral = New iGISUserDefDetailRate.General()
