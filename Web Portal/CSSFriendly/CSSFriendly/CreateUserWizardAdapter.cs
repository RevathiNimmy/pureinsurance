    ...
    public class CreateUserWizardAdapter : System.Web.UI.WebControls.Adapters.WebControlAdapter
    {
        ...
        private void WriteUserPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            ...
            if (textBox != null)
            {
                ...
                Extender.WriteTextBox(writer, false, wizard.LabelStyle.CssClass, wizard.UserNameLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_UserName", textBox.UniqueID, wizard.UserName);
        ...
        private void WritePasswordPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            ...
            if (textBox != null)
            {
                ...
                Extender.WriteTextBox(writer, true, wizard.LabelStyle.CssClass, wizard.PasswordLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_Password", textBox.UniqueID, "");
        ...
        private void WriteConfirmPasswordPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            ...
            if (textBox != null)
            {
                ...
                Extender.WriteTextBox(writer, true, wizard.LabelStyle.CssClass, wizard.ConfirmPasswordLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_ConfirmPassword", textBox.UniqueID, "");
        ...
        private void WriteEmailPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            ...
            if (textBox != null)
            {
                ...
                Extender.WriteTextBox(writer, false, wizard.LabelStyle.CssClass, wizard.EmailLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_Email", textBox.UniqueID, "");
        ...
        private void WriteQuestionPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            if ((WizardMembershipProvider != null) && WizardMembershipProvider.RequiresQuestionAndAnswer)
            {
                ...
                if (textBox != null)
                {
                    ...
                    Extender.WriteTextBox(writer, false, wizard.LabelStyle.CssClass, wizard.QuestionLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_Question", textBox.UniqueID, "");
        ...
        private void WriteAnswerPanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            if ((WizardMembershipProvider != null) && WizardMembershipProvider.RequiresQuestionAndAnswer)
            {
                ...
                if (textBox != null)
                {
                    ...
                    Extender.WriteTextBox(writer, false, wizard.LabelStyle.CssClass, wizard.AnswerLabelText, wizard.TextBoxStyle.CssClass, "CreateUserStepContainer_Answer", textBox.UniqueID, "");
		...
		private void WriteCreateUserButtonPanel(HtmlTextWriter writer, CreateUserWizard wizard)
		{
			...
			string btnParentCtrlId = "_CustomNav0"; 
			...
			if (btnParentCtrl != null)
			{
				...
				if (btn != null)
				{
                    ...
                    Extender.WriteSubmit(writer, wizard.CreateUserButtonType, wizard.CreateUserButtonStyle.CssClass, createUserBtnId, btn.UniqueID, wizard.CreateUserButtonImageUrl, javascript, wizard.CreateUserButtonText);
					...
					if (wizard.DisplayCancelButton)
					{
						...
						if (cancelBtn != null)
						{
                            ...
                            Extender.WriteSubmit(writer, wizard.CancelButtonType, wizard.CancelButtonStyle.CssClass, cancelBtnId, cancelBtn.UniqueID, wizard.CancelButtonImageUrl, "", wizard.CancelButtonText);
						}
					}
					WebControlAdapterExtender.WriteEndDiv(writer);
				}
        ...
        private void WriteContinuePanel(HtmlTextWriter writer, CreateUserWizard wizard)
        {
            ...
            if (btn != null)
            {
                ...
                Extender.WriteSubmit(writer, wizard.ContinueButtonType, wizard.ContinueButtonStyle.CssClass, btn.ClientID, btn.UniqueID, wizard.ContinueButtonImageUrl, "", wizard.ContinueButtonText);
                WebControlAdapterExtender.WriteEndDiv(writer);
            }
        }
