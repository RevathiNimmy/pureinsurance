    ...
    public class ChangePasswordAdapter : System.Web.UI.WebControls.Adapters.WebControlAdapter
    {
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            if (Extender.AdapterEnabled)
            {
                ...
                if (changePwd != null)
                {
                    ...
                    {
						if ((changePwd.ChangePasswordTemplate != null) && (changePwd.ChangePasswordTemplateContainer != null))
						{
							foreach (Control c in changePwd.ChangePasswordTemplateContainer.Controls)
							{
        ...
        private void WriteUserPanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            if (changePwd.DisplayUserName)
            {
                ...
                if (textbox != null)
                {
                    ...
                    Extender.WriteTextBox(writer, false, changePwd.LabelStyle.CssClass, changePwd.UserNameLabelText, changePwd.TextBoxStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_UserName", textbox.UniqueID, changePwd.UserName);
        ...
        private void WritePasswordPanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            ...
            if (textbox != null)
            {
                ...
                Extender.WriteTextBox(writer, true, changePwd.LabelStyle.CssClass, changePwd.PasswordLabelText, changePwd.TextBoxStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_CurrentPassword", textbox.UniqueID, "");
        ...
        private void WriteNewPasswordPanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            ...
            if (textbox != null)
            {
                ...
                Extender.WriteTextBox(writer, true, changePwd.LabelStyle.CssClass, changePwd.NewPasswordLabelText, changePwd.TextBoxStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_NewPassword", textbox.UniqueID, "");
        ...
        private void WriteConfirmNewPasswordPanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            ...
            if (textbox != null)
            {
                ...
                Extender.WriteTextBox(writer, true, changePwd.LabelStyle.CssClass, changePwd.ConfirmNewPasswordLabelText, changePwd.TextBoxStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_ConfirmNewPassword", textbox.UniqueID, "");
        ...
        private void WriteSubmitPanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            ...
            if (btn != null)
            {
                ...
                Extender.WriteSubmit(writer, changePwd.ChangePasswordButtonType, changePwd.ChangePasswordButtonStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_" + id, btn.UniqueID, changePwd.ChangePasswordButtonImageUrl, javascript, changePwd.ChangePasswordButtonText);
            }
            ...
            {
                Page.ClientScript.RegisterForEventValidation(btn.UniqueID);
                Extender.WriteSubmit(writer, changePwd.CancelButtonType, changePwd.CancelButtonStyle.CssClass, changePwd.ChangePasswordTemplateContainer.ID + "_" + id, btn.UniqueID, changePwd.CancelButtonImageUrl, "", changePwd.CancelButtonText);
            }
        ...
        private void WriteContinuePanel(HtmlTextWriter writer, ChangePassword changePwd)
        {
            ...
            {
                Page.ClientScript.RegisterForEventValidation(btn.UniqueID);
                Extender.WriteSubmit(writer, changePwd.ContinueButtonType, changePwd.ContinueButtonStyle.CssClass, changePwd.SuccessTemplateContainer.ID + "_" + id, btn.UniqueID, changePwd.ContinueButtonImageUrl, "", changePwd.ContinueButtonText);
            }
