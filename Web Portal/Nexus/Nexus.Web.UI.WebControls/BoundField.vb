...
Imports CMS.Library
Public Class BoundField : Inherits System.Web.UI.WebControls.BoundField
    ...
    Public Property DataType() As String
        ...
        Set(ByVal value As String)
            ...
            If oFormatString IsNot Nothing Then
                ...
                If MyBase.DataFormatString = String.Empty Then
                    MyBase.DataFormatString = oFormatString.DataFormatString
                End If
