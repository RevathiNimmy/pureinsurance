                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <label class="col-md-4 col-sm-3 control-label">
                                Name</label><div class="col-md-8 col-sm-9">
                                    <asp:TextBox ID="DRIVERDET__NAME" runat="server" CssClass="form-control"></asp:TextBox></div>
                        </div>
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <label class="col-md-4 col-sm-3 control-label">
                                DOB</label><div class="col-md-8 col-sm-9">
                                    <div class="input-group">
                                        <asp:TextBox ID="DRIVERDET__DOB" runat="server" CssClass="form-control"></asp:TextBox><NexusControl:calendarlookup id="calDRIVERDET__DOB" runat="server" linkedcontrol="DRIVERDET__DOB" hlevel="1"></NexusControl:calendarlookup></div>
                                </div>
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <label class="col-md-4 col-sm-3 control-label">
                                DriLicenceNo</label><div class="col-md-8 col-sm-9">
                                    <asp:TextBox ID="DRIVERDET__DRILICENCENO" runat="server" CssClass="form-control"></asp:TextBox></div>
                        </div>
                    </div>
                </div>
