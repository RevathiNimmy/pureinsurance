<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/default.master"
    MaintainScrollPositionOnPostback="true" CodeFile="MOTOR_VEHICLEDETAILSQQ.aspx.vb"
    Inherits="Nexus.MOTOR_VEHICLEDETAILSQQ" %>
            ...
            <div class="card">
                ...
                <div class="card-body clearfix">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <div class="col-md-8 col-sm-9">
                                <asp:TextBox ID="VEHDET__QUICK_QUOTE" runat="server" Text="1" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="form-horizontal">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12"></div>
                        ...
                        <!-- For UDL versioning Test in Nexus-->
                    ...
                    <legend>
                        <asp:HyperLink ID="HyperLink1" runat="server">Go to DME Page</asp:HyperLink>
                    </legend>
