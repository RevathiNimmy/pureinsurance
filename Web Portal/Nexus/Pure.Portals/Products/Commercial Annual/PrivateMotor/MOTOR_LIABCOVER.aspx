                    ...
                    <div class="grid-card table-responsive">
                        <table class="grid-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="VEHDET__TPL_LIMIT_IDEMNITY" runat="server" onblur='return CalcPremTPL();' CssClass="form-control" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox>
                    ...
                    <div class="grid-card table-responsive">
                        <table class="grid-table">
                            ...
                            <tr>
                                ...
                                <td class="fapPerc">
                                    <asp:TextBox ID="MS__DLC_CHR_RATEN" runat="server" onblur='return CalcPremCarHire();' CssClass="e-num4"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="MS__DLC_CL_LIMIT_IDEMN" runat="server" onblur='return CalcPremContLiab();' onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox>
                                ...
                                <td class="fapPerc">
                                    <asp:TextBox ID="MS__DLC_CL_RATEN" runat="server" onblur='return CalcPremContLiab();' CssClass="e-num4"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="MS__DLC_CR_LIMIT_IDEMN" runat="server" onblur='return CalcPremShrtFall();' onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox>
                                ...
                                <td class="fapPerc">
                                    <asp:TextBox ID="MS__DLC_CR_RATEN" CssClass="e-num4" runat="server" onblur='return CalcPremShrtFall();'></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="MS__DLC_WR_LIMIT_IDEMN" runat="server" onblur='return CalcPremWreck();' onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></asp:TextBox>
                                ...
                                <td class="fapPerc">
                                    <asp:TextBox ID="MS__DLC_WR_RATEN" runat="server" onblur='return CalcPremWreck();' CssClass="e-num4"></asp:TextBox>
