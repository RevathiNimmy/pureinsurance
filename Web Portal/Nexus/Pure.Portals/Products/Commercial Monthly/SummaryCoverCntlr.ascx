...
<div id="divDME" runat="server">
    <uc10:DocumentManager ID="docMgr1" runat="server" Visible="true" Documents="Quotation"></uc10:DocumentManager>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                <asp:Label ID="lblTotalCommission" runat="server" CssClass="col-md-4 col-sm-3 control-label" AssociatedControlID="lblTotalCommissionValue">
                    <asp:Literal ID="litTotalCommission" runat="server" Text="<%$ Resources:lbl_Commission%>"></asp:Literal></asp:Label>
                <div class="col-md-8 col-sm-9">
                    <p class="form-control-static font-bold">
...
<div id="TransDetails" runat="server" visible="false">
    <div class="card-body clearfix no-padding">
        <legend>
            <asp:Label ID="ltPremiumTrans" runat="server" Text="<%$ Resources:lbl_PremiumTransactions%>"></asp:Label></legend>
...
<div id="QuoteDocument" runat="server" visible="true">
    <div class="card-body clearfix no-padding">
        ...
        <br />
        <uc5:Document ID="li_QuoteDocument" runat="server" DocumentName="Quotation" PreGenerate="false" Visible="true" Text="<%$ Resources:lbl_QuoteDocument %>"></uc5:Document>
    </div>
</div>
<div id="CvrDtls" runat="server" visible="true">
    <div class="card-body clearfix no-padding">
        <legend>
