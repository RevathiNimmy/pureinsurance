                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            ...
                            <asp:UpdatePanel ID="POLICYHEADER__UpdatePanelSubBranch" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="col-md-8 col-sm-9">
                                        <asp:DropDownList ID="POLICYHEADER__SUBBRANCH" runat="server" CssClass="field-mandatory form-control">
                                        </asp:DropDownList>
                                    </div>
                                </ContentTemplate>
                                <Triggers>
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <asp:UpdatePanel ID="POLICYHEADER__updPanelAgent" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:Label runat="server" ID="lblAgent" Text="Agent Code" AssociatedControlID="POLICYHEADER__AGENTCODE" class="col-md-4 col-sm-3 control-label">
                                    ...
                                    <%-- <asp:RequiredFieldValidator ID="vldrqdAgentCode" runat="server" ControlToValidate="POLICYHEADER__AGENTCODE"
                                                    ErrorMessage="Error in Agent Code" Display="None" SetFocusOnError="true" Enabled="true" />--%>
