                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <label class="col-md-4 col-sm-3 control-label">
                                PassingYear</label><div class="col-md-8 col-sm-9">
                                    <asp:TextBox ID="QUALFICATIONS__QUAL_PASSING_YEAR" runat="server" MaxLength="4" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" CssClass="field-mandatory form-control"></asp:TextBox>
                                </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            <label class="col-md-4 col-sm-3 control-label">
                                Course Name</label><div class="col-md-8 col-sm-9">
                                    <asp:TextBox ID="QUALFICATIONS__QUAL_COURSE_NAME" runat="server" CssClass="field-mandatory form-control"></asp:TextBox>
                                </div>
                        ...
                        <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="col-md-8 col-sm-9">
                                <NexusProvider:lookuplist id="QUALFICATIONS__QUAL_AREA" runat="server" dataitemtext="Description" dataitemvalue="Key" listtype="PMLookup" listcode="AREA" defaulttext="(Please Select)" cssclass="field-mandatory form-control"></NexusProvider:lookuplist>
                            </div>
