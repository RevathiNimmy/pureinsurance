<%@ control language="VB" autoeventwireup="false" inherits="Nexus.Controls_ReportControls_ClaimsPaidGrossToNet" Codefile="ClaimsPaidGrossToNet.ascx.vb"%>
...
<div id="Controls_ReportControls_ClaimsPaidGrossToNet">
    <div class="card">
        <div class="card-body clearfix">
            <div class="form-horizontal">
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    <asp:Label ID="lblsBasis" runat="server" AssociatedControlID="RP__BASIS" Text="<%$ Resources:lbl_sBasis %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                    <div class="col-md-8 col-sm-9">
