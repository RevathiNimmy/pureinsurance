<%@ Control Language="VB" AutoEventWireup="false" Inherits="Nexus.Controls_ReportControls_PremiumCommissionRegisters" CodeFile="PremiumCommissionRegisters.ascx.vb" %>
...
<div id="Controls_ReportControls_PremiumCommissionRegisters">
	<div class="card">
		<div class="card-body clearfix">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
					<asp:Label ID="lblRegisterType" runat="server" AssociatedControlID="RP__REGISTER_TYPE" Text="<%$ Resources:lbl_RegisterType %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
					<div class="col-md-8 col-sm-9">
						<asp:DropDownList ID="RP__REGISTER_TYPE" runat="server" CssClass="field-medium form-control">
							<asp:ListItem Text="<%$ Resources:li_Premium %>" Value="Premium"></asp:ListItem>
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
					...
					<asp:CompareValidator ID="comvldPPeriodStartDate" runat="server" Display="None" ControlToValidate="RP__START_DATE" SetFocusOnError="true" ErrorMessage="<%$ Resources:lbl_invalid_PeriodStartDate %>" Operator="DataTypeCheck" Type="Date" ValidationGroup="vldReportsControlsGroup"></asp:CompareValidator>
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
					<asp:Label ID="lblDatePeriod" runat="server" AssociatedControlID="RP__REGISTER_PERIOD" Text="<%$ Resources:lbl_DatePeriod %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
					<div class="col-md-8 col-sm-9">
						<asp:DropDownList ID="RP__REGISTER_PERIOD" runat="server" CssClass="field-medium form-control">
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_SpecificDate %>" Value="Specify Dates"></asp:ListItem>
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_Yesterday %>" Value="Yesterday"></asp:ListItem>
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_Today %>" Value="Today"></asp:ListItem>
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_LFW %>" Value="Last Full Week"></asp:ListItem>
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_LFM %>" Value="Lat Full Month"></asp:ListItem>
							<asp:ListItem Text="<%$ Resources:li_DatePeriod_ThisMonth %>" Value="This Month"></asp:ListItem>
						</asp:DropDownList>
					</div>
				</div>
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
