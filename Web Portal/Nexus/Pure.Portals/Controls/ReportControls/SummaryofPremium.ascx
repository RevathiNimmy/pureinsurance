<%@ control language="VB" autoeventwireup="false" inherits="Nexus.Controls_ReportControls_SummaryofPremium" Codefile="SummaryofPremium.ascx.vb"%>
...
<div id="Controls_ReportControls_SummaryofPremium">
    <div class="card">
