<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ClaimsExperience.ascx.vb"
    Inherits="Nexus.Controls_ReportControls_ClaimsExperience" %>
...
<div id="claimsexperience-control">
    <div class="card">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    <asp:Label runat="Server" CssClass="col-md-4 col-sm-3 control-label" AssociatedControlID="RP__CORPORATECLIENT" Text="<%$ Resources:btn_Client %>" ID="lblbtnClient"></asp:Label><div class="col-md-8 col-sm-9">
                        <div class="input-group">
                            <asp:TextBox ID="RP__CORPORATECLIENT" runat="server" CssClass="form-control" Text="ALL"></asp:TextBox><span class="input-group-btn"><asp:LinkButton ID="btnClient" runat="server" OnClientClick="tb_show(null , '../Secure/Agent/FindClient.aspx?modal=true&RequestPage=BG&KeepThis=true&FromPage=PC&TB_iframe=true&height=500&width=950' , null);return false;" SkinID="btnModal">
                    ...
                    <asp:RequiredFieldValidator ID="rqdClient" runat="server" ControlToValidate="RP__CORPORATECLIENT" Display="None" ErrorMessage="<%$ Resources:lbl_req_Client %>" SetFocusOnError="true" ValidationGroup="vldReportsControlsGroup" Enabled="false"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    <asp:Label runat="Server" CssClass="col-md-4 col-sm-3 control-label" AssociatedControlID="RP__POLICYNUMBER" Text="<%$ Resources:btn_InsuranceFile %>" ID="lblbtnInsuranceFile"></asp:Label><div class="col-md-8 col-sm-9">
                        <div class="input-group">
                            <asp:TextBox ID="RP__POLICYNUMBER" runat="server" CssClass="form-control" Text=""></asp:TextBox><span class="input-group-btn">
                ...
                <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-9">
                        <asp:DropDownList ID="RP__LAPSE_CANCEL_FLAG" runat="server" CssClass="form-control form-select">
