<%@ control language="VB" autoeventwireup="false" inherits="Nexus.Controls_ReportControls_UnearnedPremium" Codefile="UnearnedPremium.ascx.vb"%>
...
<div id="Controls_ReportControls_UnearnedPremium">
    <div class="card">
        <div class="card-body clearfix">
            <div class="form-horizontal">
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    <asp:Label ID="lblDetailSummary" runat="server" AssociatedControlID="RP__DETAILSUMMARY" Text="<%$ Resources:lbl_DetailSummary %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                    <div class="col-md-8 col-sm-9">
                        <asp:DropDownList ID="RP__DETAILSUMMARY" runat="server" CssClass="field-medium form-control">
                            <asp:ListItem Text="<%$ Resources:li_DetailSummary_Summary %>" Value="Summary"></asp:ListItem>
                            <asp:ListItem Text="<%$ Resources:li_DetailSummary_Detail %>" Value="Detail"></asp:ListItem>  
                        </asp:DropDownList>
                    </div>
                </div>
