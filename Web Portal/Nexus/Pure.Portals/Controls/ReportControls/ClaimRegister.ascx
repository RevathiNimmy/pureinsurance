<%@ control language="VB" autoeventwireup="false" inherits="Nexus.Controls_ReportControls_ClaimRegister" Codefile="ClaimRegister.ascx.vb"%>
...
<div id="Controls_ReportControls_ClaimRegister">
    <div class="card">
				...
				<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-9">
                        <asp:DropDownList ID="RP__REGISTER_TYPE" runat="server" CssClass="field-medium form-control">
                            <asp:ListItem Text="<%$ Resources:li_Claim %>" Value="Claim"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
