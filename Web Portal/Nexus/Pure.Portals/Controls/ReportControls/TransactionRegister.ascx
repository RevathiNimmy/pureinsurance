<%@ control language="VB" autoeventwireup="false" inherits="Nexus.Controls_ReportControls_TransactionRegister" Codefile="TransactionRegister.ascx.vb"%>
...
<div id="Controls_ReportControls_TransactionRegister">
    <div class="card">
        <div class="card-body clearfix">
            <div class="form-horizontal">
               ...
               <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                    <asp:Label ID="lblDetailSummary" runat="server" AssociatedControlID="RP__GROUPBY" Text="<%$ Resources:lbl_DetailSummary %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                    <div class="col-md-8 col-sm-9">
