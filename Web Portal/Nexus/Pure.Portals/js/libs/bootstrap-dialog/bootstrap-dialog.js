...
(function (root, factory) {
    ...
    var BootstrapDialogModal = function (element, options) {
        if (bootstrap && bootstrap.Modal && /^5\.1\./.test(bootstrap.Modal.VERSION)) {
            ...
            return new Modal(element, options);
        } else if (bootstrap && bootstrap.Modal && /^5\.3\.3/.test(bootstrap.Modal.VERSION)) {
            return new Modal(element, options);
    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v5.3'] = {
        hide: function (e) {
            if (e) {
                e.preventDefault();
            }
    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v5.3'] = $.extend({}, BootstrapDialogModal.METHODS_TO_OVERRIDE['v5.1']); //FIXME for BootstrapV5
    BootstrapDialogModal.prototype = {
        ...
        getGlobalOpenedDialogs: function () {
            ...
            //added as it was added in old library
            if ($("#infoSection").css("display") == "block") {
                openedDialogs.push($("#infoSection"));
            }
    ...
    BootstrapDialog.METHODS_TO_OVERRIDE['v4.0'] = { //FIXME for BootstrapV4
        //	BootstrapDialog.METHODS_TO_OVERRIDE['v5.3'] = { //FIXME for BootstrapV4
        getModalBackdrop: function ($modal) {
            return $($modal.data('show.bs.modal')._backdrop);
        },
        updateZIndex: BootstrapDialog.METHODS_TO_OVERRIDE['v3.1']['updateZIndex'],
        open: BootstrapDialog.METHODS_TO_OVERRIDE['v3.1']['open'],
    ...
    BootstrapDialog.METHODS_TO_OVERRIDE['v5.3'] = $.extend({}, BootstrapDialog.METHODS_TO_OVERRIDE['v5.1'], {
        createCloseButton: function () {
            var $container = $('<div></div>');
            $container.addClass(this.getNamespace('close-button'));
            var $icon = $('<button class="btn-close" aria-label="close"></button>');
