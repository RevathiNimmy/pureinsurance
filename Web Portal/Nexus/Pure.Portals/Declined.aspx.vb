...
Namespace Nexus
    ...
    ''' <summary>
    ''' Quote has been declined, show reasons here
    ''' </summary>
    Partial Class secure_Declined : Inherits Frontend.clsCMSPage
        ...
        Protected Shadows Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If CType(GetSection("NexusFrameWork"), Config.NexusFrameWork).Portals.Portal(Portal.GetPortalID()).DetailedDeclineReasons Then
                ...
                If Session.Item(CNQuote) IsNot Nothing Then
                    ...
                    oXMLSource.XPath = "//" & Session.Item(CNDataModelCode).ToString() & "_OUTPUT[@DECLINE_REASON]"
                    ...
                    grdvDeclinedReasons.DataSource = oXMLSource
                    grdvDeclinedReasons.DataBind()

                    ' If reasons are NOT specified in BO then show the generic message
                    If grdvDeclinedReasons.Rows.Count <= 0 Then
                        grdvDeclinedReasons.Visible = False
                        lblDeclinedMsg.Visible = True
                    End If
