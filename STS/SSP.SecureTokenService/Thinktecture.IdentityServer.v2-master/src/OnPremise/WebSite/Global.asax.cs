...
namespace Thinktecture.IdentityServer.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Application_Start()
        {
            ...
            //DataAnnotationsModelValidatorProvider.RegisterAdapter(typeof(PasswordValidAttribute), typeof(RegularExpressionAttributeAdapter));
        }

        private void SetupCompositionContainer()
        {
            //Container.Current = new CompositionContainer(new RepositoryExportProvider());
            //var container = new CompositionContainer(new RepositoryExportProvider());
            var container = new CompositionContainer(new RepositoryExportProvider(), new SiriusExportProvider());
            //var container = new CompositionContainer(new SiriusExportProvider());
