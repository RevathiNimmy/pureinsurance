...
namespace Thinktecture.IdentityServer.Repositories.Sql
{
    public class ConfigurationDatabaseInitializer : CreateDatabaseIfNotExists<IdentityServerConfigurationContext>
    {
        ...
        private static GlobalConfiguration CreateDefaultGlobalConfiguration()
        {
            ...
            {
                SiteName = "SSP Pure Authentication Service",
                IssuerUri = "http://ssp.PureSTS",
                IssuerContactEmail = "support@ssp-uk.com",
        ...
        private static List<RelyingParties> CreateTestRelyingParties()
        {
            return new List<RelyingParties>
            {
                ...
                new RelyingParties
                {
                    Name = "Pure Portal",
                    Enabled = true,
                    Realm = "http://localhost/Pure.Portal/Login.aspx",
                    ReplyTo = "http://localhost/Pure.Portal/Login.aspx",
                    TokenType= Thinktecture.IdentityServer.Models.TokenType.SAML11
                },
            };
        }
