...
{
    public class BaseGetBrokerSummaryRequestType : BaseRequestType
    {
        ...
        public FilterQuotesType FilterQuotes { get; set; }
        public FilterPoliciesType FilterPolicies { get; set; }
    }
}
