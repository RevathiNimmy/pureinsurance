...
{
    public class GetRiskQueryBaseResponse : BaseResponseType
    {
        ...
        public BasePagedResponse PolicyFees { get; set; }
        public BasePagedResponse PolicyTaxes { get; set; }
        public BasePagedResponse RiskFees { get; set; }
        public BasePagedResponse RiskTaxes { get; set; }
    }
}
