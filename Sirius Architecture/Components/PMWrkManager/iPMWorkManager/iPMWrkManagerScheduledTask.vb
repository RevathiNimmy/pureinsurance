...
Private Const ACClass As String = "ScheduledTask" 
	...
	Private m_sClientCode As String = "" 'mkw100204 PN9978
    Private m_iIsReadOnlyTask As Integer
	' Function Return Code
    Private lReturn As Integer
    ''PartyName, PartyCnt
    Private m_partyName As String
	...
	Public Property PMWrkTaskInstanceCnt() As Integer
		...
		End Set
	End Property
    Public Property IsReadOnlyTask() As Integer
        Get
            Return m_iIsReadOnlyTask
        End Get
        Set(ByVal Value As Integer)
            m_iIsReadOnlyTask = Value
        End Set
    End Property
