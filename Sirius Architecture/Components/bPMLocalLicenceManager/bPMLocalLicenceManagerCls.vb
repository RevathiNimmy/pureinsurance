...
Public NotInheritable Class LicenceManager
    ...
    Public Function LicenceManager_Initialise() As Integer Implements bPMLicenceManager.LicenceManager.Initialise
        ...
        Try
            ...
            result = m_oLicenceManager.Initialise()
            WarningMessage = m_oLicenceManager.WarningMessage
            ErrorMessage = m_oLicenceManager.ErrorMessage
            Return result
    ...
    ' Changes here must be reflected in RemoteLicenceManager.GetTemporaryLicenceDetails
