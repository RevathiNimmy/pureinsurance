...
Public NotInheritable Class Interface_Renamed
    ...
    ' Interface Form
    Private m_frmWorkflowPackages As frmWorkflowPackages
    ...
    Private Function LoadInterface() As Integer
        ...
        'Load(m_frmWorkflowPackages)

        ' Check if we have had an error so far.
        If m_frmWorkflowPackages.ErrorNumber = gPMConstants.PMEReturnCode.PMFalse Then
            ' We have already encountered an error,
            ' so we MUST return the error.
            result = m_frmWorkflowPackages.ErrorNumber
        End If
    ...
    Private Function ProcessInterface() As Integer
        ...
        m_frmWorkflowPackages = New frmWorkflowPackages()
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' Display the interface.
        VB6.ShowForm(m_frmWorkflowPackages, lDisplayState)

        If lDisplayState = FormShowConstants.Modal Then
            ' Check for any form errors.
            If m_frmWorkflowPackages.ErrorNumber <> 0 Then
                result = m_frmWorkflowPackages.ErrorNumber
            End If
        End If
    ...
    Private Function UnLoadInterface() As Integer
        ...
        ' from memory.
        m_frmWorkflowPackages.Close()
        m_frmWorkflowPackages = Nothing
