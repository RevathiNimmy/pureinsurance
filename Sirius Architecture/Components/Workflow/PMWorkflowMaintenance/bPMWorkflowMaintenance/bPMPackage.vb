...
Imports System
Imports SharedFiles
Friend NotInheritable Class PMPackage
    ...
    Private Const ACClass As String = "PMPackage"
    ...
    Private m_sPackageCode As String = ""
    Private m_sPackageDescription As String = ""
    ...
    Public Property PackageCode() As String
        Get
            ...
            Return m_sPackageCode

        End Get
        Set(ByVal Value As String)

            m_sPackageCode = Value
    ...
    Public Property PackageDescription() As String
        Get
            ...
            Return m_sPackageDescription

        End Get
        Set(ByVal Value As String)

            m_sPackageDescription = Value
    ...
    Private Shared _DefaultInstance As PMPackage = Nothing
    Public Shared ReadOnly Property DefaultInstance() As PMPackage
        Get
            If _DefaultInstance Is Nothing Then
                _DefaultInstance = New PMPackage
            End If
