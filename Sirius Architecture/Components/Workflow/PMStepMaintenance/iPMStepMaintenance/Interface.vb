...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function SetFieldValidation() As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to SetFieldValidation", vApp:=ACApp, vClass:=ACClass, vMethod:="SetFieldValidation", excep:=excep)
    ...
    Private Function LoadInterface() As Integer
        ...
        m_frmInterface.WorkflowId = m_lWorkflowId
