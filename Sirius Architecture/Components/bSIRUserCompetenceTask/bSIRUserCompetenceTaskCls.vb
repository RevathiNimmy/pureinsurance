...
Public NotInheritable Class Business
    ...
    'Party Services (Private)
    Private m_oParty As Object
    'InsuranceFileServices (Private)
    ...
    Private m_lTaskUserId As Integer
    Private m_lInsuranceFileCnt As Integer
    Private m_lUpdateStatus As Integer
    ...
    Public Function SetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            '            Case PMKeyNameUserID
            '                m_lTaskUserId = CLng(vKeyArray(PMKeyValue, lRow&))
    ...
    Public Function GetSummary(ByRef vSummaryArray(,) As Object) As Integer
        ...
        Try
            ...
            vSummaryArray(gPMConstants.PMENavSummaryArrayColPosition.PMNavSummValue, 0) = "X"
    ...
    ' Name: CreateTask
    '
    ' Description: Create Memo Task For Supervisor
    '
    ' ***************************************************************** '
    Public Function CreateTask() As Integer
        ...
        Try
            ...
            m_lReturn = m_oDatabase.Parameters.Add(sName:="user_id", vValue:=CStr(m_lTaskUserId), iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            ...
            m_lReturn = m_oDatabase.Parameters.Add(sName:="os_pmwrk_task_instance_cnt", vValue:=DBNull.Value, iDirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return result
            End If

            m_lReturn = m_oDatabase.SQLAction(sSQL:=ACCreateCheckTaskSQL, sSQLName:=ACCreateCheckTaskName, bStoredProcedure:=ACCreateCheckTaskStored)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed To Create Supervisor Task", vApp:=ACApp, vClass:=ACClass, vMethod:="CreateTask", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
