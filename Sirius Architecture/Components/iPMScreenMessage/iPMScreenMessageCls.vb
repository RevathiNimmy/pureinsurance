...
Public NotInheritable Class Interface_Renamed
    ...
    Public WriteOnly Property MessageDescription() As String
        Set(ByVal Value As String)
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case PMNavKeyConst.PMKeyNameMessageBoxCaption
                        ...
                        m_sMessageDecription = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)).Trim()

                    Case PMNavKeyConst.PMKeyNameMessageBoxText

                        m_sMessageText = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)).Trim()
                End Select
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            ' {* USER DEFINED CODE (Begin) *}
            .MessageDescription = m_sMessageDecription
            .MessageText = m_sMessageText
            ' {* USER DEFINED CODE (End) *}
        End With
