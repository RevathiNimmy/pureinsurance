...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function GetSysAdminStatus() As Integer
        ...
        m_lReturn = g_oObjectManager.GetInstance(temp_oBusiness, "bPMLock.Form", vInstanceManager:="ClientManager")
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ...
            gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get bPMLock.Form", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSysAdminStatus")
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Or lStatus = 0 Then
            ...
            MessageBox.Show("You do not have permission to access " & _
                            "Lock administration." & Strings.Chr(13) & Strings.Chr(10) & Strings.Chr(13) & Strings.Chr(10) & _
