...
Public NotInheritable Class Interface_Renamed
    ...
    Public Property PMWrkTaskInstanceCntArray() As Object
        Get
            Return m_vPMWrkTaskInstanceCntArray
        End Get
    ...
    '
    ' ***************************************************************** '
    Friend Function SetKeys(ByRef vKeyArray(,) As Object) As Integer
    ...
    Private Sub GetIDsFromCodes(ByVal v_sTaskGroupCode As String, ByVal v_sTaskCode As String, ByRef r_lTaskGroupID As Integer, ByRef r_lTaskID As Integer)
        ...
        If v_sTaskGroupCode.Trim() <> "" Then
            ...
            m_lReturn = oPMLookup.GetEffectiveIDFromCode(v_sTableName:="PMWrk_task_group", v_sCode:=v_sTaskGroupCode, v_dtEffectiveDate:="01/01/1999", r_lID:=r_lTaskGroupID)
    ...
    Private Function LoadInterface() As Integer
        ...
        With m_frmInterface
            ...
            'Modified by Sumeet Singh on 5/19/2010 1:11:03 PM refer developer guide no. 24
            '.set_TaskInstKeyArray(m_vTaskInstKeyArray)
            .TaskInstKeyArray = m_vTaskInstKeyArray

            .TaskDescription = m_sTaskDescription
            ' {* USER DEFINED CODE (End) *}
        End With
        ...
        End If
        'developer guide no.(Initialise shifted to frminterface_load)
