...
Imports SSP.Shared
<System.Runtime.InteropServices.ProgId("TaskControl_NET.TaskControl")>
Public NotInheritable Class TaskControl
    ...
    ' ***************************************************************** '
    'DAK141299
    Public Function CreateNew(ByVal v_lPMWrkTaskGroupID As Integer,
                              ByVal v_lPMWrkTaskID As Integer,
                              ...
                              Optional ByVal sLockKeyName As Long = LockName.InvalidValue,
        ...
        Try
            ...
            m_lReturn = m_oBusiness.CreateNew(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID,
                                              ...
                                              bViaBackgrounJobProcess:=bViaBackgrounJobProcess,
        ...
        Catch ex As System.Exception
            ...
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="CreateNewFailed", vApp:=ACApp, vClass:=ACClass, vMethod:="CreateNew", vErrNo:=Informations.Err().Number, vErrDesc:=ex.Message, excep:=ex)
            Return nResult
    ...
    Public Function GetTaskInstKeys(ByVal v_lPMWrkTaskInstanceCnt As Integer, ByRef r_vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.GetTaskInstKeys(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt, r_vKeyArray:=r_vKeyArray)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function AmendDetails(ByVal v_lPMWrkTaskInstanceCnt As Integer, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_sDescription As String, ByVal v_iIsUrgent As Integer) As Integer
        Return AmendDetails(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_sDescription:=v_sDescription, v_iIsUrgent:=v_iIsUrgent, v_sWorkflowInformation:="")
    End Function
    ...
    Public Function AmendDetails(ByVal v_lPMWrkTaskInstanceCnt As Integer, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_sDescription As String, ByVal v_iIsUrgent As Integer, ByVal v_sWorkflowInformation As String) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.AmendDetails(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_sDescription:=v_sDescription, v_iIsUrgent:=v_iIsUrgent, v_sWorkflowInformation:=v_sWorkflowInformation)
            ' AMB 21/01/2003
    ...
    Public Function Assign(ByVal v_lPMWrkTaskInstanceCnt As Integer, ByVal v_iUserID As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.Assign(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt, v_iUserID:=v_iUserID)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function SetStatusComplete(ByVal v_lPMWrkTaskInstanceCnt As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.SetStatusComplete(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function SetStatusInComplete(ByVal v_lPMWrkTaskInstanceCnt As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.SetStatusInComplete(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function SetStatusInProgress(ByVal v_lPMWrkTaskInstanceCnt As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.SetStatusInProgress(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function Delete(ByVal v_lPMWrkTaskInstanceCnt As Integer) As Integer
        ...
        Try
            ...
            m_lReturn = m_oBusiness.Delete(v_lPMWrkTaskInstanceCnt:=v_lPMWrkTaskInstanceCnt)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    ' AMB 20/01/2003 - workflow_information column added
    ' ***************************************************************** '
    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByVal v_vKeyArray As Object) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:="", v_iUserID:=0, v_vKeyArray:=v_vKeyArray, v_iIsVisible:=gPMConstants.PMEReturnCode.PMTrue)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByVal v_iUserID As Integer, ByVal v_vKeyArray As Object, ByVal v_iIsVisible As Integer) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:="", v_iUserID:=v_iUserID, v_vKeyArray:=v_vKeyArray, v_iIsVisible:=v_iIsVisible)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByVal v_vKeyArray As Object, ByVal v_iIsVisible As Integer) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:="", v_iUserID:=0, v_vKeyArray:=v_vKeyArray, v_iIsVisible:=v_iIsVisible)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:="", v_iUserID:=0, v_vKeyArray:=Nothing, v_iIsVisible:=gPMConstants.PMEReturnCode.PMTrue)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByRef v_sWorkflowInformation As String) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:=v_sWorkflowInformation, v_iUserID:=0, v_vKeyArray:=Nothing, v_iIsVisible:=gPMConstants.PMEReturnCode.PMTrue)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByRef v_sWorkflowInformation As String, ByVal v_iUserID As Integer) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:=v_sWorkflowInformation, v_iUserID:=v_iUserID, v_vKeyArray:=Nothing, v_iIsVisible:=gPMConstants.PMEReturnCode.PMTrue)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByRef v_sWorkflowInformation As String, ByVal v_iUserID As Integer, ByVal v_vKeyArray As Object) As Integer
        Return CreateNewByCode(v_lPMWrkTaskGroupID:=v_lPMWrkTaskGroupID, v_sPMWrkTaskCode:=v_sPMWrkTaskCode, v_sCustomer:=v_sCustomer, v_dtTaskDueDate:=v_dtTaskDueDate, v_lPMUserGroupID:=v_lPMUserGroupID, v_sDescription:=v_sDescription, v_iTaskStatus:=v_iTaskStatus, v_iIsUrgent:=v_iIsUrgent, r_lPMWrkTaskInstanceCnt:=r_lPMWrkTaskInstanceCnt, v_sWorkflowInformation:=v_sWorkflowInformation, v_iUserID:=v_iUserID, v_vKeyArray:=v_vKeyArray, v_iIsVisible:=gPMConstants.PMEReturnCode.PMTrue)
    End Function

    Public Function CreateNewByCode(ByVal v_lPMWrkTaskGroupID As Integer, ByVal v_sPMWrkTaskCode As String, ByVal v_sCustomer As String, ByVal v_dtTaskDueDate As Date, ByVal v_lPMUserGroupID As Integer, ByVal v_sDescription As String, ByVal v_iTaskStatus As Integer, ByVal v_iIsUrgent As Integer, ByRef r_lPMWrkTaskInstanceCnt As Integer, ByRef v_sWorkflowInformation As String, ByVal v_iUserID As Integer, ByVal v_vKeyArray As Object, ByVal v_iIsVisible As Integer) As Integer
        ' AMB 20/01/2003
        ...
        Try
            ...
            m_lReturn = GetPMWrkTaskID(v_sPMWrkTaskCode:=v_sPMWrkTaskCode, r_lPMWrkTaskID:=lPMWrkTaskID)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return m_lReturn
            End If
    ...
    Public Function UpdateTaskStatus(ByVal nPMWrkTaskInstanceCnt As Integer,
        ...
        Try
            ...
            m_lReturn = m_oBusiness.UpdateTaskStatus(nPMWrkTaskInstanceCnt:=nPMWrkTaskInstanceCnt,
                                                     nTaskStatus:=nTaskStatus,
                                                     sGuidPMExternalItem:=sGuidPMExternalItem,
                                                     bViaBackgrounJobProcess:=bViaBackgrounJobProcess,
                                                     nExternalTaskStatus:=nExternalTaskStatus, sErrMessageUpdateTask:=sErrorMessage)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
