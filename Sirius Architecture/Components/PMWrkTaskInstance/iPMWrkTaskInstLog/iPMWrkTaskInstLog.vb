...
Module MainModule
    ...
    Public Const ACApp As String = "iPMWrkTaskInstLog"
    ...
    Public Const USRAddTask As Integer = 0
    Public Const USRViewTask As Integer = 1

    'Positional Array Constants
    Public Const ACTaskInstanceCnt As Integer = 0
    Public Const ACDateCreated As Integer = 1
    Public Const ACText As Integer = 2
    Public Const ACCreatedById As Integer = 3
    Public Const ACCreatedByName As Integer = 4
    ...
    'developer guide no. 107
    <ThreadStatic()> _
    Public g_oBusiness As bPMWrkTaskInstLog.FormClass
