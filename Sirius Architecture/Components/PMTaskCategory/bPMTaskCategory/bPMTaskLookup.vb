...
Public NotInheritable Class Lookup
    ...
    '
    ' Description: This class is used by the PMTaskLookup control.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    '
    ' ***************************************************************** '
    Public Function GetInstanceCategory(ByVal v_lPMTaskInstanceCnt As Integer, ByRef r_lPMTaskCategoryID As Integer) As Integer
        ...
        Try
            ...
            With m_oDatabase
                ...
                m_lReturn = .SQLSelect(sSql:=ACTaskCategoryLookupSQL, ssqlname:=ACTaskCategoryLookupName, bstoredprocedure:=ACTaskCategoryLookupStored, lNumberRecords:=0)
            ...
            r_lPMTaskCategoryID = oFields("pmwrk_task_category_id")
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetInstanceCategory Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetInstanceCategory", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
