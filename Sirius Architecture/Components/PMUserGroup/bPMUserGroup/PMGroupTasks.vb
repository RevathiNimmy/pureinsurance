...
Friend NotInheritable Class PMGroupTasks
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: PMGroupTasks
    '
    ' Date: 24th October 1996
    '
    ' Description: Maintains the PMGroupTasks Collection.
    '
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "PMGroupTasks"
    ...
    Private m_PMGroupTasks As Collection(Of Object)
    ...
    '
    ' ***************************************************************** '
    Public Function Add(ByRef oNewPMGroupTask As bPMUserGroup.PMGroupTask) As Integer
        ...
        Try
            ...
            m_PMGroupTasks.Add(oNewPMGroupTask)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage("", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to Add PMGroupTask to Collection", vApp:=ACApp, vClass:=ACClass, vMethod:="Add", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    ' Name: Count
    '
    ' Description: Returns the number of PMGroupTasks in the collection.
    '
    '
    ' ***************************************************************** '
    ...
    ' Name: Delete
    '
    ' Description: Delete a PMGroupTask from the Collection.
    '
    '
    ' ***************************************************************** '
    ...
    ' Name: Item
    '
    ' Description: Returns the selected PMGroupTask from the Collection.
    '
    '
    ' ***************************************************************** '
    Public Function Item(ByRef vKey As gPMConstants.PMEReturnCode) As bPMUserGroup.PMGroupTask

        Dim result As bPMUserGroup.PMGroupTask = Nothing
        Try


            Return m_PMGroupTasks(vKey)
    ...
    ' Name: DeleteAll
    '
    ' Description: Delete all PMGroupTasks from the Collection
    '
    '
    ' ***************************************************************** '
    ...
    Public Sub Clear()
        ...
        Try
            ...
            m_PMGroupTasks = Nothing
            m_PMGroupTasks = New Collection(Of Object)
    ...
    Public Sub New()
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage("", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to initialise the PMGroupTasks class", vApp:=ACApp, vClass:=ACClass, vMethod:="Class_Initialise", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
