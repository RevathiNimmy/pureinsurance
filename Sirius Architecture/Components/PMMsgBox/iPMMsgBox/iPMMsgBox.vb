...
Public NotInheritable Class Interface_Renamed
    ...
    ' Date: 03/12/1997
    '
    ' Description: Main public class
    '
    ' Edit History: TF031297 - Created
    ' ***************************************************************** '
    ...
    Private m_sMsgBoxCaption As String = ""
    Private m_sMsgBoxText As String = ""
    ...
    Public WriteOnly Property MsgBoxCaption() As String
        Set(ByVal Value As String)

            ' Set the objects parameter value.
            m_sMsgBoxCaption = Value

        End Set
    End Property

    Public WriteOnly Property MsgBoxText() As String
        Set(ByVal Value As String)
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    Case gPMConstants.PMKeyNameMsgBoxCaption

                        m_sMsgBoxCaption = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)).Trim()

                    Case gPMConstants.PMKeyNameMsgBoxText

                        m_sMsgBoxText = CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, lRow)).Trim()
                End Select
    ...
    Private Function ProcessInterface() As Integer
        ...
        MessageBox.Show(m_sMsgBoxText, m_sMsgBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Information)
