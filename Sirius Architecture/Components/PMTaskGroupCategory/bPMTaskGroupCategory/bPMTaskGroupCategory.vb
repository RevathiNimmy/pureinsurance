...
Friend NotInheritable Class Category
    ...
    ' ***************************************************************** '
    ' Class Name: PMTaskGroupCategory
    '
    ' Date: 8th October 1999
    '
    ' Description: Describes the PMTaskGroupCategory attributes.
    '
    ' Edit History:
    ' ***************************************************************** '
    ...
    Private Const ACClass As String = "PMTaskGroupCategory"
    ...
    ' DataBase Attributes
    Private m_lTaskGroupCategoryID As Integer
    ...
    Public Property TaskGroupCategoryID() As Integer
        Get

            Return m_lTaskGroupCategoryID

        End Get
        Set(ByVal Value As Integer)

            m_lTaskGroupCategoryID = Value
    ...
    Private Shared _DefaultInstance As Category = Nothing
    Public Shared ReadOnly Property DefaultInstance() As Category
        Get
            If _DefaultInstance Is Nothing Then
                _DefaultInstance = New Category
            End If
