...
Friend Partial Class frmInterface
	...
	Private Function DisplayInterfaceDetails() As Integer
		...
		Catch excep As System.Exception
			...
			' Log Error.
			iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to display the interface details", vApp:=ACApp, vClass:=ACClass, vMethod:="DisplayInterfaceDetails", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
