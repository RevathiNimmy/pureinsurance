...
Public NotInheritable Class Interface_Renamed
    ...
    Public Property INIFile() As String
        Get
            Return m_sINIFile.Trim()
        End Get
        Set(ByVal Value As String)
            m_sINIFile = Value.Trim()
        End Set
    End Property
    ' {* USER DEFINED CODE (End) *}
    ...
    Private Function ShowInterface(ByRef lDisplayState As Integer) As Integer
        ...
        ' If we have been supplied an INI File then Automatically Add it.
        If INIFile <> "" Then
            Return frmInterface.AutoAdd(INIFile)
        End If
    ...
    Private Function GetSysAdminStatus() As Integer
        ...
        Dim oBusiness As bPMProductClientInstall.FormAdmin
        ...
        m_lReturn = g_oObjectManager.GetInstance(temp_oBusiness, "bPMProductClientInstall.FormAdmin", vInstanceManager:="ClientManager")
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ...
            gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get bPMProductClientInstall.FormAdmin", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSysAdminStatus")
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Or lStatus = 0 Then
            ...
            MessageBox.Show("You do not have permission to access " & _
                            "Client Install Administration." & Strings.Chr(13) & Strings.Chr(10) & Strings.Chr(13) & Strings.Chr(10) & _
