...
Public NotInheritable Class Interface_Renamed
    ...
    Private Function ProcessInterface() As Integer
        ...
        m_lReturn = CType(ShowInterface(lDisplayState:=FormShowConstants.Modeless), gPMConstants.PMEReturnCode)
    ...
    Private Function LoadInterface() As Integer
        ...
        'Initialise the Form (not Form.InitialiZe)
        'developer guide no. 50
        m_lReturn = CType(CType(objfrmInterface, SSP.S4I.Interfaces.ILocalInterface).Initialise(), gPMConstants.PMEReturnCode)
