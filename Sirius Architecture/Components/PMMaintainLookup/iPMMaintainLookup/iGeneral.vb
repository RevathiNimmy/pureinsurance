...
Friend NotInheritable Class General
    ...
    Public Function GetInterfaceDetails() As Integer
        ...
        Try
            ...
            m_lReturn = m_frmInterface.ConnectDatabase()
            ...
            m_lReturn = m_frmInterface.GetColumns()
            ' Check for errors.
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                ' Failed to get the details.
                Return gPMConstants.PMEReturnCode.PMFalse
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            If m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel Then
                ...
                If m_frmInterface.cmdApply.Enabled Then
            ...
            If ((m_frmInterface.Status = gPMConstants.PMEReturnCode.PMCancel) Or (m_frmInterface.Status = gPMConstants.PMEReturnCode.PMOK)) And result = gPMConstants.PMEReturnCode.PMTrue Then


                result = m_frmInterface.CheckLinkedDataMandatory()
