...
<System.Runtime.InteropServices.ProgId("PMConstants_NET.PMConstants")>
Public Module PMConstants

    ' ***************************************************************** '
    ' Module Name: PMConstants
    '
    ...
    Public Enum SIRHiddenOptions
        ...
        'Set this to the last entry and you won't have to remember to change the array size
        SIROPTMasterOptionsLastEntry = SIRHiddenOptions.SIROPTEnableCloudHosting
    End Enum
    ...
    ' RDC 19072002 - for Windows Terminal Services functions in PMFunctions
    ...
    Public Const ACApp As String = "dPMDAO"
    'DAK250100
