...
Public Module GIIFunctions
    ...
    'Added by Deepak Sharma on 4/21/2010 10:10:15 AM refer developer guide no. 
            ...
            Select Case lControlType
                Case CtlType.ctllabel
                    ...
                    If r_sMandatoryForeColour = "" Then
                        ...
                        'Modified by Deepak Sharma on 4/20/2010 1:35:43 PM refer developer guide no. 124 (guide)
                        'r_sMandatoryForeColour = CStr(Color.White)
                        r_sMandatoryForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    If r_sOptionalForeColour = "" Then
                        ...
                        r_sOptionalForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    If r_sDisabledForeColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:41:32 PM refer developer guide no. 124(Guide)
                        'r_sDisabledForeColour = CStr(Color.White)
                        r_sDisabledForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    If r_sDisabledForeColour2 = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:41:48 PM refer developer guide no. 124(Guide)
                        'r_sDisabledForeColour2 = CStr(Color.White)
                        r_sDisabledForeColour2 = CStr(Color.White.Name)
                    End If
                ...
                Case CtlType.ctlYesNoCheck
                    ...
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:42:05 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightBlue)
                        r_sFirstBackColour = CStr(Color.LightBlue.Name)
                    End If
                    ...
                    If r_sSecondBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:42:23 PM refer developer guide no. 124(Guide)
                        'r_sSecondBackColour = CStr(Color.LightCyan)
                        r_sSecondBackColour = CStr(Color.LightCyan.Name)
                    End If
                ...
                Case CtlType.ctlCommand
                    ...
                    'Set default if there's nothing set in registry
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:42:36 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightCyan)
                        r_sFirstBackColour = CStr(Color.LightCyan.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sSecondBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:42:52 PM refer developer guide no. 124(Guide)
                        'r_sSecondBackColour = CStr(Color.LightBlue)
                        r_sSecondBackColour = CStr(Color.LightBlue.Name)
                    End If
                    ...
                    If r_sThirdBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:43:09 PM refer developer guide no. 124(Guide)
                        'r_sThirdBackColour = CStr(Color.LightCyan)
                        r_sThirdBackColour = CStr(Color.LightCyan.Name)
                    End If
                ...
                Case CtlType.ctlPictureBox
                    ...
                    'Set default if there's nothing set in registry
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:43:30 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightCyan)
                        r_sFirstBackColour = CStr(Color.LightCyan.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sSecondBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:43:45 PM refer developer guide no. 124(Guide)
                        'r_sSecondBackColour = CStr(Color.LightBlue)
                        r_sSecondBackColour = CStr(Color.LightBlue.Name)
                    End If
                    ...
                    If r_sFourthBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:44:00 PM refer developer guide no. 124(Guide)
                        'r_sFourthBackColour = CStr(Color.LightCyan)
                        r_sFourthBackColour = CStr(Color.LightCyan.Name)
                    End If
                ...
                Case CtlType.ctlSSPanel, CtlType.ctlFrame
                    ...
                    'Set default if there's nothing set in registry
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:44:13 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightBlue)
                        r_sFirstBackColour = CStr(Color.LightBlue.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sSecondBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:44:54 PM refer developer guide no. 124 (guide)
                        'r_sSecondBackColour = CStr(Color.LightBlue)
                        r_sSecondBackColour = CStr(Color.LightBlue.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sThirdBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:34:21 PM refer developer guide no. 60 (guide)
                        'r_sThirdBackColour = ColorTranslator.ToOle(SystemColors.Window).ToString()
                        r_sThirdBackColour = System.Drawing.SystemColors.Window.ToString()
                    End If
                ...
                Case CtlType.ctlCheckbox
                    ...
                    'Set default if there's nothing set in registry
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:45:18 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightCyan)
                        r_sFirstBackColour = CStr(Color.LightCyan.Name)
                    End If
                ...
                Case CtlType.ctlOptionButton
                    ...
                    If r_sMandatoryForeColour = "" Then
                        ...
                        'Modified by Deepak Sharma on 4/20/2010 1:44:31 PM refer developer guide no. 124(Guide)
                        'r_sMandatoryForeColour = CStr(Color.White)
                        r_sMandatoryForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    If r_sOptionalForeColour = "" Then
                        ...
                        'Modified by Deepak Sharma on 4/20/2010 1:41:00 PM refer developer guide no. 124 (Guide)
                        'r_sOptionalForeColour = CStr(Color.White)
                        r_sOptionalForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    If r_sDisabledForeColour = "" Then
                        ...
                        'Modified by Deepak Sharma on 4/20/2010 1:40:40 PM refer developer guide no. 124(Guide)
                        'r_sDisabledForeColour = CStr(Color.White)
                        r_sDisabledForeColour = CStr(Color.White.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sFirstBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:40:17 PM refer developer guide no. 124(Guide)
                        'r_sFirstBackColour = CStr(Color.LightCyan)
                        r_sFirstBackColour = CStr(Color.LightCyan.Name)
                    End If
                    ...
                    'Set default if there's nothing set in registry
                    If r_sSecondBackColour = "" Then
                        'Modified by Deepak Sharma on 4/20/2010 1:39:39 PM refer developer guide no. 124(Guide)
                        'r_sSecondBackColour = CStr(Color.LightBlue)
                        r_sSecondBackColour = CStr(Color.LightBlue.Name)
                    End If
    ...
    Public Function ValidateDateField(ByRef TxtDate As Control, Optional ByVal v_vFromDate As Object = Nothing, Optional ByVal v_vToDate As Object = Nothing, Optional ByVal v_vItemname As String = "") As Integer
        ...
        Try
            ...
            'Modified by Archana Tokas on 4/30/2010 4:17:26 PM to be checked at run time
            'If CInt(CStr(TxtDate.Text = "").Trim()) Or TxtDate.Text = GEMShortDate Then
            If CInt(CStr(TxtDate.Text = "").Trim()) Or TxtDate.Text = GIIConstants.GEMShortDate Then
                TxtDate.Text = ""
                'sj 31/05/2000 - start
            ...
            With TxtDate
                ...
                If .Text = GIIConstants.GEMShortDate Then
                    .Text = ""
                ...
                If Information.IsDate(.Text) Then
                    ...
                    .Text = StringsHelper.Format(.Text, GIIConstants.GEMLongDate)
            ...
            If Not Information.IsNothing(v_vFromDate) Then
                If Information.IsDate(v_vFromDate) Then
                    ...
                    If dtThisDate < dtFromDate Then
                        ...
                        MessageBox.Show(sItemName & " must not be before " & dtFromDate, sItemName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        TxtDate.Text = ""
                        TxtDate.Focus()
                        Return result
                    End If
            ...
            If Not Information.IsNothing(v_vToDate) Then
                If Information.IsDate(v_vToDate) Then
                    ...
                    If dtThisDate > dtToDate Then
                        ...
                        MessageBox.Show(sItemName & " must not be after " & dtToDate, sItemName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        TxtDate.Text = ""
                        TxtDate.Focus()
                        Return result
                    End If
    ...
    Public Function ValidateCardDateField(ByVal TxtDate As Control, Optional ByVal v_vItemname As String = "") As Integer
        ...
        Try
            ...
            If Not bValidDate Then
                ...
                'TxtDate.mask=""
                ReflectionHelper.SetMember(TxtDate, "Mask", "")
                TxtDate.Text = "MM/YY"
                TxtDate.Focus()
                Return result
    ...
    '
    ' ***************************************************************** '
    Public Function ValidateListField(ByRef ddList As Object) As Integer
    ...
    Public Function ValidatePostcodeFormat(ByVal ctlPostcodeControl As Control, Optional ByRef r_sPolarisPCode As String = "") As Integer
        ...
        Catch ex As Exception
            ...
            ' Log Error Message
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="ValidatePostcodeFormat Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="ValidatePostcodeFormat", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description, excep:=ex)
    ...
    ' Edit History     :
    '*************************************************************************************************
    'Modified by Archana Tokas on 5/3/2010 5:36:57 PM refer vb6 code
    ...
    Public Function HighlightContol(ByRef ctl As System.Windows.Forms.Control, Optional ByRef optBoolDateField As Boolean = False, Optional ByRef optBoolDropDown As Boolean = False) As Integer
        ...
        Try
            ...
            With ctl
                ...
                If Not False Then
                    If optBoolDateField Then
                        ...
                        If Information.IsDate(.Text) Then
                            'Modified by Archana Tokas on 4/30/2010 4:17:26 PM to be checked at run time
                            '.Text = StringsHelper.Format(CDate(.Text), GEMShortDate)
                ...
                'Modified by Archana Tokas on 5/3/2010 5:42:10 PM changes to be checked at run time
                '.SelStart = 0
            ...
            If Not False Then
                If optBoolDropDown Then
                    'Modified by Archana Tokas on 5/3/2010 5:42:10 PM changes to be checked at run time
                    'SendMessage(ctl.hwnd, CB_SHOWDROPDOWN, True, 0)
                End If
            End If
        ...
        Try
            ...
            Select Case lControlType
                ...
                Case CtlType.ctlCheckbox
                    ...
                    'If ctl.Value = CheckState.Unchecked Then
                    If DirectCast(ctl, CheckBox).CheckState = CheckState.Unchecked Then
                ...
                Case CtlType.ctlYesNoCheck
                    ...
                    If ReflectionHelper.GetMember(ctl, "Value") = 0 Then
                ...
                Case CtlType.ctlMSflexGrid
                    ...
                    'Replaced with Migrated code 114
                    'If ctl.Rows < 2 Then
                    If ReflectionHelper.GetMember(ctl, "Rows") < 2 Then
    ...
    Public Function PromptForInput(ByVal v_ctlDataControl As Control, ByRef r_sPromptText As String, ByRef r_bMandatoryPrompted As Boolean, ByVal v_bDisplayInputMessage As Boolean) As Integer
        ...
        Dim ctlLabelControl As Control = Nothing
    ...
    Public Function GetHelpfile(ByVal v_sSettingName As String) As Integer
        ...
        Try
            ...
            If sHelpFile <> "" Then
                'Modified by Deepak Sharma on 4/20/2010 5:49:34 PM refer developer guide no. 20 (Guide)
        ...
        Try
            ...
            Select Case r_lPolicyStatus
                ...
                Case GIIPolicyMTATemporary
                    ...
                    'sj 20/12/2001 - start
                    'Modified by Archana Tokas on 4/30/2010 4:15:52 PM changes as per requirement
                    'Case GEMPolicyCancelled
                Case GIIConstants.GEMPolicyCancelled
                    r_sStatusDescription = "Cancelled"
                    'Case GEMPolicyCancelPending
                Case GIIConstants.GEMPolicyCancelPending
    ...
    Public Function EnableFormCloseButton(ByVal sFormWindowName As String) As Integer
        Dim result As Integer = 0
        Dim hwndHandle, hMenuHandle As Integer
        ...
        Try
            ...
            If hwndHandle <> 0 Then
                ...
                hMenuHandle = GIIConstants.GetSystemMenu(hwndHandle, True)
            Else
                MessageBox.Show(sFormWindowName & " window not found", Application.ProductName)
            End If
    ...
    Public Sub CreateNewTask(ByVal sBusinessType As String, ByVal sClientcode As String)
        Dim lReturn As Integer
        Dim oCreateTask As Object

        Try
            oCreateTask = New Object
