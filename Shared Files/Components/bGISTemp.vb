...
<System.Runtime.InteropServices.ProgId("bGISTemp_NET.bGISTemp")> _
 Public Module bGISTemp
	...
	'
	' ***************************************************************** '
    Public Function UpdatePolicyLinkTransact(ByVal v_lPolicyLinkID As Integer, ByVal v_dTransactDate As Date, ByVal v_sTransactType As String, ByRef r_oDatabase As Object, Optional ByRef r_bTransStepRequired As Boolean = False, Optional ByVal v_lGISSchemeID As Integer = -1) As Integer
