...
Imports System
<System.Runtime.InteropServices.ProgId("bUnderwritingBranchFunc_NET.bUnderwritingBranchFunc")> _
 Public Module bUnderwritingBranchFunc
    ...
    Public Function GetSchemeDetailsFromExternalSchemeNo(ByVal v_sExternalSchemeNo As String, ByVal v_oDatabase As Object, ByVal v_sUsername As String, Optional ByRef r_lGisSchemeId As Integer = 0, Optional ByRef r_lGisInsurerId As Integer = 0, Optional ByRef r_sAbi81Insurer As String = "", Optional ByRef r_lRiskCodeId As Integer = 0, Optional ByRef r_lRiskGroupId As Integer = 0) As Integer 
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:=v_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSchemeDetailsFromExternalSchemeNo Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSchemeDetailsFromExternalSchemeNo", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    ' ***************************************************************** '
    Public Function GetPartyCntFromBrokerAbiId(ByVal v_sBrokerAbiId As String, ByVal v_oDatabase As Object, ByVal v_sUsername As String, Optional ByRef r_lPartyCnt As Integer = 0, Optional ByRef r_sTradingName As String = "") As Integer 
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:=v_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetPartyCntFromBrokerAbiId Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetPartyCntFromBrokerAbiId", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Public Function GetUnderwritingBranchDetails(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_oDatabase As Object, ByVal v_sCallingAppName As String, ByRef r_bUnderwritingBranchEnabled As Boolean, ByRef r_bIsUnderwritingBranch As Boolean) As Integer
        ...
        Catch excep As System.Exception
            ...
            bPMFunc.LogMessage(sUsername:=v_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetUnderwritingBranchDetails Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetUnderwritingBranchDetails", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    ' ***************************************************************** '
    Private Function GetUnderwritingBranchInd(ByVal v_oDatabase As Object, ByVal v_iSourceID As Integer, ByVal v_sUsername As String, ByRef r_bIsUnderwritingBranch As Boolean) As Integer 
        ...
        Dim result As Integer = 0 
            ...
            If Information.IsArray(vResultArray) Then
                ...
                If Conversion.Val(CStr(vResultArray(0, 0))) = 1 Then
