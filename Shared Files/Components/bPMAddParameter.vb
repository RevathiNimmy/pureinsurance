...
<System.Runtime.InteropServices.ProgId("bPMAddParameter_NET.bPMAddParameter")> _
 Public Module bPMAddParameter
    ...
    Public Sub AddParameter(ByVal v_oDatabase As Object, ByRef r_sSQL As String, ByRef r_lResultCode As gPMConstants.PMEReturnCode, ByVal v_sName As String, ByVal v_vValue As Object, ByVal v_iDirection As gPMConstants.PMEParameterDirection, ByVal v_iType As gPMConstants.PMEDataType, Optional ByVal v_iWhereMode As Integer = 0, Optional ByVal v_bIgnoreIfBlank As Boolean = False)
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="AddParameter Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="AddParameter", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '
    ' ***************************************************************** '
    Public Sub AddParameterLite(ByVal v_oDatabase As Object, ByVal v_sName As String, ByVal v_vValue As Object, ByVal v_iDirection As gPMConstants.PMEParameterDirection, ByVal v_iDataType As gPMConstants.PMEDataType, Optional ByVal v_bClearParameters As Boolean = False)
        ...
        If lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ' Raise
            Throw New System.Exception(Constants.vbObjectError.ToString() + ", AddDBParameter, " + "Error " & gPMFunctions.NullToString(lReturn) & " adding parameter '" & v_sName & "' with value '" & gPMFunctions.NullToString(v_vValue) & "'")
        End If
