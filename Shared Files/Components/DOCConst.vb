...
Public Module DOCConst
	...
	Public Const DOCXML As String = "XML Document" 'Xml Files
	Public Const DOCBMP As String = "BITMAP Image" 'BMP
	...
	Public Const kDocFileTypeXML As String = "S" 'XML Files
	Public Const kDocFileTypeBMP As String = "B" 'BMP
    ...
    Public Const DOCZipPMDirKey As String = "DocZipPMDir"
