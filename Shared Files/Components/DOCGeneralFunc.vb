...
Public Module DOCGeneralFunc
        ...
        Try
            ...
            If FileSystem.Dir(sTarget, FileAttribute.Normal) = "" Then
                ...
                Else
                    ...
                    If cloudHostingEnabled Then
                        bZipSuccess = oZipper.UnZipFile(sTarget, sDocFinalPath)
                    Else
                        bZipSuccess = oZipper.UnZipFile(sFilename, sDocFinalPath)
                    End If
    ...
    Public Function IsSiriusInstalled(ByRef r_bSiriusInstalled As Boolean) As Integer
        ...
        Try
            ...
            oObjectManager = CreateLateBoundObject("bObjectManager.ObjectManager")
    ...
    Public Function SetCacheStatus(ByRef bCacheDisabled As Boolean) As Integer
        ...
        Try
            ...
            ' get object manager
            oObj = CreateLateBoundObject("bObjectManager.ObjectManager")
