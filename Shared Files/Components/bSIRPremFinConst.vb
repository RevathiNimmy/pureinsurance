...
Public Module bSIRPremFinConst
    ...
    Public Const k_PFPlanDepositOnOtherMediaType As Integer = 190
    Public Const k_PFPlanCancelCode As Integer = 191
    Public Const k_PFPlanCancelDescription As Integer = 192
    Public Const k_PFPlanIsCancelPolicyRun As Integer = 193
    Public Const k_PFPlanSettleAmount As Integer = 194
    Public Const k_PFPlanDepositCCTrackingNumber As Integer = 195
    Public Const k_PFPlanUpdateInstalmentStatus As Integer = 196
    Public Const k_PFPlanReceiptDifferenceOption As Integer = 197

    Public Const k_PFPlanCountOfFields As Integer = k_PFPlanReceiptDifferenceOption
