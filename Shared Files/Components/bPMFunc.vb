...
Public Module bPMFunc
    ...
    Public Function Decrypt(ByVal v_sPassword As String, ByRef r_sDecryptedPassword As String) As Integer
        ...
        Try
            ...
            iSn = ((Strings.Asc(sAString.Substring(sAString.Length - 1)(0)) + Strings.Asc(sAString.Substring(0, 1)(0))) Mod iClen) + 1
    ...
    Public Function ValidateSQL(ByRef sSQLStatement As String) As Integer
        ...
        Try
            ...
            For i As Integer = 1 To sSQLStatement.Length
                ...
                If Strings.Asc(sSQLStatement.Substring(i - 1, 1)(0)) < Strings.Asc(" "c) Then

                    result = gPMConstants.PMEReturnCode.PMFalse

                    'message invalid SQL
                    LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogError, sMsg:="Invalid SQL - " & sSQLStatement, vApp:=ACApp, vClass:=ACClass, vMethod:="ValidateSQL", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    Public Function ConvertBaseNToDec(ByVal dValue As String, Optional ByVal byBase As Byte = 16) As String
        ...
        Try
            ...
            Do
                lReturn = ((BASENUMBERS.IndexOf(Mid(dValue, dValue.Length - n, 1))) * (byBase ^ n)) + lReturn
                n += 1
    ...
    Public Function retrieveProductOptions(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sCallingAppName As String, ByRef r_vProductOptions(,) As Object) As Integer
        ...
        Try
            ...
            lErrorValue = oProductOption.Initialise(sUsername:=v_sUsername, sPassword:=v_sPassword, iUserID:=v_iUserID, iSourceID:=v_iSourceID, iLanguageID:=v_iLanguageID, iCurrencyID:=v_iCurrencyID, iLogLevel:=v_iLogLevel, sCallingAppName:=v_sCallingAppName)
    ...
    Public Function RetrieveSingleSystemOption(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iMainSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sCallingAppName As String, ByRef v_iOptionNumber As Integer, ByRef r_sOptionValue As String, Optional ByRef v_iSourceID As Integer = 0) As Integer
        ...
        Try
            ...
            'lResult = CType(oSystemOptions, SSP.S4I.Interfaces.IBusiness).Initialise(sUsername:=v_sUsername, sPassword:=v_sPassword, iUserID:=v_iUserID, iSourceID:=v_iMainSourceID, iLanguageID:=v_iLanguageID, iCurrencyID:=v_iCurrencyID, iLogLevel:=v_iLogLevel, sCallingAppName:=ACApp)
            lResult = oSystemOptions.Initialise(sUsername:=v_sUsername, sPassword:=v_sPassword, iUserID:=v_iUserID, iSourceID:=v_iMainSourceID, iLanguageID:=v_iLanguageID, iCurrencyID:=v_iCurrencyID, iLogLevel:=v_iLogLevel, sCallingAppName:=v_sCallingAppName)
    ...
    Public Function getProductOptionValue(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iMainSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sCallingAppName As String, ByVal v_vOptionNumber As gPMConstants.SIRHiddenOptions, ByVal v_vBranch As Integer, ByRef r_vUnderwriting As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getProductOptionValue Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getProductOptionValue", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function getUnderwritingOrAgency(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iMainSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sCallingAppName As String, ByRef r_vUnderwriting As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getUnderwritingOrAgency Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getUnderwritingOrAgency", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function getUnderwritingType(ByVal v_sUsername As String, ByVal v_sPassword As String, ByVal v_iUserID As Integer, ByVal v_iMainSourceID As Integer, ByVal v_iLanguageID As Integer, ByVal v_iCurrencyID As Integer, ByVal v_iLogLevel As Integer, ByVal v_sCallingAppName As String, ByRef r_vUnderwriting As String) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="getUnderwritingType Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="getUnderwritingType", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Private Function findValueInArray(ByVal v_vOptionNumber As gPMConstants.SIRHiddenOptions, ByVal v_vBranch As Integer, ByRef r_vUnderwriting As String, ByVal v_bValue As Boolean) As Integer
        ...
        If Not IsNothing(vProductOptions) Then
    ...
    ' ***************************************************************** '
    'PN30098 - Datasure
    Public Function GetBranchBaseCurrency(ByVal v_lSourceID As Integer, ByVal v_oDatabase As Object, ByRef r_iCurrencyID As Integer, Optional ByRef r_sCurSymbol As String = "") As Integer
        ...
        Try
            ...
            With v_oDatabase
                ...
                m_lReturn = .SQLSelect(sSQL:=sSQL, sSQLName:="GetBranchBaseCurrency", bStoredProcedure:=False)
                ...
                r_iCurrencyID = .Records.Fields("base_currency_id")
                'PN30098 - Datasure
                If True Then
        ...
        Catch excep As System.Exception
            ...
            'Log Error Message
            LogMessage("", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetBranchBaseCurrency failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetBranchBaseCurrency", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    ' ***************************************************************** '
    Public Function GetBranchCurrencies(ByVal v_iSourceID As Integer, ByVal v_oDatabase As Object, ByRef r_vReturnArray(,) As Object, Optional ByVal v_bRestrictDeletedCurrency As Boolean = False) As Integer
        ...
        Try
            ...
            With v_oDatabase
                ...
                m_lReturn = .SQLSelect(sSQL:=sSQL, sSQLName:="RetrieveCurrenciesForBranch", bStoredProcedure:=False, vResultArray:=r_vReturnArray)
    ...
    Public Function GetCurrencyAuthorities(ByVal v_iUserID As Integer, ByVal v_oDatabase As Object, ByRef r_bChangeDate As Boolean, ByRef r_bChangeRate As Boolean) As Integer
        ...
        Try
            ...
            sSQL = "SELECT can_change_exchange_date, can_change_exchange_rate" & Strings.Chr(13) & Strings.Chr(10)
            sSQL = sSQL & "FROM user_authorities ua" & Strings.Chr(13) & Strings.Chr(10)
            sSQL = sSQL & "JOIN PMUser pmu ON pmu.user_id = ua.user_id" & Strings.Chr(13) & Strings.Chr(10)
            ...
            If (m_lReturn <> gPMConstants.PMEReturnCode.PMTrue) Or Not Information.IsArray(vResult) Then
                Return result
            End If
        ...
        Catch excep As System.Exception
            ...
            LogMessage("", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetCurrencyAuthorities Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetCurrencyAuthorities", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function GetSystemSecurityModel(ByRef vValue As Object) As Integer
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetSystemSecurityModel Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetSystemSecurityModel", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message)
    ...
    Public Function DecryptPassword(ByVal sEncryptedString As String, ByVal sKey As String) As String
        Try
            ...
            End Using
        Catch excep As Exception
            LogMessage(sUsername:="", iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Decrypt Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="Decrypt", vErrNo:=Information.Err().Number, vErrDesc:=excep)
            Return String.Empty
        End Try
    End Function
