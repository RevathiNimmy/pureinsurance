...
Imports System
<System.Runtime.InteropServices.ProgId("SiriusCoreFunc_NET.SiriusCoreFunc")> _
 Public Module SiriusCoreFunc
	...
	'
	' ***************************************************************** '
    Public Function GetBranches(ByVal v_oDatabase As Object, ByRef r_vBranchArray(,) As Object) As Integer 
    ...
    '
    ' ***************************************************************** '
    Public Function GetSubBranches(ByVal v_oDatabase As Object, ByVal v_lSourceID As Integer, ByRef r_vSubBranchArray(,) As Object) As Integer 
	...
	Private Function GetNumberValidationScript(ByVal v_sBranchPrefix As String, ByVal v_sScriptsPath As String, ByVal v_sFileName As String, ByVal v_sFileExt As String, ByRef r_sNumberScript As String) As Integer
		...
		Dim result As Integer = 0
			...
			If v_sBranchPrefix <> "" Then
				...
				If FileSystem.Dir(sFullScriptsPath, FileAttribute.Normal) = "" Then
			...
			iScriptFile = FileSystem.FreeFile()
