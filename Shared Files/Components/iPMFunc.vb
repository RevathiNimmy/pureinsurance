...
Public Module iPMFunc
    ...
    End Structure
    'Modified by Alkesh Kumar on 07/05/2010 20:51:43 refer developer guide no. 6 (No Solution)
    Private Delegate Function delWndProc(ByVal hwnd As Integer, ByVal Msg As Integer, ByVal wParam As Integer, ByVal lParam As Integer) As Integer
    Private Delegate Function delAppHook(ByVal idHook As Integer, ByVal wParam As Integer, ByVal lParam As Integer) As Integer
    ...
    'Modified by Alkesh Kumar on 07/05/2010 20:58:52 refer developer guide no. 6(No Solution)
    Private Declare Function SetWindowLong Lib "user32" Alias "SetWindowLongA" (ByVal hwnd As Integer, ByVal nIndex As Integer, ByVal dwNewLong As delWndProc) As Integer
    ...
    'Modified by Alkesh Kumar on 07/05/2010 20:59:36 refer developer guide no. 6(No Solution)
    Private Declare Function SetWindowsHookEx Lib "user32" Alias "SetWindowsHookExA" (ByVal idHook As Integer, ByVal lpfn As delAppHook, ByVal hmod As Integer, ByVal dwThreadId As Integer) As Integer
    Private Declare Function UnhookWindowsHookEx Lib "user32" (ByVal hHook As Integer) As Integer
    'rob    Private Declare Function GetClassName Lib "user32" Alias "GetClassNameA" (ByVal hwnd As Integer, ByVal lpClassName As String, ByVal nMaxCount As Integer) As Integer
    ...
    ' For Setting the system default printer back to original one after printing
    ' Sub routine Set_System_Default_Printer Added
    ' Added the following Declarations for the same
    ...
    '
    ' ***************************************************************** '
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String)
        LogMessage(iType, sMsg, Nothing, Nothing, Nothing, Nothing, Nothing, "", False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object)
        LogMessage(iType, sMsg, vApp, Nothing, Nothing, Nothing, Nothing, "", False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object)
        LogMessage(iType, sMsg, vApp, vClass, Nothing, Nothing, Nothing, "", False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef sUsername As String)
        LogMessage(iType, sMsg, vApp, vClass, Nothing, Nothing, Nothing, sUsername, False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, "", False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef sUsername As String)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, sUsername, False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, "", False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef sUsername As String)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, sUsername, False, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef excep As Exception)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, "", False, excep, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef bSilent As Boolean)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, "", bSilent, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef sUsername As String, ByRef bSilent As Boolean)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, sUsername, bSilent, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef bSilent As Boolean)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, "", bSilent, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef sUsername As String, ByRef bSilent As Boolean)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, sUsername, bSilent, Nothing, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef excep As Exception)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, "", False, excep, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef sUsername As String, ByRef excep As Exception)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, Nothing, Nothing, sUsername, False, excep, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef sUsername As String, ByRef excep As Exception)
        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, sUsername, False, excep, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef sUsername As String, ByRef excep As Exception)
        LogMessage(iType, sMsg, Nothing, Nothing, Nothing, Nothing, Nothing, sUsername, False, excep, Nothing)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vMethod As Object, ByRef sUsername As String, ByRef excep As Exception, ByRef oDicParms As Dictionary(Of String, Object))
        LogMessage(iType, sMsg, Nothing, Nothing, vMethod, Nothing, Nothing, sUsername, False, excep, oDicParms)
    End Sub
    Public Sub LogMessage(ByVal iType As Integer, ByVal sMsg As String, ByRef vApp As Object, ByRef vClass As Object, _
                          ByRef vMethod As Object, ByRef vErrNo As Object, ByRef vErrDesc As Object, ByRef sUsername As String, _
                          ByRef bSilent As Boolean, ByRef excep As Exception, ByRef oDicParms As Dictionary(Of String, Object))
        ...
        Try
            ...
            oMessage = CreateLateBoundObject("iPMMessage.PMMessageV2")


            Dim sbErrorMessage As New StringBuilder()
            If vErrDesc IsNot Nothing Then
                sbErrorMessage.AppendLine(vErrDesc)
            End If
            If excep IsNot Nothing AndAlso excep.Message IsNot Nothing Then
                sbErrorMessage.AppendLine("Message: " & excep.Message)
            End If
            If excep IsNot Nothing AndAlso excep.StackTrace IsNot Nothing Then
                sbErrorMessage.AppendLine("StackTrace: " & excep.StackTrace)
            End If

            vErrDesc = sbErrorMessage.ToString()
            ...
            Try
                ...
                If Not (oMessage Is Nothing) Then
                    ...
                    lReturn = oMessage.LogMessage(iType:=iType, sMsg:=sMsg, vApp:=CStr(vApp), vClass:=CStr(vClass), vMethod:=CStr(vMethod), vErrNo:=CStr(vErrNo), _
                                                  vErrDesc:=CStr(vErrDesc), bSilent:=bSilent, excep:=excep, oDicParms:=oDicParms)
    ...
    Public Sub LogExcepMessage(ByVal iType As Integer, ByVal sMsg As String, Optional ByRef vApp As Object = Nothing, _
                               ...
                               Optional ByRef sUsername As String = "", Optional ByRef bSilent As Boolean = False, _
                               Optional ByRef oException As System.Exception = Nothing)

        LogMessage(iType, sMsg, vApp, vClass, vMethod, vErrNo, vErrDesc, sUsername, bSilent)
    End Sub
    ...
    Public Sub SelectText(ByRef ctlControl As TextBox)
        Try

            ' Set the controls properties.
            With ctlControl
                'Modified by Deepak Sharma on 5/20/2010 8:06:28 PM refer developer guide no. 47
                ...
                .SelectionStart = 0
                .SelectionLength = Strings.Len(ctlControl.Text)
            End With
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            LogMessage(gPMConstants.PMELogLevel.PMLogOnError, "Failed to select the text", ACApp, ACClass, "SelectText", Information.Err().Number, excep.Message)
    ...
    Public Sub SelectText(ByRef ctlCtrl As Control)
        Try

            Dim ctlControl As TextBox
            ctlControl = DirectCast(ctlCtrl, TextBox)
            ' Set the controls properties.
            With ctlControl
                .SelectionStart = 0
                .SelectionLength = Strings.Len(ctlControl.Text)
    ...
    '
    ' ***************************************************************** '
    'Modified by Deepak Sharma on 4/20/2010 4:04:24 PM refer developer guide no. 101(Guide)
    'Public Sub CenterForm(ByRef frmForm As frmInterface)
    ...
    Public Function GetResData(ByRef iLangID As Integer, ByRef lId As Integer, ByRef iDataType As Integer) As Object
        ...
        Try
            ...
            ' ID passed.
            lLangID = (iLangID * gPMConstants.PMLangOffSetValue) + lId

            Select Case (iDataType)
                Case gPMConstants.PMEResourseFileDataType.PMResString
                    ' Get string value.
                    result = My.Resources.ResourceManager.GetString("str" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResBitmap
                    ' Get bitmap value.
                    result = My.Resources.ResourceManager.GetObject("bmp" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResIcon
                    ' Get Icon value.
                    result = My.Resources.ResourceManager.GetObject("ico" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResCursor
                    ' Get cursor value.
        ...
        Catch excep As System.Exception
            ...
            oDict.Add("iLangID", iLangID)
            oDict.Add("lId", lId)
            gPMFunctions.LogMessagePopup(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get data from the resource file", vApp:=ACApp, vClass:=ACClass, vMethod:="GetResData", excep:=excep, oDicParms:=oDict)
    ...
    Public Function GetResData(ByRef iLangID As Integer, ByRef lId As Integer, ByRef iDataType As Integer, ByRef bResFile As Object) As Object
        ...
        Try
            ...
            Select Case (iDataType)
                Case gPMConstants.PMEResourseFileDataType.PMResString
                    ' Get string value.
                    'result = My.Resources.ResourceManager.GetString("str" + CStr(lLangID))
                    result = bResFile.GetString("str" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResBitmap
                    ' Get bitmap value.
                    'result = My.Resources.ResourceManager.GetObject("bmp" + CStr(lLangID))
                    result = bResFile.GetObject("bmp" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResIcon
                    ' Get Icon value.
                    'result = My.Resources.ResourceManager.GetObject("ico" + CStr(lLangID))
                    result = bResFile.GetObject("ico" + CStr(lLangID))

                Case gPMConstants.PMEResourseFileDataType.PMResCursor
                    ' Get cursor value.
                    'result = My.Resources.ResourceManager.GetObject("cur" + CStr(lLangID))
                    result = bResFile.GetObject("cur" + CStr(lLangID))
            End Select
    ...
    '
    ' If you change this function you MUST also changethe bPMFunc version.
    ' *****************************************************************'
    ...
    Public Function LicenceEncrypt(ByRef sLicence As String, ByRef sLicenceKey As String) As Integer
        ...
        Dim sChar1 As New VB6.FixedLengthString(1)
        Dim sChar2 As New VB6.FixedLengthString(1)
        Dim iSn As Integer
    ...
    Public Function retrieveProductOptions(ByRef r_vProductOptions(,) As Object) As Integer
        ...
        Try
            ...
            Dim temp_oProductOption As Object = Nothing
    ...
    Public Function CreateUserControl(ByVal v_sProgID As String, ByVal v_sObjectName As String, ByVal v_oForm As Object, ByRef r_oContainer As Object, ByRef r_oControl As Object, Optional ByVal v_vLicenseKey As String = "", Optional ByVal v_bNoResizeControl As Boolean = False) As Integer
        ...
        Try
            ...
            'Modified by Deepak Sharma on 4/20/2010 4:45:59 PM refer developer guide no. 7(No Solutions)
            ...
            'Modified by Deepak Sharma on 6/9/2010 12:03:45 PM refer developer guide no. 37
            'r_oControl = v_oForm.Controls.Add(v_sProgID, v_sObjectName)
            v_oForm.Controls.Add(r_oControl)
    ...
    Public Sub ShowFormInTaskBar_Attach()
        ...
        Try
            ...
            'Modified by Deepak Sharma on 4/20/2010 5:05:19 PM refer developer guide no. 6(No Solutions)
            'm_hHook = SetWindowsHookEx(WH_CALLWNDPROC, AddressOf AppHook(), VB6.GetHInstance().ToInt32(), Thread.CurrentThread.ManagedThreadId)
            'Modified by Deepak Sharma on 5/7/2010 7:17:08 PM in .NET debug.assert is not required
...
Finally_Renamed:
    ...
    Private Function getProductOption(ByVal v_vOptionNumber As Object, ByVal v_vBranch As Object, ByRef r_vUnderwriting As Object, ByVal v_bValue As Boolean) As Integer
    ...
    Public Function getProductOptionValue(ByVal v_vOptionNumber As gPMConstants.SIRHiddenOptions, ByVal v_vBranch As Object, ByRef r_vUnderwriting As Object) As Integer
    ...
    ' RFC15102003 Moved from gSirLibrary as Part of the Global Data Changes
    '*******************************************************'
    Public Function getUnderwritingOrAgency(ByRef r_vUnderwriting As Object) As Integer
    ...
    Private Function findValueInArray(ByVal v_vOptionNumber As Object, ByVal v_vBranch As Object, ByRef r_vUnderwriting As Object, ByVal v_bValue As Object) As Integer
    ...
    ' ***************************************************************** '
    Public Sub LogError(ByVal v_sClass As String, ByVal v_sMethod As String, ByRef r_lFunctionReturn As Integer)
        LogError(v_sClass, v_sMethod, r_lFunctionReturn, "", Nothing)
    End Sub
    Public Sub LogError(ByVal v_sClass As String, ByVal v_sMethod As String, ByRef r_lFunctionReturn As Integer, ByVal v_sUsername As String)
        LogError(v_sClass, v_sMethod, r_lFunctionReturn, v_sUsername, Nothing)
    End Sub
    Public Sub LogError(ByVal v_sClass As String, ByVal v_sMethod As String, ByRef r_lFunctionReturn As Integer, ByRef excep As Exception)
        LogError(v_sClass, v_sMethod, r_lFunctionReturn, "", excep)
    End Sub
    Public Sub LogError(ByVal v_sClass As String, ByVal v_sMethod As String, ByRef r_lFunctionReturn As Integer, ByVal v_sUsername As String, ByRef excep As Exception)
    ...
    Public Function GetSystemSecurityModel(ByRef vValue As Object) As Integer
        ...
        Try
            ...
            m_lReturn = getProductOptionValue(v_vOptionNumber:=gPMConstants.SIRHiddenOptions.SIROPTAlternativeLogon, v_vBranch:=1, r_vUnderwriting:=vValue)
    ...
    Public Function AutoSizeDropDownComboWidth(ByRef Cbo As Object) As Integer
        ...
        Try
            ...
            With Cbo
                ...
                'Modified by Deepak Sharma on 5/4/2010 2:24:57 PM refer developer guide no. 65(Guide)
                '.Parent.ScaleMode = ScaleMode.Points
                'Find longest member
    ...
    Public Function SetComboBoxValue(ByVal oCombo As Object, ByVal sItemData As String) As Integer
        ...
        Try
            ...
            If oCombo.GetType.ToString.Equals("System.Windows.Forms.ComboBox") Then
                For lCount As Integer = 0 To CInt(oCombo.Items.Count - 1)

                    If sItemData = VB6.GetItemData(oCombo, lCount).ToString Then
                        ' Found it, set index and exit

                        oCombo.SelectedIndex = lCount
                        Return result
                    End If
                Next
            Else
    ...
    Public Sub SSTabMoveNext(ByVal oTab As Object)
        Try
            Do
    ...
    Public Sub SSTabMovePrevious(ByVal oTab As Object)
        Try
            Do
                If oTab.Tab <= 0 Then
    ...
    End Function
    ' ***************************************************************** '
    ' Name: Set_System_Default_Printer
    '
    ' Description: Set the system default printer to affect external programs
    '
    ' ***************************************************************** '
    Public Function Set_System_Default_Printer(ByVal sPrinter_Name As String) As Long
        Try

            Set_System_Default_Printer = PMConst.PMTrue
        ...
        Catch ex As Exception
            ...
            Set_System_Default_Printer = PMConst.PMFalse

            ' Log Error.
            LogMessage( _
                    iType:=PMConst.PMLogOnError, _
                    sMsg:="Failed to select the text", _
                    vApp:=ACApp, _
                    vClass:=ACClass, _
                    vMethod:="SelectText", _
                    vErrNo:=Err.Number, _
