...
Module MainModule
 ...
 Public g_oGIS As Object
	...
	Sub Main_Renamed()
		...
		'Dim o As iPMBAddress.Interface
		'Dim l As Long
		'Dim s$
		'
		'    Set o = New iPMBAddress.Interface
		'
		'    l = o.Initialise()
		'
		...
		'    'o.PostCode = "BR3 3P"
		'
		'    l = MsgBox("Yes to Add, No to Edit", vbYesNo)
		'
		'    If l = vbYes Then
		'           ' o.AddressCnt = 22
		'        l = o.SetProcessModes(vTask:=PMAdd)
		'        l = o.Start()
		'
		'    Else
		'        s = InputBox("enter address_cnt")
		'        o.AddressCnt = CLng(s)
		'        l = o.SetProcessModes(vTask:=PMEdit)
		'        l = o.Start()
		'    End If
		'
		'
		...
		'
		'
		'    MsgBox "address_cnt = " & o.AddressCnt _
		''            & Chr(10) & o.Address1 _
		''            & Chr(10) & o.Address2 _
		''            & Chr(10) & o.Address3 _
		''            & Chr(10) & o.Address4 _
