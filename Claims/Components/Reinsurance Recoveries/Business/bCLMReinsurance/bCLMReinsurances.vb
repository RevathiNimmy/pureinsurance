...
Friend NotInheritable Class Reinsurances
    ...
    Public Function Add(ByRef oNewReinsurance As bCLMReinsurance.Reinsurance) As Integer
    ...
    Public Function Item(ByVal Index As Object) As bCLMReinsurance.Reinsurance
        ' Return item
