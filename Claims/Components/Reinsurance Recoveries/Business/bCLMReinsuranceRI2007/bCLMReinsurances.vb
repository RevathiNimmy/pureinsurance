...
Friend NotInheritable Class Reinsurances
    ...
    Public Function Add(ByRef oNewReinsurance As bCLMReinsuranceRI2007.Reinsurance) As Integer
    ...
    Public Function Item(ByVal Index As String) As bCLMReinsuranceRI2007.Reinsurance
        ' Return item
