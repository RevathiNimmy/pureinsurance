...
Public NotInheritable Class Business
    ...
    ' Collection of CLMThirdPartyRecoverys (Private)
    Private m_oCLMThirdPartyRecoverys As bCLMThirdParty.CLMThirdPartyRecoverys
    ...
    Public Property CurrentRecord() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            Select Case Value
                Case Is < 1
                    m_lCurrentRecord = 0
                Case Is > m_oCLMThirdPartyRecoverys.Count()
                    m_lCurrentRecord = m_oCLMThirdPartyRecoverys.Count()
                Case Else
    ...
    Public ReadOnly Property RecordCount() As Integer
        Get
            ...
            Return m_oCLMThirdPartyRecoverys.Count()
    ...
    Public Function Initialise(ByVal sUserName As String, ByVal sPassword As String, ByVal iUserID As Integer, ByVal iSourceID As Integer, ByVal iLanguageID As Integer, ByVal iCurrencyID As Integer, ByVal iLogLevel As Integer, ByVal sCallingAppName As String, Optional ByVal bStandAlone As Boolean = False, Optional ByVal vDatabase As Object = Nothing) As Long
        ...
        Try
            ...
            ' Create CLMThirdPartyRecoverys Collection
            m_oCLMThirdPartyRecoverys = New bCLMThirdParty.CLMThirdPartyRecoverys()
        ...
        If Not Me.disposedValue Then
            ...
            If disposing Then
                If m_oLookup IsNot Nothing Then
                    ...
                    m_oLookup = Nothing
                End If
                m_oCLMThirdPartyRecoverys = Nothing
    ...
    '
    ' Description: Adds a single CLMThirdPartyRecovery directly into the database.
    '        Note: The CLMThirdPartyRecovery will NOT be added to the collection.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    Public Function DirectAdd(Optional ByRef vRecoveryId As Object = Nothing, Optional ByRef vRecoveryTypeID As Object = Nothing, Optional ByRef vPerilId As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vInitialReserve As Object = Nothing, Optional ByRef vRevisedReserve As Object = Nothing, Optional ByRef vReceivedToDate As Object = Nothing, Optional ByRef vRevisionCount As Object = Nothing, Optional ByRef vReceiptId As Object = Nothing, Optional ByRef vPartyClaimID As Object = Nothing, Optional ByRef vReceiptAmount As Object = Nothing, Optional ByRef vDateofReceipt As Object = Nothing, Optional ByRef vPaymentId As Object = Nothing, Optional ByRef vClaimID As Object = Nothing, Optional ByRef vPaymentAmount As Object = Nothing, Optional ByRef vDateofPayment As Object = Nothing, Optional ByRef vComments As Object = Nothing, Optional ByRef vTable As Object = Nothing) As gPMConstants.PMEReturnCode
        ...
        Dim oCLMThirdPartyRecovery As bCLMThirdParty.CLMThirdPartyRecovery

        Try

            result = gPMConstants.PMEReturnCode.PMTrue

            ' Create a new CLMThirdPartyRecovery
            oCLMThirdPartyRecovery = New bCLMThirdParty.CLMThirdPartyRecovery()
            m_lReturn = CType(oCLMThirdPartyRecovery.Initialise(sUserName:=m_sUsername, sPassword:=m_sPassword, iUserID:=m_iUserID, iSourceID:=m_iSourceID, iLanguageID:=m_iLanguageID, iCurrencyID:=m_iCurrencyID, iLogLevel:=m_iLogLevel, sCallingAppName:=ACApp, vDatabase:=m_oDatabase), gPMConstants.PMEReturnCode)

            ' Populate CLMThirdPartyRecovery Attributes
    ...
    '
    ' Description: Deletes a single CLMThirdPartyRecovery directly from the database.
    '        Note: The CLMThirdPartyRecovery will NOT be deleted from the collection.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    Public Function DirectDelete(Optional ByRef vRecoveryId As Object = Nothing) As Integer
        ...
        Try
            ...
            ' Set CLMThirdPartyRecovery Primary Key

            m_lReturn = CType(oCLMThirdPartyRecovery.SetProperties(iStatus:=gPMConstants.PMEComponentAction.PMDelete, vRecoveryId:=CInt(vRecoveryId)), gPMConstants.PMEReturnCode)
            ...
            ' Delete the CLMThirdPartyRecovery from the Database
            m_lReturn = CType(oCLMThirdPartyRecovery.DeleteItem(), gPMConstants.PMEReturnCode)
            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                result = gPMConstants.PMEReturnCode.PMFalse
                oCLMThirdPartyRecovery = Nothing
                Return result
    ...
    '
    ' Description: Gets the required CLMThirdPartyRecoverys and populate the Collection
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    Public Function GetDetails(Optional ByRef vLockMode As Object = Nothing, Optional ByRef vPerilId As Object = Nothing) As Integer
        ...
        Try
            ...
            For lSub As Integer = 0 To lRecordCount - 1
                ...
                ' Add CLMThirdPartyRecovery to collection
                If m_oCLMThirdPartyRecoverys.Count = 0 Then
                    m_oCLMThirdPartyRecoverys.Add(Nothing)
                End If
                m_lReturn = CType(m_oCLMThirdPartyRecoverys.Add(oNewCLMThirdPartyRecovery:=oCLMThirdPartyRecovery), gPMConstants.PMEReturnCode)
                If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Return gPMConstants.PMEReturnCode.PMFalse
                End If
    ...
    Public Function GetNext(Optional ByRef vRecoveryId As Object = Nothing, Optional ByRef vRecoveryTypeID As Object = Nothing, Optional ByRef vPerilId As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vInitialReserve As Object = Nothing, Optional ByRef vRevisedReserve As Object = Nothing, Optional ByRef vReceivedToDate As Object = Nothing, Optional ByRef vRevisionCount As Object = Nothing, Optional ByRef vReceiptId As Object = Nothing, Optional ByRef vPartyClaimID As Object = Nothing, Optional ByRef vReceiptAmount As Object = Nothing, Optional ByRef vDateofReceipt As Object = Nothing, Optional ByRef vPaymentId As Object = Nothing, Optional ByRef vClaimID As Object = Nothing, Optional ByRef vPaymentAmount As Object = Nothing, Optional ByRef vDateofPayment As Object = Nothing, Optional ByRef vComments As Object = Nothing, Optional ByRef vTable As Object = Nothing) As Integer
        ...
        Try
            ...
            If m_lCurrentRecord < m_oCLMThirdPartyRecoverys.Count() Then
            ...
            oCLMThirdPartyRecovery = m_oCLMThirdPartyRecoverys.Item(m_lCurrentRecord)

            ' Get the CLMThirdPartyRecovery Property Values
            ...
            m_lReturn = CType(oCLMThirdPartyRecovery.GetProperties(iStatus, vRecoveryId:=CInt(vRecoveryId), vRecoveryTypeID:=CStr(vRecoveryTypeID), vPerilId:=CStr(vPerilId), vCurrencyID:=CStr(vCurrencyID), vInitialReserve:=CStr(vInitialReserve), vRevisedReserve:=CStr(vRevisedReserve), vReceivedToDate:=CStr(vReceivedToDate), vRevisionCount:=CStr(vRevisionCount), vReceiptId:=CStr(vReceiptId), vPartyClaimID:=CStr(vPartyClaimID), vReceiptAmount:=CStr(vReceiptAmount), vDateofReceipt:=CStr(vDateofReceipt), vPaymentId:=CStr(vPaymentId), vClaimID:=CStr(vClaimID), vPaymentAmount:=CStr(vPaymentAmount), vDateofPayment:=CStr(vDateofPayment), vComments:=CStr(vComments), vTable:=CStr(vTable)), gPMConstants.PMEReturnCode)
    ...
    ' Name: EditAdd (Public)
    '
    ' Description: Adds the supplied CLMThirdPartyRecovery into the Collection.
    ...
    Public Function EditAdd(ByRef lRow As Integer, Optional ByRef vRecoveryId As Object = Nothing, Optional ByRef vRecoveryTypeID As Object = Nothing, Optional ByRef vPerilId As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vInitialReserve As Object = Nothing, Optional ByRef vRevisedReserve As Object = Nothing, Optional ByRef vReceivedToDate As Object = Nothing, Optional ByRef vRevisionCount As Object = Nothing, Optional ByRef vReceiptId As Object = Nothing, Optional ByRef vPartyClaimID As Object = Nothing, Optional ByRef vReceiptAmount As Object = Nothing, Optional ByRef vDateofReceipt As Object = Nothing, Optional ByRef vPaymentId As Object = Nothing, Optional ByRef vClaimID As Object = Nothing, Optional ByRef vPaymentAmount As Object = Nothing, Optional ByRef vDateofPayment As Object = Nothing, Optional ByRef vComments As Object = Nothing, Optional ByRef vTable As Object = Nothing, Optional ByRef vTaxAmount As Object = Nothing, Optional ByRef vReceiptToLossRate As Object = Nothing) As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            If m_oCLMThirdPartyRecoverys.Count() <> (lRow - 1) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If
    ...
    '
    ' Description: Validates that this action is valid on the CLMThirdPartyRecovery
    '              specified and updates the CLMThirdPartyRecovery with the new values.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    Public Function EditUpdate(ByRef lRow As Integer, Optional ByRef vRecoveryId As Object = Nothing, Optional ByRef vRecoveryTypeID As Object = Nothing, Optional ByRef vPerilId As Object = Nothing, Optional ByRef vCurrencyID As Object = Nothing, Optional ByRef vInitialReserve As Object = Nothing, Optional ByRef vRevisedReserve As Object = Nothing, Optional ByRef vReceivedToDate As Object = Nothing, Optional ByRef vRevisionCount As Object = Nothing, Optional ByRef vReceiptId As Object = Nothing, Optional ByRef vPartyClaimID As Object = Nothing, Optional ByRef vReceiptAmount As Object = Nothing, Optional ByRef vDateofReceipt As Object = Nothing, Optional ByRef vPaymentId As Object = Nothing, Optional ByRef vClaimID As Object = Nothing, Optional ByRef vPaymentAmount As Object = Nothing, Optional ByRef vDateofPayment As Object = Nothing, Optional ByRef vComments As Object = Nothing, Optional ByRef vTable As Object = Nothing, Optional ByRef vTaxAmount As Object = Nothing, Optional ByRef vReceiptToLossRate As Object = Nothing) As gPMConstants.PMEReturnCode
        ...
        Try
            ...
            If (lRow < 1) Or (lRow > m_oCLMThirdPartyRecoverys.Count()) Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            ' Get a reference to the row to Edit
            oCLMThirdPartyRecovery = m_oCLMThirdPartyRecoverys.Item(lRow)

            ' Check the Status of the CLMThirdPartyRecovery

            'If status is Add (i.e. It is not in the database),then leave status as Add
            'or If status is Delete, report an error
            'Otherwise set to Edit

            Select Case oCLMThirdPartyRecovery.DatabaseStatus
            ...
            ' Update CLMThirdPartyRecovery Attributes
            ...
            m_lReturn = CType(oCLMThirdPartyRecovery.SetProperties(iStatus:=iStatus, vRecoveryId:=CInt(vRecoveryId), vRecoveryTypeID:=CInt(vRecoveryTypeID), vPerilId:=CInt(vPerilId), vCurrencyID:=CInt(vCurrencyID), vInitialReserve:=CDec(vInitialReserve), vRevisedReserve:=CDec(vRevisedReserve), vReceivedToDate:=CDec(vReceivedToDate), vRevisionCount:=CInt(vRevisionCount), vReceiptId:=CInt(vReceiptId), vPartyClaimID:=CInt(vPartyClaimID), vReceiptAmount:=CDec(vReceiptAmount), vDateofReceipt:=vDateofReceipt, vPaymentId:=CInt(vPaymentId), vClaimID:=CInt(vClaimID), vPaymentAmount:=CDec(vPaymentAmount), vDateofPayment:=vDateofPayment, vComments:=CStr(vComments), vTable:=CInt(vTable), vTaxAmount:=CDec(vTaxAmount), vReceiptToLossRate:=CDbl(vReceiptToLossRate)), gPMConstants.PMEReturnCode)
            ...
            ' Release reference to CLMThirdPartyRecovery
            oCLMThirdPartyRecovery = Nothing
    ...
    '
    ' Description: Validate that the specified CLMThirdPartyRecovery can be deleted
    ...
    Public Function EditDelete(ByVal lRow As Integer) As Integer
        ...
        Try
            ...
            If oCLMThirdPartyRecovery.DatabaseStatus = gPMConstants.PMEComponentAction.PMAdd Then
                oCLMThirdPartyRecovery.DatabaseStatus = gPMConstants.PMEComponentAction.PMDummyDelete
            Else
                oCLMThirdPartyRecovery.DatabaseStatus = gPMConstants.PMEComponentAction.PMDelete
            End If
    ...
    Public Function Cancel() As Integer
        ...
        Try
            ...
            For lSub As Integer = 1 To m_oCLMThirdPartyRecoverys.Count()
                Select Case m_oCLMThirdPartyRecoverys.Item(lSub).DatabaseStatus
    ...
    Public Function Update() As Integer
        ...
        Dim result As Integer = 0
        Dim lSub As Integer
        Dim oCLMThirdPartyRecovery As New bCLMThirdParty.CLMThirdPartyRecovery
        ...
        Try
            ...
            For lSub = 1 To m_oCLMThirdPartyRecoverys.Count()
                oCLMThirdPartyRecovery = m_oCLMThirdPartyRecoverys.Item(lSub)
                ...
                Select Case oCLMThirdPartyRecovery.DatabaseStatus
                    ...
                    Case gPMConstants.PMEComponentAction.PMEdit
                        ...
                        ' Update Item
                        m_lReturn = CType(oCLMThirdPartyRecovery.UpdateItem(), gPMConstants.PMEReturnCode)
                        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                            result = gPMConstants.PMEReturnCode.PMFalse
                            Exit For
                        End If
            ...
            ' Retain the Primary Key of the CLMThirdPartyRecovery
            With oCLMThirdPartyRecovery
                RecoveryId = .RecoveryId
            End With
            ...
            If bTransStarted Then
                ...
                If result = gPMConstants.PMEReturnCode.PMTrue Then
                    ...
                    Do While lSub <= m_oCLMThirdPartyRecoverys.Count()

                        ' With the item
                        With m_oCLMThirdPartyRecoverys.Item(lSub)
                            ...
                            Select Case .DatabaseStatus
                                ...
                                Case gPMConstants.PMEComponentAction.PMDelete, gPMConstants.PMEComponentAction.PMDummyDelete
                                    ...
                                    m_oCLMThirdPartyRecoverys.Delete(lSub)
    ...
    '        05/07/01   RWH - Updated to also return Id.
    '********************************************************************************
    Public Function GetClassOfBusiness(ByVal v_lPerilTypeID As Integer, ByRef r_lId As Integer, ByRef r_sCode As String) As Integer
        ...
        Try
            ...
            sSQL = "SELECT cob.class_of_business_id, cob.code FROM peril_type per, class_of_business cob" & Constants.vbLf
            sSQL = sSQL & "WHERE per.peril_type_id = {peril_type_id}" & Constants.vbLf
        ...
        Catch excep As System.Exception
            ...
            ' Log Error Message
            bPMFunc.LogMessage(m_sUsername, iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="GetClassOfBusiness Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="GetClassOfBusiness", vErrNo:=Informations.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    '                            Added a functionality. On pressing OK, in Recovery screen,
    ...
    ' SJP 14062002 - getUnderwritingType uses new product options scheme
    ' ***************************************************************** '
