...
Partial Friend Class frmSelectPeril
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            'Set m_oGeneral = New iCLMSalvageRecovery.General
    ...
    Private Function DisplayCaptions() As Integer
        ...
        Try
            ...
            'JMK 10/04/2001 - show we're in Third Party Recovery
            ...
            sCaption = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACInterfaceTitle, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

            sCaption = sCaption & " - "


            sCaption = sCaption & CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACSelectPeril, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            ...
            'Caption For Select Button 18-10-2000 Pandu
            ...
            lvwSelectPeril.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACPeril, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

            'Description


            lvwSelectPeril.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACDescription, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            Else
                ...
                'Copied from cancel, as there's nothing left in the view claim roadmap...

                If m_iTask = gPMConstants.PMEComponentAction.PMView Then


                    g_oBusiness1.ClaimId = m_lClaimID


                    m_lReturn = g_oBusiness1.DeleteWorkClaim
    ...
    Private Function ResizeInterface() As Integer
        ...
        Try
            ...
            'Added Select Button Internal Bug 8
    ...
    Public Function UnlockClaim(ByVal v_lOriginalClaimID As Integer) As Integer
        ...
        Try
            ...
            'PSL 16/07/2003 The change to make it not locked in view mode was wrong
            'change it back so you always unlcok unless it is a new claim
