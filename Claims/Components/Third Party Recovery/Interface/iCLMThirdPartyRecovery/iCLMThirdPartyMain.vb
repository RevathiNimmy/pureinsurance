...
Partial Friend Class frmInterface
    ...
    'RWH(26/06/01) For calculation
    Private m_cStartingNewReserve As Decimal
    ...
    Private m_oGeneral As iCLMThirdPartyRecovery.General
    ...
    '
    ' Edit History : Pandu
    '              : 06 Sep 2001 add Received To Date column to recovery amount tab
    '              : and coinsurance and reinsurance if claim mode is pmview
    ' ***************************************************************** '
    Private Function SetInterfaceDefaults() As Integer

        Dim result As Integer = 0
        Dim iMode As gPMConstants.PMEComponentAction
        ...
        Try
            ...
            Select Case iMode
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    cmdAdd.Enabled = True
                    cmdEdit.Enabled = False 'RWH(09/04/2001) Put these back in.
            ...
            'RWH(25/06/01)RSA #1118
            Select Case m_sTransactionType.Trim()
                Case "C_RV"
                    cmdAdd.Enabled = False
    ...
    '
    ' Edit History :Pandu
    '              : 06 Sep 2001 add Received To Date
    ' ***************************************************************** '
        ...
        Try
            ...
            Select Case ClaimMode
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    Me.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACThirdPartyReceipt, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            ...
            Select Case ClaimMode
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    lvwRecovery.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACThirdPartyType, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                    ...
                    lvwRecovery.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACInitialReserve_U, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                ...
                Case gPMConstants.PMEComponentAction.PMEdit
                    ...
                    lvwRecovery.Columns.Item(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACRevisedReserve, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'New Reserve


                    lvwRecovery.Columns.Item(3).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACNewReserve, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'received to date


                    lvwRecovery.Columns.Item(4).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACReceivedToDate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    lvwRecovery.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACThirdPartyAmount, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


                    'Initial Reserve


                    lvwRecovery.Columns.Item(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACInitialReserve_U, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'Revised Reserve


                    lvwRecovery.Columns.Item(3).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACRevisedReserve, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


                    'New Reserve


                    lvwRecovery.Columns.Item(4).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACNewReserve_U, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


                    'received to date


                    lvwRecovery.Columns.Item(5).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACReceivedToDate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            ...
            Select Case ClaimMode
                Case gPMConstants.PMEComponentAction.PMEdit, gPMConstants.PMEComponentAction.PMView
                    ...
                    lvwCoInsurance.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCoInsurer, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'Share


                    lvwCoInsurance.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACShare, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'Salvage Amount


                    lvwCoInsurance.Columns.Item(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACThirdPartyAmount, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


                    'reInsurer


                    lvwReinsurance.Columns.Item(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACReInsurer, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))


                    'Share


                    lvwReinsurance.Columns.Item(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACShare, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'Salvage Amount


                    lvwReinsurance.Columns.Item(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACThirdPartyAmount, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

                    'TN20010906 - received to date
                    If ClaimMode = gPMConstants.PMEComponentAction.PMView Then


                        lvwCoInsurance.Columns.Item(3).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACReceivedToDate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))



                        lvwReinsurance.Columns.Item(3).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACReceivedToDate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            ...
            Select Case ClaimMode
                Case gPMConstants.PMEComponentAction.PMAdd, gPMConstants.PMEComponentAction.PMEdit
                    ...
                    lblClaimNumber(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACClaimNumber, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))



                    lblPerilType(0).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACPerilType, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                    ...
                    lblExchangeRate.Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACExchangeRate, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    lblClaimNumber(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACClaimNumber, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))



                    lblClaimNumber(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACClaimNumber, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
                    ...
                    lblPerilType(1).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACPerilType, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))



                    lblPerilType(2).Text = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACPerilType, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
    ...
    Private Sub cmdAdd_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdAdd.Click
        ...
        Dim frmThirdPartyDetails As New frmThirdPartyDetails

        Select Case ClaimMode
            Case gPMConstants.PMEComponentAction.PMAdd

                frmThirdPartyDetails.InitialReserve = 0
                frmThirdPartyDetails.ClaimMode = ClaimMode
                frmThirdPartyDetails.RecoveryTypeID = 0
                frmThirdPartyDetails.RevisedReserve = 0
                frmThirdPartyDetails.NewReserve = 0
                frmThirdPartyDetails.PerilID = m_lPerilId
                frmThirdPartyDetails.LossCurrencyId = m_lLossCurrencyId
                frmThirdPartyDetails.LossCurrencyDesc = cboCurrency.Text
                frmThirdPartyDetails.InsuranceFileCnt = m_lInsuranceFileCnt

                Dim tempLoadForm As frmThirdPartyDetails = frmThirdPartyDetails

                ' Alix - 15/05/2003
                'PSL 25/06/2003 Iss 4969 Underwriting only

                frmThirdPartyDetails.FillTaxTypeCombo(g_oBusiness)


                frmThirdPartyDetails.ShowDialog()

                If frmThirdPartyDetails.Status = gPMConstants.PMEReturnCode.PMOK Then

                    m_cInitialReserve = frmThirdPartyDetails.InitialReserve
                    m_lRecoveryTypeID = frmThirdPartyDetails.RecoveryTypeID
                    'RWH(09/04/2001) Initialise amount received to enable edit.
                    m_cReceivedTodate = 0
                    g_lCount += 1

                    ' Alix
                    m_cTaxAmount = frmThirdPartyDetails.TaxAmount
                    ' /Alix
            ...
            Case gPMConstants.PMEComponentAction.PMEdit, gPMConstants.PMEComponentAction.PMView
                ...
                Dim tempLoadForm2 As frmThirdPartyDetails = frmThirdPartyDetails
                ...
                If frmThirdPartyDetails.Status = gPMConstants.PMEReturnCode.PMOK Then
                    ...
                    m_cInitialReserve = frmThirdPartyDetails.InitialReserve
                    m_cRevisedReserve = frmThirdPartyDetails.RevisedReserve
                    m_cNewreserve = frmThirdPartyDetails.NewReserve
                    m_lRecoveryTypeID = frmThirdPartyDetails.RecoveryTypeID
                    m_lReceiptCurrencyId = frmThirdPartyDetails.ReceiptCurrencyId
                    m_dReceiptToLossRate = frmThirdPartyDetails.ReceiptToLossRate
                    'RWH(09/04/2001) Initialise amount received to enable edit.
                    m_cReceivedTodate = 0
                    g_lCount += 1
    ...
    Private Sub cmdDelete_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdDelete.Click
        ...
        Const ACDeleteMsg As String = "Invalid Delete Operation"
        Const AcDelete As Integer = 0
        ...
        If lvwRecovery.Items.Count > 0 Then
            If ClaimMode = gPMConstants.PMEComponentAction.PMEdit Or ClaimMode = gPMConstants.PMEComponentAction.PMView Then
                ...
                m_lReturn = g_oBusiness.Checkid(m_vRecoveryID(AcDelete, Convert.ToString(lvwRecovery.FocusedItem.Tag)))

                If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then

                    DisplayMessage(ACInvalidDeleteOperation, ACDeleteMsg)
        ...
        If lvwRecovery.Items.Count > 0 Then
            ...
            Select Case ClaimMode
                Case gPMConstants.PMEComponentAction.PMAdd
                    ...
                    frmThirdPartyDetails.InitialReserve = CDec(lvwRecovery.FocusedItem.SubItems(1).Text.Trim())
                    frmThirdPartyDetails.ClaimMode = ClaimMode

                    frmThirdPartyDetails.RecoveryTypeID = CInt(m_vRecoveryTypeID(0, Convert.ToString(lvwRecovery.FocusedItem.Tag)))
                    frmThirdPartyDetails.LossCurrencyId = m_lLossCurrencyId
                    frmThirdPartyDetails.LossCurrencyDesc = cboCurrency.Text
                    frmThirdPartyDetails.InsuranceFileCnt = m_lInsuranceFileCnt
                ...
                Case gPMConstants.PMEComponentAction.PMEdit
                    ...
                    Else
                        'cTempEditInitialReserve = CDec(lvwRecovery.listViewHelper1.GetListViewSubItem(lvwRecovery.FocusedItem, 1).Text.Trim())
                    ...
                    Else
                        'cTempEditRevisedReserve = CDec(lvwRecovery.listViewHelper1.GetListViewSubItem(lvwRecovery.FocusedItem, 2).Text.Trim())
                    ...
                    Else
                        'cTempEditNewReserve = CDec(lvwRecovery.listViewHelper1.GetListViewSubItem(lvwRecovery.FocusedItem, 3).Text.Trim())
                    ...
                    frmThirdPartyDetails.InitialReserve = cTempEditInitialReserve
                    frmThirdPartyDetails.RevisedReserve = cTempEditRevisedReserve
                    frmThirdPartyDetails.NewReserve = cTempEditNewReserve

                    frmThirdPartyDetails.RecoveryTypeID = CInt(m_vRecoveryTypeID(0, Convert.ToString(lvwRecovery.FocusedItem.Tag)))

                    frmThirdPartyDetails.ReceivedTodate = CDec(m_vRecdToDate(ACIRecoveryID, Convert.ToString(lvwRecovery.FocusedItem.Tag)))
                    frmThirdPartyDetails.ClaimMode = ClaimMode
                    frmThirdPartyDetails.LossCurrencyId = m_lLossCurrencyId
                    frmThirdPartyDetails.LossCurrencyDesc = cboCurrency.Text
                    frmThirdPartyDetails.InsuranceFileCnt = m_lInsuranceFileCnt
                    frmThirdPartyDetails.DisableCurrency = bDisableCurrency
                    ...
                    If lvwRecovery.FocusedItem.SubItems(7).Text.Trim() = Nothing Then
                        frmThirdPartyDetails.TaxAmount = 0
                    Else
                        ' frmThirdPartyDetails.TaxAmount = CDec(lvwRecovery.listViewHelper1.GetListViewSubItem(lvwRecovery.FocusedItem, 7).Text)
                        frmThirdPartyDetails.TaxAmount = CDec(lvwRecovery.FocusedItem.SubItems(7).Text)
                    End If
                    frmThirdPartyDetails.TaxTypeDesc = lvwRecovery.FocusedItem.SubItems(8).Text
                    frmThirdPartyDetails.TaxBandDesc = lvwRecovery.FocusedItem.SubItems(9).Text
                    ...
                    If frmThirdPartyDetails.Status = gPMConstants.PMEReturnCode.PMOK Then
                        ...
                        m_cRevisedReserve = frmThirdPartyDetails.RevisedReserve + cTempEditRevisedReserve
                        ...
                        m_cTaxAmount = frmThirdPartyDetails.TaxAmount
                        m_sTaxTypeDesc = frmThirdPartyDetails.TaxTypeDesc
                        m_sTaxBandDesc = frmThirdPartyDetails.TaxBandDesc
                        m_sTaxTypeCode = frmThirdPartyDetails.TaxTypeCode
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    If lvwRecovery.FocusedItem.SubItems(4).Text.Trim() = Nothing Then
                        cTempNewReserve = 0
                    Else
                    ...
                    'RWH(26/06/01) This should always be 0.
                    frmThirdPartyDetails.ReceiptAmount = cTempReceiptAmount
                    frmThirdPartyDetails.InitialReserve = cTempInitialReserve
                    frmThirdPartyDetails.NewReserve = cTempNewReserve + cTempReceiptAmount
                    ...
                    If lvwRecovery.FocusedItem.SubItems(6).Text.Trim() = Nothing Then
                        frmThirdPartyDetails.TaxAmount = 0
                    Else
                        frmThirdPartyDetails.TaxAmount = CDec(lvwRecovery.FocusedItem.SubItems(6).Text)
                    End If
                    frmThirdPartyDetails.TaxTypeDesc = lvwRecovery.FocusedItem.SubItems(7).Text
                    frmThirdPartyDetails.TaxBandDesc = lvwRecovery.FocusedItem.SubItems(8).Text



                    Dim tempLoadForm3 As frmThirdPartyDetails = frmThirdPartyDetails
                    ...
                    If frmThirdPartyDetails.Status = gPMConstants.PMEReturnCode.PMOK Then
                        ...
                        m_lRecoveryTypeID = frmThirdPartyDetails.RecoveryTypeID
                        m_cReceiptAmount = frmThirdPartyDetails.ReceiptAmount
                        m_lReceiptCurrencyId = frmThirdPartyDetails.ReceiptCurrencyId
                        m_dReceiptToLossRate = frmThirdPartyDetails.ReceiptToLossRate
                        m_cReceiptAmountLoss = frmThirdPartyDetails.ReceiptAmountLoss
                        ...
                        'RWH(26/06/1) Update Received_To_Date in cmdOK.
    ...
    ' Name: FormInitialise
    '
    ' Description: Initialise all required details of the form
    '
    ' Date:15/07/00
    '
    ' Edit History:Pandu
    ...
    Private Sub Form_Initialize_Renamed()
        ...
        Try
            ...
            m_oGeneral = New iCLMThirdPartyRecovery.General()
    ...
    Private Sub frmInterface_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bCLMThirdParty.Business", vInstanceManager:="ClientManager")
    ...
    Private Sub lvwRecovery_MouseDown(ByVal eventSender As Object, ByVal eventArgs As MouseEventArgs) Handles lvwRecovery.MouseDown
        ...
        'TN20010329 If ClaimMode <> PMView Then
    ...
    Private Sub cmdOK_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdOK.Click
        ...
        Try
            ...
            Dim sComments, sCommentsOut As String
            ...
            '    Dim sClassOfBusiness As String
            'TN20010329 End
            ...
            If ClaimMode = gPMConstants.PMEComponentAction.PMView Or m_sTransactionType.Trim() = ACTransTypeClaimRecovery Then
                ...
                If cReceiptAmount <> 0 Then
                    ...
                    m_lReturn = g_oBusiness.GetClassOfBusiness(v_lPerilTypeID:=m_lPerilTypeID, r_lId:=lCOBId, r_sCode:=sCOBCode)

                    If sCOBCode = "" Then
                        ' Log Error.
                        iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to get class of business." & Constants.vbLf & "No recovery transactions will be posted to Orion", vApp:=ACApp, vClass:=ACClass, vMethod:="cmdOK_Click", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
                    End If
                    ...
                    If nOptionValue = ACOptionValueSuspense Then
                        ...
                        If ClaimMode = gPMConstants.PMEComponentAction.PMView Then
                            ...
                            'RWH(26/06/01) Remove this, it's done in Process Command at the end.
                            'm_lReturn = g_oBusiness.Update

                            'TN20010329 Start
                            'post to orion - debit claim suspense and credit
                            If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
                                If sCOBCode <> "" Then
                                    m_lReturn = PostTPRecoveryToOrion(v_lInsuranceFileCnt:=m_lInsuranceFileCnt, v_lClaimID:=m_lClaimID, v_lPerilID:=m_lPerilId, v_cTransAmount:=cReceiptAmount, v_sDebitAccountCode:="CLAIMSUS", v_sDebitMappingCode:="CLMSUS" & sCOBCode, v_sCOBCode:=sCOBCode, v_lCOBId:=lCOBId)
                                End If
                            End If
                            'TN20010329 - End
                    ...
                    Else
                        ...
                        If ClaimMode = gPMConstants.PMEComponentAction.PMView Then
                            ...
                            If lButtonClicked = gPMConstants.PMEReturnCode.PMOK Then
                                ...
                                If m_lReturn = gPMConstants.PMEReturnCode.PMTrue Then
                                    If sCOBCode <> "" Then
                                        m_lReturn = PostTPRecoveryToOrion(v_lInsuranceFileCnt:=m_lInsuranceFileCnt, v_lClaimID:=m_lClaimID, v_lPerilID:=m_lPerilId, v_cTransAmount:=cReceiptAmount, v_sDebitAccountCode:=sAccountType, v_sDebitMappingCode:=sShortName, v_sCOBCode:=sCOBCode, v_lCOBId:=lCOBId, v_lPartyCnt:=lPartyid)
            ...
            'RWH(08/10/01) Check to see if claim can be closed and close it if required.
            If (m_lReturn = gPMConstants.PMEReturnCode.PMTrue) And (m_sTransactionType = "C_RV") Then
                CheckCurrentReserve()
            End If
    ...
    Private Sub lvwRecovery_DoubleClick(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles lvwRecovery.DoubleClick
        ...
        'Try 
        '
        '*********Start of Code Changes Internal Bug 8
        '
        ...
        '    Call cmdEdit_Click
        '
        '*********end of Code Changes Internal Bug 8
        '
        'Catch excep As System.Exception
        '
        '
    ...
    Public Function BusinessToInterface() As Integer
        ...
        Try
            ...
            Select Case ClaimMode
                'RWH(09/04/2001) Retrieve details for add mode as well to allow edit of
                'newly added records.
                Case gPMConstants.PMEComponentAction.PMEdit, gPMConstants.PMEComponentAction.PMAdd
                    ...
                    If g_oBusiness.RecordCount > 0 Then
                        ...
                        For ncount As Integer = 1 To g_oBusiness.RecordCount
                            ...
                            m_lReturn = GetRecoveryTypeDescription(m_lRecoveryTypeID, sRecoveryTypeDesc, g_vThirdPartyRecoveryTypes, g_vThirdPartyRecoveryTypes.GetLowerBound(1), g_vThirdPartyRecoveryTypes.GetUpperBound(0) + 1)
                ...
                Case gPMConstants.PMEComponentAction.PMView
                    ...
                    If g_oBusiness.RecordCount > 0 Then
                        ...
                        For ncount As Integer = 1 To g_oBusiness.RecordCount
                            ...
                            m_lReturn = GetRecoveryTypeDescription(m_lRecoveryTypeID, sRecoveryTypeDesc, g_vThirdPartyRecoveryTypes, g_vThirdPartyRecoveryTypes.GetLowerBound(0), g_vThirdPartyRecoveryTypes.GetUpperBound(0) + 1)
                            ...
                            'Current Reserve
                            'It Should be addition of initial+revised-recdtodate
                            m_cStartingNewReserve = m_cRevisedReserve + m_cInitialReserve - m_cReceivedTodate
                            ListViewHelper.GetListViewSubItem(oListItem, 4).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatCurrency, vFieldValue:=CStr(m_cStartingNewReserve).Trim())
    ...
    '    End If
    '
    '    m_lReturn& = g_oBusiness.GetSalvageRecoveryType(g_vThirdPartyrecoverytypes)
    '
    '    If (m_lReturn& <> PMTrue) Then
    '        DisplayLookupDetails = PMFalse
    '        Exit Function
    ...
    Private Function BusinessToData() As Integer
        ...
        Try
            ...
            Select Case ClaimMode
                'RWH(09/04/2001) Enable newly added records to be updated.
                Case gPMConstants.PMEComponentAction.PMEdit, gPMConstants.PMEComponentAction.PMAdd
    ...
    Public Function EditToListView(ByRef lSelectedIndex As Integer) As Integer
        ...
        Select Case ClaimMode
            ...
            Case gPMConstants.PMEComponentAction.PMView
                ...
                ListViewHelper.GetListViewSubItem(lvwRecovery.Items.Item(lSelectedIndex - 1), 1).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatCurrency, vFieldValue:=CStr(m_cReceiptAmount).Trim())

                ListViewHelper.GetListViewSubItem(lvwRecovery.Items.Item(lSelectedIndex - 1), 2).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatCurrency, vFieldValue:=CStr(m_cInitialReserve).Trim())

                'RWH(25/06/01) Add Revised Reserve here.
    ...
    '        05/07/01   RWH - Revamped stats production and removed transaction stuff
    '                   as this will now be done in stored procedures at end of roadmap.
    '*******************************************************************************
    Private Function PostTPRecoveryToOrion(ByVal v_lInsuranceFileCnt As Integer, ByVal v_lClaimID As Integer, ByVal v_lPerilID As Integer, ByVal v_cTransAmount As Decimal, ByVal v_sDebitAccountCode As String, ByVal v_sDebitMappingCode As String, ByVal v_sCOBCode As String, ByVal v_lCOBId As Integer, Optional ByVal v_lPartyCnt As Integer = 0) As Integer
        Dim result As Integer = 0
        ...
        Dim sCreditMappingCode As String
        ...
        Try
            ...
            oControlTrans.TransactionTypeCode = "C_RV" 'claim maintenance
            ...
            oControlTrans.DocumentComment = "TP Recovery for claim number "
            ...
            m_lReturn = oControlTrans.CreateStatsFolder(r_lStatsFolderCnt:=lStatsFolderCnt, v_sTransactionTypeCode:="C_RV")
        ...
        Catch excep As System.Exception
            ...
            ' Log Error.
            iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="PostTPRecoveryToOrion Failed", vApp:=ACApp, vClass:=ACClass, vMethod:="PostTPRecoveryToOrion", vErrNo:=Information.Err().Number, vErrDesc:=excep.Message, excep:=excep)
    ...
    Private Function PopulateCoReInsurerOnSelection() As Integer
        Dim result As Integer = 0
        Dim vCoInsurerDetails(,) As Object
        Dim vReInsurerDetails(,) As Object
            ...
            Select Case ClaimMode
                Case gPMConstants.PMEComponentAction.PMView, gPMConstants.PMEComponentAction.PMEdit
                    ...
                    If g_oBusiness.RecordCount > 0 Then
                        ...
                        m_lReturn = g_oBusiness.GetCoinsuranceRecoveries(vCoInsurerDetails, m_lClaimID)
                        ...
                        ' continuing.
                        If Information.IsArray(vCoInsurerDetails) Then

                            ' Assign the details to the interface.

                            For lRow As Integer = vCoInsurerDetails.GetLowerBound(1) To vCoInsurerDetails.GetUpperBound(1)
                                ...
                                oListItem = lvwCoInsurance.Items.Add(CStr(vCoInsurerDetails(ACICoInsurerName, lRow)).Trim(), "")

                                ' Assign details to other the columns
                                ' Column 2 Claim Ref

                                ListViewHelper.GetListViewSubItem(oListItem, 1).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatPercent, vFieldValue:=CStr(vCoInsurerDetails(ACICoShare, lRow)).Trim())
                                ...
                                If Information.IsArray(m_vRecdToDate) Then
                                    ...
                                    cCoinsAmount = cCoinsAmount * Conversion.Val(CStr(vCoInsurerDetails(ACICoShare, lRow))) / 100
                                ...
                                If ClaimMode = gPMConstants.PMEComponentAction.PMView Then
                                    ...
                                    cReceivedToDateCoin = m_cReceivedTodate * Conversion.Val(CStr(vCoInsurerDetails(ACICoShare, lRow))) / 100
                                ...
                                oListItem.Tag = CStr(vCoInsurerDetails(ACICoInsurerId, lRow))
                        ...
                        m_lReturn = g_oBusiness.GetReinsuranceRecoveries(vReInsurerDetails, m_lClaimID)
                        ...
                        ' Check that search details are valid before
                        ' continuing.
                        If Information.IsArray(vReInsurerDetails) Then


                            ' Assign the details to the interface.

                            For lRow As Integer = vReInsurerDetails.GetLowerBound(1) To vReInsurerDetails.GetUpperBound(1)
                                ...
                                oListItem = lvwReinsurance.Items.Add(CStr(vReInsurerDetails(ACIReInsurerName, lRow)).Trim(), "")

                                ' Assign details to other the columns
                                ' Column 2 Claim Ref

                                ListViewHelper.GetListViewSubItem(oListItem, 1).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatPercent, vFieldValue:=CStr(vReInsurerDetails(ACIReShare, lRow)).Trim())

                                '                If (ClaimMode = PMEdit) Then
                                'RWH(26/06/01) Split existing received_to_date value.

                                ListViewHelper.GetListViewSubItem(oListItem, 2).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatCurrency, vFieldValue:=CStr(cAmountAfterCoins * Conversion.Val(CStr(vReInsurerDetails(ACIReShare, lRow))) / 100))
                                '                Else
                                '                    oListItem.SubItems(2) = FormatField( _
                                ''                                            iFormatType:=PMFormatCurrency, _
                                ''                                            vFieldValue:=0)
                                ...
                                If ClaimMode = gPMConstants.PMEComponentAction.PMView Then
                                    ...
                                    ListViewHelper.GetListViewSubItem(oListItem, 3).Text = gPMFunctions.FormatField(iFormatType:=gPMConstants.PMEFormatStyle.PMFormatCurrency, vFieldValue:=CStr((m_cReceivedTodate - cReceivedToDateCoin) * Conversion.Val(CStr(vReInsurerDetails(ACIReShare, lRow))) / 100))
                                ...
                                oListItem.Tag = CStr(vReInsurerDetails(ACIReInsurerId, lRow))
    ...
    Private Sub CheckCurrentReserve()
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Or Not Information.IsArray(vDataArray) Then
            ...
            sMessage = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACFailedToGetCurrentReserve_U, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
        ...
        sTitle = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCloseClaimTitle, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))

        sMessage = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACCloseClaimDetail, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
        ...
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
            ...
            sMessage = CStr(iPMFunc.GetResData(iLangID:=g_iLanguageID, lId:=ACFailedToCloseClaim, iDataType:=gPMConstants.PMEResourseFileDataType.PMResString, bResFile:=My.Resources.ResourceManager))
            MessageBox.Show(sMessage, sTitle, MessageBoxButtons.OK)
            Exit Sub
        End If
