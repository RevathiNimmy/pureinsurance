...
Public NotInheritable Class Interface_Renamed
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness1, "bCLMThirdParty.Business", vInstanceManager:="ClientManager")
    ...
    Private Function CheckIAG() As Integer
        ...
        m_lReturn = iPMFunc.getProductOptionValue(v_vOptionNumber:=gPMConstants.SIRHiddenOptions.SIROPTIsNRMA, v_vBranch:=g_iSourceID, r_vUnderwriting:=CStr(vValue))
        If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
    ...
    Private Function ProcessInterface() As Integer
        ...
        Select Case m_sTransactionType
            ...
            Case ACTransTypeClaimSalvage, ACTransTypeClaimRecovery
