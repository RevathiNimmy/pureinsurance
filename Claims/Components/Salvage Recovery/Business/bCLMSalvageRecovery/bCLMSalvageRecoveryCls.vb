...
Friend NotInheritable Class CLMSalvageRecovery
    Implements IDisposable
    ' ***************************************************************** '
    ' Class Name: CLMSalvageRecovery
    '
    ' Date: 24/08/2000
    '
    ' Description: Describes the CLMSalvageRecovery attributes.
    '
    ' Edit History:Pandu
    ' ***************************************************************** '
    ...
    Private m_dCLMSalvageRecovery As dCLMSalvageRecovery.CLMSalvageRecovery
    ...
    Public Function Initialise(ByRef sUserName As String, ByRef sPassword As String, ByRef iUserID As Integer, ByRef iSourceID As Integer, ByRef iLanguageID As Integer, ByRef iCurrencyID As Integer, ByRef iLogLevel As Integer, ByRef sCallingAppName As String, Optional ByRef vDatabase As Object = Nothing) As Integer
        ...
        Try
            ...
            m_dCLMSalvageRecovery = New dCLMSalvageRecovery.CLMSalvageRecovery()

            m_lReturn = m_dCLMSalvageRecovery.Initialise(sUserName:=sUserName, sPassword:=sPassword, iUserID:=iUserID, iSourceID:=iSourceID, iLanguageID:=iLanguageID, iCurrencyID:=iCurrencyID, iLogLevel:=iLogLevel, sCallingAppName:=ACApp, vDatabase:=vDatabase)
    ...
    Protected Sub Dispose(disposing As Boolean)
        If Not Me.disposedValue Then
            ...
            If disposing Then
                If m_dCLMSalvageRecovery IsNot Nothing Then
                    m_dCLMSalvageRecovery.Dispose()

                End If
                m_dCLMSalvageRecovery = Nothing
            End If
        End If
        Me.disposedValue = True
    End Sub
    ...
    '
    ' Description: Returns the Default Values for the CLMSalvageRecovery.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    '
    ' Description: Sets the supplied CLMSalvageRecovery property values.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    '
    ' Description: Returns the supplied CLMSalvageRecovery property values.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    '
    ' Description: Sets the Default Values for a CLMSalvageRecovery.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
    ...
    '
    ' Description: Checks the CLMSalvageRecovery for Consistency.
    '
    ' Date :24/08/2000
    '
    ' Edit History :Pandu
