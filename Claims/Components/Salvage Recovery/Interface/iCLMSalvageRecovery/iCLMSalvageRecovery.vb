...
Module MainModule
 ...
 Public m_vLookupValues As Object
	...
	' Form
	Public Const ACInterfaceTitle As Integer = 100 'Salvage Recovery
	Public Const ACSalvageReceipt As Integer = 101 'Salvage Receipt
	Public Const ACSalvageDetails As Integer = 118 'Salvage Details
	...
	Public Const ACSalvageType As Integer = 106
	...
	Public Const ACSalvageAmount As Integer = 110
	...
	Public Const ACCurrentReserve As Integer = 123
	...
	'Constants For Salvage Details Screen
	Public Const ACSalvageInitialReserve As Integer = 208
	Public Const ACSalvageSalvageAmount As Integer = 209
	Public Const ACSalvageRevisedReserve As Integer = 210
	...
	Public Const ACInvalidSalvageAmount As Integer = 312
	...
	Public Const ACGetBussFail As Integer = 318
	'RWH(05/10/01) Constants for Close Claim messages.
	Public Const ACFailedToGetCurrentReserve As Integer = 319
	Public Const ACFailedToCloseClaim As Integer = 320
	Public Const ACInvalidAction As Integer = 321
	Public Const ACGenralDetailsFrame As Integer = 322
	Public Const ACCloseClaimTitle As Integer = 323
	Public Const ACCloseClaimDetail As Integer = 324
	
	' Alix - 21/05/2003 - VAT on claim payments
	Public Const ACTaxType As Integer = 325
	Public Const ACTaxBand As Integer = 326
	Public Const ACTaxAmount As Integer = 327
	Public Const ACNetAmount As Integer = 328
	
	Public Const ACSalvageRevisedReserveLoss As Integer = 329
	Public Const ACLossCurrency As Integer = 330
	Public Const ACReceiptCurrency As Integer = 331
	Public Const ACReceiptToLossRate As Integer = 332
	Public Const ACRevisedReserveLoss As Integer = 333
 ...
 Public g_oBusiness As Object
    ...
    'developer guide no. 107
    <ThreadStatic()> _
 Public g_oBusiness1 As Object
	
	
    'Get All Recovery Types for Salvage
    'developer guide no. 107
    <ThreadStatic()> _
 Public g_vSalvageRecoveryTypes As Object
