...
Imports SharedFiles
<System.Runtime.InteropServices.ProgId("CLMResvDefn_NET.CLMResvDefn")> _
Public NotInheritable Class CLMResvDefn
    ...
    Private m_lReserveTypeID As Integer '- Receipt Table also
    Private m_sDescription As String = ""
    Private m_lIncludeInTotal As Integer '- Receipt,Payment Table also
    Private m_sName As String = ""
    Private m_lIsExcess As Integer
    Private m_lIs_Indemnity As Integer
    Private m_lIs_Expense As Integer
    ...
    Public Property IncludeInTotal() As Integer
        Get
            ...
            Return m_lIncludeInTotal

        End Get
        Set(ByVal Value As Integer)

            m_lIncludeInTotal = Value

        End Set
    End Property

    Public Property IsExcess() As Integer
        Get
    ...
    Public Property Is_Indemnity() As Integer
        Get

            Return m_lIs_Indemnity

        End Get
        Set(ByVal Value As Integer)

            m_lIs_Indemnity = Value

        End Set
    End Property

    Public Property Is_Expense() As Integer
        Get

            Return m_lIs_Expense
    ...
    Private Function AddInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="IncludeInTotal", vValue:=CStr(IncludeInTotal), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
            ...
            m_lReturn = .Parameters.Add(sName:="IsExcess", vValue:=CStr(IsExcess), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="Is_Indemnity", vValue:=CStr(Is_Indemnity), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                Return gPMConstants.PMEReturnCode.PMFalse
            End If

            m_lReturn = .Parameters.Add(sName:="Is_Expense", vValue:=CStr(Is_Expense), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyInputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="ReserveTypeID", vValue:=CStr(ReserveTypeID), idirection:=gPMConstants.PMEParameterDirection.PMParamInput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function AddKeyOutputParam() As Integer
        ...
        With m_oDatabase
            ...
            m_lReturn = .Parameters.Add(sName:="ReserveTypeID", vValue:=CStr(0), idirection:=gPMConstants.PMEParameterDirection.PMParamOutput, iDataType:=gPMConstants.PMEDataType.PMLong)
    ...
    Private Function GetNewPrimaryKeyID() As Integer
        ...
        With m_oDatabase
            ...
            ReserveTypeID = .Parameters.Item("ReserveTypeID").Value
