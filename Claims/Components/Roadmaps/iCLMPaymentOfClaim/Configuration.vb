...
Module Configuration
	...
	Public Const ACApp As String = "iCLMPaymentOfClaim"
	
	' Work Manager Task code - THIS NEEDS TO BE EXACT!!!!!!!!!!!!!!!!!!!!!!
	Public Const ACWMTaskCode As String = "WMCLMPC"
	
	Public Const ACTaskDescription As String = "Payment Of Claim"
	...
	Public Const ACStepRiskDetails As Integer = 2
	Public Const ACStepCoinsurancePayment As Integer = 3
	
	Public Const ACMaxSteps As Integer = 3
	...
	Public Function SetupSteps() As Integer
		...
		Try 
			...
			m_lReturn = AddStep(v_vDescription:="Coinsurance Payment", v_vComponent:="iCLMCoinsuranceRecoveries.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionCompleteProcess, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
