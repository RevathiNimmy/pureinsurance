...
Module Configuration
	...
	Public Const ACApp As String = "iCLMMaintainClaim"
	
	' Work Manager Task code - THIS NEEDS TO BE EXACT!!!!!!!!!!!!!!!!!!!!!!
	Public Const ACWMTaskCode As String = "WMCLMMC"
	
	Public Const ACTaskDescription As String = "Maintain Claim"
	...
	Public Const ACStepEditClaimtextFiles As Integer = 2
	Public Const ACStepRiskDetails As Integer = 3
	Public Const ACStepInformationChecklist As Integer = 4
	Public Const ACStepThirdPartyRecovery As Integer = 5
	Public Const ACStepClaimLetter As Integer = 6
	Public Const ACStepClaimDiary As Integer = 7
	
	Public Const ACMaxSteps As Integer = 7
	...
	Public Function SetupSteps() As Integer
		...
		Try 
			...
			m_lReturn = AddStep(v_vDescription:="Edit Claim Text Files", v_vComponent:="iPMBTextFiles.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionForwardOne, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
			...
			m_lReturn = AddStep(v_vDescription:="Risk Details", v_vComponent:="iCLMRiskDetails.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionForwardOne, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
			...
			m_lReturn = AddStep(v_vDescription:="Information Checklist", v_vComponent:="iCLMInfoChklst.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionForwardOne, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
			...
			m_lReturn = AddStep(v_vDescription:="Third Party Recovery", v_vComponent:="iCLMThirdPartyRecovery.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionCompleteProcess, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
			...
			m_lReturn = AddStep(v_vDescription:="Claim Letter", v_vComponent:="iCLMGetClaimLetter.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionCompleteProcess, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
			...
			m_lReturn = AddStep(v_vDescription:="Claim Diary", v_vComponent:="iCLMCreateClaimDiary.Interface", v_vType:=gPMConstants.PMNavComponentDataForm, v_vOKAction:=gPMConstants.PMNavActionCompleteProcess, v_vCancelAction:=gPMConstants.PMNavActionAbortProcess, v_vOKSteps:=0, v_vCancelSteps:=0, v_vComponentAction:=gPMConstants.PMEComponentAction.PMEdit, v_vServerSide:=False, v_vCreateWorkManagerTask:=False)
