    ...
    Public Function ProcessCommand() As Integer
        ...
        Try
            ...
            Else
                ...
                m_lReturn = m_frmInterface.ShowMultiCurrencyDialogue()
                If m_lReturn = gPMConstants.PMEReturnCode.PMCancel Then
                    result = gPMConstants.PMEReturnCode.PMCancel
                ElseIf m_lReturn <> gPMConstants.PMEReturnCode.PMOK And m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                    Throw New System.Exception(Constants.vbObjectError.ToString() + ", , Function ShowMultiCurrencyDialogue failed.")
                End If
