...
Partial Friend Class frmMultiCurrency
    ...
    Private Sub frmMultiCurrency_Activated(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Activated
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            If m_lPartycnt = 0 Then
                uctSIRMultiCurrency1.AccountID = m_lClaimPayableAccountId
            End If
    ...
    Public Function InterfaceToProperties() As Integer
        ...
        Try
            ...
            m_cLossCurrencyAmount = uctSIRMultiCurrency1.LossCurrencyAmount
