...
Public NotInheritable Class Interface_Renamed
    ...
    Private m_oBusiness As bPMLock.User
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_m_oBusiness, "bPMLock.User", vInstanceManager:=gPMConstants.PMGetViaClientManager)
            m_oBusiness = temp_m_oBusiness

            If m_lReturn <> gPMConstants.PMEReturnCode.PMTrue Then
                iPMFunc.LogMessage(iType:=gPMConstants.PMELogLevel.PMLogOnError, sMsg:="Failed to create object ''.", vApp:=ACApp, vClass:=ACClass, vMethod:="Initialise", vErrNo:=Information.Err().Number, vErrDesc:=Information.Err().Description)
    ...
    Private Function ProcessInterface() As Integer
        ...
        If m_lClaimID <> 0 Then
            ...
            m_lReturn = m_oBusiness.UnlockKey(sKeyName:="claim_id", vKeyValue:=m_lClaimID, iUserID:=g_oObjectManager.UserID)
        End If
