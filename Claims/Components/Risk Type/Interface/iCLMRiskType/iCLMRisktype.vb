...
Public NotInheritable Class Interface_Renamed
    ...
    'Modified by Sudhanshu Behera on 6/3/2010 12:53:32 PM refer developer guide no. 50
    ...
    Public Function Initialise() As Integer
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bCLMRiskType.Business", vInstanceManager:="ClientManager")
            g_oBusiness = temp_g_oBusiness

            '******Changed Here For Making It Comaptible to Client Server Model***
            '******Added By Pandu - 12-10-2000 *******
            ...
            '******End of Change Here For Making It Comaptible to Client Server Model***
    ...
    Private Function LoadInterface() As Integer
        ...
        With frmInterface
            ...
            If ClaimBuilderIsEnable() Then
                .cmdGISScreen.Visible = True
                .cmdDefineFields.Visible = False
                .cmdGISScreen.Top = VB6.TwipsToPixelsY(3225) - 20
                .cmdDefineFields.Top = VB6.TwipsToPixelsY(2760)
                .CmdShowScreen.Visible = False
            Else
                .cmdGISScreen.Visible = False
                .cmdDefineFields.Visible = True
                .cmdGISScreen.Top = VB6.TwipsToPixelsY(2760)
                .cmdDefineFields.Top = VB6.TwipsToPixelsY(3225) - 20
                .CmdShowScreen.Visible = True
            End If
    ...
    Private Function ClaimBuilderIsEnable() As Boolean
        ...
        Try
            ...
            If gPMFunctions.ToSafeInteger(vResult) = 1 Then
                Return True
            Else
                Return False
            End If
