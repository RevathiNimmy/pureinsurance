...
Public NotInheritable Class Interface_Renamed
    ...
    'TN20010501 Start
    Private m_lDataMode As Integer '0 - risk and 1 - peril
    'TN20010501 End
    ...
    Public Function Initialise() As Integer Implements SSP.S4I.Interfaces.ILocalInterface.Initialise
        ...
        Try
            ...
            m_lReturn = g_oObjectManager.GetInstance(temp_g_oBusiness, "bCLMDefnFlds.Business", vInstanceManager:="ClientManager")
        ...
        Try
            ...
            For lRow As Integer = vKeyArray.GetLowerBound(1) To vKeyArray.GetUpperBound(1)
                ...
                Select Case CStr(vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyName, lRow)).Trim()
                    '            Case PMKeyNameMode
                    '                m_lMode& = CLng(vKeyArray(PMKeyValue, lRow&))
    ...
    Public Function GetKeys(ByRef vKeyArray(,) As Object) As Integer
        ...
        Try
            ...
            '    vKeyArray(PMKeyName, 0) = PMKeyNameMode

            vKeyArray(gPMConstants.PMENavLetGetKeyColPosition.PMKeyValue, 0) = m_lMode
    ...
    Public Function GetSummary(ByRef vSummaryArray As Object) As Integer
        ...
        '    vSummaryArray(PMNavSummValue, 0) = m_sTypeName$
        '
        '    ' {* USER DEFINED CODE (End) *}
        '
        '    Exit Function
    ...
    Private Function ProcessInterface() As Integer
        ...
        'ED 07102002 - Determine whether Underwriting or Broking
        '              Disable 'Tab' drop down when Underwriting
        ...
        frmInterface.cboTab.Visible = False
        frmInterface.lblTab.Visible = False
